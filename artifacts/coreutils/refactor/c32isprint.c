...
extern uc_general_category_t uc_general_category_or(uc_general_category_t category1, uc_general_category_t category2);
extern uc_general_category_t uc_general_category_and(uc_general_category_t category1, uc_general_category_t category2);
extern uc_general_category_t uc_general_category_and_not(uc_general_category_t category1, uc_general_category_t category2);
extern const char *uc_general_category_name(uc_general_category_t category);
extern const char *uc_general_category_long_name(uc_general_category_t category);
extern uc_general_category_t uc_general_category_byname(const char *category_name);
extern uc_general_category_t uc_general_category(ucs4_t uc);
extern bool uc_is_general_category(ucs4_t uc, uc_general_category_t category);
...
extern int uc_combining_class(ucs4_t uc);
extern const char *uc_combining_class_name(int ccc);
extern const char *uc_combining_class_long_name(int ccc);
extern int uc_combining_class_byname(const char *ccc_name);
enum 
{
  UC_BIDI_L,
  UC_BIDI_LRE,
...
extern const char *uc_bidi_class_name(int bidi_class);
extern const char *uc_bidi_category_name(int category);
extern const char *uc_bidi_class_long_name(int bidi_class);
extern int uc_bidi_class_byname(const char *bidi_class_name);
extern int uc_bidi_category_byname(const char *category_name);
extern int uc_bidi_class(ucs4_t uc);
extern int uc_bidi_category(ucs4_t uc);
extern bool uc_is_bidi_class(ucs4_t uc, int bidi_class);
extern bool uc_is_bidi_category(ucs4_t uc, int category);
extern int uc_decimal_value(ucs4_t uc);
extern int uc_digit_value(ucs4_t uc);
typedef struct 
{
  int numerator;
  int denominator;
} uc_fraction_t;
extern uc_fraction_t uc_numeric_value(ucs4_t uc);
extern bool uc_mirror_char(ucs4_t uc, ucs4_t *puc);
enum 
{
  UC_JOINING_TYPE_U,
  UC_JOINING_TYPE_T,
...
extern const char *uc_joining_type_name(int joining_type);
extern const char *uc_joining_type_long_name(int joining_type);
extern int uc_joining_type_byname(const char *joining_type_name);
extern int uc_joining_type(ucs4_t uc);
enum 
{
...
extern const char *uc_joining_group_name(int joining_group);
extern int uc_joining_group_byname(const char *joining_group_name);
extern int uc_joining_group(ucs4_t uc);
typedef struct 
{
...
extern uc_property_t uc_property_byname(const char *property_name);
...
extern const char *uc_indic_conjunct_break_name(int indic_conjunct_break);
extern int uc_indic_conjunct_break_byname(const char *indic_conjunct_break_name);
extern int uc_indic_conjunct_break(ucs4_t uc);
typedef struct 
{
...
extern const uc_script_t *uc_script(ucs4_t uc);
extern const uc_script_t *uc_script_byname(const char *script_name);
extern bool uc_is_script(ucs4_t uc, const uc_script_t *script);
extern void uc_all_scripts(const uc_script_t **scripts, size_t *count);
typedef struct 
{
  ucs4_t start;
  ucs4_t end;
...
extern const uc_block_t *uc_block(ucs4_t uc);
extern bool uc_is_block(ucs4_t uc, const uc_block_t *block);
extern void uc_all_blocks(const uc_block_t **blocks, size_t *count);
extern bool uc_is_c_whitespace(ucs4_t uc);
extern bool uc_is_java_whitespace(ucs4_t uc);
enum 
{
  UC_IDENTIFIER_START,
  UC_IDENTIFIER_VALID,
...
extern int uc_c_ident_category(ucs4_t uc);
extern int uc_java_ident_category(ucs4_t uc);
extern bool uc_is_alnum(ucs4_t uc);
extern bool uc_is_alpha(ucs4_t uc);
extern bool uc_is_cntrl(ucs4_t uc);
extern bool uc_is_digit(ucs4_t uc);
extern bool uc_is_graph(ucs4_t uc);
extern bool uc_is_lower(ucs4_t uc);
extern bool uc_is_print(ucs4_t uc);
extern bool uc_is_punct(ucs4_t uc);
extern bool uc_is_space(ucs4_t uc);
extern bool uc_is_upper(ucs4_t uc);
extern bool uc_is_xdigit(ucs4_t uc);
extern bool uc_is_blank(ucs4_t uc);
