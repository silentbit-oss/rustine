...
pub fn main() {
    ...
    }
    {
        ...
        // __AUTOCOMMENT__:df581d6a-7075-458f-897a-7d966db386a6 test_ld_library_path_parsing();
        println!("PASSED");
    }
    {
        print!("Running test_{}... ", "default_paths_setup");
        // __AUTOCOMMENT__:46c6cbcf-0ba0-4a97-a8fa-f13282d356b6 test_default_paths_setup();
        println!("PASSED");
    }
    {
        print!("Running test_{}... ", "elf_file_validation");
        // __AUTOCOMMENT__:4c2367b2-bc6e-4e5f-a7f4-8994dc61bbe6 test_elf_file_validation();
        println!("PASSED");
    }
    {
    ...
    }
    {
        ...
        // __AUTOCOMMENT__:35580589-cc95-4127-99f8-e172b48cc7a1 test_variable_interpolation();
        println!("PASSED");
    }
    {
