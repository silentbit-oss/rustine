...
#[no_mangle]
pub static mut inflate_copyright: [libc::c_char; 45] = unsafe {
    *::core::mem::transmute::<
        &[u8; 45],
        &[libc::c_char; 45],
    >(b" inflate 1.3 Copyright 1995-2023 Mark Adler \0")
};
#[no_mangle]
pub unsafe extern "C" fn inflate_table(
    ...
    static mut lext: [libc::c_ushort; 31] = [
        ...
        21 as libc::c_int as libc::c_ushort,
        16 as libc::c_int as libc::c_ushort,
        198 as libc::c_int as libc::c_ushort,
        203 as libc::c_int as libc::c_ushort,
    ];
    ...
    loop {
        ...
        if (*work.offset(sym as isize) as libc::c_uint).wrapping_add(1 as libc::c_uint)
            < match_0
        {
            ...
            here
                .op = *extra
                .offset(
                    (*work.offset(sym as isize) as libc::c_uint).wrapping_sub(match_0)
                        as isize,
                ) as libc::c_uchar;
            here
                .val = *base
