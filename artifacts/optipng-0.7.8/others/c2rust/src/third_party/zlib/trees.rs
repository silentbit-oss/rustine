...
unsafe extern "C" fn bi_flush(mut s: *mut deflate_state) {
    if (*s).bi_valid == 16 as libc::c_int {
        ...
        *((*s).pending_buf)
        ...
        (*s).pending = ((*s).pending).wrapping_add(1);
        *((*s).pending_buf).offset(fresh2 as isize) = (*s).bi_buf as Byte;
...
unsafe extern "C" fn bi_windup(mut s: *mut deflate_state) {
    if (*s).bi_valid > 8 as libc::c_int {
        ...
        *((*s).pending_buf)
        ...
        (*s).pending = ((*s).pending).wrapping_add(1);
        *((*s).pending_buf).offset(fresh5 as isize) = (*s).bi_buf as Byte;
    }
    (*s).bi_buf = 0 as libc::c_int as ush;
    (*s).bi_valid = 0 as libc::c_int;
}
unsafe extern "C" fn gen_codes(
    ...
    let mut code: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    ...
    while bits <= 15 as libc::c_int {
        code = code
            .wrapping_add(
                *bl_count.offset((bits - 1 as libc::c_int) as isize) as libc::c_uint,
            ) << 1 as libc::c_int;
...
unsafe extern "C" fn gen_bitlen(mut s: *mut deflate_state, mut desc: *mut tree_desc) {
            ...
            + 1 as libc::c_int
    {
        ...
        if !(n > max_code) {
            ...
            (*s)
                .opt_len = ((*s).opt_len)
                .wrapping_add(f as ulg * (bits + xbits) as libc::c_uint as ulg);
            if !stree.is_null() {
                (*s)
        ...
        while n != 0 as libc::c_int {
            ...
            if (*tree.offset(m as isize)).dl.len as libc::c_uint != bits as libc::c_uint
            {
                (*s)
                    ...
                    .wrapping_add(
                        (bits as ulg)
                            .wrapping_sub((*tree.offset(m as isize)).dl.len as ulg)
                            * (*tree.offset(m as isize)).fc.freq as ulg,
                    );
...
unsafe extern "C" fn build_tree(mut s: *mut deflate_state, mut desc: *mut tree_desc) {
    ...
    while (*s).heap_len < 2 as libc::c_int {
        ...
        if !stree.is_null() {
            (*s)
                .static_len = ((*s).static_len)
                .wrapping_sub((*stree.offset(node as isize)).dl.len as ulg);
        }
    }
    ...
    loop {
        ...
        let fresh7 = (*s).heap_len;
        (*s).heap_len = (*s).heap_len - 1;
        (*s).heap[1 as libc::c_int as usize] = (*s).heap[fresh7 as usize];
        ...
        let ref mut fresh8 = (*tree.offset(m as isize)).dl.dad;
        *fresh8 = node as ush;
        (*tree.offset(n as isize)).dl.dad = *fresh8;
        let fresh9 = node;
        node = node + 1;
        (*s).heap[1 as libc::c_int as usize] = fresh9;
        pqdownheap(s, tree, 1 as libc::c_int);
            ...
            if count < min_count {
                loop {
                    let mut len: libc::c_int = (*s).bl_tree[curlen as usize].dl.len
                        as libc::c_int;
                    if (*s).bi_valid > 16 as libc::c_int - len {
                        ...
                        *((*s).pending_buf)
                        ...
                        (*s)
                            ...
                            >> 16 as libc::c_int - (*s).bi_valid) as ush;
                        (*s).bi_valid += len - 16 as libc::c_int;
                    } else {
                        (*s)
                            .bi_buf = ((*s).bi_buf as libc::c_int
                ...
                if curlen != prevlen {
                    let mut len_0: libc::c_int = (*s).bl_tree[curlen as usize].dl.len
                        as libc::c_int;
                    if (*s).bi_valid > 16 as libc::c_int - len_0 {
                        ...
                        *((*s).pending_buf)
                        ...
                        (*s)
                            ...
                            >> 16 as libc::c_int - (*s).bi_valid) as ush;
                        (*s).bi_valid += len_0 - 16 as libc::c_int;
                    } else {
                        (*s)
                            .bi_buf = ((*s).bi_buf as libc::c_int
                            | ((*s).bl_tree[curlen as usize].fc.code as libc::c_int)
                ...
                let mut len_1: libc::c_int = (*s)
                    ...
                    .dl
                    .len as libc::c_int;
                if (*s).bi_valid > 16 as libc::c_int - len_1 {
                    ...
                    *((*s).pending_buf)
                    ...
                    (*s)
                        ...
                        >> 16 as libc::c_int - (*s).bi_valid) as ush;
                    (*s).bi_valid += len_1 - 16 as libc::c_int;
                } else {
                    (*s)
                        .bi_buf = ((*s).bi_buf as libc::c_int
                ...
                if (*s).bi_valid > 16 as libc::c_int - len_2 {
                    ...
                    *((*s).pending_buf)
                    ...
                    (*s)
                        ...
                        >> 16 as libc::c_int - (*s).bi_valid) as ush;
                    (*s).bi_valid += len_2 - 16 as libc::c_int;
                } else {
                    (*s)
                        .bi_buf = ((*s).bi_buf as libc::c_int
                ...
                let mut len_3: libc::c_int = (*s)
                    ...
                    .dl
                    .len as libc::c_int;
                if (*s).bi_valid > 16 as libc::c_int - len_3 {
                    ...
                    *((*s).pending_buf)
                    ...
                    (*s)
                        ...
                        >> 16 as libc::c_int - (*s).bi_valid) as ush;
                    (*s).bi_valid += len_3 - 16 as libc::c_int;
                } else {
                    (*s)
                        .bi_buf = ((*s).bi_buf as libc::c_int
                ...
                if (*s).bi_valid > 16 as libc::c_int - len_4 {
                    ...
                    *((*s).pending_buf)
                    ...
                    (*s)
                        ...
                        >> 16 as libc::c_int - (*s).bi_valid) as ush;
                    (*s).bi_valid += len_4 - 16 as libc::c_int;
                } else {
                    (*s)
                        .bi_buf = ((*s).bi_buf as libc::c_int
                        | ((count - 3 as libc::c_int) as ush as libc::c_int)
                ...
                let mut len_5: libc::c_int = (*s)
                    ...
                    .dl
                    .len as libc::c_int;
                if (*s).bi_valid > 16 as libc::c_int - len_5 {
                    ...
                    *((*s).pending_buf)
                    ...
                    (*s)
                        ...
                        >> 16 as libc::c_int - (*s).bi_valid) as ush;
                    (*s).bi_valid += len_5 - 16 as libc::c_int;
                } else {
                    (*s)
                        .bi_buf = ((*s).bi_buf as libc::c_int
                ...
                if (*s).bi_valid > 16 as libc::c_int - len_6 {
                    ...
                    *((*s).pending_buf)
                    ...
                    (*s)
                        ...
                        >> 16 as libc::c_int - (*s).bi_valid) as ush;
                    (*s).bi_valid += len_6 - 16 as libc::c_int;
                } else {
                    (*s)
                        .bi_buf = ((*s).bi_buf as libc::c_int
...
unsafe extern "C" fn build_bl_tree(mut s: *mut deflate_state) -> libc::c_int {
    ...
    (*s)
        .opt_len = ((*s).opt_len)
        .wrapping_add(
            (3 as libc::c_int as ulg
                * (max_blindex as ulg).wrapping_add(1 as libc::c_int as ulg))
                .wrapping_add(5 as libc::c_int as ulg)
                .wrapping_add(5 as libc::c_int as ulg)
                .wrapping_add(4 as libc::c_int as ulg),
        );
    return max_blindex;
}
unsafe extern "C" fn send_all_trees(
    ...
    if (*s).bi_valid > 16 as libc::c_int - len {
        ...
        *((*s).pending_buf)
        ...
        (*s)
            .bi_buf = (val as ush as libc::c_int >> 16 as libc::c_int - (*s).bi_valid)
            as ush;
        (*s).bi_valid += len - 16 as libc::c_int;
    } else {
        (*s)
    ...
    if (*s).bi_valid > 16 as libc::c_int - len_0 {
        ...
        *((*s).pending_buf)
        ...
        (*s)
            .bi_buf = (val_0 as ush as libc::c_int >> 16 as libc::c_int - (*s).bi_valid)
            as ush;
        (*s).bi_valid += len_0 - 16 as libc::c_int;
    } else {
        (*s)
    ...
    if (*s).bi_valid > 16 as libc::c_int - len_1 {
        ...
        *((*s).pending_buf)
        ...
        (*s)
            .bi_buf = (val_1 as ush as libc::c_int >> 16 as libc::c_int - (*s).bi_valid)
            as ush;
        (*s).bi_valid += len_1 - 16 as libc::c_int;
    } else {
        (*s)
...
unsafe extern "C" fn compress_block(
    ...
    let mut sx: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut code: libc::c_uint = 0;
    let mut extra: libc::c_int = 0;
    if (*s).sym_next != 0 as libc::c_int as uInt {
        loop {
            let fresh44 = sx;
            sx = sx.wrapping_add(1);
            dist = (*((*s).sym_buf).offset(fresh44 as isize) as libc::c_int
                & 0xff as libc::c_int) as libc::c_uint;
            let fresh45 = sx;
            sx = sx.wrapping_add(1);
            dist = dist
                .wrapping_add(
                    ((*((*s).sym_buf).offset(fresh45 as isize) as libc::c_int
                        & 0xff as libc::c_int) as libc::c_uint) << 8 as libc::c_int,
                );
            let fresh46 = sx;
            sx = sx.wrapping_add(1);
            lc = *((*s).sym_buf).offset(fresh46 as isize) as libc::c_int;
    ...
    if (*s).bi_valid > 16 as libc::c_int - len_4 {
        ...
        *((*s).pending_buf)
        ...
        (*s)
            .bi_buf = (val_4 as ush as libc::c_int >> 16 as libc::c_int - (*s).bi_valid)
            as ush;
        (*s).bi_valid += len_4 - 16 as libc::c_int;
    } else {
        (*s)
...
unsafe extern "C" fn detect_data_type(mut s: *mut deflate_state) -> libc::c_int {
    let mut block_mask: libc::c_ulong = 0xf3ffc07f as libc::c_ulong;
    let mut n: libc::c_int = 0;
    n = 0 as libc::c_int;
    while n <= 31 as libc::c_int {
        if block_mask & 1 as libc::c_int as libc::c_ulong != 0
...
pub unsafe extern "C" fn _tr_flush_block(
    ...
    if (*s).level > 0 as libc::c_int {
        ...
        opt_lenb = ((*s).opt_len)
            .wrapping_add(3 as libc::c_int as ulg)
            .wrapping_add(7 as libc::c_int as ulg) >> 3 as libc::c_int;
        static_lenb = ((*s).static_len)
            .wrapping_add(3 as libc::c_int as ulg)
            .wrapping_add(7 as libc::c_int as ulg) >> 3 as libc::c_int;
        if static_lenb <= opt_lenb || (*s).strategy == 4 as libc::c_int {
            opt_lenb = static_lenb;
        }
    } else {
        static_lenb = stored_len.wrapping_add(5 as libc::c_int as ulg);
        opt_lenb = static_lenb;
    }
    if stored_len.wrapping_add(4 as libc::c_int as ulg) <= opt_lenb && !buf.is_null() {
...
pub unsafe extern "C" fn _tr_tally(
    ...
    let fresh63 = (*s).sym_next;
    (*s).sym_next = ((*s).sym_next).wrapping_add(1);
    *((*s).sym_buf).offset(fresh63 as isize) = dist as uch;
    let fresh64 = (*s).sym_next;
    (*s).sym_next = ((*s).sym_next).wrapping_add(1);
    *((*s).sym_buf).offset(fresh64 as isize) = (dist >> 8 as libc::c_int) as uch;
    let fresh65 = (*s).sym_next;
    (*s).sym_next = ((*s).sym_next).wrapping_add(1);
    *((*s).sym_buf).offset(fresh65 as isize) = lc as uch;
    if dist == 0 as libc::c_int as libc::c_uint {
        (*s)
        ...
        dist;
        (*s)
            .dyn_ltree[(_length_code[lc as usize] as libc::c_int + 256 as libc::c_int
    ...
    return ((*s).sym_next == (*s).sym_end) as libc::c_int;
}
