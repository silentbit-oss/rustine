...
/* ========================================================================= */
unsafe extern "C" fn crc32_combine_(mut crc1: std::os::raw::c_ulong, mut crc2: std::os::raw::c_ulong,
...
/* ========================================================================= */
#[no_mangle]
pub unsafe extern "C" fn crc32_combine(mut crc1: std::os::raw::c_ulong, mut crc2: std::os::raw::c_ulong,
                                       mut len2: std::os::raw::c_long) -> std::os::raw::c_ulong {
    return crc32_combine_(crc1, crc2, len2);
}
#[no_mangle]
pub unsafe extern "C" fn crc32_combine64(mut crc1: std::os::raw::c_ulong, mut crc2: std::os::raw::c_ulong,
                                         mut len2: std::os::raw::c_long) -> std::os::raw::c_ulong {
    return crc32_combine_(crc1, crc2, len2);
}
