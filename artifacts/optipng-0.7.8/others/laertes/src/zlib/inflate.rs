 ...
 */
/* function prototypes */
unsafe extern "C" fn inflateStateCheck(mut strm: * mut crate::src::libpng::png::z_stream_s) -> std::os::raw::c_int {
    let mut state: * mut crate::src::zlib::infback::inflate_state<'_> = 0 as *mut inflate_state;
...
#[no_mangle]
pub unsafe extern "C" fn inflateResetKeep(mut strm: * mut crate::src::libpng::png::z_stream_s)
 -> std::os::raw::c_int {
    let mut state: * mut crate::src::zlib::infback::inflate_state<'_> = 0 as *mut inflate_state;
    ...
    (*state).head = Option::<&'_ mut crate::src::zlib::deflate::gz_header_s>::None;
...
#[no_mangle]
pub unsafe extern "C" fn inflateReset(mut strm: * mut crate::src::libpng::png::z_stream_s) -> std::os::raw::c_int {
    let mut state: * mut crate::src::zlib::infback::inflate_state<'_> = 0 as *mut inflate_state;
    if inflateStateCheck(strm) != 0 { return -(2 as std::os::raw::c_int) }
    state = (*strm).state as *mut inflate_state;
...
#[no_mangle]
pub unsafe extern "C" fn inflateReset2(mut strm: * mut crate::src::libpng::png::z_stream_s,
...
#[no_mangle]
pub unsafe extern "C" fn inflateInit2_(mut strm: * mut crate::src::libpng::png::z_stream_s,
                                       mut windowBits: std::os::raw::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn inflateInit_(mut strm: * mut crate::src::libpng::png::z_stream_s,
                                      mut version: * const std::os::raw::c_char,
                                      mut stream_size: std::os::raw::c_int)
 -> std::os::raw::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn inflatePrime(mut strm: * mut crate::src::libpng::png::z_stream_s,
 ...
 */
unsafe extern "C" fn updatewindow(mut strm: * mut crate::src::libpng::png::z_stream_s, mut end: * const std::os::raw::c_uchar,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn inflate(mut strm: * mut crate::src::libpng::png::z_stream_s, mut flush: std::os::raw::c_int)
 -> std::os::raw::c_int {
    ...
    let mut here: crate::src::zlib::infback::code = code{op: 0, bits: 0, val: 0,}; /* skip check */
    let mut last: crate::src::zlib::infback::code =
                        ...
                        if (here.val as std::os::raw::c_int) < 16 as std::os::raw::c_int {
                            ...
                            if (*state).have.wrapping_add(copy) >
                                   (*state).nlen.wrapping_add((*state).ndist)
                               {
                                ...
                                loop  {
                                    let mut fresh13 = copy;
                                    copy = copy.wrapping_sub(1);
                                    if !(fresh13 != 0) { break ; }
                                    let mut fresh14 = (*state).have;
                                    (*state).have =
               ...
               concerning the ENOUGH constants, which depend on those values */
                        ...
                        ret =
                            inflate_table(LENS, (*state).lens.as_mut_ptr(),
                                          (*state).nlen, Some(&mut (*state).next),
                                          Some(&mut (*state).lenbits),
                                          (*state).work.as_mut_ptr());
                        if ret != 0 {
                            (*strm).msg =
...
#[no_mangle]
pub unsafe extern "C" fn inflateEnd(mut strm: * mut crate::src::libpng::png::z_stream_s) -> std::os::raw::c_int {
    let mut state: * mut crate::src::zlib::infback::inflate_state<'_> = 0 as *mut inflate_state;
    if inflateStateCheck(strm) != 0 { return -(2 as std::os::raw::c_int) }
    state = (*strm).state as *mut inflate_state;
    if !(*state).window.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn inflateGetDictionary<'a1>(mut strm: * mut crate::src::libpng::png::z_stream_s,
                                              mut dictionary: * mut std::os::raw::c_uchar,
                                              mut dictLength: Option<&'a1 mut std::os::raw::c_uint>)
 -> std::os::raw::c_int {
    let mut state: * mut crate::src::zlib::infback::inflate_state<'_> = 0 as *mut inflate_state;
    /* check state */
    if inflateStateCheck(strm) != 0 { return -(2 as std::os::raw::c_int) }
    ...
    if !borrow(& dictLength).is_none() { *(borrow_mut(&mut dictLength)).unwrap() = (*state).whave }
    return 0 as std::os::raw::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn inflateSetDictionary(mut strm: * mut crate::src::libpng::png::z_stream_s,
                                              mut dictionary: * const std::os::raw::c_uchar,
                                              mut dictLength: std::os::raw::c_uint)
 -> std::os::raw::c_int {
    let mut state: * mut crate::src::zlib::infback::inflate_state<'_> = 0 as *mut inflate_state;
    let mut dictid: u64 = 0;
    let mut ret: i32 = 0;
    /* check state */
    if inflateStateCheck(strm) != 0 { return -(2 as std::os::raw::c_int) }
    state = (*strm).state as *mut inflate_state;
...
#[no_mangle]
pub unsafe extern "C" fn inflateGetHeader<'a1>(mut strm: * mut crate::src::libpng::png::z_stream_s,
                                          mut head: Option<&'a1 mut crate::src::zlib::deflate::gz_header_s>)
 -> std::os::raw::c_int {
    let mut state: * mut crate::src::zlib::infback::inflate_state<'_> = 0 as *mut inflate_state;
    /* check state */
    if inflateStateCheck(strm) != 0 { return -(2 as std::os::raw::c_int) }
    ...
    (*state).head = borrow_mut(&mut head);
    (*(borrow_mut(&mut head)).unwrap()).done = 0 as std::os::raw::c_int;
    return 0 as std::os::raw::c_int;
}
/*
 ...
 */
unsafe extern "C" fn syncsearch<'a1>(mut have: Option<&'a1 mut std::os::raw::c_uint>,
    ...
    got = *(borrow_mut(&mut have)).unwrap(); /* to restore bit buffer to byte string */
    ...
    *(borrow_mut(&mut have)).unwrap() = got;
    return next;
}
#[no_mangle]
pub unsafe extern "C" fn inflateSync(mut strm: * mut crate::src::libpng::png::z_stream_s) -> std::os::raw::c_int {
    let mut len: u32 = 0;
    let mut in_0: u64 = 0;
    let mut out: u64 = 0;
    ...
    if (*state).mode as std::os::raw::c_uint != SYNC as std::os::raw::c_int as std::os::raw::c_uint {
        ...
        (*state).have = 0 as std::os::raw::c_int as std::os::raw::c_uint;
        syncsearch(Some(&mut (*state).have), buf.as_mut_ptr(), len);
    }
    /* search available input */
    len = syncsearch(Some(&mut (*state).have), (*strm).next_in, (*strm).avail_in);
    (*strm).avail_in =
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn inflateSyncPoint(mut strm: * mut crate::src::libpng::png::z_stream_s)
 -> std::os::raw::c_int {
    let mut state: * mut crate::src::zlib::infback::inflate_state<'_> = 0 as *mut inflate_state;
    if inflateStateCheck(strm) != 0 { return -(2 as std::os::raw::c_int) }
    state = (*strm).state as *mut inflate_state;
...
#[no_mangle]
pub unsafe extern "C" fn inflateCopy(mut dest: * mut crate::src::libpng::png::z_stream_s,
                                     mut source: * mut crate::src::libpng::png::z_stream_s) -> std::os::raw::c_int {
    let mut state: * mut crate::src::zlib::infback::inflate_state<'_> = 0 as *mut inflate_state;
    let mut copy: * mut crate::src::zlib::infback::inflate_state<'_> = 0 as *mut inflate_state;
    let mut window: * mut u8 = 0 as *mut std::os::raw::c_uchar;
    let mut wsize: u32 = 0;
    /* check input */
...
#[no_mangle]
pub unsafe extern "C" fn inflateUndermine(mut strm: * mut crate::src::libpng::png::z_stream_s,
...
#[no_mangle]
pub unsafe extern "C" fn inflateValidate(mut strm: * mut crate::src::libpng::png::z_stream_s,
...
#[no_mangle]
pub unsafe extern "C" fn inflateMark(mut strm: * mut crate::src::libpng::png::z_stream_s) -> std::os::raw::c_long {
    let mut state: * mut crate::src::zlib::infback::inflate_state<'_> = 0 as *mut inflate_state;
...
#[no_mangle]
pub unsafe extern "C" fn inflateCodesUsed(mut strm: * mut crate::src::libpng::png::z_stream_s)
 -> std::os::raw::c_ulong {
    let mut state: * mut crate::src::zlib::infback::inflate_state<'_> = 0 as *mut inflate_state;
    if inflateStateCheck(strm) != 0 {
