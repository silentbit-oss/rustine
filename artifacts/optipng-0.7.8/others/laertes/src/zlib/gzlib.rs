...
extern "C" {
    ...
    #[no_mangle]
    fn lseek64(__fd: std::os::raw::c_int, __offset: std::os::raw::c_long, __whence: std::os::raw::c_int)
     -> std::os::raw::c_long;
    #[no_mangle]
...
#[repr(C)]
pub struct gz_state {
    pub x: crate::src::zlib::gzclose::gzFile_s,
    ...
    pub skip: std::os::raw::c_long,
    pub seek: std::os::raw::c_int,
    pub err: std::os::raw::c_int,
    pub msg: * mut std::os::raw::c_char,
    pub strm: crate::src::libpng::png::z_stream_s,
}
impl gz_state {
    pub const fn new() -> Self {
        gz_state {
        x: crate::src::zlib::gzclose::gzFile_s::new(),
        mode: 0,
        fd: 0,
        path: (0 as * mut std::os::raw::c_char),
        size: 0,
        want: 0,
        in_0: (0 as * mut std::os::raw::c_uchar),
        ...
        strm: crate::src::libpng::png::z_stream_s::new()
        }
    }
}

impl std::default::Default for gz_state {
    fn default() -> Self { gz_state::new() }
}

/* Local functions */
/* UNDER_CE */
/* Reset gzip file state */
unsafe extern "C" fn gz_reset(mut state: * mut crate::src::zlib::gzlib::gz_state) {
    (*state).x.have =
...
unsafe extern "C" fn gz_open(mut path: * const core::ffi::c_void,
                             mut fd: std::os::raw::c_int,
                             mut mode: * const std::os::raw::c_char) -> * mut crate::src::zlib::gzclose::gzFile_s {
    let mut state: * mut crate::src::zlib::gzlib::gz_state = 0 as *mut gz_state;
    let mut len: u64 = 0;
    let mut oflag: i32 = 0;
    let mut cloexec: i32 = 0 as std::os::raw::c_int;
    let mut exclusive: i32 = 0 as std::os::raw::c_int;
    /* check input */
...
pub unsafe extern "C" fn gzdopen(mut fd: std::os::raw::c_int,
    ...
    let mut gz: * mut crate::src::zlib::gzclose::gzFile_s = 0 as *mut gzFile_s;
    if fd == -(1 as std::os::raw::c_int) ||
           {
               path =
...
/* -- see zlib.h -- */
#[no_mangle]
pub unsafe extern "C" fn gzbuffer(mut file: * mut crate::src::zlib::gzclose::gzFile_s, mut size: std::os::raw::c_uint)
 -> std::os::raw::c_int {
    let mut state: * mut crate::src::zlib::gzlib::gz_state = (0 as * mut crate::src::zlib::gzlib::gz_state);
...
/* -- see zlib.h -- */
#[no_mangle]
pub unsafe extern "C" fn gzrewind(mut file: * mut crate::src::zlib::gzclose::gzFile_s) -> std::os::raw::c_int {
    let mut state: * mut crate::src::zlib::gzlib::gz_state = 0 as *mut gz_state;
...
/* -- see zlib.h -- */
#[no_mangle]
pub unsafe extern "C" fn gzseek64(mut file: * mut crate::src::zlib::gzclose::gzFile_s, mut offset: std::os::raw::c_long,
                                  mut whence: std::os::raw::c_int) -> std::os::raw::c_long {
    let mut n: u32 = 0;
    let mut ret: i64 = 0;
    let mut state: * mut crate::src::zlib::gzlib::gz_state = 0 as *mut gz_state;
    /* get internal structure and check integrity */
...
/* -- see zlib.h -- */
#[no_mangle]
pub unsafe extern "C" fn gzseek(mut file: * mut crate::src::zlib::gzclose::gzFile_s, mut offset: std::os::raw::c_long,
                                mut whence: std::os::raw::c_int) -> std::os::raw::c_long {
    let mut ret: i64 = 0;
...
/* -- see zlib.h -- */
#[no_mangle]
pub unsafe extern "C" fn gztell64(mut file: * mut crate::src::zlib::gzclose::gzFile_s) -> std::os::raw::c_long {
    let mut state: * mut crate::src::zlib::gzlib::gz_state = (0 as * mut crate::src::zlib::gzlib::gz_state);
    /* get internal structure and check integrity */
    if file.is_null() { return -(1 as std::os::raw::c_int) as off64_t }
    state = file as gz_statep;
...
/* -- see zlib.h -- */
#[no_mangle]
pub unsafe extern "C" fn gztell(mut file: * mut crate::src::zlib::gzclose::gzFile_s) -> std::os::raw::c_long {
    let mut ret: i64 = 0;
    ret = gztell64(file);
    return if ret == ret { ret } else { -(1 as std::os::raw::c_int) as std::os::raw::c_long };
}
/* -- see zlib.h -- */
#[no_mangle]
pub unsafe extern "C" fn gzoffset64(mut file: * mut crate::src::zlib::gzclose::gzFile_s) -> std::os::raw::c_long {
...
/* -- see zlib.h -- */
#[no_mangle]
pub unsafe extern "C" fn gzoffset(mut file: * mut crate::src::zlib::gzclose::gzFile_s) -> std::os::raw::c_long {
    let mut ret: i64 = 0;
    ret = gzoffset64(file);
    return if ret == ret { ret } else { -(1 as std::os::raw::c_int) as std::os::raw::c_long };
}
/* -- see zlib.h -- */
#[no_mangle]
pub unsafe extern "C" fn gzeof(mut file: * mut crate::src::zlib::gzclose::gzFile_s) -> std::os::raw::c_int {
    let mut state: * mut crate::src::zlib::gzlib::gz_state = (0 as * mut crate::src::zlib::gzlib::gz_state);
    /* get internal structure and check integrity */
...
/* -- see zlib.h -- */
#[no_mangle]
pub unsafe extern "C" fn gzerror<'a1>(mut file: * mut crate::src::zlib::gzclose::gzFile_s,
 ...
 -> * const std::os::raw::c_char {
    ...
    if !borrow(& errnum).is_none() { *(borrow_mut(&mut errnum)).unwrap() = (*state).err }
...
/* -- see zlib.h -- */
#[no_mangle]
pub unsafe extern "C" fn gzclearerr(mut file: * mut crate::src::zlib::gzclose::gzFile_s) {
    let mut state: * mut crate::src::zlib::gzlib::gz_state = 0 as *mut gz_state;
    /* get internal structure and check integrity */
...
/* Create an error message in allocated memory and set state->err and
   ...
   out of memory. */
#[no_mangle]
pub unsafe extern "C" fn gz_error(mut state: * mut crate::src::zlib::gzlib::gz_state, mut err: std::os::raw::c_int,
