...
pub static mut z_errmsg: [* mut std::os::raw::c_char; 10] =
    [(0 as * mut std::os::raw::c_char),(0 as * mut std::os::raw::c_char),(0 as * mut std::os::raw::c_char),(0 as * mut std::os::raw::c_char),(0 as * mut std::os::raw::c_char),(0 as * mut std::os::raw::c_char),(0 as * mut std::os::raw::c_char),(0 as * mut std::os::raw::c_char),(0 as * mut std::os::raw::c_char),(0 as * mut std::os::raw::c_char),]; unsafe fn laertes_init_z_errmsg() {
z_errmsg = [b"need dictionary\x00" as *const u8 as *const std::os::raw::c_char as
...
#[no_mangle]
pub extern "C" fn zlibCompileFlags() -> std::os::raw::c_ulong {
    let mut flags: u64 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn zcalloc(mut opaque: * mut core::ffi::c_void, mut items: std::os::raw::c_uint,
...
#[no_mangle]
pub unsafe extern "C" fn zcfree(mut opaque: * mut core::ffi::c_void, mut ptr: * mut core::ffi::c_void) {
    free(ptr);
}
