...
/* ========================================================================= */
#[no_mangle]
pub unsafe extern "C" fn adler32_z(mut adler: std::os::raw::c_ulong, mut buf: * const std::os::raw::c_uchar,
    ...
    if len < 16 as std::os::raw::c_int as std::os::raw::c_ulong {
        loop  {
            let mut fresh0 = len; /* only added so many BASE's */
...
/* ========================================================================= */
#[no_mangle]
pub unsafe extern "C" fn adler32(mut adler: std::os::raw::c_ulong, mut buf: * const std::os::raw::c_uchar,
                                 mut len: std::os::raw::c_uint) -> std::os::raw::c_ulong {
...
/* @(#) $Id$ */
/* ========================================================================= */
 extern "C" fn adler32_combine_(mut adler1: std::os::raw::c_ulong, mut adler2: std::os::raw::c_ulong,
                                      mut len2: std::os::raw::c_long) -> std::os::raw::c_ulong {
    let mut sum1: u64 = 0;
    let mut sum2: u64 = 0;
    let mut rem: u32 = 0;
...
/* ========================================================================= */
#[no_mangle]
pub extern "C" fn adler32_combine(mut adler1: std::os::raw::c_ulong, mut adler2: std::os::raw::c_ulong,
                                         mut len2: std::os::raw::c_long) -> std::os::raw::c_ulong {
    return adler32_combine_(adler1, adler2, len2);
}
#[no_mangle]
pub extern "C" fn adler32_combine64(mut adler1: std::os::raw::c_ulong,
                                           mut adler2: std::os::raw::c_ulong,
                                           mut len2: std::os::raw::c_long) -> std::os::raw::c_ulong {
    return adler32_combine_(adler1, adler2, len2);
}
