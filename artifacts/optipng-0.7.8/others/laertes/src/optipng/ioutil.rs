...
extern "C" {
    ...
    fn access(__name: * const std::os::raw::c_char, __type: std::os::raw::c_int)
     -> std::os::raw::c_int;
    #[no_mangle]
    fn chown(__file: * const std::os::raw::c_char, __owner: std::os::raw::c_uint, __group: std::os::raw::c_uint)
     -> std::os::raw::c_int;
    #[no_mangle]
    fn unlink(__name: * const std::os::raw::c_char) -> std::os::raw::c_int;
    #[no_mangle]
    fn stat(__file: * const std::os::raw::c_char, __buf: * mut crate::src::optipng::ioutil::stat) -> std::os::raw::c_int;
    #[no_mangle]
    fn fstat(__fd: std::os::raw::c_int, __buf: * mut crate::src::optipng::ioutil::stat) -> std::os::raw::c_int;
    #[no_mangle]
    fn chmod(__file: * const std::os::raw::c_char, __mode: std::os::raw::c_uint) -> std::os::raw::c_int;
    #[no_mangle]
    fn mkdir(__path: * const std::os::raw::c_char, __mode: std::os::raw::c_uint) -> std::os::raw::c_int;
    #[no_mangle]
    fn utimensat(__fd: std::os::raw::c_int, __path: * const std::os::raw::c_char,
                 __times: * const crate::src::optipng::ioutil::timespec, __flags: std::os::raw::c_int)
     -> std::os::raw::c_int;
}
...
pub struct __mbstate_t {
    ...
    pub __value: crate::src::optipng::ioutil::C2RustUnnamed,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub struct _G_fpos_t {
    pub __pos: std::os::raw::c_long,
    pub __state: crate::src::optipng::ioutil::__mbstate_t,
}
...
pub struct stat {
    ...
    pub st_atim: crate::src::optipng::ioutil::timespec,
    pub st_mtim: crate::src::optipng::ioutil::timespec,
    pub st_ctim: crate::src::optipng::ioutil::timespec,
...
impl stat {
    pub const fn new() -> Self {
        ...
        st_blksize: 0,
        st_blocks: 0,
        st_atim: crate::src::optipng::ioutil::timespec::new(),
        st_mtim: crate::src::optipng::ioutil::timespec::new(),
        st_ctim: crate::src::optipng::ioutil::timespec::new(),
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn opng_ftello(mut stream: * mut crate::src::gifread::gifread::_IO_FILE)
 -> std::os::raw::c_long {
    /* generic */
    return ftell(stream);
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn opng_fseeko(mut stream: * mut crate::src::gifread::gifread::_IO_FILE,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn opng_freado(mut stream: * mut crate::src::gifread::gifread::_IO_FILE,
                                     mut offset: std::os::raw::c_long,
                                     mut whence: std::os::raw::c_int,
                                     mut block: * mut core::ffi::c_void,
                                     mut blocksize: std::os::raw::c_ulong) -> std::os::raw::c_ulong {
    let mut pos: crate::src::optipng::ioutil::_G_fpos_t =
        fpos_t{__pos: 0,
               __state:
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn opng_fwriteo(mut stream: * mut crate::src::gifread::gifread::_IO_FILE,
                                      mut offset: std::os::raw::c_long,
                                      mut whence: std::os::raw::c_int,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn opng_fgetsize<'a1>(mut stream: * mut crate::src::gifread::gifread::_IO_FILE,
                                       mut size: Option<&'a1 mut std::os::raw::c_ulong>)
 -> std::os::raw::c_int {
    let mut sbuf: crate::src::optipng::ioutil::stat =
        stat{st_dev: 0,
             st_ino: 0,
             st_nlink: 0,
             st_mode: 0,
    ...
    *(borrow_mut(&mut size)).unwrap() = sbuf.st_size as opng_fsize_t;
...
pub unsafe extern "C" fn opng_path_replace_dir(mut buffer: * mut std::os::raw::c_char,
                                               ...
                                               mut new_dirname:
                                                   * const std::os::raw::c_char)
 -> * mut std::os::raw::c_char {
    let mut path: * const i8 = 0 as *const std::os::raw::c_char;
...
pub unsafe extern "C" fn opng_os_copy_attr(mut src_path: * const std::os::raw::c_char,
 ...
 -> std::os::raw::c_int {
    ...
    let mut times: [crate::src::optipng::ioutil::timespec; 2] = [timespec{tv_sec: 0, tv_nsec: 0,}; 2];
...
pub unsafe extern "C" fn opng_os_test_eq(mut path1: * const std::os::raw::c_char,
 ...
 -> std::os::raw::c_int {
    let mut sbuf1: crate::src::optipng::ioutil::stat =
        stat{st_dev: 0,
             st_ino: 0,
             st_nlink: 0,
             st_mode: 0,
             ...
             st_ctim: timespec{tv_sec: 0, tv_nsec: 0,},
             __glibc_reserved: [0; 3],};
    let mut sbuf2: crate::src::optipng::ioutil::stat =
        stat{st_dev: 0,
             st_ino: 0,
             st_nlink: 0,
             st_mode: 0,
