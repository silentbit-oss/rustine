 ...
 */
#[no_mangle]
pub extern "C" fn opng_bitset_count(mut set: std::os::raw::c_uint)
 -> std::os::raw::c_uint {
 ...
 */
#[no_mangle]
pub extern "C" fn opng_bitset_find_first(mut set: std::os::raw::c_uint)
 -> std::os::raw::c_int {
    let mut i: i32 = 0;
 ...
 */
#[no_mangle]
pub extern "C" fn opng_bitset_find_next(mut set: std::os::raw::c_uint,
 ...
 */
#[no_mangle]
pub extern "C" fn opng_bitset_find_last(mut set: std::os::raw::c_uint)
 -> std::os::raw::c_int {
    let mut i: i32 = 0;
 ...
 */
#[no_mangle]
pub extern "C" fn opng_bitset_find_prev(mut set: std::os::raw::c_uint,
                                               mut elt: std::os::raw::c_int)
 -> std::os::raw::c_int {
    let mut i: i32 = 0;
    i =
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn opng_strparse_rangeset_to_bitset<'a1>(mut out_set:
 ...
 -> std::os::raw::c_int {
    ...
    let mut num1: i32 = 0;
    let mut num2: i32 = 0;
    let mut err_invalid: i32 = 0;
    let mut err_range: i32 = 0;
    ...
    if err_invalid != 0 {
        ...
        *(borrow_mut(&mut out_set)).unwrap() = 0 as std::os::raw::c_uint;
        return -(1 as std::os::raw::c_int)
    } else if err_range != 0 {
        /* Range error. */
        ...
        *(borrow_mut(&mut out_set)).unwrap() = !(0 as std::os::raw::c_uint);
        ...
        /* Success. */
        *(borrow_mut(&mut out_set)).unwrap() = result;
