...
// hint:  ['ch_ref is a mutable refrence to int', 'ch8_ref is a mutable refrence to int', 'ch16_ref is a mutable refrence to int', 'ch24_ref is a mutable refrence to int', 'i_ref is a mutable refrence to size_t']
