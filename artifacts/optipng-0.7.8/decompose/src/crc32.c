...
// hint:  ['crc_ref is a mutable refrence to unsigned long', 'len_ref is a mutable refrence to z_size_t', 'buf_idx_ref is a mutable refrence to unsigned int']
void helper_crc32_z_1(unsigned long * const crc_ref, z_size_t * const len_ref, unsigned int * const buf_idx_ref, const unsigned char * const buf)
{
...
// hint:  ['words_idx_ref is a mutable refrence to unsigned int', 'k_ref is a mutable refrence to int', 'crc0_ref is a mutable refrence to z_crc_t', 'word0_ref is a mutable refrence to z_word_t', 'crc1_ref is a mutable refrence to z_crc_t', 'word1_ref is a mutable refrence to z_word_t', 'crc2_ref is a mutable refrence to z_crc_t', 'word2_ref is a mutable refrence to z_word_t', 'crc3_ref is a mutable refrence to z_crc_t', 'word3_ref is a mutable refrence to z_word_t', 'crc4_ref is a mutable refrence to z_crc_t', 'word4_ref is a mutable refrence to z_word_t']
void helper_helper_helper_crc32_z_2_1_1(unsigned int * const words_idx_ref, int * const k_ref, z_crc_t * const crc0_ref, z_word_t * const word0_ref, z_crc_t * const crc1_ref, z_word_t * const word1_ref, z_crc_t * const crc2_ref, z_word_t * const word2_ref, z_crc_t * const crc3_ref, z_word_t * const word3_ref, z_crc_t * const crc4_ref, z_word_t * const word4_ref, const z_word_t * const words)
{
...
// hint:  ['crc_ref is a mutable refrence to unsigned long', 'words_idx_ref is a mutable refrence to unsigned int', 'k_ref is a mutable refrence to int']
void helper_helper_crc32_z_2_1(unsigned long * const crc_ref, unsigned int * const words_idx_ref, int * const k_ref, z_size_t blks, const z_word_t * const words)
{
  unsigned long crc = *crc_ref;
  unsigned int words_idx = *words_idx_ref;
  int k = *k_ref;
...
// hint:  ['words_idx_ref is a mutable refrence to unsigned int', 'k_ref is a mutable refrence to int', 'crc0_ref is a mutable refrence to z_word_t', 'word0_ref is a mutable refrence to z_word_t', 'crc1_ref is a mutable refrence to z_word_t', 'word1_ref is a mutable refrence to z_word_t', 'crc2_ref is a mutable refrence to z_word_t', 'word2_ref is a mutable refrence to z_word_t', 'crc3_ref is a mutable refrence to z_word_t', 'word3_ref is a mutable refrence to z_word_t', 'crc4_ref is a mutable refrence to z_word_t', 'word4_ref is a mutable refrence to z_word_t']
void helper_helper_helper_crc32_z_2_2_1(unsigned int * const words_idx_ref, int * const k_ref, z_word_t * const crc0_ref, z_word_t * const word0_ref, z_word_t * const crc1_ref, z_word_t * const word1_ref, z_word_t * const crc2_ref, z_word_t * const word2_ref, z_word_t * const crc3_ref, z_word_t * const word3_ref, z_word_t * const crc4_ref, z_word_t * const word4_ref, const z_word_t * const words)
{
  unsigned int words_idx = *words_idx_ref;
  int k = *k_ref;
...
// hint:  ['crc_ref is a mutable refrence to unsigned long', 'words_idx_ref is a mutable refrence to unsigned int', 'k_ref is a mutable refrence to int']
void helper_helper_crc32_z_2_2(unsigned long * const crc_ref, unsigned int * const words_idx_ref, int * const k_ref, z_size_t blks, const z_word_t * const words)
{
  unsigned long crc = *crc_ref;
  unsigned int words_idx = *words_idx_ref;
  int k = *k_ref;
...
// hint:  ['crc_ref is a mutable refrence to unsigned long', 'len_ref is a mutable refrence to z_size_t', 'buf_idx_ref is a mutable refrence to unsigned int']
void helper_crc32_z_2(unsigned long * const crc_ref, z_size_t * const len_ref, unsigned int * const buf_idx_ref, const unsigned char * const buf)
{
  unsigned long crc = *crc_ref;
  z_size_t len = *len_ref;
  unsigned int buf_idx = *buf_idx_ref;
...
unsigned long crc32_z(unsigned long crc, const unsigned char *buf, z_size_t len)
{
