...
pub unsafe extern "C" fn opl_emu_set_reset_status(
    ...
    return ((*emu).m_status as uint32_t
        & !opl_emu_registers_status_mask(&mut (*emu).m_regs)) as uint8_t;
}
#[no_mangle]
pub unsafe extern "C" fn opl_emu_init(mut emu: *mut opl_emu_t) {
    ...
    while chnum < 18 as libc::c_int as uint32_t {
        opl_emu_fm_channel_init(
            &mut *((*emu).m_channel).as_mut_ptr().offset(chnum as isize),
            &mut (*emu).m_regs,
    ...
    while opnum < (18 as libc::c_int * 2 as libc::c_int) as uint32_t {
        opl_emu_fm_operator_init(
            &mut *((*emu).m_operator).as_mut_ptr().offset(opnum as isize),
            &mut (*emu).m_regs,
...
pub unsafe extern "C" fn opl_emu_reset(mut emu: *mut opl_emu_t) {
            ...
            .wrapping_div(::core::mem::size_of::<opl_emu_fm_channel>() as libc::c_ulong)
    {
        opl_emu_fm_channel_reset(
            &mut *((*emu).m_channel).as_mut_ptr().offset(i as isize),
        );
        i += 1;
        i;
    }
            ...
            .wrapping_div(::core::mem::size_of::<opl_emu_fm_operator>() as libc::c_ulong)
    {
        opl_emu_fm_operator_reset(
            &mut *((*emu).m_operator).as_mut_ptr().offset(i_0 as isize),
        );
        i_0 += 1;
        i_0;
    }
    ...
    while chnum_0 < 18 as libc::c_int as uint32_t {
        if opl_emu_bitfield(chanmask, chnum_0 as libc::c_int, 1 as libc::c_int) != 0 {
            opl_emu_fm_channel_clock(
                &mut *((*emu).m_channel).as_mut_ptr().offset(chnum_0 as isize),
                (*emu).m_env_counter,
                lfo_raw_pm,
            );
        }
...
pub unsafe extern "C" fn opl_emu_out(
    ...
    if opl_emu_registers_rhythm_enable(&mut (*emu).m_regs) != 0 {
        let mut op13phase: uint32_t = opl_emu_fm_operator_phase(
            &mut *((*emu).m_operator).as_mut_ptr().offset(13 as libc::c_int as isize),
        );
        let mut op17phase: uint32_t = opl_emu_fm_operator_phase(
            &mut *((*emu).m_operator).as_mut_ptr().offset(17 as libc::c_int as isize),
        );
    ...
    ) != 0
    {
        if keyon_channel < 18 as libc::c_int as uint32_t {
            opl_emu_fm_channel_keyonoff(
                &mut *((*emu).m_channel).as_mut_ptr().offset(keyon_channel as isize),
                keyon_opmask,
        ...
        {
            opl_emu_fm_channel_keyonoff(
                &mut *((*emu).m_channel).as_mut_ptr().offset(6 as libc::c_int as isize),
            ...
            opl_emu_fm_channel_keyonoff(
                &mut *((*emu).m_channel).as_mut_ptr().offset(7 as libc::c_int as isize),
            ...
            opl_emu_fm_channel_keyonoff(
                &mut *((*emu).m_channel).as_mut_ptr().offset(8 as libc::c_int as isize),
...
pub unsafe extern "C" fn opl_emu_assign_operators(mut emu: *mut opl_emu_t) {
    ...
    opl_emu_registers_operator_map(&mut (*emu).m_regs, &mut map);
    let mut chnum: uint32_t = 0 as libc::c_int as uint32_t;
    while chnum < 18 as libc::c_int as uint32_t {
    ...
    if enable != 0 && (*emu).m_timer_running[tnum as usize] == 0 {
        let mut period: uint32_t = if tnum == 0 as libc::c_int as uint32_t {
            (1024 as libc::c_int as uint32_t)
                .wrapping_sub(opl_emu_registers_timer_a_value(&mut (*emu).m_regs))
        } else {
            16 as libc::c_int as uint32_t
                * (256 as libc::c_int as uint32_t)
                    .wrapping_sub(opl_emu_registers_timer_b_value(&mut (*emu).m_regs))
        };
...
pub unsafe extern "C" fn opl_emu_registers_init(mut regs: *mut opl_emu_registers) {
    ...
    let mut wf0: *mut uint16_t = &mut *(*((*regs).m_waveform)
        .as_mut_ptr()
        .offset(0 as libc::c_int as isize))
        .as_mut_ptr()
        .offset(0 as libc::c_int as isize) as *mut uint16_t;
    let mut wf1: *mut uint16_t = &mut *(*((*regs).m_waveform)
        .as_mut_ptr()
        .offset((1 as libc::c_int % 8 as libc::c_int) as isize))
        .as_mut_ptr()
        .offset(0 as libc::c_int as isize) as *mut uint16_t;
    let mut wf2: *mut uint16_t = &mut *(*((*regs).m_waveform)
        .as_mut_ptr()
        .offset((2 as libc::c_int % 8 as libc::c_int) as isize))
        .as_mut_ptr()
        .offset(0 as libc::c_int as isize) as *mut uint16_t;
    let mut wf3: *mut uint16_t = &mut *(*((*regs).m_waveform)
        .as_mut_ptr()
        .offset((3 as libc::c_int % 8 as libc::c_int) as isize))
        .as_mut_ptr()
        .offset(0 as libc::c_int as isize) as *mut uint16_t;
    let mut wf4: *mut uint16_t = &mut *(*((*regs).m_waveform)
        .as_mut_ptr()
        .offset((4 as libc::c_int % 8 as libc::c_int) as isize))
        .as_mut_ptr()
        .offset(0 as libc::c_int as isize) as *mut uint16_t;
    let mut wf5: *mut uint16_t = &mut *(*((*regs).m_waveform)
        .as_mut_ptr()
        .offset((5 as libc::c_int % 8 as libc::c_int) as isize))
        .as_mut_ptr()
        .offset(0 as libc::c_int as isize) as *mut uint16_t;
    let mut wf6: *mut uint16_t = &mut *(*((*regs).m_waveform)
        .as_mut_ptr()
        .offset((6 as libc::c_int % 8 as libc::c_int) as isize))
        .as_mut_ptr()
        .offset(0 as libc::c_int as isize) as *mut uint16_t;
    let mut wf7: *mut uint16_t = &mut *(*((*regs).m_waveform)
        .as_mut_ptr()
...
pub unsafe extern "C" fn opl_emu_registers_clock_noise_and_lfo(
    ...
    return opl_emu_opl_clock_noise_and_lfo(
        &mut (*regs).m_noise_lfsr,
        &mut (*regs).m_lfo_am_counter,
        &mut (*regs).m_lfo_pm_counter,
        &mut (*regs).m_lfo_am,
        opl_emu_registers_lfo_am_depth(regs),
...
pub unsafe extern "C" fn opl_emu_fm_operator_prepare(
    ...
    opl_emu_fm_operator_clock_keystate(
        fmop,
        ((*fmop).m_keyon_live as libc::c_int != 0 as libc::c_int) as libc::c_int
            as uint32_t,
    );
    (*fmop)
...
pub unsafe extern "C" fn opl_write(
    ...
    let mut emu: *mut opl_emu_t = &mut (*opl).opl_emu;
    let mut i: libc::c_int = 0 as libc::c_int;
    while i < count {
...
pub unsafe extern "C" fn opl_midi_noteon_op2(
    ...
    let mut timbre: *mut opl_timbre_t = if vindex == 0 as libc::c_int {
        &mut *((*opl).opl_gmtimbres).as_mut_ptr().offset(instrument as isize)
            as *mut opl_timbre_t
    } else {
        &mut *((*opl).opl_gmtimbres_voice2).as_mut_ptr().offset(instrument as isize)
            as *mut opl_timbre_t
    };
        ...
        as libc::c_int >= 0 as libc::c_int
    {
        ...
        if voice < 0 as libc::c_int {
            ...
            opl_midi_noteoff_op2(
                opl,
                (*opl).voices2notes[voice as usize].channel as libc::c_int,
...
pub unsafe extern "C" fn opl_loadbank_op2(
    ...
    while i < 175 as libc::c_int {
        ...
        opl_load_op2_voice(
            &mut *((*opl).opl_gmtimbres).as_mut_ptr().offset(i as isize),
            buff,
        );
        (*opl).opl_gmtimbres[i as usize].notenum = fixednote;
        buff = buff.offset(16 as libc::c_int as isize);
        opl_load_op2_voice(
            &mut *((*opl).opl_gmtimbres_voice2).as_mut_ptr().offset(i as isize),
            buff,
        );
