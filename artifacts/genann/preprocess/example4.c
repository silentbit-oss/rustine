# 0 "/app/subjects/genann/example4.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/app/subjects/genann/example4.c"
...
# 7 "/app/subjects/genann/example4.c" 2
