# 0 "/app/subjects/genann/example2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/app/subjects/genann/example2.c"
...
# 6 "/app/subjects/genann/example2.c" 2
