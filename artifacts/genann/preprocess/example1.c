# 0 "/app/subjects/genann/example1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/app/subjects/genann/example1.c"
...
# 5 "/app/subjects/genann/example1.c" 2
