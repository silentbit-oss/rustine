# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/layout-set.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/layout-set.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/layout-set.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/layout-set.c" 2
...
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/layout-set.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 24 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/layout-set.c" 2
...
layout_set_lookup(const char *name)
{
 ...
 for (i = 0; i < (sizeof((layout_sets)) / sizeof((layout_sets)[0])); i++) {
...
layout_set_main_h(struct window *w)
{
 ...
 do { (lcmain)->entry.tqe_next = 0; (lcmain)->entry.tqe_prev = (&lc->cells)->tqh_last; *(&lc->cells)->tqh_last = (lcmain); (&lc->cells)->tqh_last = &(lcmain)->entry.tqe_next; } while (0);
 ...
 for (j = 0; j < rows; j++) {
  ...
  do { (lcrow)->entry.tqe_next = 0; (lcrow)->entry.tqe_prev = (&lc->cells)->tqh_last; *(&lc->cells)->tqh_last = (lcrow); (&lc->cells)->tqh_last = &(lcrow)->entry.tqe_next; } while (0);
  ...
  for (i = 0; i < columns; i++) {
   ...
   do { (lcchild)->entry.tqe_next = 0; (lcchild)->entry.tqe_prev = (&lcrow->cells)->tqh_last; *(&lcrow->cells)->tqh_last = (lcchild); (&lcrow->cells)->tqh_last = &(lcchild)->entry.tqe_next; } while (0);
  ...
  if (w->sx <= used)
   continue;
  lcchild = (*(((struct layout_cells *)((&lcrow->cells)->tqh_last))->tqh_last));
 ...
 if (w->sy > used) {
  lcrow = (*(((struct layout_cells *)((&lc->cells)->tqh_last))->tqh_last));
...
layout_set_main_v(struct window *w)
{
 ...
 for (j = 0; j < columns; j++) {
  ...
  do { (lccolumn)->entry.tqe_next = 0; (lccolumn)->entry.tqe_prev = (&lc->cells)->tqh_last; *(&lc->cells)->tqh_last = (lccolumn); (&lc->cells)->tqh_last = &(lccolumn)->entry.tqe_next; } while (0);
  ...
  for (i = 0; i < rows; i++) {
   ...
   layout_set_size(lcchild, width, height, 0, 0);
   layout_make_leaf(lcchild, wp);
   do { (lcchild)->entry.tqe_next = 0; (lcchild)->entry.tqe_prev = (&lccolumn->cells)->tqh_last; *(&lccolumn->cells)->tqh_last = (lcchild); (&lccolumn->cells)->tqh_last = &(lcchild)->entry.tqe_next; } while (0);
  ...
  if (w->sy <= used)
   continue;
  lcchild = (*(((struct layout_cells *)((&lccolumn->cells)->tqh_last))->tqh_last));
 ...
 if (w->sx > used) {
  lccolumn = (*(((struct layout_cells *)((&lc->cells)->tqh_last))->tqh_last));
