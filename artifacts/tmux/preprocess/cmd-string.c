# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-string.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-string.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-string.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-string.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 29 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-string.c" 2
...
cmd_string_split(const char *s, int *rargc, char ***rargv)
{
 ...
 for (;;) {
  ...
  switch (ch) {
  case '\'':
   if ((t = cmd_string_string(s, &p, '\'', 0)) == 0)
    goto error;
   cmd_string_copy(&buf, t, &len);
   break;
  case '"':
   if ((t = cmd_string_string(s, &p, '"', 1)) == 0)
    goto error;
   cmd_string_copy(&buf, t, &len);
   break;
  case '$':
   if ((t = cmd_string_variable(s, &p)) == 0)
    goto error;
   cmd_string_copy(&buf, t, &len);
   break;
  case '#':
