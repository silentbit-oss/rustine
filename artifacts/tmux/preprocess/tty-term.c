# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty-term.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty-term.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty-term.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty-term.c" 2
...
# 27 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty-term.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/stdlib.h" 1
# 28 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty-term.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/string.h" 1
# 29 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty-term.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/term.h" 1
# 30 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty-term.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 32 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty-term.c" 2

static void tty_term_override(struct tty_term *, const char *);
static char *tty_term_strip(const char *);

struct tty_terms tty_terms = { 0 };
...
tty_term_override(struct tty_term *term, const char *override)
{
 ...
 s = strsep(&next, ":");
 if (s == 0 || next == 0 || fnmatch(s, term->name, 0) != 0) {
  free(copy);
  return;
 }

 while ((s = strsep(&next, ":")) != 0) {
  if (*s == '\0')
   continue;
  value = 0;
...
tty_term_find(char *name, int fd, char **cause)
{
 ...
 for((term) = ((&tty_terms)->lh_first); (term)!= 0; (term) = ((term)->entry.le_next)) {
 ...
 do { if (((term)->entry.le_next = (&tty_terms)->lh_first) != 0) (&tty_terms)->lh_first->entry.le_prev = &(term)->entry.le_next; (&tty_terms)->lh_first = (term); (term)->entry.le_prev = &(&tty_terms)->lh_first; } while (0);
 ...
 if (tty_term_number(term, TTYC_COLORS) == 256)
  term->flags |= 0x1;
# 511 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty-term.c"
...
tty_term_free(struct tty_term *term)
{
 ...
 do { if ((term)->entry.le_next != 0) (term)->entry.le_next->entry.le_prev = (term)->entry.le_prev; *(term)->entry.le_prev = (term)->entry.le_next; ; ; } while (0);
