# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/compat/imsg.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/compat/imsg.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/compat/imsg.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/compat/imsg.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/sys/socket.h" 1
# 21 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/compat/imsg.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/sys/uio.h" 1
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/compat/imsg.c" 2
...
# 24 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/compat/imsg.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/stdlib.h" 1
# 25 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/compat/imsg.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/string.h" 1
# 26 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/compat/imsg.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/unistd.h" 1
# 27 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/compat/imsg.c" 2
...
# 29 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/compat/imsg.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/compat/imsg.h" 1
# 30 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/compat/imsg.c" 2
...
imsg_init(struct imsgbuf *ibuf, int fd)
{
 ...
 ibuf->w.fd = fd;
 ibuf->pid = getpid();
 do { (&ibuf->fds)->tqh_first = 0; (&ibuf->fds)->tqh_last = &(&ibuf->fds)->tqh_first; } while (0);
}
...
imsg_read(struct imsgbuf *ibuf)
{
 ...
 if ((ifd = calloc(1, sizeof(struct imsg_fd))) == 0)
  return (-1);

again:
 if (getdtablecount() + imsg_fd_overhead +
     (int)((((((sizeof(struct cmsghdr)) + sizeof(long) - 1) & ~(sizeof(long) - 1)) + (((sizeof(int)) + sizeof(long) - 1) & ~(sizeof(long) - 1)))-((((sizeof(struct cmsghdr)) + sizeof(long) - 1) & ~(sizeof(long) - 1)) + (((0) + sizeof(long) - 1) & ~(sizeof(long) - 1))))/sizeof(int))
     >= getdtablesize()) {
  errno = EAGAIN;
  free(ifd);
  return (-1);
 ...
 for (cmsg = CMSG_FIRSTHDR(&msg); cmsg != 0;
  ...
  if (cmsg->cmsg_level == SOL_SOCKET &&
   ...
   for (i = 0; i < j; i++) {
    ...
    if (ifd != 0) {
     ifd->fd = fd;
     do { (ifd)->entry.tqe_next = 0; (ifd)->entry.tqe_prev = (&ibuf->fds)->tqh_last; *(&ibuf->fds)->tqh_last = (ifd); (&ibuf->fds)->tqh_last = &(ifd)->entry.tqe_next; } while (0)
               ;
     ifd = 0;
    } else
     close(fd);
...
imsg_get(struct imsgbuf *ibuf, struct imsg *imsg)
{
 ...
 if (imsg->hdr.len < sizeof(struct imsg_hdr) ||
     imsg->hdr.len > 16384) {
  errno = ERANGE;
  return (-1);
 }
 ...
 if (datalen == 0)
  imsg->data = 0;
 else if ((imsg->data = malloc(datalen)) == 0)
  return (-1);
    ...
    int fd, const void *data, uint16_t datalen)
{
 ...
 if ((wbuf = imsg_create(ibuf, type, peerid, pid, datalen)) == 0)
  return (-1);
    ...
    uint16_t datalen)
{
 ...
 if ((hdr.pid = pid) == 0)
  hdr.pid = ibuf->pid;
 if ((wbuf = ibuf_dynamic(datalen, 16384)) == 0) {
  return (0);
 }
...
imsg_get_fd(struct imsgbuf *ibuf)
{
 ...
 if ((ifd = ((&ibuf->fds)->tqh_first)) == 0)
  return (-1);

 fd = ifd->fd;
 do { if (((ifd)->entry.tqe_next) != 0) (ifd)->entry.tqe_next->entry.tqe_prev = (ifd)->entry.tqe_prev; else (&ibuf->fds)->tqh_last = (ifd)->entry.tqe_prev; *(ifd)->entry.tqe_prev = (ifd)->entry.tqe_next; ; ; } while (0);
 free(ifd);
