# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-buffer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-buffer.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-buffer.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-buffer.c" 2
...
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-buffer.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/string.h" 1
# 23 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-buffer.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/time.h" 1
# 24 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-buffer.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 26 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-buffer.c" 2
...
static void
window_buffer_build(void *modedata, u_int sort_type, uint64_t *tag,
    const char *filter)
{
 ...
 for (i = 0; i < data->item_size; i++) {
  ...
  mode_tree_add(data->data, 0, item, item->order, item->name,
      text, -1);
  free(text);
...
static void
window_buffer_draw( void *modedata, void *itemdata,
    struct screen_write_ctx *ctx, u_int sx, u_int sy)
{
 ...
 for (i = 0; i < sy; i++) {
  ...
  while (end != pdata + psize && *end != '\n') {
   if ((sizeof line) - at > 5) {
    cp = vis(line + at, *end, 0x08|0x01, 0);
    at = cp - line;
   }
   end++;
  }
...
static int
window_buffer_search( void *modedata, void *itemdata, const char *ss)
{
 struct window_buffer_itemdata *item = itemdata;
 struct paste_buffer *pb;
 const char *bufdata;
 ...
 if ((pb = paste_get_name(item->name)) == 0)
  return (0);
...
window_buffer_init(struct window_pane *wp, struct cmd_find_state *fs,
    struct args *args)
{
 ...
 data->data = mode_tree_start(wp, args, window_buffer_build,
     ...
     window_buffer_sort_list, (sizeof((window_buffer_sort_list)) / sizeof((window_buffer_sort_list)[0])), &s);
