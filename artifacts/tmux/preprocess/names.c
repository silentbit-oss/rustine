# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/names.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/names.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/names.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/names.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 27 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/names.c" 2
...
static void
name_time_callback( int fd, short events, void *arg)
{
 struct window *w = arg;
...
name_time_expired(struct window *w, struct timeval *tv)
{
 ...
 do { (&offset)->tv_sec = (tv)->tv_sec - (&w->name_time)->tv_sec; (&offset)->tv_usec = (tv)->tv_usec - (&w->name_time)->tv_usec; if ((&offset)->tv_usec < 0) { (&offset)->tv_sec--; (&offset)->tv_usec += 1000000; } } while (0);
...
format_window_name(struct window *w)
{
 ...
 ft = format_create(0, 0, 0x40000000U|w->id, 0);
