# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-new-window.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-new-window.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-new-window.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-new-window.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 28 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-new-window.c" 2
...
cmd_new_window_exec(struct cmd *self, struct cmdq_item *item)
{
 ...
 if ((tmp = args_get(args, 'n')) != 0)
  name = format_single(item, tmp, c, s, 0, 0);
 else
  name = 0;
 ...
 if (args_has(args, 'P')) {
  ...
  cp = format_single(item, template, c, s, wl, 0);
