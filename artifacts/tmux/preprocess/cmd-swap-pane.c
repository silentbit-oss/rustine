# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-swap-pane.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-swap-pane.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-swap-pane.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-swap-pane.c" 2
...
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-swap-pane.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 24 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-swap-pane.c" 2
...
cmd_swap_pane_exec(struct cmd *self, struct cmdq_item *item)
{
 ...
 if (args_has(self->args, 'D')) {
  ...
  src_w = dst_w;
  src_wp = (*(((struct window_panes *)((dst_wp)->entry.tqe_prev))->tqh_last));
  if (src_wp == 0)
   src_wp = (*(((struct window_panes *)((&dst_w->panes)->tqh_last))->tqh_last));
 }
 ...
 tmp_wp = (*(((struct window_panes *)((dst_wp)->entry.tqe_prev))->tqh_last));
 do { if (((dst_wp)->entry.tqe_next) != 0) (dst_wp)->entry.tqe_next->entry.tqe_prev = (dst_wp)->entry.tqe_prev; else (&dst_w->panes)->tqh_last = (dst_wp)->entry.tqe_prev; *(dst_wp)->entry.tqe_prev = (dst_wp)->entry.tqe_next; ; ; } while (0);
 do { if (((dst_wp)->entry.tqe_next = (src_wp)->entry.tqe_next) != 0) (dst_wp)->entry.tqe_next->entry.tqe_prev = &(dst_wp)->entry.tqe_next; else (&src_w->panes)->tqh_last = &(dst_wp)->entry.tqe_next; (dst_wp)->entry.tqe_prev = (src_wp)->entry.tqe_prev; *(dst_wp)->entry.tqe_prev = (dst_wp); ; ; } while (0);
 if (tmp_wp == src_wp)
  tmp_wp = dst_wp;
 if (tmp_wp == 0)
  do { if (((src_wp)->entry.tqe_next = (&dst_w->panes)->tqh_first) != 0) (&dst_w->panes)->tqh_first->entry.tqe_prev = &(src_wp)->entry.tqe_next; else (&dst_w->panes)->tqh_last = &(src_wp)->entry.tqe_next; (&dst_w->panes)->tqh_first = (src_wp); (src_wp)->entry.tqe_prev = &(&dst_w->panes)->tqh_first; } while (0);
 else
  do { if (((src_wp)->entry.tqe_next = (tmp_wp)->entry.tqe_next) != 0) (src_wp)->entry.tqe_next->entry.tqe_prev = &(src_wp)->entry.tqe_next; else (&dst_w->panes)->tqh_last = &(src_wp)->entry.tqe_next; (tmp_wp)->entry.tqe_next = (src_wp); (src_wp)->entry.tqe_prev = &(tmp_wp)->entry.tqe_next; } while (0);
