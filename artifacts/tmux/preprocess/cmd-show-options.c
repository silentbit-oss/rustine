# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-show-options.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-show-options.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-show-options.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-show-options.c" 2
...
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-show-options.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/string.h" 1
# 23 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-show-options.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 25 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-show-options.c" 2
    ...
    struct options *oo)
{
 ...
 name = format_single(item, args->argv[0], c, s, wl, 0);
 ...
 if (o == 0) {
  ...
  if (*name != '@' &&
      options_match_get(oo, name, &idx, 0, &ambiguous) != 0) {
   free(name);
   return (CMD_RETURN_NORMAL);
  }
