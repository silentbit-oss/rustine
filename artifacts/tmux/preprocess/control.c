# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/control.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/control.c"
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/control.c"
...
# 21 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/control.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 28 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/control.c" 2
...
# 29 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/control.c" 2
# 45 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/control.c"
void
...
void
control_callback(struct client *c, int closed, void *data)
{
 char *line, *cause;
 struct cmd_list *cmdlist;
 struct cmd *cmd;
 ...
 for (;;) {
  line = evbuffer_readln(c->stdin_data, 0, EVBUFFER_EOL_LF);
  if (line == 0)
   break;
  if (*line == '\0') {
   c->flags |= 0x4;
  ...
  cmdlist = cmd_string_parse(line, 0, 0, &cause);
  if (cmdlist == 0) {
   item = cmdq_get_callback1("control_error", control_error, cause);
   cmdq_append(c, item);
  } else {
   for((cmd) = ((&cmdlist->list)->tqh_first); (cmd) != 0; (cmd) = ((cmd)->qentry.tqe_next))
    cmd->flags |= 0x1;
   item = cmdq_get_command(cmdlist, 0, 0, 0);
   cmdq_append(c, item);
