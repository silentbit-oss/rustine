# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/sys/ioctl.h" 1
# 21 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty.c" 2

# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/netinet/in.h" 1
# 23 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty.c" 2

# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/curses.h" 1
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/_fake_defines.h" 1
# 2 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/curses.h" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/_fake_typedefs.h" 1
# 3 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/curses.h" 2
# 25 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/errno.h" 1
# 26 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/fcntl.h" 1
# 27 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/resolv.h" 1
# 28 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/stdlib.h" 1
# 29 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/string.h" 1
# 30 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/termios.h" 1
# 31 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/unistd.h" 1
# 32 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 34 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty.c" 2
...
static void tty_default_attributes(struct tty *, const struct window_pane *,
      u_int);
# 84 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty.c"
void
tty_create_log(void)
{
 char name[64];
...
static void
tty_read_callback( int fd, short events, void *data)
{
 struct tty *tty = data;
 struct client *c = tty->client;
...
static void
tty_timer_callback( int fd, short events, void *data)
{
 struct tty *tty = data;
 struct client *c = tty->client;
...
static void
tty_write_callback( int fd, short events, void *data)
{
 struct tty *tty = data;
 struct client *c = tty->client;
 size_t size = EVBUFFER_LENGTH(tty->out);
...
tty_update_mode(struct tty *tty, int mode, struct screen *s)
{
 ...
 if (changed & (0x20|0x40|0x1000)) {
  if (mode & (0x20|0x40|0x1000)) {
   ...
   else if (tty->mode & 0x40)
    tty_puts(tty, "\033[?1002l");
   else if (tty->mode & 0x20)
...
static int
tty_large_region( struct tty *tty, const struct tty_ctx *ctx)
{
    ...
    struct screen *s, u_int py, u_int ox, u_int oy)
{
 ...
 if (wp == 0 ||
     py == 0 ||
     (~gd->linedata[gd->hsize + py - 1].flags & 0x1) ||
     ox != 0 ||
     tty->cx < tty->sx ||
     ((s)->grid->sx) < tty->sx) {
  if (((s)->grid->sx) < tty->sx &&
 ...
 for (i = 0; i < sx; i++) {
  ...
  if (len != 0 &&
      ...
      gcp->fg != last.fg ||
      gcp->bg != last.bg ||
      ux + width + gcp->data.width >= ((s)->grid->sx) ||
...
tty_cmd_linefeed(struct tty *tty, const struct tty_ctx *ctx)
{
 ...
 if ((!((ctx)->xoff == 0 && (((ctx)->wp->screen)->grid->sx) >= (tty)->sx) && !((tty)->term_type == TTY_VT420)) ||
     tty_fake_bce(tty, wp, 8) ||
     !tty_term_has(tty->term, TTYC_CSR)) {
  tty_redraw_region(tty, ctx);
  return;
...
# 1253 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty.c"
...
tty_cmd_alignmenttest(struct tty *tty, const struct tty_ctx *ctx)
{
 ...
 for (j = 0; j < ((s)->grid->sy); j++) {
  tty_cursor_pane(tty, ctx, 0, j);
  for (i = 0; i < ((s)->grid->sx); i++)
   tty_putc(tty, 'E');
 }
}
...
{
 if (!ctx->wrapped ||
     !((ctx)->xoff == 0 && (((ctx)->wp->screen)->grid->sx) >= (tty)->sx) ||
     (tty->term->flags & 0x2) ||
     ctx->xoff + cx != 0 ||
...
tty_cursor(struct tty *tty, u_int cx, u_int cy)
{
 ...
 if (cx == 0 && cy == thisy + 1 && thisy != tty->rlower &&
     (!((tty)->term_type == TTY_VT420) || tty->rleft == 0)) {
  tty_putc(tty, '\r');
  tty_putc(tty, '\n');
  goto out;
 }
...
# 2071 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tty.c"
  if ((tty->term_flags & 0x1) ||
