# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-queue.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-queue.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-queue.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-queue.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 27 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-queue.c" 2
...
# 28 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-queue.c" 2
...
cmdq_append(struct client *c, struct cmdq_item *item)
{
 ...
 do {
  ...
  item->queue = queue;
  do { (item)->entry.tqe_next = 0; (item)->entry.tqe_prev = (queue)->tqh_last; *(queue)->tqh_last = (item); (queue)->tqh_last = &(item)->entry.tqe_next; } while (0);
...
cmdq_insert_after(struct cmdq_item *after, struct cmdq_item *item)
{
 ...
 do {
  ...
  item->queue = queue;
  if (after->next != 0)
   do { if (((item)->entry.tqe_next = (after->next)->entry.tqe_next) != 0) (item)->entry.tqe_next->entry.tqe_prev = &(item)->entry.tqe_next; else (queue)->tqh_last = &(item)->entry.tqe_next; (after->next)->entry.tqe_next = (item); (item)->entry.tqe_prev = &(after->next)->entry.tqe_next; } while (0);
  else
   do { if (((item)->entry.tqe_next = (after)->entry.tqe_next) != 0) (item)->entry.tqe_next->entry.tqe_prev = &(item)->entry.tqe_next; else (queue)->tqh_last = &(item)->entry.tqe_next; (after)->entry.tqe_next = (item); (item)->entry.tqe_prev = &(after)->entry.tqe_next; } while (0);
  after->next = item;
...
cmdq_remove(struct cmdq_item *item)
{
 ...
 do { if (((item)->entry.tqe_next) != 0) (item)->entry.tqe_next->entry.tqe_prev = (item)->entry.tqe_prev; else (item->queue)->tqh_last = (item)->entry.tqe_prev; *(item)->entry.tqe_prev = (item)->entry.tqe_next; ; ; } while (0);
...
{
 struct cmdq_item *item, *first = 0, *last = 0;
 struct cmd *cmd;
...
# 310 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-queue.c"
u_int
