# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/alerts.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/alerts.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/alerts.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/alerts.c" 2

# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/event.h" 1
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/_fake_defines.h" 1
# 2 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/event.h" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/_fake_typedefs.h" 1
# 3 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/event.h" 2
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/alerts.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/stdlib.h" 1
# 23 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/alerts.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 25 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/alerts.c" 2
...
static struct { struct window *tqh_first; struct window **tqh_last; } alerts_list = { 0, &(alerts_list).tqh_first };

static void
alerts_timer( int fd, short events, void *arg)
{
 struct window *w = arg;
...
static void
alerts_callback( int fd, short events, void *arg)
{
 struct window *w, *w1;
 int alerts;

 for ((w) = ((&alerts_list)->tqh_first); (w) != 0 && ((w1) = ((w)->alerts_entry.tqe_next), 1); (w) = (w1)) {
  alerts = alerts_check_all(w);
  log_debug("@%u alerts check, alerts %#x", w->id, alerts);

  w->alerts_queued = 0;
  do { if (((w)->alerts_entry.tqe_next) != 0) (w)->alerts_entry.tqe_next->alerts_entry.tqe_prev = (w)->alerts_entry.tqe_prev; else (&alerts_list)->tqh_last = (w)->alerts_entry.tqe_prev; *(w)->alerts_entry.tqe_prev = (w)->alerts_entry.tqe_next; ; ; } while (0);
...
alerts_queue(struct window *w, int flags)
{
 ...
 if (alerts_enabled(w, flags)) {
  if (!w->alerts_queued) {
   w->alerts_queued = 1;
   do { (w)->alerts_entry.tqe_next = 0; (w)->alerts_entry.tqe_prev = (&alerts_list)->tqh_last; *(&alerts_list)->tqh_last = (w); (&alerts_list)->tqh_last = &(w)->alerts_entry.tqe_next; } while (0);
...
alerts_set_message(struct winlink *wl, const char *type, const char *option)
{
 struct client *c;
 int visual;
# 309 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/alerts.c"
