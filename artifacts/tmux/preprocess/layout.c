# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/layout.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/layout.c"
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/layout.c"
...
# 21 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/layout.c" 2
...
# 23 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/layout.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 25 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/layout.c" 2
# 36 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/layout.c"
...
layout_create_cell(struct layout_cell *lcparent)
{
 ...
 do { (&lc->cells)->tqh_first = 0; (&lc->cells)->tqh_last = &(&lc->cells)->tqh_first; } while (0);
...
layout_free_cell(struct layout_cell *lc)
{
 ...
 case LAYOUT_TOPBOTTOM:
  while (!(((&lc->cells)->tqh_first) == 0)) {
   ...
   do { if (((lcchild)->entry.tqe_next) != 0) (lcchild)->entry.tqe_next->entry.tqe_prev = (lcchild)->entry.tqe_prev; else (&lc->cells)->tqh_last = (lcchild)->entry.tqe_prev; *(lcchild)->entry.tqe_prev = (lcchild)->entry.tqe_next; ; ; } while (0);
...
layout_print_cell(struct layout_cell *lc, const char *hdr, u_int n)
{
 ...
 case LAYOUT_LEFTRIGHT:
 case LAYOUT_TOPBOTTOM:
  for((lcchild) = ((&lc->cells)->tqh_first); (lcchild) != 0; (lcchild) = ((lcchild)->entry.tqe_next))
...
layout_need_status(struct layout_cell *lc, int at_top)
{
 ...
 if (lc->parent) {
  ...
  if (at_top)
   ...
   first_lc = (*(((struct layout_cells *)((&lc->parent->cells)->tqh_last))->tqh_last));
  if (lc == first_lc)
   return (layout_need_status(lc->parent, at_top));
  return (0);
 }
...
layout_fix_panes(struct window *w, u_int wsx, u_int wsy)
{
 ...
 for((wp) = ((&w->panes)->tqh_first); (wp) != 0; (wp) = ((wp)->entry.tqe_next)) {
  ...
  if (shift && at_top)
   wp->yoff += 1;
# 261 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/layout.c"
    ...
    struct layout_cell **lcroot)
{
 ...
 if (lc == ((&lcparent->cells)->tqh_first))
  ...
  lcother = (*(((struct layout_cells *)((lc)->entry.tqe_prev))->tqh_last));
 ...
 do { if (((lc)->entry.tqe_next) != 0) (lc)->entry.tqe_next->entry.tqe_prev = (lc)->entry.tqe_prev; else (&lcparent->cells)->tqh_last = (lc)->entry.tqe_prev; *(lc)->entry.tqe_prev = (lc)->entry.tqe_next; ; ; } while (0);
 layout_free_cell(lc);
 ...
 if (((lc)->entry.tqe_next) == 0) {
   ...
   *lcroot = lc;
   ...
   do { if (((lc)->entry.tqe_next = (lcparent)->entry.tqe_next) != 0) (lc)->entry.tqe_next->entry.tqe_prev = &(lc)->entry.tqe_next; else (&lc->parent->cells)->tqh_last = &(lc)->entry.tqe_next; (lc)->entry.tqe_prev = (lcparent)->entry.tqe_prev; *(lc)->entry.tqe_prev = (lc); ; ; } while (0);
...
layout_init(struct window *w, struct window_pane *wp)
{
 ...
 lc = w->layout_root = layout_create_cell(0);
...
# 488 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/layout.c"
 xchange = sx - w->sx;
    ...
    u_int new_size)
{
 ...
 lcparent = lc->parent;
 while (lcparent != 0 && lcparent->type != type) {
  lc = lcparent;
  lcparent = lc->parent;
 }
 if (lcparent == 0)
 ...
 if (type == LAYOUT_LEFTRIGHT)
  ...
  size = lc->sy;
 if (lc == (*(((struct layout_cells *)((&lcparent->cells)->tqh_last))->tqh_last)))
    ...
    int opposite)
{
 ...
 if (lc == (*(((struct layout_cells *)((&lcparent->cells)->tqh_last))->tqh_last)))
  lc = (*(((struct layout_cells *)((lc)->entry.tqe_prev))->tqh_last));
    ...
    enum layout_type type, int needed, int opposite)
{
 ...
 if (opposite && lcremove == 0) {
  lcremove = (*(((struct layout_cells *)((lc)->entry.tqe_prev))->tqh_last));
  while (lcremove != 0) {
   size = layout_resize_check(w, lcremove, type);
   if (size > 0)
    break;
   lcremove = (*(((struct layout_cells *)((lcremove)->entry.tqe_prev))->tqh_last));
  }
 }
 if (lcremove == 0)
  return (0);
    ...
    int insert_before, int full_size)
{
 ...
 if (lc->parent != 0 && lc->parent->type == type) {
  ...
  if (insert_before)
   do { (lcnew)->entry.tqe_prev = (lc)->entry.tqe_prev; (lcnew)->entry.tqe_next = (lc); *(lc)->entry.tqe_prev = (lcnew); (lc)->entry.tqe_prev = &(lcnew)->entry.tqe_next; } while (0);
  else
   do { if (((lcnew)->entry.tqe_next = (lc)->entry.tqe_next) != 0) (lcnew)->entry.tqe_next->entry.tqe_prev = &(lcnew)->entry.tqe_next; else (&lcparent->cells)->tqh_last = &(lcnew)->entry.tqe_next; (lc)->entry.tqe_next = (lcnew); (lcnew)->entry.tqe_prev = &(lc)->entry.tqe_next; } while (0);
 } else if (full_size && lc->parent == 0 && lc->type == type) {
  ...
  if (insert_before)
   do { if (((lcnew)->entry.tqe_next = (&lc->cells)->tqh_first) != 0) (&lc->cells)->tqh_first->entry.tqe_prev = &(lcnew)->entry.tqe_next; else (&lc->cells)->tqh_last = &(lcnew)->entry.tqe_next; (&lc->cells)->tqh_first = (lcnew); (lcnew)->entry.tqe_prev = &(&lc->cells)->tqh_first; } while (0);
  else
   do { (lcnew)->entry.tqe_next = 0; (lcnew)->entry.tqe_prev = (&lc->cells)->tqh_last; *(&lc->cells)->tqh_last = (lcnew); (&lc->cells)->tqh_last = &(lcnew)->entry.tqe_next; } while (0);
 } else {
  ...
  if (lc->parent == 0)
   ...
   do { if (((lcparent)->entry.tqe_next = (lc)->entry.tqe_next) != 0) (lcparent)->entry.tqe_next->entry.tqe_prev = &(lcparent)->entry.tqe_next; else (&lc->parent->cells)->tqh_last = &(lcparent)->entry.tqe_next; (lcparent)->entry.tqe_prev = (lc)->entry.tqe_prev; *(lcparent)->entry.tqe_prev = (lcparent); ; ; } while (0);


  lc->parent = lcparent;
  do { if (((lc)->entry.tqe_next = (&lcparent->cells)->tqh_first) != 0) (&lcparent->cells)->tqh_first->entry.tqe_prev = &(lc)->entry.tqe_next; else (&lcparent->cells)->tqh_last = &(lc)->entry.tqe_next; (&lcparent->cells)->tqh_first = (lc); (lc)->entry.tqe_prev = &(&lcparent->cells)->tqh_first; } while (0);


  lcnew = layout_create_cell(lcparent);
  if (insert_before)
   do { if (((lcnew)->entry.tqe_next = (&lcparent->cells)->tqh_first) != 0) (&lcparent->cells)->tqh_first->entry.tqe_prev = &(lcnew)->entry.tqe_next; else (&lcparent->cells)->tqh_last = &(lcnew)->entry.tqe_next; (&lcparent->cells)->tqh_first = (lcnew); (lcnew)->entry.tqe_prev = &(&lcparent->cells)->tqh_first; } while (0);
  else
   do { (lcnew)->entry.tqe_next = 0; (lcnew)->entry.tqe_prev = (&lcparent->cells)->tqh_last; *(&lcparent->cells)->tqh_last = (lcnew); (&lcparent->cells)->tqh_last = &(lcnew)->entry.tqe_next; } while (0);
 }
 if (insert_before) {
  lc1 = lcnew;
  lc2 = lc;
...
layout_spread_cell(struct window *w, struct layout_cell *parent)
{
 ...
 number = 0;
 for((lc) = ((&parent->cells)->tqh_first); (lc) != 0; (lc) = ((lc)->entry.tqe_next))
     number++;
 if (number <= 1)
  return (0);
