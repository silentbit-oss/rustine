# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-set-option.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-set-option.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-set-option.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-set-option.c" 2
...
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-set-option.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/string.h" 1
# 23 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-set-option.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 25 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-set-option.c" 2
...
cmd_set_option_exec(struct cmd *self, struct cmdq_item *item)
{
 ...
 char *name, *argument, *value = 0, *cause;
 const char *target;
 int window, idx, already, error, ambiguous;


 c = cmd_find_client(item, 0, 1);
 argument = format_single(item, args->argv[0], c, s, wl, 0);
 ...
 if (args->argc < 2)
  ...
  value = format_single(item, args->argv[1], c, s, wl, 0);
 else
 ...
 if (*name == '@') {
  ...
  else if (options_get_only(global_s_options, name) != 0)
   scope = OPTIONS_TABLE_SESSION;
  else if (options_get_only(global_w_options, name) != 0)
 ...
 if (idx != -1) {
  if (*name == '@' || options_array_size(parent, 0) == -1) {
 ...
 } else if (idx == -1 && options_array_size(parent, 0) == -1) {
 ...
 if (strcmp(name, "key-table") == 0) {
  for((loop) = ((&clients)->tqh_first); (loop) != 0; (loop) = ((loop)->entry.tqe_next))
