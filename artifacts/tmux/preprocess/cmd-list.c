# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-list.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-list.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-list.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-list.c" 2
...
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-list.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/string.h" 1
# 23 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-list.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 25 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-list.c" 2
    ...
    char **cause)
{
 ...
 do { (&cmdlist->list)->tqh_first = 0; (&cmdlist->list)->tqh_last = &(&cmdlist->list)->tqh_first; } while (0);
 ...
 for (i = 0; i < argc; i++) {
  ...
  if (cmd == 0)
   goto bad;
  do { (cmd)->qentry.tqe_next = 0; (cmd)->qentry.tqe_prev = (&cmdlist->list)->tqh_last; *(&cmdlist->list)->tqh_last = (cmd); (&cmdlist->list)->tqh_last = &(cmd)->qentry.tqe_next; } while (0);
...
cmd_list_free(struct cmd_list *cmdlist)
{
 ...
 for ((cmd) = ((&cmdlist->list)->tqh_first); (cmd) != 0 && ((cmd1) = ((cmd)->qentry.tqe_next), 1); (cmd) = (cmd1)) {
  do { if (((cmd)->qentry.tqe_next) != 0) (cmd)->qentry.tqe_next->qentry.tqe_prev = (cmd)->qentry.tqe_prev; else (&cmdlist->list)->tqh_last = (cmd)->qentry.tqe_prev; *(cmd)->qentry.tqe_prev = (cmd)->qentry.tqe_next; ; ; } while (0);
  args_free(cmd->args);
  free(cmd->file);
  free(cmd);
 }
