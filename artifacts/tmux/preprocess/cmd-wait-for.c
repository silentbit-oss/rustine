# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-wait-for.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-wait-for.c"
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-wait-for.c"
...
# 21 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-wait-for.c" 2
...
# 23 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-wait-for.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/string.h" 1
# 24 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-wait-for.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 26 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-wait-for.c" 2
...
struct wait_item {
 ...
 struct { struct wait_item *tqe_next; struct wait_item **tqe_prev; } entry;
};
...
struct wait_channel {
 ...
 struct { struct wait_item *tqh_first; struct wait_item **tqh_last; } waiters;
 struct { struct wait_item *tqh_first; struct wait_item **tqh_last; } lockers;

 struct { struct wait_channel *rbe_left; struct wait_channel *rbe_right; struct wait_channel *rbe_parent; int rbe_color; } entry;
};
struct wait_channels { struct wait_channel *rbh_root; };
static struct wait_channels wait_channels = { 0 };

static int wait_channel_cmp(struct wait_channel *, struct wait_channel *);
 static void wait_channels_RB_INSERT_COLOR(struct wait_channels *head, struct wait_channel *elm) { struct wait_channel *parent, *gparent, *tmp; while ((parent = (elm)->entry.rbe_parent) && (parent)->entry.rbe_color == 1) { gparent = (parent)->entry.rbe_parent; if (parent == (gparent)->entry.rbe_left) { tmp = (gparent)->entry.rbe_right; if (tmp && (tmp)->entry.rbe_color == 1) { (tmp)->entry.rbe_color = 0; do { (parent)->entry.rbe_color = 0; (gparent)->entry.rbe_color = 1; } while (0); elm = gparent; continue; } if ((parent)->entry.rbe_right == elm) { do { (tmp) = (parent)->entry.rbe_right; if (((parent)->entry.rbe_right = (tmp)->entry.rbe_left)) { ((tmp)->entry.rbe_left)->entry.rbe_parent = (parent); } do {} while (0); if (((tmp)->entry.rbe_parent = (parent)->entry.rbe_parent)) { if ((parent) == ((parent)->entry.rbe_parent)->entry.rbe_left) ((parent)->entry.rbe_parent)->entry.rbe_left = (tmp); else ((parent)->entry.rbe_parent)->entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->entry.rbe_left = (parent); (parent)->entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->entry.rbe_parent)) do {} while (0); } while (0); tmp = parent; parent = elm; elm = tmp; } do { (parent)->entry.rbe_color = 0; (gparent)->entry.rbe_color = 1; } while (0); do { (tmp) = (gparent)->entry.rbe_left; if (((gparent)->entry.rbe_left = (tmp)->entry.rbe_right)) { ((tmp)->entry.rbe_right)->entry.rbe_parent = (gparent); } do {} while (0); if (((tmp)->entry.rbe_parent = (gparent)->entry.rbe_parent)) { if ((gparent) == ((gparent)->entry.rbe_parent)->entry.rbe_left) ((gparent)->entry.rbe_parent)->entry.rbe_left = (tmp); else ((gparent)->entry.rbe_parent)->entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->entry.rbe_right = (gparent); (gparent)->entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->entry.rbe_parent)) do {} while (0); } while (0); } else { tmp = (gparent)->entry.rbe_left; if (tmp && (tmp)->entry.rbe_color == 1) { (tmp)->entry.rbe_color = 0; do { (parent)->entry.rbe_color = 0; (gparent)->entry.rbe_color = 1; } while (0); elm = gparent; continue; } if ((parent)->entry.rbe_left == elm) { do { (tmp) = (parent)->entry.rbe_left; if (((parent)->entry.rbe_left = (tmp)->entry.rbe_right)) { ((tmp)->entry.rbe_right)->entry.rbe_parent = (parent); } do {} while (0); if (((tmp)->entry.rbe_parent = (parent)->entry.rbe_parent)) { if ((parent) == ((parent)->entry.rbe_parent)->entry.rbe_left) ((parent)->entry.rbe_parent)->entry.rbe_left = (tmp); else ((parent)->entry.rbe_parent)->entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->entry.rbe_right = (parent); (parent)->entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->entry.rbe_parent)) do {} while (0); } while (0); tmp = parent; parent = elm; elm = tmp; } do { (parent)->entry.rbe_color = 0; (gparent)->entry.rbe_color = 1; } while (0); do { (tmp) = (gparent)->entry.rbe_right; if (((gparent)->entry.rbe_right = (tmp)->entry.rbe_left)) { ((tmp)->entry.rbe_left)->entry.rbe_parent = (gparent); } do {} while (0); if (((tmp)->entry.rbe_parent = (gparent)->entry.rbe_parent)) { if ((gparent) == ((gparent)->entry.rbe_parent)->entry.rbe_left) ((gparent)->entry.rbe_parent)->entry.rbe_left = (tmp); else ((gparent)->entry.rbe_parent)->entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->entry.rbe_left = (gparent); (gparent)->entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->entry.rbe_parent)) do {} while (0); } while (0); } } (head->rbh_root)->entry.rbe_color = 0; } static void wait_channels_RB_REMOVE_COLOR(struct wait_channels *head, struct wait_channel *parent, struct wait_channel *elm) { struct wait_channel *tmp; while ((elm == 0 || (elm)->entry.rbe_color == 0) && elm != (head)->rbh_root) { if ((parent)->entry.rbe_left == elm) { tmp = (parent)->entry.rbe_right; if ((tmp)->entry.rbe_color == 1) { do { (tmp)->entry.rbe_color = 0; (parent)->entry.rbe_color = 1; } while (0); do { (tmp) = (parent)->entry.rbe_right; if (((parent)->entry.rbe_right = (tmp)->entry.rbe_left)) { ((tmp)->entry.rbe_left)->entry.rbe_parent = (parent); } do {} while (0); if (((tmp)->entry.rbe_parent = (parent)->entry.rbe_parent)) { if ((parent) == ((parent)->entry.rbe_parent)->entry.rbe_left) ((parent)->entry.rbe_parent)->entry.rbe_left = (tmp); else ((parent)->entry.rbe_parent)->entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->entry.rbe_left = (parent); (parent)->entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->entry.rbe_parent)) do {} while (0); } while (0); tmp = (parent)->entry.rbe_right; } if (((tmp)->entry.rbe_left == 0 || ((tmp)->entry.rbe_left)->entry.rbe_color == 0) && ((tmp)->entry.rbe_right == 0 || ((tmp)->entry.rbe_right)->entry.rbe_color == 0)) { (tmp)->entry.rbe_color = 1; elm = parent; parent = (elm)->entry.rbe_parent; } else { if ((tmp)->entry.rbe_right == 0 || ((tmp)->entry.rbe_right)->entry.rbe_color == 0) { struct wait_channel *oleft; if ((oleft = (tmp)->entry.rbe_left)) (oleft)->entry.rbe_color = 0; (tmp)->entry.rbe_color = 1; do { (oleft) = (tmp)->entry.rbe_left; if (((tmp)->entry.rbe_left = (oleft)->entry.rbe_right)) { ((oleft)->entry.rbe_right)->entry.rbe_parent = (tmp); } do {} while (0); if (((oleft)->entry.rbe_parent = (tmp)->entry.rbe_parent)) { if ((tmp) == ((tmp)->entry.rbe_parent)->entry.rbe_left) ((tmp)->entry.rbe_parent)->entry.rbe_left = (oleft); else ((tmp)->entry.rbe_parent)->entry.rbe_right = (oleft); } else (head)->rbh_root = (oleft); (oleft)->entry.rbe_right = (tmp); (tmp)->entry.rbe_parent = (oleft); do {} while (0); if (((oleft)->entry.rbe_parent)) do {} while (0); } while (0); tmp = (parent)->entry.rbe_right; } (tmp)->entry.rbe_color = (parent)->entry.rbe_color; (parent)->entry.rbe_color = 0; if ((tmp)->entry.rbe_right) ((tmp)->entry.rbe_right)->entry.rbe_color = 0; do { (tmp) = (parent)->entry.rbe_right; if (((parent)->entry.rbe_right = (tmp)->entry.rbe_left)) { ((tmp)->entry.rbe_left)->entry.rbe_parent = (parent); } do {} while (0); if (((tmp)->entry.rbe_parent = (parent)->entry.rbe_parent)) { if ((parent) == ((parent)->entry.rbe_parent)->entry.rbe_left) ((parent)->entry.rbe_parent)->entry.rbe_left = (tmp); else ((parent)->entry.rbe_parent)->entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->entry.rbe_left = (parent); (parent)->entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->entry.rbe_parent)) do {} while (0); } while (0); elm = (head)->rbh_root; break; } } else { tmp = (parent)->entry.rbe_left; if ((tmp)->entry.rbe_color == 1) { do { (tmp)->entry.rbe_color = 0; (parent)->entry.rbe_color = 1; } while (0); do { (tmp) = (parent)->entry.rbe_left; if (((parent)->entry.rbe_left = (tmp)->entry.rbe_right)) { ((tmp)->entry.rbe_right)->entry.rbe_parent = (parent); } do {} while (0); if (((tmp)->entry.rbe_parent = (parent)->entry.rbe_parent)) { if ((parent) == ((parent)->entry.rbe_parent)->entry.rbe_left) ((parent)->entry.rbe_parent)->entry.rbe_left = (tmp); else ((parent)->entry.rbe_parent)->entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->entry.rbe_right = (parent); (parent)->entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->entry.rbe_parent)) do {} while (0); } while (0); tmp = (parent)->entry.rbe_left; } if (((tmp)->entry.rbe_left == 0 || ((tmp)->entry.rbe_left)->entry.rbe_color == 0) && ((tmp)->entry.rbe_right == 0 || ((tmp)->entry.rbe_right)->entry.rbe_color == 0)) { (tmp)->entry.rbe_color = 1; elm = parent; parent = (elm)->entry.rbe_parent; } else { if ((tmp)->entry.rbe_left == 0 || ((tmp)->entry.rbe_left)->entry.rbe_color == 0) { struct wait_channel *oright; if ((oright = (tmp)->entry.rbe_right)) (oright)->entry.rbe_color = 0; (tmp)->entry.rbe_color = 1; do { (oright) = (tmp)->entry.rbe_right; if (((tmp)->entry.rbe_right = (oright)->entry.rbe_left)) { ((oright)->entry.rbe_left)->entry.rbe_parent = (tmp); } do {} while (0); if (((oright)->entry.rbe_parent = (tmp)->entry.rbe_parent)) { if ((tmp) == ((tmp)->entry.rbe_parent)->entry.rbe_left) ((tmp)->entry.rbe_parent)->entry.rbe_left = (oright); else ((tmp)->entry.rbe_parent)->entry.rbe_right = (oright); } else (head)->rbh_root = (oright); (oright)->entry.rbe_left = (tmp); (tmp)->entry.rbe_parent = (oright); do {} while (0); if (((oright)->entry.rbe_parent)) do {} while (0); } while (0); tmp = (parent)->entry.rbe_left; } (tmp)->entry.rbe_color = (parent)->entry.rbe_color; (parent)->entry.rbe_color = 0; if ((tmp)->entry.rbe_left) ((tmp)->entry.rbe_left)->entry.rbe_color = 0; do { (tmp) = (parent)->entry.rbe_left; if (((parent)->entry.rbe_left = (tmp)->entry.rbe_right)) { ((tmp)->entry.rbe_right)->entry.rbe_parent = (parent); } do {} while (0); if (((tmp)->entry.rbe_parent = (parent)->entry.rbe_parent)) { if ((parent) == ((parent)->entry.rbe_parent)->entry.rbe_left) ((parent)->entry.rbe_parent)->entry.rbe_left = (tmp); else ((parent)->entry.rbe_parent)->entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->entry.rbe_right = (parent); (parent)->entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->entry.rbe_parent)) do {} while (0); } while (0); elm = (head)->rbh_root; break; } } } if (elm) (elm)->entry.rbe_color = 0; } static struct wait_channel * wait_channels_RB_REMOVE(struct wait_channels *head, struct wait_channel *elm) { struct wait_channel *child, *parent, *old = elm; int color; if ((elm)->entry.rbe_left == 0) child = (elm)->entry.rbe_right; else if ((elm)->entry.rbe_right == 0) child = (elm)->entry.rbe_left; else { struct wait_channel *left; elm = (elm)->entry.rbe_right; while ((left = (elm)->entry.rbe_left)) elm = left; child = (elm)->entry.rbe_right; parent = (elm)->entry.rbe_parent; color = (elm)->entry.rbe_color; if (child) (child)->entry.rbe_parent = parent; if (parent) { if ((parent)->entry.rbe_left == elm) (parent)->entry.rbe_left = child; else (parent)->entry.rbe_right = child; do {} while (0); } else (head)->rbh_root = child; if ((elm)->entry.rbe_parent == old) parent = elm; (elm)->entry = (old)->entry; if ((old)->entry.rbe_parent) { if (((old)->entry.rbe_parent)->entry.rbe_left == old) ((old)->entry.rbe_parent)->entry.rbe_left = elm; else ((old)->entry.rbe_parent)->entry.rbe_right = elm; do {} while (0); } else (head)->rbh_root = elm; ((old)->entry.rbe_left)->entry.rbe_parent = elm; if ((old)->entry.rbe_right) ((old)->entry.rbe_right)->entry.rbe_parent = elm; if (parent) { left = parent; do { do {} while (0); } while ((left = (left)->entry.rbe_parent)); } goto color; } parent = (elm)->entry.rbe_parent; color = (elm)->entry.rbe_color; if (child) (child)->entry.rbe_parent = parent; if (parent) { if ((parent)->entry.rbe_left == elm) (parent)->entry.rbe_left = child; else (parent)->entry.rbe_right = child; do {} while (0); } else (head)->rbh_root = child; color: if (color == 0) wait_channels_RB_REMOVE_COLOR(head, parent, child); return (old); } static struct wait_channel * wait_channels_RB_INSERT(struct wait_channels *head, struct wait_channel *elm) { struct wait_channel *tmp; struct wait_channel *parent = 0; int comp = 0; tmp = (head)->rbh_root; while (tmp) { parent = tmp; comp = (wait_channel_cmp)(elm, parent); if (comp < 0) tmp = (tmp)->entry.rbe_left; else if (comp > 0) tmp = (tmp)->entry.rbe_right; else return (tmp); } do { (elm)->entry.rbe_parent = parent; (elm)->entry.rbe_left = (elm)->entry.rbe_right = 0; (elm)->entry.rbe_color = 1; } while (0); if (parent != 0) { if (comp < 0) (parent)->entry.rbe_left = elm; else (parent)->entry.rbe_right = elm; do {} while (0); } else (head)->rbh_root = elm; wait_channels_RB_INSERT_COLOR(head, elm); return (0); } static struct wait_channel * wait_channels_RB_FIND(struct wait_channels *head, struct wait_channel *elm) { struct wait_channel *tmp = (head)->rbh_root; int comp; while (tmp) { comp = wait_channel_cmp(elm, tmp); if (comp < 0) tmp = (tmp)->entry.rbe_left; else if (comp > 0) tmp = (tmp)->entry.rbe_right; else return (tmp); } return (0); } static struct wait_channel * wait_channels_RB_NFIND(struct wait_channels *head, struct wait_channel *elm) { struct wait_channel *tmp = (head)->rbh_root; struct wait_channel *res = 0; int comp; while (tmp) { comp = wait_channel_cmp(elm, tmp); if (comp < 0) { res = tmp; tmp = (tmp)->entry.rbe_left; } else if (comp > 0) tmp = (tmp)->entry.rbe_right; else return (tmp); } return (res); } static struct wait_channel * wait_channels_RB_NEXT(struct wait_channel *elm) { if ((elm)->entry.rbe_right) { elm = (elm)->entry.rbe_right; while ((elm)->entry.rbe_left) elm = (elm)->entry.rbe_left; } else { if ((elm)->entry.rbe_parent && (elm == ((elm)->entry.rbe_parent)->entry.rbe_left)) elm = (elm)->entry.rbe_parent; else { while ((elm)->entry.rbe_parent && (elm == ((elm)->entry.rbe_parent)->entry.rbe_right)) elm = (elm)->entry.rbe_parent; elm = (elm)->entry.rbe_parent; } } return (elm); } static struct wait_channel * wait_channels_RB_PREV(struct wait_channel *elm) { if ((elm)->entry.rbe_left) { elm = (elm)->entry.rbe_left; while ((elm)->entry.rbe_right) elm = (elm)->entry.rbe_right; } else { if ((elm)->entry.rbe_parent && (elm == ((elm)->entry.rbe_parent)->entry.rbe_right)) elm = (elm)->entry.rbe_parent; else { while ((elm)->entry.rbe_parent && (elm == ((elm)->entry.rbe_parent)->entry.rbe_left)) elm = (elm)->entry.rbe_parent; elm = (elm)->entry.rbe_parent; } } return (elm); } static struct wait_channel * wait_channels_RB_MINMAX(struct wait_channels *head, int val) { struct wait_channel *tmp = (head)->rbh_root; struct wait_channel *parent = 0; while (tmp) { parent = tmp; if (val < 0) tmp = (tmp)->entry.rbe_left; else tmp = (tmp)->entry.rbe_right; } return (parent); };
...
cmd_wait_for_add(const char *name)
{
 ...
 do { (&wc->waiters)->tqh_first = 0; (&wc->waiters)->tqh_last = &(&wc->waiters)->tqh_first; } while (0);
 do { (&wc->lockers)->tqh_first = 0; (&wc->lockers)->tqh_last = &(&wc->lockers)->tqh_first; } while (0);
...
cmd_wait_for_exec(struct cmd *self, struct cmdq_item *item)
{
 ...
 wc0.name = name;
 wc = wait_channels_RB_FIND(&wait_channels, &wc0);
...
static enum cmd_retval
cmd_wait_for_signal( struct cmdq_item *item, const char *name,
    struct wait_channel *wc)
{
 ...
 for ((wi) = ((&wc->waiters)->tqh_first); (wi) != 0 && ((wi1) = ((wi)->entry.tqe_next), 1); (wi) = (wi1)) {
  wi->item->flags &= ~0x2;

  do { if (((wi)->entry.tqe_next) != 0) (wi)->entry.tqe_next->entry.tqe_prev = (wi)->entry.tqe_prev; else (&wc->waiters)->tqh_last = (wi)->entry.tqe_prev; *(wi)->entry.tqe_prev = (wi)->entry.tqe_next; ; ; } while (0);
  free(wi);
 }
    ...
    struct wait_channel *wc)
{
 ...
 wi->item = item;
 do { (wi)->entry.tqe_next = 0; (wi)->entry.tqe_prev = (&wc->waiters)->tqh_last; *(&wc->waiters)->tqh_last = (wi); (&wc->waiters)->tqh_last = &(wi)->entry.tqe_next; } while (0);
    ...
    struct wait_channel *wc)
{
 ...
 if (wc->locked) {
  wi = xcalloc(1, sizeof *wi);
  wi->item = item;
  do { (wi)->entry.tqe_next = 0; (wi)->entry.tqe_prev = (&wc->lockers)->tqh_last; *(&wc->lockers)->tqh_last = (wi); (&wc->lockers)->tqh_last = &(wi)->entry.tqe_next; } while (0);
  return (CMD_RETURN_WAIT);
 }
 wc->locked = 1;
    ...
    struct wait_channel *wc)
{
 ...
 if ((wi = ((&wc->lockers)->tqh_first)) != 0) {
  wi->item->flags &= ~0x2;
  do { if (((wi)->entry.tqe_next) != 0) (wi)->entry.tqe_next->entry.tqe_prev = (wi)->entry.tqe_prev; else (&wc->lockers)->tqh_last = (wi)->entry.tqe_prev; *(wi)->entry.tqe_prev = (wi)->entry.tqe_next; ; ; } while (0);
  free(wi);
 } else {
  wc->locked = 0;
  cmd_wait_for_remove(wc);
...
cmd_wait_for_flush(void)
{
 ...
 for ((wc) = wait_channels_RB_MINMAX(&wait_channels, -1); ((wc) != 0) && ((wc1) = wait_channels_RB_NEXT(wc), 1); (wc) = (wc1)) {
  for ((wi) = ((&wc->waiters)->tqh_first); (wi) != 0 && ((wi1) = ((wi)->entry.tqe_next), 1); (wi) = (wi1)) {
   wi->item->flags &= ~0x2;
   do { if (((wi)->entry.tqe_next) != 0) (wi)->entry.tqe_next->entry.tqe_prev = (wi)->entry.tqe_prev; else (&wc->waiters)->tqh_last = (wi)->entry.tqe_prev; *(wi)->entry.tqe_prev = (wi)->entry.tqe_next; ; ; } while (0);
   free(wi);
  ...
  wc->woken = 1;
  for ((wi) = ((&wc->lockers)->tqh_first); (wi) != 0 && ((wi1) = ((wi)->entry.tqe_next), 1); (wi) = (wi1)) {
   wi->item->flags &= ~0x2;
   do { if (((wi)->entry.tqe_next) != 0) (wi)->entry.tqe_next->entry.tqe_prev = (wi)->entry.tqe_prev; else (&wc->lockers)->tqh_last = (wi)->entry.tqe_prev; *(wi)->entry.tqe_prev = (wi)->entry.tqe_next; ; ; } while (0);
   free(wi);
  }
