# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/paste.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/paste.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/paste.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/paste.c" 2
...
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/paste.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/string.h" 1
# 23 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/paste.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/time.h" 1
# 24 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/paste.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 26 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/paste.c" 2
...
struct paste_buffer {
 ...
 struct { struct paste_buffer *rbe_left; struct paste_buffer *rbe_right; struct paste_buffer *rbe_parent; int rbe_color; } name_entry;
 struct { struct paste_buffer *rbe_left; struct paste_buffer *rbe_right; struct paste_buffer *rbe_parent; int rbe_color; } time_entry;
};

static u_int paste_next_index;
static u_int paste_next_order;
static u_int paste_num_automatic;
static struct paste_name_tree { struct paste_buffer *rbh_root; } paste_by_name;
static struct paste_time_tree { struct paste_buffer *rbh_root; } paste_by_time;

static int paste_cmp_names(const struct paste_buffer *,
      const struct paste_buffer *);
 static void paste_name_tree_RB_INSERT_COLOR(struct paste_name_tree *head, struct paste_buffer *elm) { struct paste_buffer *parent, *gparent, *tmp; while ((parent = (elm)->name_entry.rbe_parent) && (parent)->name_entry.rbe_color == 1) { gparent = (parent)->name_entry.rbe_parent; if (parent == (gparent)->name_entry.rbe_left) { tmp = (gparent)->name_entry.rbe_right; if (tmp && (tmp)->name_entry.rbe_color == 1) { (tmp)->name_entry.rbe_color = 0; do { (parent)->name_entry.rbe_color = 0; (gparent)->name_entry.rbe_color = 1; } while (0); elm = gparent; continue; } if ((parent)->name_entry.rbe_right == elm) { do { (tmp) = (parent)->name_entry.rbe_right; if (((parent)->name_entry.rbe_right = (tmp)->name_entry.rbe_left)) { ((tmp)->name_entry.rbe_left)->name_entry.rbe_parent = (parent); } do {} while (0); if (((tmp)->name_entry.rbe_parent = (parent)->name_entry.rbe_parent)) { if ((parent) == ((parent)->name_entry.rbe_parent)->name_entry.rbe_left) ((parent)->name_entry.rbe_parent)->name_entry.rbe_left = (tmp); else ((parent)->name_entry.rbe_parent)->name_entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->name_entry.rbe_left = (parent); (parent)->name_entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->name_entry.rbe_parent)) do {} while (0); } while (0); tmp = parent; parent = elm; elm = tmp; } do { (parent)->name_entry.rbe_color = 0; (gparent)->name_entry.rbe_color = 1; } while (0); do { (tmp) = (gparent)->name_entry.rbe_left; if (((gparent)->name_entry.rbe_left = (tmp)->name_entry.rbe_right)) { ((tmp)->name_entry.rbe_right)->name_entry.rbe_parent = (gparent); } do {} while (0); if (((tmp)->name_entry.rbe_parent = (gparent)->name_entry.rbe_parent)) { if ((gparent) == ((gparent)->name_entry.rbe_parent)->name_entry.rbe_left) ((gparent)->name_entry.rbe_parent)->name_entry.rbe_left = (tmp); else ((gparent)->name_entry.rbe_parent)->name_entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->name_entry.rbe_right = (gparent); (gparent)->name_entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->name_entry.rbe_parent)) do {} while (0); } while (0); } else { tmp = (gparent)->name_entry.rbe_left; if (tmp && (tmp)->name_entry.rbe_color == 1) { (tmp)->name_entry.rbe_color = 0; do { (parent)->name_entry.rbe_color = 0; (gparent)->name_entry.rbe_color = 1; } while (0); elm = gparent; continue; } if ((parent)->name_entry.rbe_left == elm) { do { (tmp) = (parent)->name_entry.rbe_left; if (((parent)->name_entry.rbe_left = (tmp)->name_entry.rbe_right)) { ((tmp)->name_entry.rbe_right)->name_entry.rbe_parent = (parent); } do {} while (0); if (((tmp)->name_entry.rbe_parent = (parent)->name_entry.rbe_parent)) { if ((parent) == ((parent)->name_entry.rbe_parent)->name_entry.rbe_left) ((parent)->name_entry.rbe_parent)->name_entry.rbe_left = (tmp); else ((parent)->name_entry.rbe_parent)->name_entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->name_entry.rbe_right = (parent); (parent)->name_entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->name_entry.rbe_parent)) do {} while (0); } while (0); tmp = parent; parent = elm; elm = tmp; } do { (parent)->name_entry.rbe_color = 0; (gparent)->name_entry.rbe_color = 1; } while (0); do { (tmp) = (gparent)->name_entry.rbe_right; if (((gparent)->name_entry.rbe_right = (tmp)->name_entry.rbe_left)) { ((tmp)->name_entry.rbe_left)->name_entry.rbe_parent = (gparent); } do {} while (0); if (((tmp)->name_entry.rbe_parent = (gparent)->name_entry.rbe_parent)) { if ((gparent) == ((gparent)->name_entry.rbe_parent)->name_entry.rbe_left) ((gparent)->name_entry.rbe_parent)->name_entry.rbe_left = (tmp); else ((gparent)->name_entry.rbe_parent)->name_entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->name_entry.rbe_left = (gparent); (gparent)->name_entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->name_entry.rbe_parent)) do {} while (0); } while (0); } } (head->rbh_root)->name_entry.rbe_color = 0; } static void paste_name_tree_RB_REMOVE_COLOR(struct paste_name_tree *head, struct paste_buffer *parent, struct paste_buffer *elm) { struct paste_buffer *tmp; while ((elm == 0 || (elm)->name_entry.rbe_color == 0) && elm != (head)->rbh_root) { if ((parent)->name_entry.rbe_left == elm) { tmp = (parent)->name_entry.rbe_right; if ((tmp)->name_entry.rbe_color == 1) { do { (tmp)->name_entry.rbe_color = 0; (parent)->name_entry.rbe_color = 1; } while (0); do { (tmp) = (parent)->name_entry.rbe_right; if (((parent)->name_entry.rbe_right = (tmp)->name_entry.rbe_left)) { ((tmp)->name_entry.rbe_left)->name_entry.rbe_parent = (parent); } do {} while (0); if (((tmp)->name_entry.rbe_parent = (parent)->name_entry.rbe_parent)) { if ((parent) == ((parent)->name_entry.rbe_parent)->name_entry.rbe_left) ((parent)->name_entry.rbe_parent)->name_entry.rbe_left = (tmp); else ((parent)->name_entry.rbe_parent)->name_entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->name_entry.rbe_left = (parent); (parent)->name_entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->name_entry.rbe_parent)) do {} while (0); } while (0); tmp = (parent)->name_entry.rbe_right; } if (((tmp)->name_entry.rbe_left == 0 || ((tmp)->name_entry.rbe_left)->name_entry.rbe_color == 0) && ((tmp)->name_entry.rbe_right == 0 || ((tmp)->name_entry.rbe_right)->name_entry.rbe_color == 0)) { (tmp)->name_entry.rbe_color = 1; elm = parent; parent = (elm)->name_entry.rbe_parent; } else { if ((tmp)->name_entry.rbe_right == 0 || ((tmp)->name_entry.rbe_right)->name_entry.rbe_color == 0) { struct paste_buffer *oleft; if ((oleft = (tmp)->name_entry.rbe_left)) (oleft)->name_entry.rbe_color = 0; (tmp)->name_entry.rbe_color = 1; do { (oleft) = (tmp)->name_entry.rbe_left; if (((tmp)->name_entry.rbe_left = (oleft)->name_entry.rbe_right)) { ((oleft)->name_entry.rbe_right)->name_entry.rbe_parent = (tmp); } do {} while (0); if (((oleft)->name_entry.rbe_parent = (tmp)->name_entry.rbe_parent)) { if ((tmp) == ((tmp)->name_entry.rbe_parent)->name_entry.rbe_left) ((tmp)->name_entry.rbe_parent)->name_entry.rbe_left = (oleft); else ((tmp)->name_entry.rbe_parent)->name_entry.rbe_right = (oleft); } else (head)->rbh_root = (oleft); (oleft)->name_entry.rbe_right = (tmp); (tmp)->name_entry.rbe_parent = (oleft); do {} while (0); if (((oleft)->name_entry.rbe_parent)) do {} while (0); } while (0); tmp = (parent)->name_entry.rbe_right; } (tmp)->name_entry.rbe_color = (parent)->name_entry.rbe_color; (parent)->name_entry.rbe_color = 0; if ((tmp)->name_entry.rbe_right) ((tmp)->name_entry.rbe_right)->name_entry.rbe_color = 0; do { (tmp) = (parent)->name_entry.rbe_right; if (((parent)->name_entry.rbe_right = (tmp)->name_entry.rbe_left)) { ((tmp)->name_entry.rbe_left)->name_entry.rbe_parent = (parent); } do {} while (0); if (((tmp)->name_entry.rbe_parent = (parent)->name_entry.rbe_parent)) { if ((parent) == ((parent)->name_entry.rbe_parent)->name_entry.rbe_left) ((parent)->name_entry.rbe_parent)->name_entry.rbe_left = (tmp); else ((parent)->name_entry.rbe_parent)->name_entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->name_entry.rbe_left = (parent); (parent)->name_entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->name_entry.rbe_parent)) do {} while (0); } while (0); elm = (head)->rbh_root; break; } } else { tmp = (parent)->name_entry.rbe_left; if ((tmp)->name_entry.rbe_color == 1) { do { (tmp)->name_entry.rbe_color = 0; (parent)->name_entry.rbe_color = 1; } while (0); do { (tmp) = (parent)->name_entry.rbe_left; if (((parent)->name_entry.rbe_left = (tmp)->name_entry.rbe_right)) { ((tmp)->name_entry.rbe_right)->name_entry.rbe_parent = (parent); } do {} while (0); if (((tmp)->name_entry.rbe_parent = (parent)->name_entry.rbe_parent)) { if ((parent) == ((parent)->name_entry.rbe_parent)->name_entry.rbe_left) ((parent)->name_entry.rbe_parent)->name_entry.rbe_left = (tmp); else ((parent)->name_entry.rbe_parent)->name_entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->name_entry.rbe_right = (parent); (parent)->name_entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->name_entry.rbe_parent)) do {} while (0); } while (0); tmp = (parent)->name_entry.rbe_left; } if (((tmp)->name_entry.rbe_left == 0 || ((tmp)->name_entry.rbe_left)->name_entry.rbe_color == 0) && ((tmp)->name_entry.rbe_right == 0 || ((tmp)->name_entry.rbe_right)->name_entry.rbe_color == 0)) { (tmp)->name_entry.rbe_color = 1; elm = parent; parent = (elm)->name_entry.rbe_parent; } else { if ((tmp)->name_entry.rbe_left == 0 || ((tmp)->name_entry.rbe_left)->name_entry.rbe_color == 0) { struct paste_buffer *oright; if ((oright = (tmp)->name_entry.rbe_right)) (oright)->name_entry.rbe_color = 0; (tmp)->name_entry.rbe_color = 1; do { (oright) = (tmp)->name_entry.rbe_right; if (((tmp)->name_entry.rbe_right = (oright)->name_entry.rbe_left)) { ((oright)->name_entry.rbe_left)->name_entry.rbe_parent = (tmp); } do {} while (0); if (((oright)->name_entry.rbe_parent = (tmp)->name_entry.rbe_parent)) { if ((tmp) == ((tmp)->name_entry.rbe_parent)->name_entry.rbe_left) ((tmp)->name_entry.rbe_parent)->name_entry.rbe_left = (oright); else ((tmp)->name_entry.rbe_parent)->name_entry.rbe_right = (oright); } else (head)->rbh_root = (oright); (oright)->name_entry.rbe_left = (tmp); (tmp)->name_entry.rbe_parent = (oright); do {} while (0); if (((oright)->name_entry.rbe_parent)) do {} while (0); } while (0); tmp = (parent)->name_entry.rbe_left; } (tmp)->name_entry.rbe_color = (parent)->name_entry.rbe_color; (parent)->name_entry.rbe_color = 0; if ((tmp)->name_entry.rbe_left) ((tmp)->name_entry.rbe_left)->name_entry.rbe_color = 0; do { (tmp) = (parent)->name_entry.rbe_left; if (((parent)->name_entry.rbe_left = (tmp)->name_entry.rbe_right)) { ((tmp)->name_entry.rbe_right)->name_entry.rbe_parent = (parent); } do {} while (0); if (((tmp)->name_entry.rbe_parent = (parent)->name_entry.rbe_parent)) { if ((parent) == ((parent)->name_entry.rbe_parent)->name_entry.rbe_left) ((parent)->name_entry.rbe_parent)->name_entry.rbe_left = (tmp); else ((parent)->name_entry.rbe_parent)->name_entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->name_entry.rbe_right = (parent); (parent)->name_entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->name_entry.rbe_parent)) do {} while (0); } while (0); elm = (head)->rbh_root; break; } } } if (elm) (elm)->name_entry.rbe_color = 0; } static struct paste_buffer * paste_name_tree_RB_REMOVE(struct paste_name_tree *head, struct paste_buffer *elm) { struct paste_buffer *child, *parent, *old = elm; int color; if ((elm)->name_entry.rbe_left == 0) child = (elm)->name_entry.rbe_right; else if ((elm)->name_entry.rbe_right == 0) child = (elm)->name_entry.rbe_left; else { struct paste_buffer *left; elm = (elm)->name_entry.rbe_right; while ((left = (elm)->name_entry.rbe_left)) elm = left; child = (elm)->name_entry.rbe_right; parent = (elm)->name_entry.rbe_parent; color = (elm)->name_entry.rbe_color; if (child) (child)->name_entry.rbe_parent = parent; if (parent) { if ((parent)->name_entry.rbe_left == elm) (parent)->name_entry.rbe_left = child; else (parent)->name_entry.rbe_right = child; do {} while (0); } else (head)->rbh_root = child; if ((elm)->name_entry.rbe_parent == old) parent = elm; (elm)->name_entry = (old)->name_entry; if ((old)->name_entry.rbe_parent) { if (((old)->name_entry.rbe_parent)->name_entry.rbe_left == old) ((old)->name_entry.rbe_parent)->name_entry.rbe_left = elm; else ((old)->name_entry.rbe_parent)->name_entry.rbe_right = elm; do {} while (0); } else (head)->rbh_root = elm; ((old)->name_entry.rbe_left)->name_entry.rbe_parent = elm; if ((old)->name_entry.rbe_right) ((old)->name_entry.rbe_right)->name_entry.rbe_parent = elm; if (parent) { left = parent; do { do {} while (0); } while ((left = (left)->name_entry.rbe_parent)); } goto color; } parent = (elm)->name_entry.rbe_parent; color = (elm)->name_entry.rbe_color; if (child) (child)->name_entry.rbe_parent = parent; if (parent) { if ((parent)->name_entry.rbe_left == elm) (parent)->name_entry.rbe_left = child; else (parent)->name_entry.rbe_right = child; do {} while (0); } else (head)->rbh_root = child; color: if (color == 0) paste_name_tree_RB_REMOVE_COLOR(head, parent, child); return (old); } static struct paste_buffer * paste_name_tree_RB_INSERT(struct paste_name_tree *head, struct paste_buffer *elm) { struct paste_buffer *tmp; struct paste_buffer *parent = 0; int comp = 0; tmp = (head)->rbh_root; while (tmp) { parent = tmp; comp = (paste_cmp_names)(elm, parent); if (comp < 0) tmp = (tmp)->name_entry.rbe_left; else if (comp > 0) tmp = (tmp)->name_entry.rbe_right; else return (tmp); } do { (elm)->name_entry.rbe_parent = parent; (elm)->name_entry.rbe_left = (elm)->name_entry.rbe_right = 0; (elm)->name_entry.rbe_color = 1; } while (0); if (parent != 0) { if (comp < 0) (parent)->name_entry.rbe_left = elm; else (parent)->name_entry.rbe_right = elm; do {} while (0); } else (head)->rbh_root = elm; paste_name_tree_RB_INSERT_COLOR(head, elm); return (0); } static struct paste_buffer * paste_name_tree_RB_FIND(struct paste_name_tree *head, struct paste_buffer *elm) { struct paste_buffer *tmp = (head)->rbh_root; int comp; while (tmp) { comp = paste_cmp_names(elm, tmp); if (comp < 0) tmp = (tmp)->name_entry.rbe_left; else if (comp > 0) tmp = (tmp)->name_entry.rbe_right; else return (tmp); } return (0); } static struct paste_buffer * paste_name_tree_RB_NFIND(struct paste_name_tree *head, struct paste_buffer *elm) { struct paste_buffer *tmp = (head)->rbh_root; struct paste_buffer *res = 0; int comp; while (tmp) { comp = paste_cmp_names(elm, tmp); if (comp < 0) { res = tmp; tmp = (tmp)->name_entry.rbe_left; } else if (comp > 0) tmp = (tmp)->name_entry.rbe_right; else return (tmp); } return (res); } static struct paste_buffer * paste_name_tree_RB_NEXT(struct paste_buffer *elm) { if ((elm)->name_entry.rbe_right) { elm = (elm)->name_entry.rbe_right; while ((elm)->name_entry.rbe_left) elm = (elm)->name_entry.rbe_left; } else { if ((elm)->name_entry.rbe_parent && (elm == ((elm)->name_entry.rbe_parent)->name_entry.rbe_left)) elm = (elm)->name_entry.rbe_parent; else { while ((elm)->name_entry.rbe_parent && (elm == ((elm)->name_entry.rbe_parent)->name_entry.rbe_right)) elm = (elm)->name_entry.rbe_parent; elm = (elm)->name_entry.rbe_parent; } } return (elm); } static struct paste_buffer * paste_name_tree_RB_PREV(struct paste_buffer *elm) { if ((elm)->name_entry.rbe_left) { elm = (elm)->name_entry.rbe_left; while ((elm)->name_entry.rbe_right) elm = (elm)->name_entry.rbe_right; } else { if ((elm)->name_entry.rbe_parent && (elm == ((elm)->name_entry.rbe_parent)->name_entry.rbe_right)) elm = (elm)->name_entry.rbe_parent; else { while ((elm)->name_entry.rbe_parent && (elm == ((elm)->name_entry.rbe_parent)->name_entry.rbe_left)) elm = (elm)->name_entry.rbe_parent; elm = (elm)->name_entry.rbe_parent; } } return (elm); } static struct paste_buffer * paste_name_tree_RB_MINMAX(struct paste_name_tree *head, int val) { struct paste_buffer *tmp = (head)->rbh_root; struct paste_buffer *parent = 0; while (tmp) { parent = tmp; if (val < 0) tmp = (tmp)->name_entry.rbe_left; else tmp = (tmp)->name_entry.rbe_right; } return (parent); };

static int paste_cmp_times(const struct paste_buffer *,
      const struct paste_buffer *);
 static void paste_time_tree_RB_INSERT_COLOR(struct paste_time_tree *head, struct paste_buffer *elm) { struct paste_buffer *parent, *gparent, *tmp; while ((parent = (elm)->time_entry.rbe_parent) && (parent)->time_entry.rbe_color == 1) { gparent = (parent)->time_entry.rbe_parent; if (parent == (gparent)->time_entry.rbe_left) { tmp = (gparent)->time_entry.rbe_right; if (tmp && (tmp)->time_entry.rbe_color == 1) { (tmp)->time_entry.rbe_color = 0; do { (parent)->time_entry.rbe_color = 0; (gparent)->time_entry.rbe_color = 1; } while (0); elm = gparent; continue; } if ((parent)->time_entry.rbe_right == elm) { do { (tmp) = (parent)->time_entry.rbe_right; if (((parent)->time_entry.rbe_right = (tmp)->time_entry.rbe_left)) { ((tmp)->time_entry.rbe_left)->time_entry.rbe_parent = (parent); } do {} while (0); if (((tmp)->time_entry.rbe_parent = (parent)->time_entry.rbe_parent)) { if ((parent) == ((parent)->time_entry.rbe_parent)->time_entry.rbe_left) ((parent)->time_entry.rbe_parent)->time_entry.rbe_left = (tmp); else ((parent)->time_entry.rbe_parent)->time_entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->time_entry.rbe_left = (parent); (parent)->time_entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->time_entry.rbe_parent)) do {} while (0); } while (0); tmp = parent; parent = elm; elm = tmp; } do { (parent)->time_entry.rbe_color = 0; (gparent)->time_entry.rbe_color = 1; } while (0); do { (tmp) = (gparent)->time_entry.rbe_left; if (((gparent)->time_entry.rbe_left = (tmp)->time_entry.rbe_right)) { ((tmp)->time_entry.rbe_right)->time_entry.rbe_parent = (gparent); } do {} while (0); if (((tmp)->time_entry.rbe_parent = (gparent)->time_entry.rbe_parent)) { if ((gparent) == ((gparent)->time_entry.rbe_parent)->time_entry.rbe_left) ((gparent)->time_entry.rbe_parent)->time_entry.rbe_left = (tmp); else ((gparent)->time_entry.rbe_parent)->time_entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->time_entry.rbe_right = (gparent); (gparent)->time_entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->time_entry.rbe_parent)) do {} while (0); } while (0); } else { tmp = (gparent)->time_entry.rbe_left; if (tmp && (tmp)->time_entry.rbe_color == 1) { (tmp)->time_entry.rbe_color = 0; do { (parent)->time_entry.rbe_color = 0; (gparent)->time_entry.rbe_color = 1; } while (0); elm = gparent; continue; } if ((parent)->time_entry.rbe_left == elm) { do { (tmp) = (parent)->time_entry.rbe_left; if (((parent)->time_entry.rbe_left = (tmp)->time_entry.rbe_right)) { ((tmp)->time_entry.rbe_right)->time_entry.rbe_parent = (parent); } do {} while (0); if (((tmp)->time_entry.rbe_parent = (parent)->time_entry.rbe_parent)) { if ((parent) == ((parent)->time_entry.rbe_parent)->time_entry.rbe_left) ((parent)->time_entry.rbe_parent)->time_entry.rbe_left = (tmp); else ((parent)->time_entry.rbe_parent)->time_entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->time_entry.rbe_right = (parent); (parent)->time_entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->time_entry.rbe_parent)) do {} while (0); } while (0); tmp = parent; parent = elm; elm = tmp; } do { (parent)->time_entry.rbe_color = 0; (gparent)->time_entry.rbe_color = 1; } while (0); do { (tmp) = (gparent)->time_entry.rbe_right; if (((gparent)->time_entry.rbe_right = (tmp)->time_entry.rbe_left)) { ((tmp)->time_entry.rbe_left)->time_entry.rbe_parent = (gparent); } do {} while (0); if (((tmp)->time_entry.rbe_parent = (gparent)->time_entry.rbe_parent)) { if ((gparent) == ((gparent)->time_entry.rbe_parent)->time_entry.rbe_left) ((gparent)->time_entry.rbe_parent)->time_entry.rbe_left = (tmp); else ((gparent)->time_entry.rbe_parent)->time_entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->time_entry.rbe_left = (gparent); (gparent)->time_entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->time_entry.rbe_parent)) do {} while (0); } while (0); } } (head->rbh_root)->time_entry.rbe_color = 0; } static void paste_time_tree_RB_REMOVE_COLOR(struct paste_time_tree *head, struct paste_buffer *parent, struct paste_buffer *elm) { struct paste_buffer *tmp; while ((elm == 0 || (elm)->time_entry.rbe_color == 0) && elm != (head)->rbh_root) { if ((parent)->time_entry.rbe_left == elm) { tmp = (parent)->time_entry.rbe_right; if ((tmp)->time_entry.rbe_color == 1) { do { (tmp)->time_entry.rbe_color = 0; (parent)->time_entry.rbe_color = 1; } while (0); do { (tmp) = (parent)->time_entry.rbe_right; if (((parent)->time_entry.rbe_right = (tmp)->time_entry.rbe_left)) { ((tmp)->time_entry.rbe_left)->time_entry.rbe_parent = (parent); } do {} while (0); if (((tmp)->time_entry.rbe_parent = (parent)->time_entry.rbe_parent)) { if ((parent) == ((parent)->time_entry.rbe_parent)->time_entry.rbe_left) ((parent)->time_entry.rbe_parent)->time_entry.rbe_left = (tmp); else ((parent)->time_entry.rbe_parent)->time_entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->time_entry.rbe_left = (parent); (parent)->time_entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->time_entry.rbe_parent)) do {} while (0); } while (0); tmp = (parent)->time_entry.rbe_right; } if (((tmp)->time_entry.rbe_left == 0 || ((tmp)->time_entry.rbe_left)->time_entry.rbe_color == 0) && ((tmp)->time_entry.rbe_right == 0 || ((tmp)->time_entry.rbe_right)->time_entry.rbe_color == 0)) { (tmp)->time_entry.rbe_color = 1; elm = parent; parent = (elm)->time_entry.rbe_parent; } else { if ((tmp)->time_entry.rbe_right == 0 || ((tmp)->time_entry.rbe_right)->time_entry.rbe_color == 0) { struct paste_buffer *oleft; if ((oleft = (tmp)->time_entry.rbe_left)) (oleft)->time_entry.rbe_color = 0; (tmp)->time_entry.rbe_color = 1; do { (oleft) = (tmp)->time_entry.rbe_left; if (((tmp)->time_entry.rbe_left = (oleft)->time_entry.rbe_right)) { ((oleft)->time_entry.rbe_right)->time_entry.rbe_parent = (tmp); } do {} while (0); if (((oleft)->time_entry.rbe_parent = (tmp)->time_entry.rbe_parent)) { if ((tmp) == ((tmp)->time_entry.rbe_parent)->time_entry.rbe_left) ((tmp)->time_entry.rbe_parent)->time_entry.rbe_left = (oleft); else ((tmp)->time_entry.rbe_parent)->time_entry.rbe_right = (oleft); } else (head)->rbh_root = (oleft); (oleft)->time_entry.rbe_right = (tmp); (tmp)->time_entry.rbe_parent = (oleft); do {} while (0); if (((oleft)->time_entry.rbe_parent)) do {} while (0); } while (0); tmp = (parent)->time_entry.rbe_right; } (tmp)->time_entry.rbe_color = (parent)->time_entry.rbe_color; (parent)->time_entry.rbe_color = 0; if ((tmp)->time_entry.rbe_right) ((tmp)->time_entry.rbe_right)->time_entry.rbe_color = 0; do { (tmp) = (parent)->time_entry.rbe_right; if (((parent)->time_entry.rbe_right = (tmp)->time_entry.rbe_left)) { ((tmp)->time_entry.rbe_left)->time_entry.rbe_parent = (parent); } do {} while (0); if (((tmp)->time_entry.rbe_parent = (parent)->time_entry.rbe_parent)) { if ((parent) == ((parent)->time_entry.rbe_parent)->time_entry.rbe_left) ((parent)->time_entry.rbe_parent)->time_entry.rbe_left = (tmp); else ((parent)->time_entry.rbe_parent)->time_entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->time_entry.rbe_left = (parent); (parent)->time_entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->time_entry.rbe_parent)) do {} while (0); } while (0); elm = (head)->rbh_root; break; } } else { tmp = (parent)->time_entry.rbe_left; if ((tmp)->time_entry.rbe_color == 1) { do { (tmp)->time_entry.rbe_color = 0; (parent)->time_entry.rbe_color = 1; } while (0); do { (tmp) = (parent)->time_entry.rbe_left; if (((parent)->time_entry.rbe_left = (tmp)->time_entry.rbe_right)) { ((tmp)->time_entry.rbe_right)->time_entry.rbe_parent = (parent); } do {} while (0); if (((tmp)->time_entry.rbe_parent = (parent)->time_entry.rbe_parent)) { if ((parent) == ((parent)->time_entry.rbe_parent)->time_entry.rbe_left) ((parent)->time_entry.rbe_parent)->time_entry.rbe_left = (tmp); else ((parent)->time_entry.rbe_parent)->time_entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->time_entry.rbe_right = (parent); (parent)->time_entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->time_entry.rbe_parent)) do {} while (0); } while (0); tmp = (parent)->time_entry.rbe_left; } if (((tmp)->time_entry.rbe_left == 0 || ((tmp)->time_entry.rbe_left)->time_entry.rbe_color == 0) && ((tmp)->time_entry.rbe_right == 0 || ((tmp)->time_entry.rbe_right)->time_entry.rbe_color == 0)) { (tmp)->time_entry.rbe_color = 1; elm = parent; parent = (elm)->time_entry.rbe_parent; } else { if ((tmp)->time_entry.rbe_left == 0 || ((tmp)->time_entry.rbe_left)->time_entry.rbe_color == 0) { struct paste_buffer *oright; if ((oright = (tmp)->time_entry.rbe_right)) (oright)->time_entry.rbe_color = 0; (tmp)->time_entry.rbe_color = 1; do { (oright) = (tmp)->time_entry.rbe_right; if (((tmp)->time_entry.rbe_right = (oright)->time_entry.rbe_left)) { ((oright)->time_entry.rbe_left)->time_entry.rbe_parent = (tmp); } do {} while (0); if (((oright)->time_entry.rbe_parent = (tmp)->time_entry.rbe_parent)) { if ((tmp) == ((tmp)->time_entry.rbe_parent)->time_entry.rbe_left) ((tmp)->time_entry.rbe_parent)->time_entry.rbe_left = (oright); else ((tmp)->time_entry.rbe_parent)->time_entry.rbe_right = (oright); } else (head)->rbh_root = (oright); (oright)->time_entry.rbe_left = (tmp); (tmp)->time_entry.rbe_parent = (oright); do {} while (0); if (((oright)->time_entry.rbe_parent)) do {} while (0); } while (0); tmp = (parent)->time_entry.rbe_left; } (tmp)->time_entry.rbe_color = (parent)->time_entry.rbe_color; (parent)->time_entry.rbe_color = 0; if ((tmp)->time_entry.rbe_left) ((tmp)->time_entry.rbe_left)->time_entry.rbe_color = 0; do { (tmp) = (parent)->time_entry.rbe_left; if (((parent)->time_entry.rbe_left = (tmp)->time_entry.rbe_right)) { ((tmp)->time_entry.rbe_right)->time_entry.rbe_parent = (parent); } do {} while (0); if (((tmp)->time_entry.rbe_parent = (parent)->time_entry.rbe_parent)) { if ((parent) == ((parent)->time_entry.rbe_parent)->time_entry.rbe_left) ((parent)->time_entry.rbe_parent)->time_entry.rbe_left = (tmp); else ((parent)->time_entry.rbe_parent)->time_entry.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->time_entry.rbe_right = (parent); (parent)->time_entry.rbe_parent = (tmp); do {} while (0); if (((tmp)->time_entry.rbe_parent)) do {} while (0); } while (0); elm = (head)->rbh_root; break; } } } if (elm) (elm)->time_entry.rbe_color = 0; } static struct paste_buffer * paste_time_tree_RB_REMOVE(struct paste_time_tree *head, struct paste_buffer *elm) { struct paste_buffer *child, *parent, *old = elm; int color; if ((elm)->time_entry.rbe_left == 0) child = (elm)->time_entry.rbe_right; else if ((elm)->time_entry.rbe_right == 0) child = (elm)->time_entry.rbe_left; else { struct paste_buffer *left; elm = (elm)->time_entry.rbe_right; while ((left = (elm)->time_entry.rbe_left)) elm = left; child = (elm)->time_entry.rbe_right; parent = (elm)->time_entry.rbe_parent; color = (elm)->time_entry.rbe_color; if (child) (child)->time_entry.rbe_parent = parent; if (parent) { if ((parent)->time_entry.rbe_left == elm) (parent)->time_entry.rbe_left = child; else (parent)->time_entry.rbe_right = child; do {} while (0); } else (head)->rbh_root = child; if ((elm)->time_entry.rbe_parent == old) parent = elm; (elm)->time_entry = (old)->time_entry; if ((old)->time_entry.rbe_parent) { if (((old)->time_entry.rbe_parent)->time_entry.rbe_left == old) ((old)->time_entry.rbe_parent)->time_entry.rbe_left = elm; else ((old)->time_entry.rbe_parent)->time_entry.rbe_right = elm; do {} while (0); } else (head)->rbh_root = elm; ((old)->time_entry.rbe_left)->time_entry.rbe_parent = elm; if ((old)->time_entry.rbe_right) ((old)->time_entry.rbe_right)->time_entry.rbe_parent = elm; if (parent) { left = parent; do { do {} while (0); } while ((left = (left)->time_entry.rbe_parent)); } goto color; } parent = (elm)->time_entry.rbe_parent; color = (elm)->time_entry.rbe_color; if (child) (child)->time_entry.rbe_parent = parent; if (parent) { if ((parent)->time_entry.rbe_left == elm) (parent)->time_entry.rbe_left = child; else (parent)->time_entry.rbe_right = child; do {} while (0); } else (head)->rbh_root = child; color: if (color == 0) paste_time_tree_RB_REMOVE_COLOR(head, parent, child); return (old); } static struct paste_buffer * paste_time_tree_RB_INSERT(struct paste_time_tree *head, struct paste_buffer *elm) { struct paste_buffer *tmp; struct paste_buffer *parent = 0; int comp = 0; tmp = (head)->rbh_root; while (tmp) { parent = tmp; comp = (paste_cmp_times)(elm, parent); if (comp < 0) tmp = (tmp)->time_entry.rbe_left; else if (comp > 0) tmp = (tmp)->time_entry.rbe_right; else return (tmp); } do { (elm)->time_entry.rbe_parent = parent; (elm)->time_entry.rbe_left = (elm)->time_entry.rbe_right = 0; (elm)->time_entry.rbe_color = 1; } while (0); if (parent != 0) { if (comp < 0) (parent)->time_entry.rbe_left = elm; else (parent)->time_entry.rbe_right = elm; do {} while (0); } else (head)->rbh_root = elm; paste_time_tree_RB_INSERT_COLOR(head, elm); return (0); } static struct paste_buffer * paste_time_tree_RB_FIND(struct paste_time_tree *head, struct paste_buffer *elm) { struct paste_buffer *tmp = (head)->rbh_root; int comp; while (tmp) { comp = paste_cmp_times(elm, tmp); if (comp < 0) tmp = (tmp)->time_entry.rbe_left; else if (comp > 0) tmp = (tmp)->time_entry.rbe_right; else return (tmp); } return (0); } static struct paste_buffer * paste_time_tree_RB_NFIND(struct paste_time_tree *head, struct paste_buffer *elm) { struct paste_buffer *tmp = (head)->rbh_root; struct paste_buffer *res = 0; int comp; while (tmp) { comp = paste_cmp_times(elm, tmp); if (comp < 0) { res = tmp; tmp = (tmp)->time_entry.rbe_left; } else if (comp > 0) tmp = (tmp)->time_entry.rbe_right; else return (tmp); } return (res); } static struct paste_buffer * paste_time_tree_RB_NEXT(struct paste_buffer *elm) { if ((elm)->time_entry.rbe_right) { elm = (elm)->time_entry.rbe_right; while ((elm)->time_entry.rbe_left) elm = (elm)->time_entry.rbe_left; } else { if ((elm)->time_entry.rbe_parent && (elm == ((elm)->time_entry.rbe_parent)->time_entry.rbe_left)) elm = (elm)->time_entry.rbe_parent; else { while ((elm)->time_entry.rbe_parent && (elm == ((elm)->time_entry.rbe_parent)->time_entry.rbe_right)) elm = (elm)->time_entry.rbe_parent; elm = (elm)->time_entry.rbe_parent; } } return (elm); } static struct paste_buffer * paste_time_tree_RB_PREV(struct paste_buffer *elm) { if ((elm)->time_entry.rbe_left) { elm = (elm)->time_entry.rbe_left; while ((elm)->time_entry.rbe_right) elm = (elm)->time_entry.rbe_right; } else { if ((elm)->time_entry.rbe_parent && (elm == ((elm)->time_entry.rbe_parent)->time_entry.rbe_right)) elm = (elm)->time_entry.rbe_parent; else { while ((elm)->time_entry.rbe_parent && (elm == ((elm)->time_entry.rbe_parent)->time_entry.rbe_left)) elm = (elm)->time_entry.rbe_parent; elm = (elm)->time_entry.rbe_parent; } } return (elm); } static struct paste_buffer * paste_time_tree_RB_MINMAX(struct paste_time_tree *head, int val) { struct paste_buffer *tmp = (head)->rbh_root; struct paste_buffer *parent = 0; while (tmp) { parent = tmp; if (val < 0) tmp = (tmp)->time_entry.rbe_left; else tmp = (tmp)->time_entry.rbe_right; } return (parent); };
...
paste_get_top(const char **name)
{
 ...
 pb = paste_time_tree_RB_MINMAX(&paste_by_time, -1);
 if (pb == 0)
  return (0);
 if (name != 0)
  *name = pb->name;
...
paste_add(char *data, size_t size)
{
 ...
 for ((pb) = paste_time_tree_RB_MINMAX(&paste_by_time, 1); ((pb) != 0) && ((pb1) = paste_time_tree_RB_PREV(pb), 1); (pb) = (pb1)) {
