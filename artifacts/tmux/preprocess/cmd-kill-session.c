# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-kill-session.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-kill-session.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-kill-session.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-kill-session.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-kill-session.c" 2
# 30 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-kill-session.c"
...
cmd_kill_session_exec(struct cmd *self, struct cmdq_item *item)
{
 ...
 if (args_has(args, 'C')) {
  ...
  for ((sloop) = sessions_RB_MINMAX(&sessions, -1); ((sloop) != 0) && ((stmp) = sessions_RB_NEXT(sloop), 1); (sloop) = (stmp)) {
   if (sloop != s) {
