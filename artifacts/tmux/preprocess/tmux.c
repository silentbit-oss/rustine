# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tmux.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tmux.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tmux.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tmux.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/sys/stat.h" 1
# 21 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tmux.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 34 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tmux.c" 2
...
getshell(void)
{
 ...
 pw = getpwuid(getuid());
 if (pw != 0 && checkshell(pw->pw_shell))
  return (pw->pw_shell);
 ...
 *cause = 0;
 ...
 if ((s = getenv("TMUX_TMPDIR")) != 0 && *s != '\0')
  xasprintf(&base, "%s/tmux-%ld", s, (long)uid);
 else
  xasprintf(&base, "%s/tmux-%ld", "/tmp/", (long)uid);
 if (realpath(base, resolved) == 0 &&
...
main(int argc, char **argv)
{
 ...
 if ((0)
                                      != 0)
  err(1, "pledge");
# 276 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/tmux.c"
 if (getenv("TMUX") != 0)
  flags |= 0x10000;
 else {
  s = getenv("LC_ALL");
 ...
 if ((s = getenv("VISUAL")) != 0 || (s = getenv("EDITOR")) != 0) {
  if (strrchr(s, '/') != 0)
   s = strrchr(s, '/') + 1;
  if (strstr(s, "vi") != 0)
   keys = 1;
 ...
 if (path == 0 && (path = make_label(label, &cause)) == 0) {
  if (cause != 0) {
   fprintf(stderr, "%s\n", cause);
   free(cause);
  }
