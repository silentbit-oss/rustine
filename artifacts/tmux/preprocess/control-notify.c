# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/control-notify.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/control-notify.c"
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/control-notify.c"
...
# 21 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/control-notify.c" 2
...
# 23 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/control-notify.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 25 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/control-notify.c" 2
...
control_notify_window_layout_changed(struct window *w)
{
 ...
 for((c) = ((&clients)->tqh_first); (c) != 0; (c) = ((c)->entry.tqe_next)) {
  if (!((c) != 0 && ((c)->flags & 0x2000)) || c->session == 0)
   continue;
  s = c->session;
  ...
  if (wl != 0) {
   cp = format_single(0, template, c, 0, wl, 0);
...
void
control_notify_window_unlinked( struct session *s, struct window *w)
{
 struct client *c;
 struct session *cs;
...
void
control_notify_window_linked( struct session *s, struct window *w)
{
 struct client *c;
 struct session *cs;
...
void
control_notify_session_created( struct session *s)
{
 struct client *c;
...
void
control_notify_session_closed( struct session *s)
{
 struct client *c;
