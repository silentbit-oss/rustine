# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-switch-client.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-switch-client.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-switch-client.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-switch-client.c" 2
...
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-switch-client.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/string.h" 1
# 23 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-switch-client.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 25 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-switch-client.c" 2
...
cmd_switch_client_exec(struct cmd *self, struct cmdq_item *item)
{
 ...
 if ((c = cmd_find_client(item, args_get(args, 'c'), 0)) == 0)
 ...
 if (args_has(args, 'n')) {
  if ((s = session_next_session(c->session)) == 0) {
   cmdq_error(item, "can't find next session");
   return (CMD_RETURN_ERROR);
  }
 } else if (args_has(args, 'p')) {
  if ((s = session_previous_session(c->session)) == 0) {
   cmdq_error(item, "can't find previous session");
   return (CMD_RETURN_ERROR);
  }
 } else if (args_has(args, 'l')) {
  if (c->last_session != 0 && session_alive(c->last_session))
   s = c->last_session;
  else
   s = 0;
  if (s == 0) {
