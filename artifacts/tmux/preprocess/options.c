# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/options.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/options.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/options.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/options.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 27 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/options.c" 2
...
# 28 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/options.c" 2
...
options_free(struct options *oo)
{
 ...
 for ((o) = options_tree_RB_MINMAX(&oo->tree, -1); ((o) != 0) && ((tmp) = options_tree_RB_NEXT(o), 1); (o) = (tmp))
  options_remove(o);
 free(oo);
}
...
options_remove(struct options_entry *o)
{
 ...
 if (((o)->tableentry == 0 || (o)->tableentry->type == OPTIONS_TABLE_STRING))
  free((void *)o->string);
 else if (((o)->tableentry != 0 && (o)->tableentry->type == OPTIONS_TABLE_ARRAY)) {
...
options_array_assign(struct options_entry *o, const char *s)
{
 ...
 while ((next = strsep(&string, separator)) != 0) {
  if (*next == '\0')
   continue;
  for (i = 0; i < 1000; i++) {
...
options_parse(const char *name, int *idx)
{
 ...
 if (end == 0 || end[1] != '\0' || !isdigit((u_char)end[-1])) {
  free(copy);
  return (0);
 }
...
options_match(const char *s, int *idx, int* ambiguous)
{
 ...
 found = 0;
 for (oe = options_table; oe->name != 0; oe++) {
...
# 554 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/options.c"
struct options_entry *
    ...
    const char *value)
{
 ...
 o = options_get_only(oo, name);
 if (o != 0 && append && ((o)->tableentry != 0 && (o)->tableentry->type == OPTIONS_TABLE_STYLE))
...
options_style_update_new(struct options *oo, struct options_entry *o)
{
 ...
 else if (strstr(o->name, "-fg") != 0)
  new->style.fg = o->number;
 else if (strstr(o->name, "-attr") != 0)
