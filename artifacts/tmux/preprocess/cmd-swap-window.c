# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-swap-window.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-swap-window.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-swap-window.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-swap-window.c" 2
...
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-swap-window.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 24 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-swap-window.c" 2
...
cmd_swap_window_exec(struct cmd *self, struct cmdq_item *item)
{
 ...
 w_dst = wl_dst->window;
 do { if (((wl_dst)->wentry.tqe_next) != 0) (wl_dst)->wentry.tqe_next->wentry.tqe_prev = (wl_dst)->wentry.tqe_prev; else (&w_dst->winlinks)->tqh_last = (wl_dst)->wentry.tqe_prev; *(wl_dst)->wentry.tqe_prev = (wl_dst)->wentry.tqe_next; ; ; } while (0);
 w_src = wl_src->window;
 do { if (((wl_src)->wentry.tqe_next) != 0) (wl_src)->wentry.tqe_next->wentry.tqe_prev = (wl_src)->wentry.tqe_prev; else (&w_src->winlinks)->tqh_last = (wl_src)->wentry.tqe_prev; *(wl_src)->wentry.tqe_prev = (wl_src)->wentry.tqe_next; ; ; } while (0);

 wl_dst->window = w_src;
 do { (wl_dst)->wentry.tqe_next = 0; (wl_dst)->wentry.tqe_prev = (&w_src->winlinks)->tqh_last; *(&w_src->winlinks)->tqh_last = (wl_dst); (&w_src->winlinks)->tqh_last = &(wl_dst)->wentry.tqe_next; } while (0);
 wl_src->window = w_dst;
 do { (wl_src)->wentry.tqe_next = 0; (wl_src)->wentry.tqe_prev = (&w_dst->winlinks)->tqh_last; *(&w_dst->winlinks)->tqh_last = (wl_src); (&w_dst->winlinks)->tqh_last = &(wl_src)->wentry.tqe_next; } while (0);
