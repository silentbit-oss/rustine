# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/grid.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/grid.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/grid.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/grid.c" 2
...
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/grid.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/string.h" 1
# 23 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/grid.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 25 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/grid.c" 2
# 39 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/grid.c"
...
grid_compact_line(struct grid_line *gl)
{
 ...
 new_extddata = xreallocarray(0, new_extdsize, sizeof *gl->extddata);
    ...
    u_int ny)
{
 ...
 for (yy = 0; yy < ny; yy++) {
  ...
  if (srcl->extdsize != 0) {
   ...
   dstl->extddata = xreallocarray(0, dstl->extdsize,
...
grid_reflow(struct grid *gd, u_int sx, u_int *cursor)
{
 ...
 gettimeofday(&tv, 0);
 do { (&tv)->tv_sec = (&tv)->tv_sec - (&start)->tv_sec; (&tv)->tv_usec = (&tv)->tv_usec - (&start)->tv_usec; if ((&tv)->tv_usec < 0) { (&tv)->tv_sec--; (&tv)->tv_usec += 1000000; } } while (0);
