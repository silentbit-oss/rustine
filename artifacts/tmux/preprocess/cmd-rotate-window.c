# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-rotate-window.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-rotate-window.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-rotate-window.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-rotate-window.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-rotate-window.c" 2
...
cmd_rotate_window_exec(struct cmd *self, struct cmdq_item *item)
{
 ...
 if (args_has(self->args, 'D')) {
  ...
  if ((wp = (*(((struct window_panes *)((w->active)->entry.tqe_prev))->tqh_last))) == 0)
   wp = (*(((struct window_panes *)((&w->panes)->tqh_last))->tqh_last));
  ...
  xoff = wp->xoff; yoff = wp->yoff;
  sx = wp->sx; sy = wp->sy;
  for((wp) = (*(((struct window_panes *)((&w->panes)->tqh_last))->tqh_last)); (wp) != 0; (wp) = (*(((struct window_panes *)((wp)->entry.tqe_prev))->tqh_last))) {
   if ((wp2 = (*(((struct window_panes *)((wp)->entry.tqe_prev))->tqh_last))) == 0)
    break;
   wp->layout_cell = wp2->layout_cell;
   if (wp->layout_cell != 0)
    wp->layout_cell->wp = wp;
  ...
  if ((wp = ((w->active)->entry.tqe_next)) == 0)
   wp = ((&w->panes)->tqh_first);
  window_set_active_pane(w, wp);
  cmd_find_from_winlink_pane(current, wl, wp, 0);
  server_redraw_window(w);
