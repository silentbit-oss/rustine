# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-tree.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-tree.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-tree.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-tree.c" 2
...
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-tree.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/stdlib.h" 1
# 23 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-tree.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/string.h" 1
# 24 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-tree.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 26 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-tree.c" 2
...
static void window_tree_key(struct window_pane *,
        ...
        struct mouse_event *);
# 55 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-tree.c"
    ...
    struct window_pane *wp, void *modedata, struct mode_tree_item *parent)
{
 ...
 text = format_single(0, data->format, 0, s, wl, wp);
    ...
    struct window_pane *wp, const char *filter)
{
 ...
 cp = format_single(0, filter, 0, s, wl, wp);
    ...
    u_int sort_type, struct mode_tree_item *parent, const char *filter)
{
 ...
 text = format_single(0, data->format, 0, s, wl, 0);
 ...
 if ((wp = ((&wl->window->panes)->tqh_first)) == 0)
  goto empty;
 ...
 for((wp) = ((&wl->window->panes)->tqh_first); (wp) != 0; (wp) = ((wp)->entry.tqe_next)) {
  if (!window_tree_filter_pane(s, wl, wp, filter))
   continue;
    ...
    u_int sort_type, const char *filter)
{
 ...
 text = format_single(0, data->format, 0, s, 0, 0);

 if (data->type == WINDOW_TREE_SESSION)
  expanded = 0;
 else
  expanded = 1;
 mti = mode_tree_add(data->data, 0, item, (uint64_t)s, s->name, text,
     expanded);
 free(text);
...
static int
window_tree_search( void *modedata, void *itemdata, const char *ss)
{
 struct window_tree_itemdata *item = itemdata;
 struct session *s;
 struct winlink *wl;
    ...
    struct args *args)
{
 ...
 data->data = mode_tree_start(wp, args, window_tree_build,
     ...
     (sizeof((window_tree_sort_list)) / sizeof((window_tree_sort_list)[0])), &s);
...
window_tree_command_done( struct cmdq_item *item, void *modedata)
{
 struct window_tree_modedata *data = modedata;
...
static void
window_tree_kill_each( void* modedata, void* itemdata,
    ...
    struct session *s, key_code key, struct mouse_event *m)
{
 ...
 case ':':
  ...
  status_prompt_set(c, prompt, "", window_tree_command_callback,
      window_tree_command_free, data, 0x8);
  free(prompt);
  break;
 case '\r':
  item = mode_tree_get_current(data->data);
