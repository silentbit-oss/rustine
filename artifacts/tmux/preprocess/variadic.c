# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/variadic.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/variadic.c"
...
# 2 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/variadic.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/errno.h" 1
# 3 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/variadic.c" 2
...
# 10 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/variadic.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 11 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/variadic.c" 2
...
# 12 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/variadic.c" 2
...
cmdq_print(struct cmdq_item *item, const char *fmt, ...)
{
 ...
 if (c == 0)
               ;
 else if (c->session == 0 || (c->flags & 0x2000)) {
  if (~c->flags & 0x10000) {
  ...
  if (w->active->mode != &window_copy_mode) {
   ...
   window_pane_set_mode(w->active, &window_copy_mode, 0,
       0);
    ...
    struct cmd_find_state *fs, const char *fmt, ...)
{
 ...
 new_item = cmdq_get_command(hook->cmdlist, fs, 0, 0x4);
    ...
    const char *fmt, ...)
{
 ...
 if (o != 0 && append && ((o)->tableentry == 0 || (o)->tableentry->type == OPTIONS_TABLE_STRING)) {
...
server_client_add_message(struct client *c, const char *fmt, ...)
{
 ...
 msg->msg = s;
 do { (msg)->entry.tqe_next = 0; (msg)->entry.tqe_prev = (&c->message_log)->tqh_last; *(&c->message_log)->tqh_last = (msg); (&c->message_log)->tqh_last = &(msg)->entry.tqe_next; } while (0);
...
# 776 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/variadic.c"
void
