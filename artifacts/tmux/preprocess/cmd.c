# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/sys/time.h" 1
# 21 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 29 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd.c" 2
...
cmd_try_alias(int *argc, char ***argv)
{
 ...
 if (o == 0 || options_array_size(o, &size) == -1 || size == 0)
  return (-1);
...
retry:
 ambiguous = 0;
 entry = 0;
 for (entryp = cmd_table; *entryp != 0; entryp++) {
  if ((*entryp)->alias != 0 &&
...
cmd_mouse_window(struct mouse_event *m, struct session **sp)
{
 ...
 if (!m->valid || m->s == -1 || m->w == -1)
  return (0);
 if ((s = session_find_by_id(m->s)) == 0)
  return (0);
 if ((w = window_find_by_id(m->w)) == 0)
  return (0);
    ...
    struct winlink **wlp)
{
 ...
 if ((wl = cmd_mouse_window(m, sp)) == 0)
  return (0);
 if ((wp = window_pane_find_by_id(m->wp)) == 0)
  return (0);
