# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/server.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/server.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/server.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/server.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/sys/ioctl.h" 1
# 21 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/server.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/sys/socket.h" 1
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/server.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/sys/stat.h" 1
# 23 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/server.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/sys/un.h" 1
# 24 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/server.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/sys/wait.h" 1
# 25 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/server.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 38 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/server.c" 2
    ...
    char *lockfile)
{
 ...
 do { (&windows)->rbh_root = 0; } while (0);
 do { (&all_window_panes)->rbh_root = 0; } while (0);
 do { (&clients)->tqh_first = 0; (&clients)->tqh_last = &(&clients)->tqh_first; } while (0);
 do { (&sessions)->rbh_root = 0; } while (0);
 do { (&session_groups)->rbh_root = 0; } while (0);
 key_bindings_init();
 ...
 for((job) = ((&all_jobs)->lh_first); (job)!= 0; (job) = ((job)->entry.le_next)) {
  if (job->pid != -1)
...
server_send_exit(void)
{
 ...
 for ((c) = ((&clients)->tqh_first); (c) != 0 && ((c1) = ((c)->entry.tqe_next), 1); (c) = (c1)) {
  if (c->flags & 0x40)
 ...
 for ((s) = sessions_RB_MINMAX(&sessions, -1); ((s) != 0) && ((s1) = sessions_RB_NEXT(s), 1); (s) = (s1))
...
static void
server_accept(int fd, short events, void *data)
{
...
server_child_exited(pid_t pid, int status)
{
 ...
 for ((w) = windows_RB_MINMAX(&windows, -1); ((w) != 0) && ((w1) = windows_RB_NEXT(w), 1); (w) = (w1)) {
