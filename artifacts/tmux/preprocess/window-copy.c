# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-copy.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-copy.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-copy.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-copy.c" 2
...
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-copy.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/stdlib.h" 1
# 23 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-copy.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/string.h" 1
# 24 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-copy.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 26 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-copy.c" 2
...
# 27 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-copy.c" 2
...
# 149 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-copy.c"
...
window_copy_init(struct window_pane *wp, struct cmd_find_state *fs,
    struct args *args)
{
...
window_copy_init_for_output(struct window_pane *wp)
{
 ...
 screen_init(data->backing, ((&wp->base)->grid->sx),
     ((&wp->base)->grid->sy), 4294967295U);
}
...
# 305 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/window-copy.c"
void
...
window_copy_search_marks(struct window_pane *wp, struct screen *ssp)
{
 ...
 for (py = 0; py < gd->hsize + gd->sy; py++) {
  ...
  for (;;) {
   ...
   b = (py * gd->sx) + px;
   do { register bitstr_t *_name = data->searchmark; register int _start = b, _stop = b + width - 1; while (_start <= _stop) { ((_name)[((_start) >> 3)] |= (1 << ((_start)&0x7))); _start++; } } while(0);
    ...
    u_int py)
{
 ...
 if (py == 0) {
  if (data->searchmark == 0) {
   size = xsnprintf(hdr, sizeof hdr,
       "[%u/%u]", data->oy, ((data->backing)->grid->hsize));
  } else {
 ...
 if (size < ((s)->grid->sx)) {
  ...
  screen_write_copy(ctx, data->backing, 0,
      (((data->backing)->grid->hsize) - data->oy) + py,
      ((s)->grid->sx) - size, 1, data->searchmark, &gc);
 }
    ...
    const char *bufname, const char *arg)
{
 ...
 if (buf == 0)
  return;
 expanded = format_single(0, arg, 0, s, 0, wp);

 job = job_run(expanded, s, 0, 0, 0, 0, 0, 0x1);
 ...
 if (sx < ex) {
  for (i = sx; i < ex; i++) {
   ...
   if (ud.size == 1 && (gc.attr & 0x80)) {
    s = tty_acs_get(0, ud.data[0]);
    if (s != 0 && strlen(s) <= sizeof ud.data) {
     ud.size = strlen(s);
...
window_copy_other_end(struct window_pane *wp)
{
 ...
 if (sely < hsize - data->oy) {
  data->oy = hsize - sely;
  data->cy = 0;
 } else if (sely > hsize - data->oy + ((s)->grid->sy)) {
    ...
    const char *separators)
{
 ...
 for (;;) {
  if (px > 0) {
   ...
   if (data->cy == 0 &&
       (((data->backing)->grid->hsize) == 0 ||
       data->oy >= ((data->backing)->grid->hsize) - 1))
    goto out;
   window_copy_cursor_up(wp, 0);
...
window_copy_move_mouse(struct mouse_event *m)
{
 ...
 wp = cmd_mouse_pane(m, 0, 0);
 if (wp == 0 || wp->mode != &window_copy_mode)
  return;
