# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-find.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-find.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-find.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-find.c" 2

# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/fnmatch.h" 1
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/_fake_defines.h" 1
# 2 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/fnmatch.h" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/_fake_typedefs.h" 1
# 3 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/fnmatch.h" 2
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-find.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/limits.h" 1
# 23 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-find.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/stdlib.h" 1
# 24 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-find.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/string.h" 1
# 25 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-find.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/unistd.h" 1
# 26 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-find.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 28 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-find.c" 2
...
cmd_find_best_client(struct session *s)
{
 ...
 c = 0;
 for((c_loop) = ((&clients)->tqh_first); (c_loop) != 0; (c_loop) = ((c_loop)->entry.tqe_next)) {
  if (c_loop->session == 0)
   continue;
  if (s != 0 && c_loop->session != s)
   continue;
...
cmd_find_best_winlink_with_window(struct cmd_find_state *fs)
{
 ...
 if (fs->s->curw != 0 && fs->s->curw->window == fs->w)
  ...
  for ((wl_loop) = winlinks_RB_MINMAX(&fs->s->windows, -1); (wl_loop) != 0; (wl_loop) = winlinks_RB_NEXT(wl_loop)) {
...
cmd_find_get_window_with_session(struct cmd_find_state *fs, const char *window)
{
 ...
 fs->wl = 0;
 for ((wl) = winlinks_RB_MINMAX(&fs->s->windows, -1); (wl) != 0; (wl) = winlinks_RB_NEXT(wl)) {
    ...
    const char *target, enum cmd_find_type type, int flags)
{
 ...
 log_debug("%s: target %s (flags %#x): session=%s, window=%s, pane=%s",
     __func__, target, flags, session == 0 ? "none" : session,
     window == 0 ? "none" : window, pane == 0 ? "none" : pane);
...
cmd_find_current_client(struct cmdq_item *item, int quiet)
{
 ...
 c = 0;
 if ((wp = cmd_find_inside_pane(item->client)) != 0) {
  cmd_find_clear_state(&fs, 0x2);
  fs.w = wp->window;
  if (cmd_find_best_session_with_window(&fs) == 0)
   c = cmd_find_best_client(fs.s);
 } else {
  s = cmd_find_best_session(0, 0, 0x2);
  if (s != 0)
