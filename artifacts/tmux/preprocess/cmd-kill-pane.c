# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-kill-pane.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-kill-pane.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-kill-pane.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-kill-pane.c" 2
...
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-kill-pane.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 24 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/cmd-kill-pane.c" 2
...
cmd_kill_pane_exec(struct cmd *self, struct cmdq_item *item)
{
 ...
 if (args_has(self->args, 'a')) {
  ...
  for ((loopwp) = ((&wl->window->panes)->tqh_first); (loopwp) != 0 && ((tmpwp) = ((loopwp)->entry.tqe_next), 1); (loopwp) = (tmpwp)) {
   if (loopwp == wp)
    continue;
