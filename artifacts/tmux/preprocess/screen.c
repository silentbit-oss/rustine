# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/screen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/screen.c"
# 19 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/screen.c"
...
# 20 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/screen.c" 2
...
# 22 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/screen.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/string.h" 1
# 23 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/screen.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/unistd.h" 1
# 24 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/screen.c" 2
...
int style_equal(const struct grid_cell *,
       const struct grid_cell *);
# 26 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/screen.c" 2

struct screen_title_entry {
 char *text;

 struct { struct screen_title_entry *tqe_next; struct screen_title_entry **tqe_prev; } entry;
};
struct screen_titles { struct screen_title_entry *tqh_first; struct screen_title_entry **tqh_last; };
...
screen_free_titles(struct screen *s)
{
 ...
 while ((title_entry = ((s->titles)->tqh_first)) != 0) {
  do { if (((title_entry)->entry.tqe_next) != 0) (title_entry)->entry.tqe_next->entry.tqe_prev = (title_entry)->entry.tqe_prev; else (s->titles)->tqh_last = (title_entry)->entry.tqe_prev; *(title_entry)->entry.tqe_prev = (title_entry)->entry.tqe_next; ; ; } while (0);
...
screen_push_title(struct screen *s)
{
 ...
 if (s->titles == 0) {
  ...
  do { (s->titles)->tqh_first = 0; (s->titles)->tqh_last = &(s->titles)->tqh_first; } while (0);
 }
 title_entry = xmalloc(sizeof *title_entry);
 title_entry->text = xstrdup(s->title);
 do { if (((title_entry)->entry.tqe_next = (s->titles)->tqh_first) != 0) (s->titles)->tqh_first->entry.tqe_prev = &(title_entry)->entry.tqe_next; else (s->titles)->tqh_last = &(title_entry)->entry.tqe_next; (s->titles)->tqh_first = (title_entry); (title_entry)->entry.tqe_prev = &(s->titles)->tqh_first; } while (0);
}
...
screen_resize_x(struct screen *s, u_int sx)
{
 ...
 if (sx == 0)
  fatalx("zero size");
# 226 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/screen.c"
 if (s->cx >= sx)
  s->cx = sx - 1;
 gd->sx = sx;
}
...
screen_resize_y(struct screen *s, u_int sy)
{
 ...
 if (sy == 0)
  fatalx("zero size");
 oldy = ((s)->grid->sy);
# 253 "/home/enumclass/Documents/C2RustTranslation/bkp/tmux/screen.c"
 if (sy < oldy) {
  needed = oldy - sy;
