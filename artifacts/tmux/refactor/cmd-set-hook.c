...
const struct cmd_entry cmd_set_hook_entry = {.name = "set-hook", .alias = 0, .args = {"gt:u", 1, 2}, .usage = "[-gu] [-t target-session] hook-name [command]", .target = {'t', CMD_FIND_SESSION, 0x40}, .flags = 0x4, .exec = cmd_set_hook_exec};
const struct cmd_entry cmd_show_hooks_entry = {.name = "show-hooks", .alias = 0, .args = {"gt:", 0, 1}, .usage = "[-g] [-t target-session]", .target = {'t', CMD_FIND_SESSION, 0}, .flags = 0x4, .exec = cmd_set_hook_exec};
