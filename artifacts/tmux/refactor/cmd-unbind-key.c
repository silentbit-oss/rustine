...
const struct cmd_entry cmd_unbind_key_entry = {.name = "unbind-key", .alias = "unbind", .args = {"anT:", 0, 1}, .usage = "[-an] [-T key-table] key", .flags = 0x4, .exec = cmd_unbind_key_exec};
