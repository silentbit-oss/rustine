...
const struct cmd_entry cmd_break_pane_entry = {.name = "break-pane", .alias = "breakp", .args = {"dPF:n:s:t:", 0, 0}, .usage = "[-dP] [-F format] [-n window-name] [-s src-pane] [-t dst-window]", .source = {'s', CMD_FIND_PANE, 0}, .target = {'t', CMD_FIND_WINDOW, 0x4}, .flags = 0, .exec = cmd_break_pane_exec};
