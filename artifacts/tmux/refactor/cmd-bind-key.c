...
const struct cmd_entry cmd_bind_key_entry = {.name = "bind-key", .alias = "bind", .args = {"cnrT:", 2, -1}, .usage = "[-cnr] [-T key-table] key command [arguments]", .flags = 0x4, .exec = cmd_bind_key_exec};
