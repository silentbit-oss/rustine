...
const struct cmd_entry cmd_kill_session_entry = {.name = "kill-session", .alias = 0, .args = {"aCt:", 0, 0}, .usage = "[-aC] [-t target-session]", .target = {'t', CMD_FIND_SESSION, 0}, .flags = 0, .exec = cmd_kill_session_exec};
