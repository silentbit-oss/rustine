...
const struct cmd_entry cmd_paste_buffer_entry = {.name = "paste-buffer", .alias = "pasteb", .args = {"db:prs:t:", 0, 0}, .usage = "[-dpr] [-s separator] [-b buffer-name] [-t target-pane]", .target = {'t', CMD_FIND_PANE, 0}, .flags = 0x4, .exec = cmd_paste_buffer_exec};
