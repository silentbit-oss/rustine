...
static int screen_redraw_check_cell(struct client *, u_int, u_int, int, struct window_pane **);
static int screen_redraw_check_is(u_int, u_int, int, int, struct window *, struct window_pane *, struct window_pane *);
static int screen_redraw_make_pane_status(struct client *, struct window *, struct window_pane *);
...
static void screen_redraw_draw_number(struct client *, struct window_pane *, u_int, u_int);
