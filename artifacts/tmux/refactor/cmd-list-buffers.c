...
const struct cmd_entry cmd_list_buffers_entry = {.name = "list-buffers", .alias = "lsb", .args = {"F:", 0, 0}, .usage = "[-F format]", .flags = 0x4, .exec = cmd_list_buffers_exec};
