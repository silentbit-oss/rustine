...
const struct cmd_entry cmd_copy_mode_entry = {.name = "copy-mode", .alias = 0, .args = {"Met:u", 0, 0}, .usage = "[-Mu] [-t target-pane]", .target = {'t', CMD_FIND_PANE, 0}, .flags = 0x4, .exec = cmd_copy_mode_exec};
const struct cmd_entry cmd_clock_mode_entry = {.name = "clock-mode", .alias = 0, .args = {"t:", 0, 0}, .usage = "[-t target-pane]", .target = {'t', CMD_FIND_PANE, 0}, .flags = 0x4, .exec = cmd_copy_mode_exec};
