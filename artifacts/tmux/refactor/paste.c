...
static int paste_cmp_names(const struct paste_buffer *, const struct paste_buffer *);
...
static int paste_cmp_times(const struct paste_buffer *, const struct paste_buffer *);
