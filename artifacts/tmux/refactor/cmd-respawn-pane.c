...
const struct cmd_entry cmd_respawn_pane_entry = {.name = "respawn-pane", .alias = "respawnp", .args = {"c:kt:", 0, -1}, .usage = "[-c start-directory] [-k] [-t target-pane] [command]", .target = {'t', CMD_FIND_PANE, 0}, .flags = 0, .exec = cmd_respawn_pane_exec};
