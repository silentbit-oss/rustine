...
static enum cmd_retval cmd_select_window_exec(struct cmd *, struct cmdq_item *);
const struct cmd_entry cmd_select_window_entry = {.name = "select-window", .alias = "selectw", .args = {"lnpTt:", 0, 0}, .usage = "[-lnpT] [-t target-window]", .target = {'t', CMD_FIND_WINDOW, 0}, .flags = 0, .exec = cmd_select_window_exec};
const struct cmd_entry cmd_next_window_entry = {.name = "next-window", .alias = "next", .args = {"at:", 0, 0}, .usage = "[-a] [-t target-session]", .target = {'t', CMD_FIND_SESSION, 0}, .flags = 0, .exec = cmd_select_window_exec};
const struct cmd_entry cmd_previous_window_entry = {.name = "previous-window", .alias = "prev", .args = {"at:", 0, 0}, .usage = "[-a] [-t target-session]", .target = {'t', CMD_FIND_SESSION, 0}, .flags = 0, .exec = cmd_select_window_exec};
const struct cmd_entry cmd_last_window_entry = {.name = "last-window", .alias = "last", .args = {"t:", 0, 0}, .usage = "[-t target-session]", .target = {'t', CMD_FIND_SESSION, 0}, .flags = 0, .exec = cmd_select_window_exec};
