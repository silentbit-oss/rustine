...
const struct cmd_entry cmd_kill_pane_entry = {.name = "kill-pane", .alias = "killp", .args = {"at:", 0, 0}, .usage = "[-a] [-t target-pane]", .target = {'t', CMD_FIND_PANE, 0}, .flags = 0, .exec = cmd_kill_pane_exec};
