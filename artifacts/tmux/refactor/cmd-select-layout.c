...
static enum cmd_retval cmd_select_layout_exec(struct cmd *, struct cmdq_item *);
const struct cmd_entry cmd_select_layout_entry = {.name = "select-layout", .alias = "selectl", .args = {"Enopt:", 0, 1}, .usage = "[-Enop] [-t target-pane] [layout-name]", .target = {'t', CMD_FIND_PANE, 0}, .flags = 0x4, .exec = cmd_select_layout_exec};
const struct cmd_entry cmd_next_layout_entry = {.name = "next-layout", .alias = "nextl", .args = {"t:", 0, 0}, .usage = "[-t target-window]", .target = {'t', CMD_FIND_WINDOW, 0}, .flags = 0x4, .exec = cmd_select_layout_exec};
const struct cmd_entry cmd_previous_layout_entry = {.name = "previous-layout", .alias = "prevl", .args = {"t:", 0, 0}, .usage = "[-t target-window]", .target = {'t', CMD_FIND_WINDOW, 0}, .flags = 0x4, .exec = cmd_select_layout_exec};
