...
const struct cmd_entry cmd_load_buffer_entry = {.name = "load-buffer", .alias = "loadb", .args = {"b:", 1, 1}, .usage = "[-b buffer-name] path", .flags = 0x4, .exec = cmd_load_buffer_exec};
