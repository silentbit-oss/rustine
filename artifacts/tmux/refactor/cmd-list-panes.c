...
const struct cmd_entry cmd_list_panes_entry = {.name = "list-panes", .alias = "lsp", .args = {"asF:t:", 0, 0}, .usage = "[-as] [-F format] [-t target-window]", .target = {'t', CMD_FIND_WINDOW, 0}, .flags = 0x4, .exec = cmd_list_panes_exec};
