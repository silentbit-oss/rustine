...
const struct cmd_entry cmd_lock_server_entry = {.name = "lock-server", .alias = "lock", .args = {"", 0, 0}, .usage = "", .flags = 0x4, .exec = cmd_lock_server_exec};
const struct cmd_entry cmd_lock_session_entry = {.name = "lock-session", .alias = "locks", .args = {"t:", 0, 0}, .usage = "[-t target-session]", .target = {'t', CMD_FIND_SESSION, 0}, .flags = 0x4, .exec = cmd_lock_server_exec};
const struct cmd_entry cmd_lock_client_entry = {.name = "lock-client", .alias = "lockc", .args = {"t:", 0, 0}, .usage = "[-t target-client]", .flags = 0x4, .exec = cmd_lock_server_exec};
