...
const struct cmd_entry cmd_detach_client_entry = {.name = "detach-client", .alias = "detach", .args = {"aE:s:t:P", 0, 0}, .usage = "[-aP] [-E shell-command] [-s target-session] [-t target-client]", .source = {'s', CMD_FIND_SESSION, 0x40}, .flags = 0x2, .exec = cmd_detach_client_exec};
const struct cmd_entry cmd_suspend_client_entry = {.name = "suspend-client", .alias = "suspendc", .args = {"t:", 0, 0}, .usage = "[-t target-client]", .flags = 0, .exec = cmd_detach_client_exec};
