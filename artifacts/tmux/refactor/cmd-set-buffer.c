...
const struct cmd_entry cmd_set_buffer_entry = {.name = "set-buffer", .alias = "setb", .args = {"ab:n:", 0, 1}, .usage = "[-a] [-b buffer-name] [-n new-buffer-name] data", .flags = 0x4, .exec = cmd_set_buffer_exec};
const struct cmd_entry cmd_delete_buffer_entry = {.name = "delete-buffer", .alias = "deleteb", .args = {"b:", 0, 0}, .usage = "[-b buffer-name]", .flags = 0x4, .exec = cmd_set_buffer_exec};
