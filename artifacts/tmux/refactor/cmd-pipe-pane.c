...
const struct cmd_entry cmd_pipe_pane_entry = {.name = "pipe-pane", .alias = "pipep", .args = {"IOot:", 0, 1}, .usage = "[-IOo] [-t target-pane] [command]", .target = {'t', CMD_FIND_PANE, 0}, .flags = 0x4, .exec = cmd_pipe_pane_exec};
