...
static enum cmd_retval cmd_rename_window_exec(struct cmd *, struct cmdq_item *);
const struct cmd_entry cmd_rename_window_entry = {.name = "rename-window", .alias = "renamew", .args = {"t:", 1, 1}, .usage = "[-t target-window] new-name", .target = {'t', CMD_FIND_WINDOW, 0}, .flags = 0x4, .exec = cmd_rename_window_exec};
