...
static enum cmd_retval cmd_list_keys_commands(struct cmd *, struct cmdq_item *);
const struct cmd_entry cmd_list_keys_entry = {.name = "list-keys", .alias = "lsk", .args = {"T:", 0, 0}, .usage = "[-T key-table]", .flags = 0x1 | 0x4, .exec = cmd_list_keys_exec};
const struct cmd_entry cmd_list_commands_entry = {.name = "list-commands", .alias = "lscm", .args = {"F:", 0, 0}, .usage = "[-F format]", .flags = 0x1 | 0x4, .exec = cmd_list_keys_exec};
