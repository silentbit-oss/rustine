...
static enum cmd_retval cmd_show_options_one(struct cmd *, struct cmdq_item *, struct options *);
static enum cmd_retval cmd_show_options_all(struct cmd *, struct cmdq_item *, struct options *);
const struct cmd_entry cmd_show_options_entry = {.name = "show-options", .alias = "show", .args = {"gqst:vw", 0, 1}, .usage = "[-gqsvw] [-t target-session|target-window] [option]", .target = {'t', CMD_FIND_WINDOW, 0x40}, .flags = 0x4, .exec = cmd_show_options_exec};
const struct cmd_entry cmd_show_window_options_entry = {.name = "show-window-options", .alias = "showw", .args = {"gvt:", 0, 1}, .usage = "[-gv] [-t target-window] [option]", .target = {'t', CMD_FIND_WINDOW, 0x40}, .flags = 0x4, .exec = cmd_show_options_exec};
