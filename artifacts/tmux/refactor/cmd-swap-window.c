...
const struct cmd_entry cmd_swap_window_entry = {.name = "swap-window", .alias = "swapw", .args = {"ds:t:", 0, 0}, .usage = "[-d] [-s src-window] [-t dst-window]", .source = {'s', CMD_FIND_WINDOW, 0x8}, .target = {'t', CMD_FIND_WINDOW, 0}, .flags = 0, .exec = cmd_swap_window_exec};
