...
const struct cmd_entry cmd_swap_pane_entry = {.name = "swap-pane", .alias = "swapp", .args = {"dDs:t:U", 0, 0}, .usage = "[-dDU] [-s src-pane] [-t dst-pane]", .source = {'s', CMD_FIND_PANE, 0x8}, .target = {'t', CMD_FIND_PANE, 0}, .flags = 0, .exec = cmd_swap_pane_exec};
