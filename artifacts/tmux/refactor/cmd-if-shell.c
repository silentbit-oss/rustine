...
const struct cmd_entry cmd_if_shell_entry = {.name = "if-shell", .alias = "if", .args = {"bFt:", 2, 3}, .usage = "[-bF] [-t target-pane] shell-command command [command]", .target = {'t', CMD_FIND_PANE, 0x40}, .flags = 0, .exec = cmd_if_shell_exec};
