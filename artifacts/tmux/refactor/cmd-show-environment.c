#include <bitstring.h>
#include <cmd-show-environment.c>
#include <compat.h>
#include <event.h>
#include <imsg.h>
#include <inttypes.h>
...
static enum cmd_retval cmd_show_environment_exec(struct cmd *, struct cmdq_item *);
...
const struct cmd_entry cmd_show_environment_entry = {.name = "show-environment", .alias = "showenv", .args = {"gst:", 0, 1}, .usage = "[-gs] [-t target-session] [name]", .target = {'t', CMD_FIND_SESSION, 0x40}, .flags = 0x4, .exec = cmd_show_environment_exec};
