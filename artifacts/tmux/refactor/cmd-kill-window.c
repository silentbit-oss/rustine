...
const struct cmd_entry cmd_kill_window_entry = {.name = "kill-window", .alias = "killw", .args = {"at:", 0, 0}, .usage = "[-a] [-t target-window]", .target = {'t', CMD_FIND_WINDOW, 0}, .flags = 0, .exec = cmd_kill_window_exec};
const struct cmd_entry cmd_unlink_window_entry = {.name = "unlink-window", .alias = "unlinkw", .args = {"kt:", 0, 0}, .usage = "[-k] [-t target-window]", .target = {'t', CMD_FIND_WINDOW, 0}, .flags = 0, .exec = cmd_kill_window_exec};
