...
const struct cmd_entry cmd_new_window_entry = {.name = "new-window", .alias = "neww", .args = {"ac:dF:kn:Pt:", 0, -1}, .usage = "[-adkP] [-c start-directory] [-F format] [-n window-name] [-t target-window] [command]", .target = {'t', CMD_FIND_WINDOW, 0x4}, .flags = 0, .exec = cmd_new_window_exec};
