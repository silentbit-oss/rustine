...
const struct cmd_entry cmd_choose_tree_entry = {.name = "choose-tree", .alias = 0, .args = {"F:Gf:NO:st:wZ", 0, 1}, .usage = "[-GNsw] [-F format] [-f filter] [-O sort-order] [-t target-pane]", .target = {'t', CMD_FIND_PANE, 0}, .flags = 0, .exec = cmd_choose_tree_exec};
const struct cmd_entry cmd_choose_client_entry = {.name = "choose-client", .alias = 0, .args = {"F:f:NO:t:Z", 0, 1}, .usage = "[-N] [-F format] [-f filter] [-O sort-order] [-t target-pane]", .target = {'t', CMD_FIND_PANE, 0}, .flags = 0, .exec = cmd_choose_tree_exec};
const struct cmd_entry cmd_choose_buffer_entry = {.name = "choose-buffer", .alias = 0, .args = {"F:f:NO:t:Z", 0, 1}, .usage = "[-N] [-F format] [-f filter] [-O sort-order] [-t target-pane]", .target = {'t', CMD_FIND_PANE, 0}, .flags = 0, .exec = cmd_choose_tree_exec};
