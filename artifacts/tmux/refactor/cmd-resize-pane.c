...
const struct cmd_entry cmd_resize_pane_entry = {.name = "resize-pane", .alias = "resizep", .args = {"DLMRt:Ux:y:Z", 0, 1}, .usage = "[-DLMRUZ] [-x width] [-y height] [-t target-pane] [adjustment]", .target = {'t', CMD_FIND_PANE, 0}, .flags = 0x4, .exec = cmd_resize_pane_exec};
