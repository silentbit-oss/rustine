...
const struct cmd_entry cmd_command_prompt_entry = {.name = "command-prompt", .alias = 0, .args = {"1iI:Np:t:", 0, 1}, .usage = "[-1Ni] [-I inputs] [-p prompts] [-t target-client] [template]", .flags = 0, .exec = cmd_command_prompt_exec};
