...
const struct cmd_entry cmd_join_pane_entry = {.name = "join-pane", .alias = "joinp", .args = {"bdhvp:l:s:t:", 0, 0}, .usage = "[-bdhv] [-p percentage|-l size] [-s src-pane] [-t dst-pane]", .source = {'s', CMD_FIND_PANE, 0x8}, .target = {'t', CMD_FIND_PANE, 0}, .flags = 0, .exec = cmd_join_pane_exec};
const struct cmd_entry cmd_move_pane_entry = {.name = "move-pane", .alias = "movep", .args = {"bdhvp:l:s:t:", 0, 0}, .usage = "[-bdhv] [-p percentage|-l size] [-s src-pane] [-t dst-pane]", .source = {'s', CMD_FIND_PANE, 0}, .target = {'t', CMD_FIND_PANE, 0}, .flags = 0, .exec = cmd_join_pane_exec};
