...
const struct cmd_entry cmd_run_shell_entry = {.name = "run-shell", .alias = "run", .args = {"bt:", 1, 1}, .usage = "[-b] [-t target-pane] shell-command", .target = {'t', CMD_FIND_PANE, 0x40}, .flags = 0, .exec = cmd_run_shell_exec};
