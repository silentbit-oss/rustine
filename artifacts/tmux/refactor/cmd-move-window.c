...
const struct cmd_entry cmd_move_window_entry = {.name = "move-window", .alias = "movew", .args = {"adkrs:t:", 0, 0}, .usage = "[-dkr] [-s src-window] [-t dst-window]", .source = {'s', CMD_FIND_WINDOW, 0}, .flags = 0, .exec = cmd_move_window_exec};
const struct cmd_entry cmd_link_window_entry = {.name = "link-window", .alias = "linkw", .args = {"adks:t:", 0, 0}, .usage = "[-dk] [-s src-window] [-t dst-window]", .source = {'s', CMD_FIND_WINDOW, 0}, .flags = 0, .exec = cmd_move_window_exec};
