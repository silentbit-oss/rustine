...
const struct cmd_entry cmd_split_window_entry = {.name = "split-window", .alias = "splitw", .args = {"bc:dfF:l:hp:Pt:v", 0, -1}, .usage = "[-bdfhvP] [-c start-directory] [-F format] [-p percentage|-l size] [-t target-pane] [command]", .target = {'t', CMD_FIND_PANE, 0}, .flags = 0, .exec = cmd_split_window_exec};
