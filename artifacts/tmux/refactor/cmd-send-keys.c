...
const struct cmd_entry cmd_send_keys_entry = {.name = "send-keys", .alias = "send", .args = {"lXRMN:t:", 0, -1}, .usage = "[-lXRM] [-N repeat-count] [-t target-pane] key ...", .target = {'t', CMD_FIND_PANE, 0}, .flags = 0x4, .exec = cmd_send_keys_exec};
const struct cmd_entry cmd_send_prefix_entry = {.name = "send-prefix", .alias = 0, .args = {"2t:", 0, 0}, .usage = "[-2] [-t target-pane]", .target = {'t', CMD_FIND_PANE, 0}, .flags = 0x4, .exec = cmd_send_keys_exec};
