...
const struct cmd_entry cmd_capture_pane_entry = {.name = "capture-pane", .alias = "capturep", .args = {"ab:CeE:JpPqS:t:", 0, 0}, .usage = "[-aCeJpPq] [-b buffer-name] [-E end-line] [-S start-line][-t target-pane]", .target = {'t', CMD_FIND_PANE, 0}, .flags = 0x4, .exec = cmd_capture_pane_exec};
const struct cmd_entry cmd_clear_history_entry = {.name = "clear-history", .alias = "clearhist", .args = {"t:", 0, 0}, .usage = "[-t target-pane]", .target = {'t', CMD_FIND_PANE, 0}, .flags = 0x4, .exec = cmd_capture_pane_exec};
