...
pub static mut cmd_select_layout_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"select-layout\0" as *const u8 as *const libc::c_char,
            alias: b"selectl\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"Enopt:\0" as *const u8 as *const libc::c_char,
...
pub static mut cmd_next_layout_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"next-layout\0" as *const u8 as *const libc::c_char,
            alias: b"nextl\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
            ...
            usage: b"[-t target-window]\0" as *const u8 as *const libc::c_char,
            source: cmd_entry_flag {
                flag: 0,
                type_0: CMD_FIND_PANE,
                flags: 0,
...
pub static mut cmd_previous_layout_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"previous-layout\0" as *const u8 as *const libc::c_char,
            alias: b"prevl\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"t:\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
...
unsafe extern "C" fn cmd_select_layout_exec(
    ...
    next = ((*self_0).entry == &cmd_next_layout_entry as *const cmd_entry)
        as libc::c_int;
    if args_has(args, 'n' as i32 as u_char) != 0 {
        next = 1 as libc::c_int;
    }
    previous = ((*self_0).entry == &cmd_previous_layout_entry as *const cmd_entry)
        as libc::c_int;
            ...
            _ => {
                ...
                if !layoutname.is_null() {
                    if layout_parse(w, layoutname) == -(1 as libc::c_int) {
                        cmdq_error(
                            item,
                            b"can't set layout: %s\0" as *const u8
                                as *const libc::c_char,
                            layoutname,
                        );
