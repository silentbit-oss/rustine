...
pub static mut cmd_kill_window_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"kill-window\0" as *const u8 as *const libc::c_char,
            alias: b"killw\0" as *const u8 as *const libc::c_char,
            args: {
            ...
            usage: b"[-a] [-t target-window]\0" as *const u8 as *const libc::c_char,
...
pub static mut cmd_unlink_window_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"unlink-window\0" as *const u8 as *const libc::c_char,
            alias: b"unlinkw\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"kt:\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 0 as libc::c_int,
                };
                init
            },
            usage: b"[-k] [-t target-window]\0" as *const u8 as *const libc::c_char,
            source: cmd_entry_flag {
                flag: 0,
                type_0: CMD_FIND_PANE,
                flags: 0,
...
unsafe extern "C" fn cmd_kill_window_exec(
    ...
    let mut wl3: *mut winlink = 0 as *mut winlink;
    let mut w: *mut window = (*wl).window;
    let mut s: *mut session = (*item).target.s;
    if (*self_0).entry == &cmd_unlink_window_entry as *const cmd_entry {
        if args_has((*self_0).args, 'k' as i32 as u_char) == 0
            && session_is_linked(s, w) == 0
        {
            cmdq_error(
                item,
                b"window only linked to one session\0" as *const u8
        ...
        wl2 = winlinks_RB_MINMAX(&mut (*s).windows, -(1 as libc::c_int));
        while !wl2.is_null()
            && {
                wl3 = winlinks_RB_NEXT(wl2);
                1 as libc::c_int != 0
            }
        {
            if wl != wl2 {
