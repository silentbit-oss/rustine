...
pub static mut cmd_kill_pane_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"kill-pane\0" as *const u8 as *const libc::c_char,
            alias: b"killp\0" as *const u8 as *const libc::c_char,
            args: {
            ...
            usage: b"[-a] [-t target-pane]\0" as *const u8 as *const libc::c_char,
