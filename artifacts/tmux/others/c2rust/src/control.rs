...
extern "C" {
    ...
    fn evbuffer_add_buffer(outbuf: *mut evbuffer, inbuf: *mut evbuffer) -> libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn control_write_buffer(
    mut c: *mut client,
...
unsafe extern "C" fn control_error(
    ...
    cmdq_guard(item, b"begin\0" as *const u8 as *const libc::c_char, 1 as libc::c_int);
    control_write(c, b"parse error: %s\0" as *const u8 as *const libc::c_char, error);
    cmdq_guard(item, b"error\0" as *const u8 as *const libc::c_char, 1 as libc::c_int);
    free(error as *mut libc::c_void);
    return CMD_RETURN_NORMAL;
}
#[no_mangle]
pub unsafe extern "C" fn control_callback(
    mut c: *mut client,
    ...
    loop {
        line = evbuffer_readln((*c).stdin_data, 0 as *mut size_t, EVBUFFER_EOL_LF);
        if line.is_null() {
            break;
        }
        if *line as libc::c_int == '\0' as i32 {
            ...
            if cmdlist.is_null() {
                item = cmdq_get_callback1(
                    b"control_error\0" as *const u8 as *const libc::c_char,
                    Some(
                        control_error
