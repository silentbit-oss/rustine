...
extern "C" {
    ...
    fn input_pending(_: *mut window_pane) -> *mut evbuffer;
...
pub static mut cmd_capture_pane_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"capture-pane\0" as *const u8 as *const libc::c_char,
            alias: b"capturep\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"ab:CeE:JpPqS:t:\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 0 as libc::c_int,
                };
                init
            },
            usage: b"[-aCeJpPq] [-b buffer-name] [-E end-line] [-S start-line][-t target-pane]\0"
...
pub static mut cmd_clear_history_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"clear-history\0" as *const u8 as *const libc::c_char,
            alias: b"clearhist\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
            ...
            usage: b"[-t target-pane]\0" as *const u8 as *const libc::c_char,
            source: cmd_entry_flag {
                flag: 0,
                type_0: CMD_FIND_PANE,
                flags: 0,
...
unsafe extern "C" fn cmd_capture_pane_append(
    ...
    buf = xrealloc(
        ...
        (*len).wrapping_add(linelen).wrapping_add(1 as libc::c_int as size_t),
    ) as *mut libc::c_char;
    memcpy(
...
unsafe extern "C" fn cmd_capture_pane_pending(
    ...
    buf = xstrdup(b"\0" as *const u8 as *const libc::c_char);
        ...
        while (i as size_t) < linelen {
                ...
                && *line.offset(i as isize) as libc::c_int != '\\' as i32
            {
                ...
                xsnprintf(
                    ...
                    b"\\%03hho\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn cmd_capture_pane_history(
    ...
    if args_has(args, 'a' as i32 as u_char) != 0 {
        ...
        if gd.is_null() {
            if args_has(args, 'q' as i32 as u_char) == 0 {
                cmdq_error(
                    item,
                    b"no alternate screen\0" as *const u8 as *const libc::c_char,
                );
    ...
    if !Sflag.is_null()
        && strcmp(Sflag, b"-\0" as *const u8 as *const libc::c_char) == 0 as libc::c_int
    {
    ...
    if !Eflag.is_null()
        && strcmp(Eflag, b"-\0" as *const u8 as *const libc::c_char) == 0 as libc::c_int
    {
        bottom = ((*gd).hsize)
            .wrapping_add((*gd).sy)
            .wrapping_sub(1 as libc::c_int as u_int);
...
unsafe extern "C" fn cmd_capture_pane_exec(
    ...
    if (*self_0).entry == &cmd_clear_history_entry as *const cmd_entry {
    ...
    if args_has(args, 'p' as i32 as u_char) != 0 {
        c = (*item).client;
        if c.is_null()
            || !((*c).session).is_null() && (*c).flags & 0x2000 as libc::c_int == 0
        {
            cmdq_error(
                item,
        ...
        evbuffer_add((*c).stdout_data, buf as *const libc::c_void, len);
        free(buf as *mut libc::c_void);
        if args_has(args, 'P' as i32 as u_char) != 0 && len > 0 as libc::c_int as size_t
        {
            evbuffer_add(
                (*c).stdout_data,
