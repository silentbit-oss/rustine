...
pub static mut cmd_set_hook_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"set-hook\0" as *const u8 as *const libc::c_char,
            alias: 0 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"gt:u\0" as *const u8 as *const libc::c_char,
                    lower: 1 as libc::c_int,
                    upper: 2 as libc::c_int,
                };
                init
            },
            usage: b"[-gu] [-t target-session] hook-name [command]\0" as *const u8
...
pub static mut cmd_show_hooks_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"show-hooks\0" as *const u8 as *const libc::c_char,
            alias: 0 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"gt:\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 1 as libc::c_int,
                };
                init
            },
            usage: b"[-g] [-t target-session]\0" as *const u8 as *const libc::c_char,
            source: cmd_entry_flag {
                flag: 0,
                type_0: CMD_FIND_PANE,
                flags: 0,
...
unsafe extern "C" fn cmd_set_hook_exec(
    mut self_0: *mut cmd,
    ...
    if *name as libc::c_int == '\0' as i32 {
        cmdq_error(item, b"invalid hook name\0" as *const u8 as *const libc::c_char);
        return CMD_RETURN_ERROR;
    }
    ...
    if args_has(args, 'u' as i32 as u_char) != 0 {
        if !cmd.is_null() {
            cmdq_error(
                item,
                b"command passed to unset hook: %s\0" as *const u8
                    as *const libc::c_char,
                name,
            );
            return CMD_RETURN_ERROR;
    ...
    if cmd.is_null() {
        cmdq_error(
            item,
            b"no command to set hook: %s\0" as *const u8 as *const libc::c_char,
            name,
        );
        return CMD_RETURN_ERROR;
    }
