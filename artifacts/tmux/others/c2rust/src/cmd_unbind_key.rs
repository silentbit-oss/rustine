...
pub static mut cmd_unbind_key_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"unbind-key\0" as *const u8 as *const libc::c_char,
            alias: b"unbind\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"anT:\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 1 as libc::c_int,
                };
                init
            },
            usage: b"[-an] [-T key-table] key\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn cmd_unbind_key_exec(
    ...
    if args_has(args, 'a' as i32 as u_char) == 0 {
        if (*args).argc != 1 as libc::c_int {
            cmdq_error(item, b"missing key\0" as *const u8 as *const libc::c_char);
            return CMD_RETURN_ERROR;
        }
        key = key_string_lookup_string(
        ...
        if (*args).argc != 0 as libc::c_int {
            cmdq_error(item, b"key given with -a\0" as *const u8 as *const libc::c_char);
            return CMD_RETURN_ERROR;
        }
        key = 0xfffe00000000 as libc::c_ulonglong;
    }
    if key == 0xfffe00000000 as libc::c_ulonglong {
        ...
        if tablename.is_null() {
            key_bindings_remove_table(b"root\0" as *const u8 as *const libc::c_char);
            key_bindings_remove_table(b"prefix\0" as *const u8 as *const libc::c_char);
