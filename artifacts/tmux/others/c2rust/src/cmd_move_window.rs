...
pub static mut cmd_move_window_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"move-window\0" as *const u8 as *const libc::c_char,
            alias: b"movew\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"adkrs:t:\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 0 as libc::c_int,
                };
                init
            },
            usage: b"[-dkr] [-s src-window] [-t dst-window]\0" as *const u8
...
pub static mut cmd_link_window_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"link-window\0" as *const u8 as *const libc::c_char,
            alias: b"linkw\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"adks:t:\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 0 as libc::c_int,
                };
                init
            },
            usage: b"[-dk] [-s src-window] [-t dst-window]\0" as *const u8
                as *const libc::c_char,
            source: {
                let mut init = cmd_entry_flag {
                    flag: 's' as i32 as libc::c_char,
...
unsafe extern "C" fn cmd_move_window_exec(
    ...
    wl = (*item).source.wl;
    idx = (*item).target.idx;
    kflag = args_has((*self_0).args, 'k' as i32 as u_char);
    dflag = args_has((*self_0).args, 'd' as i32 as u_char);
    sflag = args_has((*self_0).args, 's' as i32 as u_char);
    ...
    ) != 0 as libc::c_int
    {
        cmdq_error(
            item,
            b"can't link window: %s\0" as *const u8 as *const libc::c_char,
            cause,
        );
        free(cause as *mut libc::c_void);
        return CMD_RETURN_ERROR;
    }
    if (*self_0).entry == &cmd_move_window_entry as *const cmd_entry {
