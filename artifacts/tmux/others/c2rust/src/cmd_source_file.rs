...
extern "C" {
    ...
    fn server_client_get_cwd(_: *mut client) -> *const libc::c_char;
    fn utf8_stravis(
        _: *mut *mut libc::c_char,
        _: *const libc::c_char,
        _: libc::c_int,
...
pub static mut cmd_source_file_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"source-file\0" as *const u8 as *const libc::c_char,
            alias: b"source\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"q\0" as *const u8 as *const libc::c_char,
                    lower: 1 as libc::c_int,
                    upper: 1 as libc::c_int,
                };
                init
            },
            usage: b"[-q] path\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn cmd_source_file_exec(
    ...
    let mut path: *const libc::c_char = *((*args).argv)
    ...
    if *path as libc::c_int == '/' as i32 {
        ...
        utf8_stravis(&mut tmp, server_client_get_cwd(c), 0x100 as libc::c_int);
        xasprintf(
    ...
    log_debug(
        ...
        (*::core::mem::transmute::<
            &[u8; 21],
            &[libc::c_char; 21],
        >(b"cmd_source_file_exec\0"))
            .as_ptr(),
        pattern,
    );
    retval = CMD_RETURN_NORMAL;
    if glob(pattern, 0 as libc::c_int, None, &mut g) != 0 as libc::c_int {
        if quiet == 0 || *__errno_location() != 2 as libc::c_int {
            cmdq_error(
                item,
                b"%s: %s\0" as *const u8 as *const libc::c_char,
                path,
    ...
    while i < g.gl_pathc as u_int {
        if load_cfg(*(g.gl_pathv).offset(i as isize), c, item, quiet) < 0 as libc::c_int
        {
            retval = CMD_RETURN_ERROR;
        }
        i = i.wrapping_add(1);
    ...
    if cfg_finished != 0 {
        new_item = cmdq_get_callback1(
            b"cmd_source_file_done\0" as *const u8 as *const libc::c_char,
            Some(
