...
pub static mut cmd_set_environment_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"set-environment\0" as *const u8 as *const libc::c_char,
            alias: b"setenv\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"grt:u\0" as *const u8 as *const libc::c_char,
                    lower: 1 as libc::c_int,
                    upper: 2 as libc::c_int,
                };
                init
            },
            usage: b"[-gru] [-t target-session] name [value]\0" as *const u8
...
unsafe extern "C" fn cmd_set_environment_exec(
    ...
    if *name as libc::c_int == '\0' as i32 {
        cmdq_error(item, b"empty variable name\0" as *const u8 as *const libc::c_char);
        return CMD_RETURN_ERROR;
    }
    if !(strchr(name, '=' as i32)).is_null() {
        cmdq_error(
            item,
            b"variable name contains =\0" as *const u8 as *const libc::c_char,
        );
        return CMD_RETURN_ERROR;
    }
    ...
    if args_has((*self_0).args, 'u' as i32 as u_char) != 0 {
        if !value.is_null() {
            cmdq_error(
                item,
                b"can't specify a value with -u\0" as *const u8 as *const libc::c_char,
            );
            return CMD_RETURN_ERROR;
        }
        ...
        if !value.is_null() {
            cmdq_error(
                item,
                b"can't specify a value with -r\0" as *const u8 as *const libc::c_char,
            );
            return CMD_RETURN_ERROR;
        }
        ...
        if value.is_null() {
            cmdq_error(
                item,
                b"no value specified\0" as *const u8 as *const libc::c_char,
            );
            return CMD_RETURN_ERROR;
        }
