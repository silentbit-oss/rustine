...
pub static mut cmd_bind_key_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"bind-key\0" as *const u8 as *const libc::c_char,
            alias: b"bind\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"cnrT:\0" as *const u8 as *const libc::c_char,
                    lower: 2 as libc::c_int,
                    upper: -(1 as libc::c_int),
                };
                init
            },
            usage: b"[-cnr] [-T key-table] key command [arguments]\0" as *const u8
...
unsafe extern "C" fn cmd_bind_key_exec(
        ...
        || key == 0xfffe00000000 as libc::c_ulonglong
    {
        cmdq_error(
            item,
            b"unknown key: %s\0" as *const u8 as *const libc::c_char,
    ...
    if args_has(args, 'T' as i32 as u_char) != 0 {
        ...
        tablename = b"root\0" as *const u8 as *const libc::c_char;
    } else {
        tablename = b"prefix\0" as *const u8 as *const libc::c_char;
    }
    ...
    key_bindings_add(tablename, key, args_has(args, 'r' as i32 as u_char), cmdlist);
