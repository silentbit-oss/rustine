...
pub static mut cmd_lock_server_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"lock-server\0" as *const u8 as *const libc::c_char,
            alias: b"lock\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 0 as libc::c_int,
                };
                init
            },
            usage: b"\0" as *const u8 as *const libc::c_char,
...
pub static mut cmd_lock_session_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"lock-session\0" as *const u8 as *const libc::c_char,
            alias: b"locks\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
...
pub static mut cmd_lock_client_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"lock-client\0" as *const u8 as *const libc::c_char,
            alias: b"lockc\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"t:\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
...
unsafe extern "C" fn cmd_lock_server_exec(
    ...
    if (*self_0).entry == &cmd_lock_server_entry as *const cmd_entry {
        server_lock();
    } else if (*self_0).entry == &cmd_lock_session_entry as *const cmd_entry {
