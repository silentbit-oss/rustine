...
pub static mut cmd_select_window_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"select-window\0" as *const u8 as *const libc::c_char,
            alias: b"selectw\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"lnpTt:\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 0 as libc::c_int,
                };
                init
            },
            usage: b"[-lnpT] [-t target-window]\0" as *const u8 as *const libc::c_char,
...
pub static mut cmd_next_window_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"next-window\0" as *const u8 as *const libc::c_char,
            alias: b"next\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"at:\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 0 as libc::c_int,
                };
                init
            },
            usage: b"[-a] [-t target-session]\0" as *const u8 as *const libc::c_char,
            source: cmd_entry_flag {
                flag: 0,
                type_0: CMD_FIND_PANE,
                flags: 0,
...
pub static mut cmd_previous_window_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"previous-window\0" as *const u8 as *const libc::c_char,
            alias: b"prev\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"at:\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
...
pub static mut cmd_last_window_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"last-window\0" as *const u8 as *const libc::c_char,
            alias: b"last\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
...
unsafe extern "C" fn cmd_select_window_exec(
    ...
    next = ((*self_0).entry == &cmd_next_window_entry as *const cmd_entry)
        as libc::c_int;
    if args_has((*self_0).args, 'n' as i32 as u_char) != 0 {
        next = 1 as libc::c_int;
    }
    previous = ((*self_0).entry == &cmd_previous_window_entry as *const cmd_entry)
        as libc::c_int;
    if args_has((*self_0).args, 'p' as i32 as u_char) != 0 {
        previous = 1 as libc::c_int;
    }
    last = ((*self_0).entry == &cmd_last_window_entry as *const cmd_entry)
        as libc::c_int;
    if args_has((*self_0).args, 'l' as i32 as u_char) != 0 {
        last = 1 as libc::c_int;
    }
    if next != 0 || previous != 0 || last != 0 {
        activity = args_has((*self_0).args, 'a' as i32 as u_char);
        if next != 0 {
            if session_next(s, activity) != 0 as libc::c_int {
                cmdq_error(
                    item,
                    b"no next window\0" as *const u8 as *const libc::c_char,
                );
            ...
            if session_previous(s, activity) != 0 as libc::c_int {
                cmdq_error(
                    item,
                    b"no previous window\0" as *const u8 as *const libc::c_char,
                );
                return CMD_RETURN_ERROR;
            }
        } else if session_last(s) != 0 as libc::c_int {
            cmdq_error(item, b"no last window\0" as *const u8 as *const libc::c_char);
            return CMD_RETURN_ERROR;
        }
        ...
        hooks_insert(
            ...
            item,
            current,
            b"after-select-window\0" as *const u8 as *const libc::c_char,
        );
    } else {
        if args_has((*self_0).args, 'T' as i32 as u_char) != 0 && wl == (*s).curw {
            if session_last(s) != 0 as libc::c_int {
                cmdq_error(
                    item,
                    b"no last window\0" as *const u8 as *const libc::c_char,
                );
                return CMD_RETURN_ERROR;
            }
            if (*current).s == s {
