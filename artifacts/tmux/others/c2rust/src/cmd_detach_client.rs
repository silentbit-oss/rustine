...
pub static mut cmd_detach_client_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"detach-client\0" as *const u8 as *const libc::c_char,
            alias: b"detach\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"aE:s:t:P\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 0 as libc::c_int,
                };
                init
            },
            usage: b"[-aP] [-E shell-command] [-s target-session] [-t target-client]\0"
...
pub static mut cmd_suspend_client_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"suspend-client\0" as *const u8 as *const libc::c_char,
            alias: b"suspendc\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
            ...
            usage: b"[-t target-client]\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn cmd_detach_client_exec(
    ...
    let mut cloop: *mut client = 0 as *mut client;
    ...
    if (*self_0).entry == &cmd_suspend_client_entry as *const cmd_entry {
    ...
    if args_has(args, 'a' as i32 as u_char) != 0 {
        cloop = clients.tqh_first;
        while !cloop.is_null() {
            if !((*cloop).session).is_null() && cloop != c {
                if !cmd.is_null() {
                    server_client_exec(cloop, cmd);
                } else {
                    server_client_detach(cloop, msgtype);
