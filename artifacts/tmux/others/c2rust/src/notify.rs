...
extern "C" {
    ...
    fn control_notify_input(_: *mut client, _: *mut window_pane, _: *mut evbuffer);
...
unsafe extern "C" fn notify_hook(mut item: *mut cmdq_item, mut ne: *mut notify_entry) {
    ...
    log_debug(b"notify hook %s\0" as *const u8 as *const libc::c_char, (*ne).name);
    ...
    if !s.is_null() {
        cmdq_format(
            new_item,
            b"hook_session\0" as *const u8 as *const libc::c_char,
            b"$%u\0" as *const u8 as *const libc::c_char,
            (*s).id,
        );
        cmdq_format(
            new_item,
            b"hook_session_name\0" as *const u8 as *const libc::c_char,
            b"%s\0" as *const u8 as *const libc::c_char,
            (*s).name,
        );
    }
    if !w.is_null() {
        cmdq_format(
            new_item,
            b"hook_window\0" as *const u8 as *const libc::c_char,
            b"@%u\0" as *const u8 as *const libc::c_char,
            (*w).id,
        );
        cmdq_format(
            new_item,
            b"hook_window_name\0" as *const u8 as *const libc::c_char,
            b"%s\0" as *const u8 as *const libc::c_char,
            (*w).name,
        );
    }
    if (*ne).pane != -(1 as libc::c_int) {
        cmdq_format(
            new_item,
            b"hook_pane\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn notify_callback(
    ...
    log_debug(
        ...
        (*::core::mem::transmute::<&[u8; 16], &[libc::c_char; 16]>(b"notify_callback\0"))
            .as_ptr(),
        (*ne).name,
    );
    if strcmp((*ne).name, b"pane-mode-changed\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        control_notify_pane_mode_changed((*ne).pane);
    }
    if strcmp((*ne).name, b"window-layout-changed\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        control_notify_window_layout_changed((*ne).window);
    }
    if strcmp((*ne).name, b"window-pane-changed\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        control_notify_window_pane_changed((*ne).window);
    }
    if strcmp((*ne).name, b"window-unlinked\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        control_notify_window_unlinked((*ne).session, (*ne).window);
    }
    if strcmp((*ne).name, b"window-linked\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        control_notify_window_linked((*ne).session, (*ne).window);
    }
    if strcmp((*ne).name, b"window-renamed\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
    ...
    if strcmp((*ne).name, b"session-renamed\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        control_notify_session_renamed((*ne).session);
    }
    if strcmp((*ne).name, b"session-created\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        control_notify_session_created((*ne).session);
    }
    if strcmp((*ne).name, b"session-closed\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
    ...
    if strcmp(
        (*ne).name,
        b"session-window-changed\0" as *const u8 as *const libc::c_char,
    ) == 0 as libc::c_int
    {
...
unsafe extern "C" fn notify_add(
    ...
    ne = xcalloc(
        ...
        ::core::mem::size_of::<notify_entry>() as libc::c_ulong,
    ) as *mut notify_entry;
    ...
    if !s.is_null() {
        session_add_ref(
            s,
            (*::core::mem::transmute::<&[u8; 11], &[libc::c_char; 11]>(b"notify_add\0"))
                .as_ptr(),
        );
    }
    if !w.is_null() {
    ...
    new_item = cmdq_get_callback1(
        b"notify_callback\0" as *const u8 as *const libc::c_char,
        Some(
            notify_callback
...
#[no_mangle]
pub unsafe extern "C" fn notify_input(
    mut wp: *mut window_pane,
...
#[no_mangle]
pub unsafe extern "C" fn notify_client(
    mut name: *const libc::c_char,
    mut c: *mut client,
) {
    let mut fs: cmd_find_state = cmd_find_state {
...
#[no_mangle]
pub unsafe extern "C" fn notify_session(
    mut name: *const libc::c_char,
    mut s: *mut session,
) {
    let mut fs: cmd_find_state = cmd_find_state {
...
#[no_mangle]
pub unsafe extern "C" fn notify_winlink(
    mut name: *const libc::c_char,
    mut wl: *mut winlink,
) {
    let mut fs: cmd_find_state = cmd_find_state {
...
#[no_mangle]
pub unsafe extern "C" fn notify_window(
    mut name: *const libc::c_char,
    mut w: *mut window,
) {
    let mut fs: cmd_find_state = cmd_find_state {
...
#[no_mangle]
pub unsafe extern "C" fn notify_pane(
    mut name: *const libc::c_char,
    mut wp: *mut window_pane,
) {
    let mut fs: cmd_find_state = cmd_find_state {
    ...
    notify_add(name, &mut fs, 0 as *mut client, 0 as *mut session, 0 as *mut window, wp);
}
