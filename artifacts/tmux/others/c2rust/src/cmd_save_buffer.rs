...
pub static mut cmd_save_buffer_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"save-buffer\0" as *const u8 as *const libc::c_char,
            alias: b"saveb\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"ab:\0" as *const u8 as *const libc::c_char,
                    lower: 1 as libc::c_int,
                    upper: 1 as libc::c_int,
                };
                init
            },
            usage: b"[-a] [-b buffer-name] path\0" as *const u8 as *const libc::c_char,
...
pub static mut cmd_show_buffer_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"show-buffer\0" as *const u8 as *const libc::c_char,
            alias: b"showb\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"b:\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 0 as libc::c_int,
                };
                init
            },
            usage: b"[-b buffer-name]\0" as *const u8 as *const libc::c_char,
            source: cmd_entry_flag {
                flag: 0,
                type_0: CMD_FIND_PANE,
                flags: 0,
...
unsafe extern "C" fn cmd_save_buffer_exec(
    ...
    if args_has(args, 'b' as i32 as u_char) == 0 {
        ...
        if pb.is_null() {
            cmdq_error(item, b"no buffers\0" as *const u8 as *const libc::c_char);
    ...
    if (*self_0).entry == &cmd_show_buffer_entry as *const cmd_entry {
        path = b"-\0" as *const u8 as *const libc::c_char;
    } else {
        path = *((*args).argv).offset(0 as libc::c_int as isize);
    }
    if strcmp(path, b"-\0" as *const u8 as *const libc::c_char) == 0 as libc::c_int {
        if c.is_null() {
            cmdq_error(
                item,
                b"can't write to stdout\0" as *const u8 as *const libc::c_char,
            );
            return CMD_RETURN_ERROR;
        }
        if ((*c).session).is_null() || (*c).flags & 0x2000 as libc::c_int != 0 {
            evbuffer_add((*c).stdout_data, bufdata as *const libc::c_void, bufsize);
            server_client_push_stdout(c);
            return CMD_RETURN_NORMAL;
        } else {
            if bufsize
                > (2147483647 as libc::c_int / 4 as libc::c_int - 1 as libc::c_int)
                    as size_t
            {
                cmdq_error(
                    item,
                    b"buffer too big\0" as *const u8 as *const libc::c_char,
                );
                return CMD_RETURN_ERROR;
            }
            ...
            while used != bufsize {
                start = bufdata.offset(used as isize);
                end = memchr(
                    start as *const libc::c_void,
                    '\n' as i32,
                    bufsize.wrapping_sub(used),
                ) as *const libc::c_char;
                if !end.is_null() {
                    size = end.offset_from(start) as libc::c_long as size_t;
                } else {
                    size = bufsize.wrapping_sub(used);
                }
                msglen = (size * 4 as libc::c_int as size_t)
                    .wrapping_add(1 as libc::c_int as size_t);
                msg = xrealloc(msg as *mut libc::c_void, msglen) as *mut libc::c_char;
                strvisx(msg, start, size, 0x1 as libc::c_int | 0x8 as libc::c_int);
                cmdq_print(item, b"%s\0" as *const u8 as *const libc::c_char, msg);
                used = used
                    .wrapping_add(
                        size
                            .wrapping_add(
                                (end != 0 as *mut libc::c_void as *const libc::c_char)
        ...
        flags = b"wb\0" as *const u8 as *const libc::c_char;
        if args_has((*self_0).args, 'a' as i32 as u_char) != 0 {
            flags = b"ab\0" as *const u8 as *const libc::c_char;
        }
