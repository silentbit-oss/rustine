...
pub static mut cmd_choose_tree_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"choose-tree\0" as *const u8 as *const libc::c_char,
            alias: 0 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"F:Gf:NO:st:wZ\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 1 as libc::c_int,
                };
                init
            },
            usage: b"[-GNsw] [-F format] [-f filter] [-O sort-order] [-t target-pane]\0"
...
pub static mut cmd_choose_client_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"choose-client\0" as *const u8 as *const libc::c_char,
            alias: 0 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"F:f:NO:t:Z\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 1 as libc::c_int,
                };
                init
            },
            usage: b"[-N] [-F format] [-f filter] [-O sort-order] [-t target-pane]\0"
                as *const u8 as *const libc::c_char,
            source: cmd_entry_flag {
                flag: 0,
                type_0: CMD_FIND_PANE,
...
pub static mut cmd_choose_buffer_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"choose-buffer\0" as *const u8 as *const libc::c_char,
            alias: 0 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"F:f:NO:t:Z\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn cmd_choose_tree_exec(
    ...
    if (*self_0).entry == &cmd_choose_buffer_entry as *const cmd_entry {
        if (paste_get_top(0 as *mut *const libc::c_char)).is_null() {
            return CMD_RETURN_NORMAL;
        }
        mode = &window_buffer_mode;
    } else if (*self_0).entry == &cmd_choose_client_entry as *const cmd_entry {
        if server_client_how_many() == 0 as libc::c_int as u_int {
            return CMD_RETURN_NORMAL;
        }
    ...
    window_pane_set_mode(wp, mode, &mut (*item).target, args);
    return CMD_RETURN_NORMAL;
}
