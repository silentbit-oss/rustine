...
pub static mut cmd_rotate_window_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"rotate-window\0" as *const u8 as *const libc::c_char,
            alias: b"rotatew\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"Dt:U\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 0 as libc::c_int,
                };
                init
            },
            usage: b"[-DU] [-t target-window]\0" as *const u8 as *const libc::c_char,
