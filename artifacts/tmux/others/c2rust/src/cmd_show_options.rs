...
pub static mut cmd_show_options_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"show-options\0" as *const u8 as *const libc::c_char,
            alias: b"show\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"gqst:vw\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 1 as libc::c_int,
                };
                init
            },
            usage: b"[-gqsvw] [-t target-session|target-window] [option]\0" as *const u8
...
pub static mut cmd_show_window_options_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"show-window-options\0" as *const u8 as *const libc::c_char,
            alias: b"showw\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"gvt:\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 1 as libc::c_int,
                };
                init
            },
            usage: b"[-gv] [-t target-window] [option]\0" as *const u8
                as *const libc::c_char,
            source: cmd_entry_flag {
                flag: 0,
                type_0: CMD_FIND_PANE,
...
unsafe extern "C" fn cmd_show_options_exec(
    ...
    window = ((*self_0).entry == &cmd_show_window_options_entry as *const cmd_entry)
        as libc::c_int;
    ...
    if (*args).argc == 0 as libc::c_int {
        ...
        return cmd_show_options_one(self_0, item, oo)
    };
}
unsafe extern "C" fn cmd_show_options_print(
    ...
    if idx != -(1 as libc::c_int) {
        ...
        if options_array_size(o, &mut size) != -(1 as libc::c_int) {
            ...
            while i < size {
                if !(options_array_get(o, i)).is_null() {
    ...
    value = options_tostring(o, idx, 0 as libc::c_int);
    if args_has((*self_0).args, 'v' as i32 as u_char) != 0 {
        cmdq_print(item, b"%s\0" as *const u8 as *const libc::c_char, value);
    } else if options_isstring(o) != 0 {
        utf8_stravis(
            &mut escaped,
            value,
        ...
        cmdq_print(item, b"%s %s\0" as *const u8 as *const libc::c_char, name, value);
    }
    free(tmp as *mut libc::c_void);
}
unsafe extern "C" fn cmd_show_options_one(
    mut self_0: *mut cmd,
    mut item: *mut cmdq_item,
    mut oo: *mut options,
) -> cmd_retval {
    ...
    o = options_match_get(oo, name, &mut idx, 1 as libc::c_int, &mut ambiguous);
    if o.is_null() {
        ...
        if *name as libc::c_int != '@' as i32
            && !(options_match_get(oo, name, &mut idx, 0 as libc::c_int, &mut ambiguous))
                .is_null()
        {
            free(name as *mut libc::c_void);
            return CMD_RETURN_NORMAL;
...
unsafe extern "C" fn cmd_show_options_all(
    ...
    while !o.is_null() {
        ...
        if !oe.is_null() && !((*oe).style).is_null() {
            o = options_next(o);
        } else {
            if options_array_size(o, &mut size) == -(1 as libc::c_int) {
                ...
                while idx < size {
                    if !(options_array_get(o, idx)).is_null() {
                        cmd_show_options_print(self_0, item, o, idx as libc::c_int);
                    }
