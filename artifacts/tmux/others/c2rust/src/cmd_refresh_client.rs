...
extern "C" {
    ...
    fn tty_set_size(_: *mut tty, _: u_int, _: u_int);
...
pub static mut cmd_refresh_client_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"refresh-client\0" as *const u8 as *const libc::c_char,
            alias: b"refresh\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"C:St:\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 0 as libc::c_int,
                };
                init
            },
            usage: b"[-S] [-C size] [-t target-client]\0" as *const u8
...
unsafe extern "C" fn cmd_refresh_client_exec(
    ...
    if args_has(args, 'C' as i32 as u_char) != 0 {
        ...
        if size.is_null() {
            cmdq_error(item, b"missing size\0" as *const u8 as *const libc::c_char);
            return CMD_RETURN_ERROR;
        }
        if sscanf(
            size,
        ...
        {
            cmdq_error(item, b"bad size argument\0" as *const u8 as *const libc::c_char);
            return CMD_RETURN_ERROR;
        }
        if w < 2 as libc::c_int as u_int || w > 5000 as libc::c_int as u_int
            || h < 2 as libc::c_int as u_int || h > 5000 as libc::c_int as u_int
        {
            cmdq_error(
                item,
                b"size too small or too big\0" as *const u8 as *const libc::c_char,
            );
            return CMD_RETURN_ERROR;
        }
        if (*c).flags & 0x2000 as libc::c_int == 0 {
            cmdq_error(
                item,
                b"not a control client\0" as *const u8 as *const libc::c_char,
            );
            return CMD_RETURN_ERROR;
        }
        tty_set_size(&mut (*c).tty, w, h);
        (*c).flags |= 0x400000 as libc::c_int;
        recalculate_sizes();
    } else if args_has(args, 'S' as i32 as u_char) != 0 {
        (*c).flags |= 0x80000 as libc::c_int;
