...
pub static mut cmd_kill_server_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"kill-server\0" as *const u8 as *const libc::c_char,
...
pub static mut cmd_start_server_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"start-server\0" as *const u8 as *const libc::c_char,
            alias: b"start\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
...
unsafe extern "C" fn cmd_kill_server_exec(
    ...
    if (*self_0).entry == &cmd_kill_server_entry as *const cmd_entry {
