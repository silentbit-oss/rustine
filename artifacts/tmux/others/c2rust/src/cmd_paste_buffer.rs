...
pub static mut cmd_paste_buffer_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"paste-buffer\0" as *const u8 as *const libc::c_char,
            alias: b"pasteb\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"db:prs:t:\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 0 as libc::c_int,
                };
                init
            },
            usage: b"[-dpr] [-s separator] [-b buffer-name] [-t target-pane]\0"
    ...
    if !pb.is_null() && !(*wp).flags & 0x40 as libc::c_int != 0 {
        ...
        if sepstr.is_null() {
            if args_has(args, 'r' as i32 as u_char) != 0 {
                ...
                sepstr = b"\r\0" as *const u8 as *const libc::c_char;
            }
        }
        ...
        if bracket != 0 && (*(*wp).screen).mode & 0x400 as libc::c_int != 0 {
            bufferevent_write(
                (*wp).event,
                b"\x1B[200~\0" as *const u8 as *const libc::c_char
        ...
        loop {
            line = memchr(
                ...
                '\n' as i32,
                bufend.offset_from(bufdata) as libc::c_long as libc::c_ulong,
            ...
            bufferevent_write(
                (*wp).event,
                bufdata as *const libc::c_void,
                line.offset_from(bufdata) as libc::c_long as size_t,
            );
        ...
        if bufdata != bufend {
            bufferevent_write(
                (*wp).event,
                bufdata as *const libc::c_void,
                bufend.offset_from(bufdata) as libc::c_long as size_t,
            );
        }
        if bracket != 0 && (*(*wp).screen).mode & 0x400 as libc::c_int != 0 {
            bufferevent_write(
                (*wp).event,
                b"\x1B[201~\0" as *const u8 as *const libc::c_char
                    as *const libc::c_void,
                6 as libc::c_int as size_t,
            );
        }
