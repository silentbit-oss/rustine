...
pub static mut cmd_rename_window_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"rename-window\0" as *const u8 as *const libc::c_char,
            alias: b"renamew\0" as *const u8 as *const libc::c_char,
            args: {
            ...
            usage: b"[-t target-window] new-name\0" as *const u8 as *const libc::c_char,
