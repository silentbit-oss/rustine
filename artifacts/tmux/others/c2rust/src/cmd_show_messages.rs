...
pub static mut cmd_show_messages_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"show-messages\0" as *const u8 as *const libc::c_char,
            alias: b"showmsgs\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"JTt:\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 0 as libc::c_int,
                };
                init
            },
            usage: b"[-JT] [-t target-client]\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn cmd_show_messages_terminals(
    ...
    while !term.is_null() {
        ...
        cmdq_print(
            item,
            b"Terminal %u: %s [references=%u, flags=0x%x]:\0" as *const u8
    ...
    return (n != 0 as libc::c_int as u_int) as libc::c_int;
}
unsafe extern "C" fn cmd_show_messages_jobs(
    mut item: *mut cmdq_item,
    mut blank: libc::c_int,
) -> libc::c_int {
    ...
    while !job.is_null() {
        ...
        cmdq_print(
            item,
            b"Job %u: %s [fd=%d, pid=%ld, status=%d]\0" as *const u8
                as *const libc::c_char,
            n,
            (*job).cmd,
            (*job).fd,
...
unsafe extern "C" fn cmd_show_messages_exec(
    ...
    let mut tim: *mut libc::c_char = 0 as *mut libc::c_char;
