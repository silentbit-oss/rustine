...
unsafe extern "C" fn EncodeData(
    ...
    if (*s).params.quality == 0 as libc::c_int || (*s).params.quality == 1 as libc::c_int
    {
        ...
        *storage
        ...
        table= {let crown_promoted_local_0 = (*s).params.quality;GetHashTable(s, crown_promoted_local_0, bytes as size_t, Some(&mut table_size))};
        if 0 as libc::c_int != 0 {
            return 0 as libc::c_int;
        }
        if (*s).params.quality == 0 as libc::c_int {
    ...
    *storage_0
    ...
    {let crown_promoted_local_1 = (*s).prev_byte_;WriteMetaBlockInternal(
        m,
        data,
        mask as size_t,
        (*s).last_flush_pos_,
    ...
    loop {
        ...
        if force_flush != 0 && block_size == 0 as libc::c_int as libc::c_ulong {
            ...
            *storage
            ...
            table= {let crown_promoted_local_0 = (*s).params.quality;GetHashTable(s, crown_promoted_local_0, block_size, Some(&mut table_size))};
            if 0 as libc::c_int != 0 {
                return 0 as libc::c_int;
            }
            if (*s).params.quality == 0 as libc::c_int {
...
unsafe extern "C" fn ProcessMetadata(
    ...
    loop {
            ...
            == BROTLI_STREAM_METADATA_HEAD as libc::c_int as libc::c_uint
        {
            ...
            (*s).available_out_= {let crown_promoted_local_0 = (*s).remaining_metadata_bytes_ as size_t;WriteMetadataHeader(
                s,
