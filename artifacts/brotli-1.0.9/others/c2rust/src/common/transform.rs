...
unsafe extern "C" fn Shift(
    ...
    let mut scalar: uint32_t = (parameter as libc::c_uint & 0x7fff as libc::c_uint)
        .wrapping_add(
        ...
        < 0xe0 as libc::c_int
    {
        ...
        *word
            ...
            | scalar >> 6 as libc::c_uint & 0x1f as libc::c_int as uint32_t) as uint8_t;
        *word
            .offset(
                1 as libc::c_int as isize,
            ) = ((*word.offset(1 as libc::c_int as isize) as libc::c_int
            & 0xc0 as libc::c_int) as uint32_t
            | scalar & 0x3f as libc::c_int as uint32_t) as uint8_t;
        return 2 as libc::c_int;
    } else if (*word.offset(0 as libc::c_int as isize) as libc::c_int)
        < 0xf0 as libc::c_int
    {
        ...
        *word
            ...
            | scalar >> 12 as libc::c_uint & 0xf as libc::c_int as uint32_t) as uint8_t;
        *word
            .offset(
                1 as libc::c_int as isize,
            ) = ((*word.offset(1 as libc::c_int as isize) as libc::c_int
            & 0xc0 as libc::c_int) as uint32_t
            | scalar >> 6 as libc::c_uint & 0x3f as libc::c_int as uint32_t) as uint8_t;
        *word
            .offset(
        ...
        < 0xf8 as libc::c_int
    {
        ...
        *word
            ...
            | scalar >> 18 as libc::c_uint & 0x7 as libc::c_int as uint32_t) as uint8_t;
        *word
            .offset(
                1 as libc::c_int as isize,
            ) = ((*word.offset(1 as libc::c_int as isize) as libc::c_int
            & 0xc0 as libc::c_int) as uint32_t
            | scalar >> 12 as libc::c_uint & 0x3f as libc::c_int as uint32_t) as uint8_t;
        *word
            .offset(
                2 as libc::c_int as isize,
            ) = ((*word.offset(2 as libc::c_int as isize) as libc::c_int
...
unsafe extern "C" fn run_static_initializers() {
    kBrotliTransforms = {
        let mut init = BrotliTransforms {
            ...
            num_transforms: (::core::mem::size_of::<[uint8_t; 363]>() as libc::c_ulong)
                .wrapping_div(
