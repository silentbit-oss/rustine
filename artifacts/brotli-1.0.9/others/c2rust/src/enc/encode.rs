...
unsafe extern "C" fn RingBufferInitBuffer(
    ...
    let mut new_data: *mut uint8_t = if ((2 as libc::c_int as uint32_t)
        .wrapping_add(buflen) as size_t)
        .wrapping_add(kSlackForEightByteHashingEverywhere) > 0 as libc::c_int as size_t
    {
        BrotliAllocate(
            m,
            ((2 as libc::c_int as uint32_t).wrapping_add(buflen) as size_t)
    ...
    if !((*rb).data_).is_null() {
        memcpy(
            ...
            ((2 as libc::c_int as uint32_t).wrapping_add((*rb).cur_size_) as size_t)
                .wrapping_add(kSlackForEightByteHashingEverywhere),
        );
        BrotliFree(m, (*rb).data_ as *mut libc::c_void);
        (*rb).data_ = 0 as *mut uint8_t;
    ...
    *((*rb).buffer_).offset(-(2 as libc::c_int) as isize) = *fresh0;
    ...
    while i < kSlackForEightByteHashingEverywhere {
        *((*rb).buffer_)
            .offset(
                ((*rb).cur_size_ as size_t).wrapping_add(i) as isize,
...
unsafe extern "C" fn RingBufferWriteTail(
    ...
    if (masked_pos < (*rb).tail_size_ as size_t) as libc::c_int as libc::c_long != 0 {
...
unsafe extern "C" fn RingBufferWrite(
    ...
    if (*rb).pos_ == 0 as libc::c_int as uint32_t && n < (*rb).tail_size_ as size_t {
    ...
    if (*rb).cur_size_ < (*rb).total_size_ {
        ...
        *((*rb).buffer_)
            .offset(
                ((*rb).size_).wrapping_sub(2 as libc::c_int as uint32_t) as isize,
            ) = 0 as libc::c_int as uint8_t;
        *((*rb).buffer_)
            .offset(
                ((*rb).size_).wrapping_sub(1 as libc::c_int as uint32_t) as isize,
            ) = 0 as libc::c_int as uint8_t;
        *((*rb).buffer_).offset((*rb).size_ as isize) = 241 as libc::c_int as uint8_t;
    }
    let masked_pos: size_t = ((*rb).pos_ & (*rb).mask_) as size_t;
    RingBufferWriteTail(bytes, n, rb);
    if (masked_pos.wrapping_add(n) <= (*rb).size_ as size_t) as libc::c_int
        as libc::c_long != 0
    {
        memcpy(
    ...
    let mut not_first_lap: libc::c_int = ((*rb).pos_
        & (1 as libc::c_uint) << 31 as libc::c_int != 0 as libc::c_int as libc::c_uint)
        as libc::c_int;
    ...
    *((*rb).buffer_)
        ...
        .offset(((*rb).size_).wrapping_sub(2 as libc::c_int as uint32_t) as isize);
    *((*rb).buffer_)
        .offset(
            -(1 as libc::c_int) as isize,
        ) = *((*rb).buffer_)
        .offset(((*rb).size_).wrapping_sub(1 as libc::c_int as uint32_t) as isize);
    (*rb)
        .pos_ = ((*rb).pos_ & rb_pos_mask)
        .wrapping_add((n & rb_pos_mask as size_t) as uint32_t);
    if not_first_lap != 0 {
...
unsafe extern "C" fn GetInsertLengthCode(mut insertlen: size_t) -> uint16_t {
    if insertlen < 6 as libc::c_int as size_t {
        ...
        let mut nbits: uint32_t = (Log2FloorNonZero(
            insertlen.wrapping_sub(2 as libc::c_int as size_t),
        ))
            .wrapping_sub(1 as libc::c_uint);
        return ((nbits << 1 as libc::c_int) as size_t)
            .wrapping_add(insertlen.wrapping_sub(2 as libc::c_int as size_t) >> nbits)
            .wrapping_add(2 as libc::c_int as size_t) as uint16_t;
    } else if insertlen < 2114 as libc::c_int as size_t {
        return (Log2FloorNonZero(insertlen.wrapping_sub(66 as libc::c_int as size_t)))
            .wrapping_add(10 as libc::c_int as uint32_t) as uint16_t
    } else if insertlen < 6210 as libc::c_int as size_t {
        return 21 as libc::c_uint as uint16_t
    } else if insertlen < 22594 as libc::c_int as size_t {
...
unsafe extern "C" fn GetCopyLengthCode(mut copylen: size_t) -> uint16_t {
    if copylen < 10 as libc::c_int as size_t {
        return copylen.wrapping_sub(2 as libc::c_int as size_t) as uint16_t
    } else if copylen < 134 as libc::c_int as size_t {
        let mut nbits: uint32_t = (Log2FloorNonZero(
            copylen.wrapping_sub(6 as libc::c_int as size_t),
        ))
            .wrapping_sub(1 as libc::c_uint);
        return ((nbits << 1 as libc::c_int) as size_t)
            .wrapping_add(copylen.wrapping_sub(6 as libc::c_int as size_t) >> nbits)
            .wrapping_add(4 as libc::c_int as size_t) as uint16_t;
    } else if copylen < 2118 as libc::c_int as size_t {
        return (Log2FloorNonZero(copylen.wrapping_sub(70 as libc::c_int as size_t)))
            .wrapping_add(12 as libc::c_int as uint32_t) as uint16_t
    } else {
        return 23 as libc::c_uint as uint16_t
    };
}
...
static mut kHashMul64: uint64_t = (0x1e35a7bd as libc::c_int as uint64_t)
    << 32 as libc::c_int | 0x1e35a7bd as libc::c_int as uint64_t;
static mut kHashMul64Long: uint64_t = (0x1fe35a7b as libc::c_uint as uint64_t)
    << 32 as libc::c_int | 0xd3579bd3 as libc::c_uint as uint64_t;
#[inline(always)]
...
unsafe extern "C" fn HasherSetup(
    ...
    let mut one_shot: libc::c_int = (position == 0 as libc::c_int as size_t
    ...
    if ((*hasher).common.extra).is_null() {
        ...
        (*hasher)
            .common
            .extra = (if alloc_size > 0 as libc::c_int as size_t {
            BrotliAllocate(
                m,
                alloc_size
                    .wrapping_mul(::core::mem::size_of::<uint8_t>() as libc::c_ulong),
    ...
    if (*hasher).common.is_prepared_ == 0 {
        ...
        if position == 0 as libc::c_int as size_t {
...
unsafe extern "C" fn HashBytesH2(mut data: *const uint8_t) -> uint32_t {
    let h: uint64_t = (BrotliUnalignedRead64(data as *const libc::c_void)
        << 64 as libc::c_int - 8 as libc::c_int * 5 as libc::c_int) * kHashMul64;
...
unsafe extern "C" fn PrepareH2(
    ...
    let mut partial_prepare_threshold: size_t = ((1 as libc::c_int) << 16 as libc::c_int
        ...
        while i < input_size {
            ...
            if (1 as libc::c_int) << 0 as libc::c_int == 1 as libc::c_int {
                *buckets.offset(key as isize) = 0 as libc::c_int as uint32_t;
                ...
                while j < ((1 as libc::c_int) << 0 as libc::c_int) as uint32_t {
                    *buckets
                        .offset(
                            (key.wrapping_add(j << 3 as libc::c_int)
                                & (((1 as libc::c_int) << 16 as libc::c_int)
                                    - 1 as libc::c_int) as uint32_t) as isize,
        ...
        *((*self_0).buckets_).offset(key as isize) = ix as uint32_t;
        ...
        let off: uint32_t = (ix
            & ((((1 as libc::c_int) << 0 as libc::c_int) - 1 as libc::c_int)
                << 3 as libc::c_int) as size_t) as uint32_t;
        *((*self_0).buckets_)
            .offset(
...
unsafe extern "C" fn StitchToPreviousBlockH2(
    ...
    if num_bytes >= (HashTypeLengthH2()).wrapping_sub(1 as libc::c_int as size_t)
        && position >= 3 as libc::c_int as size_t
    {
        StoreH2(
            self_0,
            ringbuffer,
            ringbuffer_mask,
            position.wrapping_sub(3 as libc::c_int as size_t),
        );
        StoreH2(
            self_0,
            ringbuffer,
            ringbuffer_mask,
            position.wrapping_sub(2 as libc::c_int as size_t),
        );
        StoreH2(
            self_0,
            ringbuffer,
            ringbuffer_mask,
            position.wrapping_sub(1 as libc::c_int as size_t),
        );
    }
}
#[inline(always)]
        ...
        while i < input_size {
            ...
            if (1 as libc::c_int) << 1 as libc::c_int == 1 as libc::c_int {
                *buckets.offset(key as isize) = 0 as libc::c_int as uint32_t;
                ...
                let mut j: uint32_t = 0;
                j = 0 as libc::c_int as uint32_t;
                while j < ((1 as libc::c_int) << 1 as libc::c_int) as uint32_t {
                    *buckets
                        .offset(
                            (key.wrapping_add(j << 3 as libc::c_int)
                                & (((1 as libc::c_int) << 16 as libc::c_int)
...
unsafe extern "C" fn StitchToPreviousBlockH3(
    ...
    if num_bytes >= (HashTypeLengthH3()).wrapping_sub(1 as libc::c_int as size_t)
        && position >= 3 as libc::c_int as size_t
    {
        StoreH3(
            self_0,
...
unsafe extern "C" fn PrepareH4(
    ...
    let mut buckets: *mut uint32_t = (*self_0).buckets_;
    let mut partial_prepare_threshold: size_t = ((1 as libc::c_int) << 17 as libc::c_int
        >> 5 as libc::c_int) as size_t;
    if one_shot != 0 && input_size <= partial_prepare_threshold {
        let mut i: size_t = 0;
        i = 0 as libc::c_int as size_t;
        while i < input_size {
            ...
            if (1 as libc::c_int) << 2 as libc::c_int == 1 as libc::c_int {
                *buckets.offset(key as isize) = 0 as libc::c_int as uint32_t;
                ...
                let mut j: uint32_t = 0;
                j = 0 as libc::c_int as uint32_t;
                while j < ((1 as libc::c_int) << 2 as libc::c_int) as uint32_t {
                    *buckets
                        .offset(
                            (key.wrapping_add(j << 3 as libc::c_int)
...
unsafe extern "C" fn StitchToPreviousBlockH4(
    ...
    if num_bytes >= (HashTypeLengthH4()).wrapping_sub(1 as libc::c_int as size_t)
        && position >= 3 as libc::c_int as size_t
    {
        StoreH4(
            self_0,
...
unsafe extern "C" fn HashBytesH54(mut data: *const uint8_t) -> uint32_t {
    let h: uint64_t = (BrotliUnalignedRead64(data as *const libc::c_void)
        << 64 as libc::c_int - 8 as libc::c_int * 7 as libc::c_int) * kHashMul64;
...
unsafe extern "C" fn PrepareH54(
    ...
    let mut buckets: *mut uint32_t = (*self_0).buckets_;
    let mut partial_prepare_threshold: size_t = ((1 as libc::c_int) << 20 as libc::c_int
        >> 5 as libc::c_int) as size_t;
    if one_shot != 0 && input_size <= partial_prepare_threshold {
        let mut i: size_t = 0;
        i = 0 as libc::c_int as size_t;
...
unsafe extern "C" fn StitchToPreviousBlockH54(
    ...
    if num_bytes >= (HashTypeLengthH54()).wrapping_sub(1 as libc::c_int as size_t)
        && position >= 3 as libc::c_int as size_t
    {
        StoreH54(
            self_0,
...
unsafe extern "C" fn InitializeH5(
    ...
    (*self_0)
        .block_mask_ = ((*self_0).block_size_).wrapping_sub(1 as libc::c_int as size_t)
        as uint32_t;
    (*self_0).num_ = (*common).extra as *mut uint16_t;
    (*self_0)
        .buckets_ = &mut *((*self_0).num_).offset((*self_0).bucket_size_ as isize)
...
unsafe extern "C" fn PrepareH5(
    ...
    let mut partial_prepare_threshold: size_t = (*self_0).bucket_size_
        >> 6 as libc::c_int;
    if one_shot != 0 && input_size <= partial_prepare_threshold {
        let mut i: size_t = 0;
        i = 0 as libc::c_int as size_t;
...
unsafe extern "C" fn HashMemAllocInBytesH5(
    ...
    let mut bucket_size: size_t = (1 as libc::c_int as size_t)
        << (*params).hasher.bucket_bits;
    let mut block_size: size_t = (1 as libc::c_int as size_t)
        << (*params).hasher.block_bits;
...
unsafe extern "C" fn StoreH5(
    ...
    let minor_ix: size_t = (*((*self_0).num_).offset(key as isize) as uint32_t
...
unsafe extern "C" fn StitchToPreviousBlockH5(
    ...
    if num_bytes >= (HashTypeLengthH5()).wrapping_sub(1 as libc::c_int as size_t)
        && position >= 3 as libc::c_int as size_t
    {
        StoreH5(
            self_0,
...
unsafe extern "C" fn HashBytesH6(
    ...
    let h: uint64_t = (BrotliUnalignedRead64(data as *const libc::c_void) & mask)
        * kHashMul64Long;
...
unsafe extern "C" fn StoreH6(
    ...
    let minor_ix: size_t = (*num.offset(key as isize) as uint32_t
        & (*self_0).block_mask_) as size_t;
    let offset: size_t = minor_ix.wrapping_add((key << (*self_0).block_bits_) as size_t);
...
unsafe extern "C" fn StitchToPreviousBlockH6(
    ...
    if num_bytes >= (HashTypeLengthH6()).wrapping_sub(1 as libc::c_int as size_t)
        && position >= 3 as libc::c_int as size_t
    {
        StoreH6(
            self_0,
...
unsafe extern "C" fn HashBytesH40(mut data: *const uint8_t) -> size_t {
    let h: uint32_t = BrotliUnalignedRead32(data as *const libc::c_void) * kHashMul32;
...
unsafe extern "C" fn PrepareH40(
    ...
    let mut partial_prepare_threshold: size_t = ((1 as libc::c_int) << 15 as libc::c_int
...
unsafe extern "C" fn StoreH40(
    ...
    let bank: size_t = key & (1 as libc::c_int - 1 as libc::c_int) as size_t;
    let fresh3 = (*self_0).free_slot_idx[bank as usize];
    (*self_0)
        .free_slot_idx[bank
        as usize] = ((*self_0).free_slot_idx[bank as usize]).wrapping_add(1);
    ...
    *tiny_hash.offset(ix as uint16_t as isize) = key as uint8_t;
    if delta > 0xffff as libc::c_int as size_t {
...
unsafe extern "C" fn StitchToPreviousBlockH40(
    ...
    if num_bytes >= (HashTypeLengthH40()).wrapping_sub(1 as libc::c_int as size_t)
        && position >= 3 as libc::c_int as size_t
    {
        StoreH40(
            self_0,
...
unsafe extern "C" fn StitchToPreviousBlockH41(
    ...
    if num_bytes >= (HashTypeLengthH41()).wrapping_sub(1 as libc::c_int as size_t)
        && position >= 3 as libc::c_int as size_t
    {
        StoreH41(
            self_0,
...
unsafe extern "C" fn StoreH42(
    ...
    let bank: size_t = key & (512 as libc::c_int - 1 as libc::c_int) as size_t;
...
unsafe extern "C" fn StitchToPreviousBlockH42(
    ...
    if num_bytes >= (HashTypeLengthH42()).wrapping_sub(1 as libc::c_int as size_t)
        && position >= 3 as libc::c_int as size_t
    {
        StoreH42(
            self_0,
...
unsafe extern "C" fn PrepareH35(
    ...
    if (*self_0).fresh != 0 {
        ...
        (*self_0)
            .hb_common
            .extra = ((*self_0).extra as *mut uint8_t)
            .offset(
...
unsafe extern "C" fn HashRollingFunctionInitialHROLLING_FAST(
    ...
    return (factor * state).wrapping_add(HashByteHROLLING_FAST(add));
}
unsafe extern "C" fn InitializeHROLLING_FAST(
    ...
    while i < 32 as libc::c_int as size_t {
        (*self_0).factor_remove = (*self_0).factor_remove * (*self_0).factor;
        i = i.wrapping_add(4 as libc::c_int as size_t);
    }
    (*self_0).table = (*common).extra as *mut uint32_t;
    i = 0 as libc::c_int as size_t;
    while i < 16777216 as libc::c_int as size_t {
...
unsafe extern "C" fn PrepareHROLLING_FAST(
    ...
    let mut i: size_t = 0;
    if input_size < 32 as libc::c_int as size_t {
        return;
    }
    (*self_0).state = 0 as libc::c_int as uint32_t;
    i = 0 as libc::c_int as size_t;
...
unsafe extern "C" fn StitchToPreviousBlockHROLLING_FAST(
    ...
    if position & (4 as libc::c_int - 1 as libc::c_int) as size_t
        != 0 as libc::c_int as size_t
    {
        let mut diff: size_t = (4 as libc::c_int as size_t)
            .wrapping_sub(position & (4 as libc::c_int - 1 as libc::c_int) as size_t);
        available = if diff > available {
            0 as libc::c_int as size_t
        } else {
            available.wrapping_sub(diff)
        };
        position = position.wrapping_add(diff);
    }
...
unsafe extern "C" fn HashRollingFunctionInitialHROLLING(
    ...
    return (factor * state).wrapping_add(HashByteHROLLING(add));
}
...
unsafe extern "C" fn StitchToPreviousBlockHROLLING(
    ...
    let mut position_masked: size_t = 0;
    let mut available: size_t = num_bytes;
    if position & (1 as libc::c_int - 1 as libc::c_int) as size_t
        != 0 as libc::c_int as size_t
    {
        let mut diff: size_t = (1 as libc::c_int as size_t)
            .wrapping_sub(position & (1 as libc::c_int - 1 as libc::c_int) as size_t);
        available = if diff > available {
            0 as libc::c_int as size_t
        } else {
            available.wrapping_sub(diff)
...
unsafe extern "C" fn InitializeH10(
    ...
    (*self_0)
        .invalid_pos_ = (0 as libc::c_int as size_t).wrapping_sub((*self_0).window_mask_)
        as uint32_t;
}
unsafe extern "C" fn PrepareH10(
    ...
    while i < ((1 as libc::c_int) << 17 as libc::c_int) as uint32_t {
...
unsafe extern "C" fn LeftChildIndexH10(mut self_0: *mut H10, pos: size_t) -> size_t {
    return 2 as libc::c_int as size_t * (pos & (*self_0).window_mask_);
}
#[inline(always)]
...
unsafe extern "C" fn StoreAndFindMatchesH10(
    ...
    let max_comp_len: size_t = brotli_min_size_t(
        max_length,
        128 as libc::c_int as size_t,
    );
    let should_reroot_tree: libc::c_int = if max_length >= 128 as libc::c_int as size_t {
        1 as libc::c_int
    } else {
        0 as libc::c_int
    };
    ...
    loop {
        ...
        if backward == 0 as libc::c_int as size_t || backward > max_backward
            || depth_remaining == 0 as libc::c_int as size_t
        {
            if should_reroot_tree != 0 {
            ...
            let cur_len: size_t = brotli_min_size_t(best_len_left, best_len_right);
...
unsafe extern "C" fn StitchToPreviousBlockH10(
    ...
    if num_bytes >= (HashTypeLengthH10()).wrapping_sub(1 as libc::c_int as size_t)
        && position >= 128 as libc::c_int as size_t
    {
        let i_start: size_t = position
            .wrapping_sub(128 as libc::c_int as size_t)
            .wrapping_add(1 as libc::c_int as size_t);
        let i_end: size_t = brotli_min_size_t(position, i_start.wrapping_add(num_bytes));
        let mut i: size_t = 0;
        i = i_start;
        while i < i_end {
...
unsafe extern "C" fn MaxMetablockSize(mut params: *const BrotliEncoderParams) -> size_t {
    let mut bits: libc::c_int = brotli_min_int(ComputeRbBits(params), 24 as libc::c_int);
...
unsafe extern "C" fn ChooseHasher(
    ...
    if (*params).quality > 9 as libc::c_int {
        ...
        && (*params).size_hint >= ((1 as libc::c_int) << 20 as libc::c_int) as size_t
    {
    ...
    } else if (*params).size_hint >= ((1 as libc::c_int) << 20 as libc::c_int) as size_t
...
unsafe extern "C" fn ShannonEntropy(
    ...
    if size & 1 as libc::c_int as size_t != 0 {
        current_block = 16096130736481370755;
    } else {
...
unsafe extern "C" fn WrapPosition(mut position: uint64_t) -> uint32_t {
    ...
    if gb > 2 as libc::c_int as uint64_t {
        result = result
            & ((1 as libc::c_uint) << 30 as libc::c_int)
                .wrapping_sub(1 as libc::c_int as libc::c_uint)
            | ((gb.wrapping_sub(1 as libc::c_int as uint64_t)
                & 1 as libc::c_int as uint64_t) as uint32_t)
                .wrapping_add(1 as libc::c_int as uint32_t) << 30 as libc::c_int;
    }
    return result;
}
unsafe extern "C" fn GetBrotliStorage(
    ...
    if (*s).storage_size_ < size {
        ...
        (*s)
            .storage_ = if size > 0 as libc::c_int as size_t {
            BrotliAllocate(
                m,
                size.wrapping_mul(::core::mem::size_of::<uint8_t>() as libc::c_ulong),
            ) as *mut uint8_t
        } else {
            0 as *mut uint8_t
        };
...
unsafe extern "C" fn GetHashTable(
    ...
    if quality == 0 as libc::c_int {
        if htsize & 0xaaaaa as libc::c_int as size_t == 0 as libc::c_int as size_t {
            htsize <<= 1 as libc::c_int;
        }
    }
    if htsize
            ...
            .wrapping_div(::core::mem::size_of::<libc::c_int>() as libc::c_ulong)
    {
        ...
        if htsize > (*s).large_table_size_ {
            ...
            (*s)
                .large_table_ = if htsize > 0 as libc::c_int as size_t {
                BrotliAllocate(
                    m,
                    htsize
                        .wrapping_mul(
    ...
    *table_size = htsize;
    memset(
        ...
        0 as libc::c_int,
        htsize.wrapping_mul(::core::mem::size_of::<libc::c_int>() as libc::c_ulong),
    );
    return table;
}
...
unsafe extern "C" fn ChooseContextMap(
    ...
    while i < 9 as libc::c_int as size_t {
        monogram_histo[(i % 3 as libc::c_int as size_t)
            as usize] = (monogram_histo[(i % 3 as libc::c_int as size_t) as usize])
            .wrapping_add(*bigram_histo.offset(i as isize));
        two_prefix_histo[(i % 6 as libc::c_int as size_t)
            as usize] = (two_prefix_histo[(i % 6 as libc::c_int as size_t) as usize])
            .wrapping_add(*bigram_histo.offset(i as isize));
        i = i.wrapping_add(1);
        i;
    }
    ...
    while i < 3 as libc::c_int as size_t {
        entropy[3 as libc::c_int as usize]
            += ShannonEntropy(
                bigram_histo.offset((3 as libc::c_int as size_t * i) as isize),
                3 as libc::c_int as size_t,
                &mut dummy,
            );
        i = i.wrapping_add(1);
...
unsafe extern "C" fn ShouldUseComplexStaticContextMap(
    ...
    if size_hint < ((1 as libc::c_int) << 20 as libc::c_int) as size_t {
        return 0 as libc::c_int
    } else {
        ...
        let mut utf8_lut: ContextLut = &*_kBrotliContextLookupTable
            ...
            as *const uint8_t;
        while start_pos.wrapping_add(64 as libc::c_int as size_t) <= end_pos {
            let stride_end_pos: size_t = start_pos
                .wrapping_add(64 as libc::c_int as size_t);
            let mut prev2: uint8_t = *input.offset((start_pos & mask) as isize);
            let mut prev1: uint8_t = *input
                .offset(
                    (start_pos.wrapping_add(1 as libc::c_int as size_t) & mask) as isize,
                );
            let mut pos: size_t = 0;
            pos = start_pos.wrapping_add(2 as libc::c_int as size_t);
            while pos < stride_end_pos {
                ...
                combined_histo[(literal as libc::c_int >> 3 as libc::c_int)
                    ...
                    .wrapping_add(1);
                combined_histo[(literal as libc::c_int >> 3 as libc::c_int) as usize];
            ...
            start_pos = start_pos.wrapping_add(4096 as libc::c_int as size_t);
        }
        entropy[1 as libc::c_int
            as usize] = ShannonEntropy(
        ...
        i = 0 as libc::c_int as size_t;
        while i < 13 as libc::c_int as size_t {
...
unsafe extern "C" fn DecideOverLiteralContextModeling(
    ...
    if quality < 5 as libc::c_int || length < 64 as libc::c_int as size_t {
        return
    ...
    ) != 0)
    {
        ...
        while start_pos.wrapping_add(64 as libc::c_int as size_t) <= end_pos {
            ...
            let stride_end_pos: size_t = start_pos
                .wrapping_add(64 as libc::c_int as size_t);
            let mut prev: libc::c_int = lut[(*input.offset((start_pos & mask) as isize)
                as libc::c_int >> 6 as libc::c_int) as usize] * 3 as libc::c_int;
            let mut pos: size_t = 0;
            pos = start_pos.wrapping_add(1 as libc::c_int as size_t);
            while pos < stride_end_pos {
                let literal: uint8_t = *input.offset((pos & mask) as isize);
...
unsafe extern "C" fn ShouldCompress(
    ...
    if bytes <= 2 as libc::c_int as size_t {
        return 0 as libc::c_int;
    }
    if num_commands
        < (bytes >> 8 as libc::c_int).wrapping_add(2 as libc::c_int as size_t)
    {
        if num_literals as libc::c_double > 0.99f64 * bytes as libc::c_double {
            ...
            let bit_cost_threshold: libc::c_double = bytes as libc::c_double
                * kMinEntropy / kSampleRate as libc::c_double;
            let mut t: size_t = bytes
                .wrapping_add(kSampleRate as size_t)
                .wrapping_sub(1 as libc::c_int as size_t) / kSampleRate as size_t;
            let mut pos: uint32_t = last_flush_pos as uint32_t;
            let mut i: size_t = 0;
            i = 0 as libc::c_int as size_t;
            while i < t {
                literal_histo[*data.offset((pos as size_t & mask) as isize)
                    as usize] = (literal_histo[*data
                    .offset((pos as size_t & mask) as isize) as usize])
                    .wrapping_add(1);
...
unsafe extern "C" fn WriteMetaBlockInternal(
    ...
    if bytes.wrapping_add(4 as libc::c_int as size_t) < *storage_ix >> 3 as libc::c_int {
        memcpy(
            dist_cache as *mut libc::c_void,
            saved_dist_cache as *const libc::c_void,
            (4 as libc::c_int as libc::c_ulong)
...
unsafe extern "C" fn ChooseDistanceParams(mut params: *mut BrotliEncoderParams) {
    ...
    if (*params).quality >= 4 as libc::c_int {
        ...
        if distance_postfix_bits > 3 as libc::c_int as uint32_t
            || num_direct_distance_codes > 120 as libc::c_int as uint32_t
...
unsafe extern "C" fn EnsureInitialized(mut s: *mut BrotliEncoderState) -> libc::c_int {
    ...
    if (*s).params.stream_offset != 0 as libc::c_int as size_t {
...
pub unsafe extern "C" fn BrotliEncoderCreateInstance(
    ...
    if alloc_func.is_none() && free_func.is_none() {
        state = malloc(::core::mem::size_of::<BrotliEncoderState>() as libc::c_ulong)
            as *mut BrotliEncoderState;
    } else if alloc_func.is_some() && free_func.is_some() {
        state = alloc_func
            .expect(
                "non-null function pointer",
            )(opaque, ::core::mem::size_of::<BrotliEncoderState>() as libc::c_ulong)
            as *mut BrotliEncoderState;
    }
    if state.is_null() {
...
unsafe extern "C" fn CopyInputToRingBuffer(
    ...
    (*s)
        .input_pos_ = ((*s).input_pos_ as libc::c_ulong).wrapping_add(input_size)
...
unsafe extern "C" fn UpdateLastProcessedPos(
    ...
    let mut wrapped_last_processed_pos: uint32_t = WrapPosition(
        (*s).last_processed_pos_,
    );
...
unsafe extern "C" fn ExtendLastCommand(
    ...
    let mut last_command: *mut Command = &mut *((*s).commands_)
        .offset(((*s).num_commands_).wrapping_sub(1 as libc::c_int as size_t) as isize)
        as *mut Command;
    ...
    let mut max_backward_distance: uint64_t = ((1 as libc::c_int as uint64_t)
        << (*s).params.lgwin)
        .wrapping_sub(16 as libc::c_int as uint64_t);
    let mut last_copy_len: uint64_t = ((*last_command).copy_len_
        & 0x1ffffff as libc::c_int as uint32_t) as uint64_t;
    let mut last_processed_pos: uint64_t = ((*s).last_processed_pos_)
        .wrapping_sub(last_copy_len);
    let mut max_distance: uint64_t = if last_processed_pos < max_backward_distance {
        last_processed_pos
    } else {
        max_backward_distance
    };
    let mut cmd_dist: uint64_t = (*s).dist_cache_[0 as libc::c_int as usize] as uint64_t;
    let mut distance_code: uint32_t = CommandRestoreDistanceCode(
        last_command,
        &mut (*s).params.dist,
    );
    if distance_code < 16 as libc::c_int as uint32_t
        || distance_code.wrapping_sub((16 as libc::c_int - 1 as libc::c_int) as uint32_t)
            as uint64_t == cmd_dist
    {
        if cmd_dist <= max_distance {
            while *bytes != 0 as libc::c_int as uint32_t
                && *data.offset((*wrapped_last_processed_pos & mask) as isize)
                    as libc::c_int
                    == *data
                        .offset(
                            ((*wrapped_last_processed_pos as uint64_t)
                                .wrapping_sub(cmd_dist) & mask as uint64_t) as isize,
                        ) as libc::c_int
            {
        ...
        GetLengthCode(
            ...
            (((*last_command).copy_len_ & 0x1ffffff as libc::c_int as uint32_t)
                as libc::c_int
...
unsafe extern "C" fn EncodeData(
    ...
    if (*s).params.quality == 1 as libc::c_int && ((*s).command_buf_).is_null() {
        (*s)
            .command_buf_ = if kCompressFragmentTwoPassBlockSize
            > 0 as libc::c_int as size_t
        {
            BrotliAllocate(
                m,
        ...
        (*s)
            .literal_buf_ = if kCompressFragmentTwoPassBlockSize
            > 0 as libc::c_int as size_t
        {
            BrotliAllocate(
                m,
    ...
    if (*s).params.quality == 0 as libc::c_int || (*s).params.quality == 1 as libc::c_int
    {
        ...
        let mut table: *mut libc::c_int = 0 as *mut libc::c_int;
        if delta == 0 as libc::c_int as uint64_t && is_last == 0 {
            *out_size = 0 as libc::c_int as size_t;
            return 1 as libc::c_int;
        }
        storage = GetBrotliStorage(
            s,
            (2 as libc::c_int as uint32_t * bytes)
                .wrapping_add(503 as libc::c_int as uint32_t) as size_t,
        );
        if 0 as libc::c_int != 0 {
            return 0 as libc::c_int;
        }
        ...
        *storage
        ...
        (*s)
            ...
            as uint16_t;
        (*s).last_bytes_bits_ = (storage_ix & 7 as libc::c_uint as size_t) as uint8_t;
    ...
    let mut newsize: size_t = ((*s).num_commands_)
        .wrapping_add((bytes / 2 as libc::c_int as uint32_t) as size_t)
        .wrapping_add(1 as libc::c_int as size_t);
    if newsize > (*s).cmd_alloc_size_ {
        let mut new_commands: *mut Command = 0 as *mut Command;
        newsize = newsize
            .wrapping_add(
                (bytes / 4 as libc::c_int as uint32_t)
                    .wrapping_add(16 as libc::c_int as uint32_t) as size_t,
            );
        (*s).cmd_alloc_size_ = newsize;
        new_commands = if newsize > 0 as libc::c_int as size_t {
            BrotliAllocate(
                m,
                newsize.wrapping_mul(::core::mem::size_of::<Command>() as libc::c_ulong),
            ) as *mut Command
        } else {
            0 as *mut Command
        };
    ...
    if (*s).num_commands_ != 0 && (*s).last_insert_len_ == 0 as libc::c_int as size_t {
    ...
    let max_literals: size_t = max_length / 8 as libc::c_int as size_t;
    let max_commands: size_t = max_length / 8 as libc::c_int as size_t;
    let processed_bytes: size_t = ((*s).input_pos_).wrapping_sub((*s).last_flush_pos_);
    let next_input_fits_metablock: libc::c_int = if processed_bytes
        .wrapping_add(InputBlockSize(s)) <= max_length
    {
        1 as libc::c_int
    } else {
        0 as libc::c_int
    ...
    let should_flush: libc::c_int = if (*s).params.quality < 4 as libc::c_int
        && ((*s).num_literals_).wrapping_add((*s).num_commands_)
            >= 0x2fff as libc::c_int as size_t
    {
        1 as libc::c_int
    } else {
        0 as libc::c_int
    ...
    if (*s).last_insert_len_ > 0 as libc::c_int as size_t {
    ...
    let metablock_size: uint32_t = ((*s).input_pos_).wrapping_sub((*s).last_flush_pos_)
        as uint32_t;
    let mut storage_0: *mut uint8_t = GetBrotliStorage(
        s,
        (2 as libc::c_int as uint32_t * metablock_size)
            .wrapping_add(503 as libc::c_int as uint32_t) as size_t,
    );
    ...
    *storage_0
    ...
    (*s)
        ...
        as uint16_t;
    (*s).last_bytes_bits_ = (storage_ix_0 & 7 as libc::c_uint as size_t) as uint8_t;
    (*s).last_flush_pos_ = (*s).input_pos_;
    if UpdateLastProcessedPos(s) != 0 {
        HasherReset(&mut (*s).hasher_);
    }
    if (*s).last_flush_pos_ > 0 as libc::c_int as uint64_t {
        (*s)
            .prev_byte_ = *data
            .offset(
                (((*s).last_flush_pos_ as uint32_t)
                    .wrapping_sub(1 as libc::c_int as uint32_t) & mask) as isize,
            );
    }
    if (*s).last_flush_pos_ > 1 as libc::c_int as uint64_t {
        (*s)
            .prev_byte2_ = *data
            .offset(
                (((*s).last_flush_pos_).wrapping_sub(2 as libc::c_int as uint64_t)
...
unsafe extern "C" fn WriteMetadataHeader(
    ...
    *header
    ...
    if block_size == 0 as libc::c_int as size_t {
        ...
        let mut nbits: uint32_t = if block_size == 1 as libc::c_int as size_t {
            0 as libc::c_int as uint32_t
        } else {
            (Log2FloorNonZero(
                (block_size as uint32_t).wrapping_sub(1 as libc::c_int as uint32_t)
                    as size_t,
            ))
                .wrapping_add(1 as libc::c_int as uint32_t)
        };
        let mut nbytes: uint32_t = nbits.wrapping_add(7 as libc::c_int as uint32_t)
            / 8 as libc::c_int as uint32_t;
        BrotliWriteBits(
            2 as libc::c_int as size_t,
            nbytes as uint64_t,
        ...
        BrotliWriteBits(
            (8 as libc::c_int as uint32_t * nbytes) as size_t,
            block_size.wrapping_sub(1 as libc::c_int as size_t),
            &mut storage_ix,
            header,
        );
    }
    return storage_ix.wrapping_add(7 as libc::c_uint as size_t) >> 3 as libc::c_int;
}
unsafe extern "C" fn BrotliCompressBufferQuality10(
    ...
    let lgmetablock: libc::c_int = brotli_min_int(
        24 as libc::c_int,
        lgwin + 1 as libc::c_int,
    );
    let mut max_block_size: size_t = 0;
    let max_metablock_size: size_t = (1 as libc::c_int as size_t) << lgmetablock;
    let max_literals_per_metablock: size_t = max_metablock_size
        / 8 as libc::c_int as size_t;
    let max_commands_per_metablock: size_t = max_metablock_size
        / 8 as libc::c_int as size_t;
    ...
    if 0 as libc::c_int != 0 {
        current_block = 17852373592898860362;
    } else {
        current_block = 2370887241019905314;
    }
    '_oom: loop {
        match current_block {
            17852373592898860362 => {
                BrotliWipeOutMemoryManager(m);
                return 0 as libc::c_int;
            }
            _ => {
                if ok != 0 && metablock_start < input_size {
                    ...
                    let expected_num_commands: size_t = (metablock_end
                        .wrapping_sub(metablock_start) / 12 as libc::c_int as size_t)
                        .wrapping_add(16 as libc::c_int as size_t);
                    let mut commands: *mut Command = 0 as *mut Command;
                    let mut num_commands: size_t = 0 as libc::c_int as size_t;
                    let mut last_insert_len: size_t = 0 as libc::c_int as size_t;
                    ...
                    let mut storage: *mut uint8_t = 0 as *mut uint8_t;
                    let mut storage_ix: size_t = 0;
                    let mut literal_context_mode: ContextType = ChooseContextMode(
                        &mut params,
                        input_buffer,
                        metablock_start,
                        mask,
                    ...
                    while block_start < metablock_end {
                        ...
                        BrotliInitZopfliNodes(
                            nodes,
                            block_size.wrapping_add(1 as libc::c_int as size_t),
                        );
                        StitchToPreviousBlockH10(
                            &mut hasher.privat._H10,
                            block_size,
                        ...
                        if cmd_alloc_size != new_cmd_alloc_size {
                            let mut new_commands: *mut Command = if new_cmd_alloc_size
                                > 0 as libc::c_int as size_t
                            {
                                BrotliAllocate(
                                    m,
                    ...
                    if last_insert_len > 0 as libc::c_int as size_t {
                    ...
                    storage_ix = last_bytes_bits as size_t;
                    if metablock_size == 0 as libc::c_int as size_t {
                    ...
                    ) == 0
                    {
                        ...
                        *storage
                        ...
                        storage = if (2 as libc::c_int as size_t * metablock_size)
                            .wrapping_add(503 as libc::c_int as size_t)
                            > 0 as libc::c_int as size_t
                        {
                            BrotliAllocate(
                                m,
                                (2 as libc::c_int as size_t * metablock_size)
                                    .wrapping_add(503 as libc::c_int as size_t)
                                    .wrapping_mul(
                                        ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                                    ),
                        ...
                        *storage
                        ...
                        if metablock_size.wrapping_add(4 as libc::c_int as size_t)
                    ...
                    last_bytes_bits = (storage_ix & 7 as libc::c_uint as size_t)
                        as uint8_t;
                    metablock_start = metablock_start.wrapping_add(metablock_size);
                    if metablock_start < input_size {
                        prev_byte = *input_buffer
                            .offset(
                                metablock_start.wrapping_sub(1 as libc::c_int as size_t)
                                    as isize,
                            );
                        prev_byte2 = *input_buffer
                            .offset(
                                metablock_start.wrapping_sub(2 as libc::c_int as size_t)
                                    as isize,
                            );
                    }
                    memcpy(
...
pub unsafe extern "C" fn BrotliEncoderMaxCompressedSize(
    ...
    let mut overhead: size_t = (2 as libc::c_int as size_t)
        .wrapping_add(4 as libc::c_int as size_t * num_large_blocks)
    ...
    return if result < input_size { 0 as libc::c_int as size_t } else { result };
}
unsafe extern "C" fn MakeUncompressedStream(
    ...
    *output.offset(fresh12 as isize) = 0x3 as libc::c_int as uint8_t;
    while size > 0 as libc::c_int as size_t {
        ...
        chunk_size = if size > ((1 as libc::c_uint) << 24 as libc::c_int) as size_t {
        ...
        bits = nibbles << 1 as libc::c_int
            | chunk_size.wrapping_sub(1 as libc::c_int as uint32_t) << 3 as libc::c_int
            | (1 as libc::c_uint)
                << (19 as libc::c_int as uint32_t)
                    .wrapping_add(4 as libc::c_int as uint32_t * nibbles);
        let fresh13 = result;
        result = result.wrapping_add(1);
        *output.offset(fresh13 as isize) = bits as uint8_t;
        let fresh14 = result;
        result = result.wrapping_add(1);
        *output.offset(fresh14 as isize) = (bits >> 8 as libc::c_int) as uint8_t;
        let fresh15 = result;
        result = result.wrapping_add(1);
        *output.offset(fresh15 as isize) = (bits >> 16 as libc::c_int) as uint8_t;
        if nibbles == 2 as libc::c_int as uint32_t {
            let fresh16 = result;
            result = result.wrapping_add(1);
            *output.offset(fresh16 as isize) = (bits >> 24 as libc::c_int) as uint8_t;
        }
        memcpy(
        ...
        result = result.wrapping_add(chunk_size as size_t);
        offset = offset.wrapping_add(chunk_size as size_t);
        size = size.wrapping_sub(chunk_size as size_t);
    }
    let fresh17 = result;
    result = result.wrapping_add(1);
...
pub unsafe extern "C" fn BrotliEncoderCompress(
    ...
    if out_size == 0 as libc::c_int as size_t {
        return 0 as libc::c_int;
    }
    if input_size == 0 as libc::c_int as size_t {
...
unsafe extern "C" fn InjectBytePaddingBlock(mut s: *mut BrotliEncoderState) {
    ...
    seal_bits = seal_bits.wrapping_add(6 as libc::c_int as size_t);
    ...
    *destination.offset(0 as libc::c_int as isize) = seal as uint8_t;
    if seal_bits > 8 as libc::c_int as size_t {
        *destination
            .offset(1 as libc::c_int as isize) = (seal >> 8 as libc::c_int) as uint8_t;
    }
    if seal_bits > 16 as libc::c_int as size_t {
        *destination
            .offset(2 as libc::c_int as isize) = (seal >> 16 as libc::c_int) as uint8_t;
    }
    (*s)
        .available_out_ = ((*s).available_out_)
        .wrapping_add(
            seal_bits.wrapping_add(7 as libc::c_int as size_t) >> 3 as libc::c_int,
        );
}
unsafe extern "C" fn InjectFlushOrPushOutput(
    ...
    if (*s).available_out_ != 0 as libc::c_int as size_t
        && *available_out != 0 as libc::c_int as size_t
    {
        let mut copy_output_size: size_t = brotli_min_size_t(
            (*s).available_out_,
            *available_out,
        );
        memcpy(
...
unsafe extern "C" fn BrotliEncoderCompressStreamFast(
    ...
    let block_size_limit: size_t = (1 as libc::c_int as size_t) << (*s).params.lgwin;
    ...
    if (*s).params.quality == 1 as libc::c_int {
        ...
        if !((*s).command_buf_).is_null() {
            ...
            tmp_command_buf = if buf_size > 0 as libc::c_int as size_t {
                BrotliAllocate(
                    m,
                    buf_size
                        .wrapping_mul(
            ...
            tmp_literal_buf = if buf_size > 0 as libc::c_int as size_t {
                BrotliAllocate(
                    m,
                    buf_size
                        .wrapping_mul(::core::mem::size_of::<uint8_t>() as libc::c_ulong),
    ...
    loop {
        ...
        if !((*s).available_out_ == 0 as libc::c_int as size_t
            ...
            && (*available_in != 0 as libc::c_int as size_t
                || op as libc::c_uint
        ...
        let mut max_out_size: size_t = (2 as libc::c_int as size_t * block_size)
            .wrapping_add(503 as libc::c_int as size_t);
        ...
        let mut table_size: size_t = 0;
        let mut table: *mut libc::c_int = 0 as *mut libc::c_int;
        if force_flush != 0 && block_size == 0 as libc::c_int as size_t {
            ...
            *storage
            ...
            (*s)
                ...
                as uint16_t;
            (*s)
                .last_bytes_bits_ = (storage_ix & 7 as libc::c_uint as size_t)
                as uint8_t;
            if force_flush != 0 {
                (*s).stream_state_ = BROTLI_STREAM_FLUSH_REQUESTED;
            }
...
unsafe extern "C" fn ProcessMetadata(
    ...
    if *available_in > ((1 as libc::c_uint) << 24 as libc::c_int) as size_t {
        return 0 as libc::c_int;
    }
    if (*s).stream_state_ as libc::c_uint
        == BROTLI_STREAM_PROCESSING as libc::c_int as libc::c_uint
    ...
    loop {
            ...
            == BROTLI_STREAM_METADATA_HEAD as libc::c_int as libc::c_uint
        {
        ...
        } else if (*s).remaining_metadata_bytes_ == 0 as libc::c_int as uint32_t {
            (*s).remaining_metadata_bytes_ = !(0 as libc::c_int as uint32_t);
            (*s).stream_state_ = BROTLI_STREAM_PROCESSING;
            break;
            ...
            *available_in = (*available_in).wrapping_sub(copy as size_t);
            (*s)
                .remaining_metadata_bytes_ = ((*s).remaining_metadata_bytes_)
                .wrapping_sub(copy);
            *next_out = (*next_out).offset(copy as isize);
            *available_out = (*available_out).wrapping_sub(copy as size_t);
        } else {
            ...
            *available_in = (*available_in).wrapping_sub(copy_0 as size_t);
            (*s)
                .remaining_metadata_bytes_ = ((*s).remaining_metadata_bytes_)
                .wrapping_sub(copy_0);
...
unsafe extern "C" fn UpdateSizeHint(
    ...
    if (*s).params.size_hint == 0 as libc::c_int as size_t {
        ...
        if delta >= limit as uint64_t || tail >= limit as uint64_t
...
pub unsafe extern "C" fn BrotliEncoderCompressStream(
    ...
    loop {
        ...
        if remaining_block_size != 0 as libc::c_int as size_t
            && *available_in != 0 as libc::c_int as size_t
        {
            let mut copy_input_size: size_t = brotli_min_size_t(
            ...
            *available_in = (*available_in).wrapping_sub(copy_input_size);
            ...
            let mut is_last: libc::c_int = if *available_in == 0 as libc::c_int as size_t
                && op as libc::c_uint
                    == BROTLI_OPERATION_FINISH as libc::c_int as libc::c_uint
            {
                1 as libc::c_int
...
pub unsafe extern "C" fn BrotliEncoderHasMoreOutput(
    ...
    return if (*s).available_out_ != 0 as libc::c_int as size_t {
        1 as libc::c_int
    } else {
        0 as libc::c_int
    };
