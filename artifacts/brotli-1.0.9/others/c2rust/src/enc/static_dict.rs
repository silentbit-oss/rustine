...
unsafe extern "C" fn AddMatch(
    ...
    let mut match_0: uint32_t = (distance << 5 as libc::c_int).wrapping_add(len_code)
        as uint32_t;
    *matches
        .offset(
            len as isize,
...
unsafe extern "C" fn IsMatch(
    ...
    if w.len as size_t > max_length {
        ...
        let offset: size_t = ((*dictionary).offsets_by_length[w.len as usize] as size_t)
            .wrapping_add(w.len as size_t * w.idx as size_t);
...
pub unsafe extern "C" fn BrotliFindAllStaticDictionaryMatches(
    ...
    let mut offset: size_t = *((*dictionary).buckets).offset(Hash(data) as isize)
        as size_t;
    ...
    while end == 0 {
        ...
        w.len = l as uint8_t;
        if w.transform as libc::c_int == 0 as libc::c_int {
            let matchlen: size_t = DictMatchLength(
                (*dictionary).words,
                data,
                id,
                l,
            ...
            if matchlen >= l.wrapping_sub(1 as libc::c_int as size_t) {
                AddMatch(
                    id.wrapping_add(12 as libc::c_int as size_t * n),
                    l.wrapping_sub(1 as libc::c_int as size_t),
                    l,
                    matches,
                );
                if l.wrapping_add(2 as libc::c_int as size_t) < max_length
                    && *data.offset(l.wrapping_sub(1 as libc::c_int as size_t) as isize)
                        as libc::c_int == 'i' as i32
                    && *data.offset(l as isize) as libc::c_int == 'n' as i32
                    && *data.offset(l.wrapping_add(1 as libc::c_int as size_t) as isize)
                        as libc::c_int == 'g' as i32
                    && *data.offset(l.wrapping_add(2 as libc::c_int as size_t) as isize)
                        as libc::c_int == ' ' as i32
                {
                    AddMatch(
                        id.wrapping_add(49 as libc::c_int as size_t * n),
                        l.wrapping_add(3 as libc::c_int as size_t),
                        l,
                        matches,
                    );
                }
            ...
            minlen = min_length;
            if l > 9 as libc::c_int as size_t {
                minlen = brotli_max_size_t(
                    minlen,
                    l.wrapping_sub(9 as libc::c_int as size_t),
                );
            }
            maxlen = brotli_min_size_t(
                matchlen,
                l.wrapping_sub(2 as libc::c_int as size_t),
            );
            len = minlen;
            while len <= maxlen {
                ...
                let mut transform_id: size_t = (cut << 2 as libc::c_int)
                    .wrapping_add(
                        (*dictionary).cutoffTransforms
                            >> cut * 6 as libc::c_int as size_t
                            & 0x3f as libc::c_int as uint64_t,
                    );
                AddMatch(id.wrapping_add(transform_id * n), len, l, matches);
                has_found_match = 1 as libc::c_int;
                len = len.wrapping_add(1);
                len;
            }
            if matchlen < l || l.wrapping_add(6 as libc::c_int as size_t) >= max_length {
                continue;
            }
            ...
            if *s.offset(0 as libc::c_int as isize) as libc::c_int == ' ' as i32 {
                AddMatch(
                    id.wrapping_add(n),
                    l.wrapping_add(1 as libc::c_int as size_t),
                    l,
                    matches,
                );
                if *s.offset(1 as libc::c_int as isize) as libc::c_int == 'a' as i32 {
                    ...
                    {
                        AddMatch(
                            id.wrapping_add(28 as libc::c_int as size_t * n),
                            l.wrapping_add(3 as libc::c_int as size_t),
                            l,
                            matches,
                        );
                        ...
                        == 's' as i32
                    {
                        ...
                        {
                            AddMatch(
                                id.wrapping_add(46 as libc::c_int as size_t * n),
                                l.wrapping_add(4 as libc::c_int as size_t),
                                l,
                                matches,
                            );
                        }
                        ...
                        == 't' as i32
                    {
                        ...
                        {
                            AddMatch(
                                id.wrapping_add(60 as libc::c_int as size_t * n),
                                l.wrapping_add(4 as libc::c_int as size_t),
                                l,
                                matches,
                            );
                        ...
                        == 'n' as i32
                    {
                        ...
                        {
                            AddMatch(
                                id.wrapping_add(10 as libc::c_int as size_t * n),
                                l.wrapping_add(5 as libc::c_int as size_t),
                                l,
                                matches,
                            );
                        }
                    ...
                    == 'b' as i32
                {
                    ...
                    {
                        AddMatch(
                            id.wrapping_add(38 as libc::c_int as size_t * n),
                            l.wrapping_add(4 as libc::c_int as size_t),
                            l,
                            matches,
                        );
                    ...
                    == 'i' as i32
                {
                    if *s.offset(2 as libc::c_int as isize) as libc::c_int == 'n' as i32
                    {
                        ...
                        {
                            AddMatch(
                                id.wrapping_add(16 as libc::c_int as size_t * n),
                                l.wrapping_add(4 as libc::c_int as size_t),
                                l,
                                matches,
                            );
                        ...
                        == 's' as i32
                    {
                        ...
                        {
                            AddMatch(
                                id.wrapping_add(47 as libc::c_int as size_t * n),
                                l.wrapping_add(4 as libc::c_int as size_t),
                                l,
                                matches,
                            );
                    ...
                    == 'f' as i32
                {
                    if *s.offset(2 as libc::c_int as isize) as libc::c_int == 'o' as i32
                    {
                        ...
                        {
                            AddMatch(
                                id.wrapping_add(25 as libc::c_int as size_t * n),
                                l.wrapping_add(5 as libc::c_int as size_t),
                                l,
                                matches,
                            );
                        ...
                        == 'r' as i32
                    {
                        ...
                        {
                            AddMatch(
                                id.wrapping_add(37 as libc::c_int as size_t * n),
                                l.wrapping_add(6 as libc::c_int as size_t),
                                l,
                                matches,
                            );
                        }
                    ...
                    == 'o' as i32
                {
                    if *s.offset(2 as libc::c_int as isize) as libc::c_int == 'f' as i32
                    {
                        ...
                        {
                            AddMatch(
                                id.wrapping_add(8 as libc::c_int as size_t * n),
                                l.wrapping_add(4 as libc::c_int as size_t),
                                l,
                                matches,
                            );
                        ...
                        == 'n' as i32
                    {
                        ...
                        {
                            AddMatch(
                                id.wrapping_add(45 as libc::c_int as size_t * n),
                                l.wrapping_add(4 as libc::c_int as size_t),
                                l,
                                matches,
                            );
                    ...
                    == 'n' as i32
                {
                    ...
                    {
                        AddMatch(
                            id.wrapping_add(80 as libc::c_int as size_t * n),
                            l.wrapping_add(5 as libc::c_int as size_t),
                            l,
                            matches,
                        );
                    ...
                    == 't' as i32
                {
                    if *s.offset(2 as libc::c_int as isize) as libc::c_int == 'h' as i32
                    {
                            ...
                            == 'e' as i32
                        {
                            ...
                            {
                                AddMatch(
                                    id.wrapping_add(5 as libc::c_int as size_t * n),
                                    l.wrapping_add(5 as libc::c_int as size_t),
                                    l,
                                    matches,
                                );
                            ...
                            == 'a' as i32
                        {
                            ...
                            {
                                AddMatch(
                                    id.wrapping_add(29 as libc::c_int as size_t * n),
                                    l.wrapping_add(6 as libc::c_int as size_t),
                                    l,
                                    matches,
                                );
                        ...
                        == 'o' as i32
                    {
                        ...
                        {
                            AddMatch(
                                id.wrapping_add(17 as libc::c_int as size_t * n),
                                l.wrapping_add(4 as libc::c_int as size_t),
                                l,
                                matches,
                            );
                    ...
                    == 'w' as i32
                {
                    ...
                    {
                        AddMatch(
                            id.wrapping_add(35 as libc::c_int as size_t * n),
                            l.wrapping_add(6 as libc::c_int as size_t),
                            l,
                            matches,
                        );
                ...
                AddMatch(
                    id.wrapping_add(19 as libc::c_int as size_t * n),
                    l.wrapping_add(1 as libc::c_int as size_t),
                    l,
                    matches,
                );
                if *s.offset(1 as libc::c_int as isize) as libc::c_int == '>' as i32 {
                    AddMatch(
                        id.wrapping_add(21 as libc::c_int as size_t * n),
                        l.wrapping_add(2 as libc::c_int as size_t),
                        l,
                        matches,
                    );
                }
                ...
                AddMatch(
                    id.wrapping_add(20 as libc::c_int as size_t * n),
                    l.wrapping_add(1 as libc::c_int as size_t),
                    l,
                    matches,
                );
                if *s.offset(1 as libc::c_int as isize) as libc::c_int == ' ' as i32 {
                    AddMatch(
                        id.wrapping_add(31 as libc::c_int as size_t * n),
                        l.wrapping_add(2 as libc::c_int as size_t),
                        l,
                        matches,
                    );
                            ...
                            == 'h' as i32
                    {
                            ...
                            == 'e' as i32
                        {
                            ...
                            {
                                AddMatch(
                                    id.wrapping_add(43 as libc::c_int as size_t * n),
                                    l.wrapping_add(6 as libc::c_int as size_t),
                                    l,
                                    matches,
                                );
                            ...
                            == 'i' as i32
                        {
                            ...
                            {
                                AddMatch(
                                    id.wrapping_add(75 as libc::c_int as size_t * n),
                                    l.wrapping_add(7 as libc::c_int as size_t),
                                    l,
                                    matches,
                                );
                            }
                ...
                AddMatch(
                    id.wrapping_add(76 as libc::c_int as size_t * n),
                    l.wrapping_add(1 as libc::c_int as size_t),
                    l,
                    matches,
                );
                if *s.offset(1 as libc::c_int as isize) as libc::c_int == ' ' as i32 {
                    AddMatch(
                        id.wrapping_add(14 as libc::c_int as size_t * n),
                        l.wrapping_add(2 as libc::c_int as size_t),
                        l,
                        matches,
                    );
            ...
            {
                AddMatch(
                    id.wrapping_add(22 as libc::c_int as size_t * n),
                    l.wrapping_add(1 as libc::c_int as size_t),
                    l,
                    matches,
                );
                if *s.offset(1 as libc::c_int as isize) as libc::c_int == '\t' as i32 {
                    AddMatch(
                        id.wrapping_add(50 as libc::c_int as size_t * n),
                        l.wrapping_add(2 as libc::c_int as size_t),
                        l,
                        matches,
                    );
                ...
                AddMatch(
                    id.wrapping_add(24 as libc::c_int as size_t * n),
                    l.wrapping_add(1 as libc::c_int as size_t),
                    l,
                    matches,
                );
            ...
            {
                AddMatch(
                    id.wrapping_add(36 as libc::c_int as size_t * n),
                    l.wrapping_add(1 as libc::c_int as size_t),
                    l,
                    matches,
                );
                ...
                AddMatch(
                    id.wrapping_add(51 as libc::c_int as size_t * n),
                    l.wrapping_add(1 as libc::c_int as size_t),
                    l,
                    matches,
                );
                ...
                AddMatch(
                    id.wrapping_add(57 as libc::c_int as size_t * n),
                    l.wrapping_add(1 as libc::c_int as size_t),
                    l,
                    matches,
                );
                ...
                if *s.offset(1 as libc::c_int as isize) as libc::c_int == '"' as i32 {
                    AddMatch(
                        id.wrapping_add(70 as libc::c_int as size_t * n),
                        l.wrapping_add(2 as libc::c_int as size_t),
                        l,
                        matches,
                    );
                ...
                {
                    AddMatch(
                        id.wrapping_add(86 as libc::c_int as size_t * n),
                        l.wrapping_add(2 as libc::c_int as size_t),
                        l,
                        matches,
                    );
                ...
                {
                    AddMatch(
                        id.wrapping_add(84 as libc::c_int as size_t * n),
                        l.wrapping_add(3 as libc::c_int as size_t),
                        l,
                        matches,
                    );
                ...
                if *s.offset(1 as libc::c_int as isize) as libc::c_int == 'd' as i32 {
                    ...
                    {
                        AddMatch(
                            id.wrapping_add(53 as libc::c_int as size_t * n),
                            l.wrapping_add(3 as libc::c_int as size_t),
                            l,
                            matches,
                        );
                    ...
                    == 'r' as i32
                {
                    ...
                    {
                        AddMatch(
                            id.wrapping_add(82 as libc::c_int as size_t * n),
                            l.wrapping_add(3 as libc::c_int as size_t),
                            l,
                            matches,
                        );
                    ...
                    == 's' as i32
                {
                    ...
                    {
                        AddMatch(
                            id.wrapping_add(95 as libc::c_int as size_t * n),
                            l.wrapping_add(4 as libc::c_int as size_t),
                            l,
                            matches,
                        );
                ...
                {
                    AddMatch(
                        id.wrapping_add(90 as libc::c_int as size_t * n),
                        l.wrapping_add(4 as libc::c_int as size_t),
                        l,
                        matches,
                    );
                ...
                if *s.offset(1 as libc::c_int as isize) as libc::c_int == 'v' as i32 {
                    ...
                    {
                        AddMatch(
                            id.wrapping_add(92 as libc::c_int as size_t * n),
                            l.wrapping_add(4 as libc::c_int as size_t),
                            l,
                            matches,
                        );
                    ...
                    == 'z' as i32
                {
                    ...
                    {
                        AddMatch(
                            id.wrapping_add(100 as libc::c_int as size_t * n),
                            l.wrapping_add(4 as libc::c_int as size_t),
                            l,
                            matches,
                        );
                ...
                if *s.offset(1 as libc::c_int as isize) as libc::c_int == 'e' as i32 {
                    ...
                    {
                        AddMatch(
                            id.wrapping_add(93 as libc::c_int as size_t * n),
                            l.wrapping_add(5 as libc::c_int as size_t),
                            l,
                            matches,
                        );
                    ...
                    == 'y' as i32
                {
                    ...
                    {
                        AddMatch(
                            id.wrapping_add(61 as libc::c_int as size_t * n),
                            l.wrapping_add(3 as libc::c_int as size_t),
                            l,
                            matches,
                        );
                ...
                {
                    AddMatch(
                        id.wrapping_add(106 as libc::c_int as size_t * n),
                        l.wrapping_add(4 as libc::c_int as size_t),
                        l,
                        matches,
                    );
            ...
            has_found_match = 1 as libc::c_int;
            if l.wrapping_add(1 as libc::c_int as size_t) >= max_length {
                continue;
            }
    ...
    if max_length >= 5 as libc::c_int as size_t
        && (*data.offset(0 as libc::c_int as isize) as libc::c_int == ' ' as i32
            || *data.offset(0 as libc::c_int as isize) as libc::c_int == '.' as i32)
    {
        let mut is_space: libc::c_int = if *data.offset(0 as libc::c_int as isize)
            as libc::c_int == ' ' as i32
        {
            1 as libc::c_int
        } else {
        ...
        while end_0 == 0 {
            ...
            let l_0: size_t = (w_0.len as libc::c_int & 0x1f as libc::c_int) as size_t;
            ...
            if w_0.transform as libc::c_int == 0 as libc::c_int {
                ...
                if IsMatch(
                    ...
                    w_0,
                    &*data.offset(1 as libc::c_int as isize),
                    max_length.wrapping_sub(1 as libc::c_int as size_t),
                ) == 0
                {
                    continue;
                }
                AddMatch(
                    ...
                    l_0.wrapping_add(1 as libc::c_int as size_t),
                    l_0,
                    matches,
                );
                has_found_match = 1 as libc::c_int;
                if l_0.wrapping_add(2 as libc::c_int as size_t) >= max_length {
                    continue;
                }
                s_1 = &*data
                    .offset(l_0.wrapping_add(1 as libc::c_int as size_t) as isize)
                    as *const uint8_t;
                if *s_1.offset(0 as libc::c_int as isize) as libc::c_int == ' ' as i32 {
                    AddMatch(
                        ...
                        l_0.wrapping_add(2 as libc::c_int as size_t),
                        l_0,
                        matches,
                    );
                    ...
                    == '(' as i32
                {
                    ...
                    {
                        AddMatch(
                            id_0.wrapping_add(103 as libc::c_int as size_t * n_0),
                            l_0.wrapping_add(2 as libc::c_int as size_t),
                            l_0,
                            matches,
                        );
                        ...
                        {
                            AddMatch(
                                id_0.wrapping_add(33 as libc::c_int as size_t * n_0),
                                l_0.wrapping_add(3 as libc::c_int as size_t),
                                l_0,
                                matches,
                            );
                        }
                    ...
                    {
                        AddMatch(
                            id_0.wrapping_add(71 as libc::c_int as size_t * n_0),
                            l_0.wrapping_add(2 as libc::c_int as size_t),
                            l_0,
                            matches,
                        );
                        ...
                        {
                            AddMatch(
                                id_0.wrapping_add(52 as libc::c_int as size_t * n_0),
                                l_0.wrapping_add(3 as libc::c_int as size_t),
                                l_0,
                                matches,
                            );
                        ...
                        == '=' as i32
                    {
                        ...
                        {
                            AddMatch(
                                id_0.wrapping_add(81 as libc::c_int as size_t * n_0),
                                l_0.wrapping_add(3 as libc::c_int as size_t),
                                l_0,
                                matches,
                            );
                        ...
                        {
                            AddMatch(
                                id_0.wrapping_add(98 as libc::c_int as size_t * n_0),
                                l_0.wrapping_add(3 as libc::c_int as size_t),
                                l_0,
                                matches,
                            );
                    ...
                    == ',' as i32
                {
                    if is_all_caps_0 == 0 {
                        AddMatch(
                            id_0.wrapping_add(109 as libc::c_int as size_t * n_0),
                            l_0.wrapping_add(2 as libc::c_int as size_t),
                            l_0,
                            matches,
                        );
    ...
    if max_length >= 6 as libc::c_int as size_t {
                    ...
                    == 0xa0 as libc::c_int
        {
            ...
            while end_1 == 0 {
                ...
                let mut w_1: DictWord = *((*dictionary).dict_words)
                    .offset(fresh2 as isize);
                let l_1: size_t = (w_1.len as libc::c_int & 0x1f as libc::c_int)
                    as size_t;
                ...
                if w_1.transform as libc::c_int == 0 as libc::c_int
                    && IsMatch(
                        ...
                        max_length.wrapping_sub(2 as libc::c_int as size_t),
                    ) != 0
                {
                    ...
                    {
                        AddMatch(
                            id_1.wrapping_add(102 as libc::c_int as size_t * n_1),
                            l_1.wrapping_add(2 as libc::c_int as size_t),
                            l_1,
                            matches,
                        );
                        has_found_match = 1 as libc::c_int;
                    } else if l_1.wrapping_add(2 as libc::c_int as size_t) < max_length
                        && *data
                            .offset(
                                l_1.wrapping_add(2 as libc::c_int as size_t) as isize,
                            ) as libc::c_int == ' ' as i32
                    {
                        let mut t: size_t = (if *data.offset(0 as libc::c_int as isize)
                        ...
                        AddMatch(
                            id_1.wrapping_add(t * n_1),
                            l_1.wrapping_add(3 as libc::c_int as size_t),
                            l_1,
                            matches,
                        );
                        has_found_match = 1 as libc::c_int;
    ...
    if max_length >= 9 as libc::c_int as size_t {
                ...
                && *data.offset(4 as libc::c_int as isize) as libc::c_int == '/' as i32
        {
            ...
            while end_2 == 0 {
                ...
                let mut w_2: DictWord = *((*dictionary).dict_words)
                    .offset(fresh3 as isize);
                let l_2: size_t = (w_2.len as libc::c_int & 0x1f as libc::c_int)
                    as size_t;
                ...
                if w_2.transform as libc::c_int == 0 as libc::c_int
                    && IsMatch(
                        ...
                        max_length.wrapping_sub(5 as libc::c_int as size_t),
                    ) != 0
                {
                    AddMatch(
                        id_2
                        ...
                        l_2.wrapping_add(5 as libc::c_int as size_t),
                        l_2,
                        matches,
                    );
                    has_found_match = 1 as libc::c_int;
                    if l_2.wrapping_add(5 as libc::c_int as size_t) < max_length {
                        let mut s_3: *const uint8_t = &*data
                            .offset(
                                l_2.wrapping_add(5 as libc::c_int as size_t) as isize,
                            ) as *const uint8_t;
                        if *data.offset(0 as libc::c_int as isize) as libc::c_int
                            == ' ' as i32
                        {
                            if l_2.wrapping_add(8 as libc::c_int as size_t) < max_length
                            ...
                            {
                                AddMatch(
                                    id_2.wrapping_add(62 as libc::c_int as size_t * n_2),
                                    l_2.wrapping_add(9 as libc::c_int as size_t),
                                    l_2,
                                    matches,
                                );
                                if l_2.wrapping_add(12 as libc::c_int as size_t)
                                    < max_length
                                ...
                                {
                                    AddMatch(
                                        id_2.wrapping_add(73 as libc::c_int as size_t * n_2),
                                        l_2.wrapping_add(13 as libc::c_int as size_t),
                                        l_2,
                                        matches,
                                    );
                                }
