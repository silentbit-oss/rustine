...
unsafe extern "C" fn PrepareDistanceCache(
    ...
    if num_distances > 4 as libc::c_int {
        let mut last_distance: libc::c_int = *distance_cache
        ...
        *distance_cache
        ...
        if num_distances > 10 as libc::c_int {
            let mut next_last_distance: libc::c_int = *distance_cache
...
unsafe extern "C" fn BackwardReferenceScore(
    ...
    return ((30 as libc::c_int * 8 as libc::c_int) as libc::c_ulong)
        ...
        .wrapping_add(135 as libc::c_int as size_t * copy_length)
        .wrapping_sub(
            (30 as libc::c_int as uint32_t * Log2FloorNonZero(backward_reference_offset))
                as libc::c_ulong,
        );
}
#[inline(always)]
unsafe extern "C" fn BackwardReferenceScoreUsingLastDistance(
    ...
    return (135 as libc::c_int as size_t * copy_length)
        .wrapping_add(
    ...
    return (39 as libc::c_int as size_t)
        .wrapping_add(
            (0x1ca10 as libc::c_int
                >> (distance_short_code & 0xe as libc::c_int as size_t)
...
unsafe extern "C" fn TestStaticDictionaryItem(
    ...
    if matchlen.wrapping_add((*dictionary).cutoffTransformsCount as size_t) <= len
        || matchlen == 0 as libc::c_int as size_t
    {
        return 0 as libc::c_int;
    }
    ...
    let mut transform_id: size_t = (cut << 2 as libc::c_int)
        .wrapping_add(
            (*dictionary).cutoffTransforms >> cut * 6 as libc::c_int as size_t
                & 0x3f as libc::c_int as uint64_t,
        );
...
unsafe extern "C" fn SearchInStaticDictionary(
    ...
    while i
        < (if shallow != 0 { 1 as libc::c_uint } else { 2 as libc::c_uint }) as size_t
    {
            ...
            != 0 as libc::c_int
        {
            ...
            if item_matches != 0 {
                (*common)
                    .dict_num_matches = ((*common).dict_num_matches).wrapping_add(1);
...
unsafe extern "C" fn FindLongestMatchH2(
    ...
    let mut compare_char: libc::c_int = *data
        .offset(cur_ix_masked.wrapping_add(best_len_in) as isize) as libc::c_int;
    let mut key: size_t = HashBytesH2(&*data.offset(cur_ix_masked as isize)) as size_t;
    ...
    let mut cached_backward: size_t = *distance_cache.offset(0 as libc::c_int as isize)
        as size_t;
    let mut prev_ix: size_t = cur_ix.wrapping_sub(cached_backward);
    (*out).len_code_delta = 0 as libc::c_int;
    if prev_ix < cur_ix {
        prev_ix &= ring_buffer_mask as uint32_t as size_t;
        if compare_char
            == *data.offset(prev_ix.wrapping_add(best_len) as isize) as libc::c_int
        {
            ...
            if len >= 4 as libc::c_int as size_t {
                let score: size_t = BackwardReferenceScoreUsingLastDistance(len);
                if best_score < score {
                    (*out).len = len;
    ...
    if (1 as libc::c_int) << 0 as libc::c_int == 1 as libc::c_int {
        ...
        *buckets.offset(key as isize) = cur_ix as uint32_t;
        ...
        if len_0 >= 4 as libc::c_int as size_t {
        ...
        let mut i: size_t = 0;
        i = 0 as libc::c_int as size_t;
        while i < ((1 as libc::c_int) << 0 as libc::c_int) as size_t {
            keys[i
        ...
        key_out = keys[((cur_ix
            & ((((1 as libc::c_int) << 0 as libc::c_int) - 1 as libc::c_int)
                << 3 as libc::c_int) as size_t) >> 3 as libc::c_int) as usize];
        i = 0 as libc::c_int as size_t;
        while i < ((1 as libc::c_int) << 0 as libc::c_int) as size_t {
            ...
            if !(compare_char
                != *data.offset(prev_ix.wrapping_add(best_len) as isize) as libc::c_int)
            {
                if !((backward_0 == 0 as libc::c_int as size_t
                    || backward_0 > max_backward) as libc::c_int as libc::c_long != 0)
                {
                    ...
                    if len_1 >= 4 as libc::c_int as size_t {
                        let score_1: size_t = BackwardReferenceScore(len_1, backward_0);
...
unsafe extern "C" fn FindLongestMatchH3(
    ...
    let mut compare_char: libc::c_int = *data
        .offset(cur_ix_masked.wrapping_add(best_len_in) as isize) as libc::c_int;
    let mut key: size_t = HashBytesH3(&*data.offset(cur_ix_masked as isize)) as size_t;
    let mut key_out: size_t = 0;
    let mut min_score: size_t = (*out).score;
    let mut best_score: size_t = (*out).score;
    let mut best_len: size_t = best_len_in;
    ...
    if (1 as libc::c_int) << 1 as libc::c_int == 1 as libc::c_int {
        ...
        *buckets.offset(key as isize) = cur_ix as uint32_t;
        ...
        let mut i: size_t = 0;
        i = 0 as libc::c_int as size_t;
        while i < ((1 as libc::c_int) << 1 as libc::c_int) as size_t {
            keys[i
                as usize] = key.wrapping_add(i << 3 as libc::c_int)
                & (((1 as libc::c_int) << 16 as libc::c_int) - 1 as libc::c_int)
                    as size_t;
...
unsafe extern "C" fn FindLongestMatchH4(
    ...
    let mut compare_char: libc::c_int = *data
        .offset(cur_ix_masked.wrapping_add(best_len_in) as isize) as libc::c_int;
    let mut key: size_t = HashBytesH4(&*data.offset(cur_ix_masked as isize)) as size_t;
    let mut key_out: size_t = 0;
    let mut min_score: size_t = (*out).score;
    let mut best_score: size_t = (*out).score;
    let mut best_len: size_t = best_len_in;
    ...
    if (1 as libc::c_int) << 2 as libc::c_int == 1 as libc::c_int {
        ...
        *buckets.offset(key as isize) = cur_ix as uint32_t;
        ...
        let mut i: size_t = 0;
        i = 0 as libc::c_int as size_t;
        while i < ((1 as libc::c_int) << 2 as libc::c_int) as size_t {
            keys[i
                as usize] = key.wrapping_add(i << 3 as libc::c_int)
                & (((1 as libc::c_int) << 17 as libc::c_int) - 1 as libc::c_int)
                    as size_t;
...
unsafe extern "C" fn FindLongestMatchH54(
    ...
    let mut compare_char: libc::c_int = *data
        .offset(cur_ix_masked.wrapping_add(best_len_in) as isize) as libc::c_int;
    let mut key: size_t = HashBytesH54(&*data.offset(cur_ix_masked as isize)) as size_t;
    let mut key_out: size_t = 0;
    let mut min_score: size_t = (*out).score;
    let mut best_score: size_t = (*out).score;
    let mut best_len: size_t = best_len_in;
...
unsafe extern "C" fn FindLongestMatchH5(
        ...
        if !(prev_ix >= cur_ix) {
            if !((backward > max_backward) as libc::c_int as libc::c_long != 0) {
                            ...
                            as libc::c_int)
                {
                    ...
                    {
                        let mut score: size_t = BackwardReferenceScoreUsingLastDistance(
                            len,
                        );
                        if best_score < score {
    ...
    while i > down {
        ...
        let mut prev_ix_0: size_t = *bucket
            .offset((i & (*self_0).block_mask_ as size_t) as isize) as size_t;
    ...
    *bucket
        .offset(
            (*num.offset(key as isize) as uint32_t & (*self_0).block_mask_) as isize,
        ) = cur_ix as uint32_t;
...
unsafe extern "C" fn FindLongestMatchH40(
    ...
    loop {
        ...
        backward_0 = backward_0.wrapping_add(delta);
...
unsafe extern "C" fn HashRollingFunctionHROLLING_FAST(
    ...
    return (factor * state)
        ...
        .wrapping_sub(factor_remove * HashByteHROLLING_FAST(rem));
}
#[inline(always)]
...
unsafe extern "C" fn FindLongestMatchHROLLING_FAST(
    ...
    if cur_ix & (4 as libc::c_int - 1 as libc::c_int) as size_t
        != 0 as libc::c_int as size_t
    {
        return;
    }
    if max_length < 32 as libc::c_int as size_t {
        return;
    }
    pos = (*self_0).next_ix;
    while pos <= cur_ix {
        ...
        let mut add: uint8_t = *data
            .offset(
                (pos.wrapping_add(32 as libc::c_int as size_t) & ring_buffer_mask)
                    as isize,
            );
        ...
        if code < 16777216 as libc::c_int as uint32_t {
            ...
            *((*self_0).table).offset(code as isize) = pos as uint32_t;
            if pos == cur_ix && found_ix != kInvalidPosHROLLING_FAST as size_t {
                let mut backward: size_t = cur_ix.wrapping_sub(found_ix) as uint32_t
                    as size_t;
                if backward <= max_backward {
                    ...
                    if len >= 4 as libc::c_int as size_t && len > (*out).len {
        ...
        pos = pos.wrapping_add(4 as libc::c_int as size_t);
    }
    (*self_0).next_ix = cur_ix.wrapping_add(4 as libc::c_int as size_t);
}
...
unsafe extern "C" fn HashRollingFunctionHROLLING(
    ...
    return (factor * state)
        ...
        .wrapping_sub(factor_remove * HashByteHROLLING(rem));
}
#[inline(always)]
...
unsafe extern "C" fn FindLongestMatchHROLLING(
    ...
    let cur_ix_masked: size_t = cur_ix & ring_buffer_mask;
    let mut pos: size_t = 0;
    if cur_ix & (1 as libc::c_int - 1 as libc::c_int) as size_t
        != 0 as libc::c_int as size_t
    {
        return;
    }
    ...
    while pos <= cur_ix {
        ...
        pos = pos.wrapping_add(1 as libc::c_int as size_t);
    }
    (*self_0).next_ix = cur_ix.wrapping_add(1 as libc::c_int as size_t);
}
#[inline(always)]
...
unsafe extern "C" fn ComputeDistanceCode(
    ...
    if distance <= max_distance {
        let mut distance_plus_3: size_t = distance
        ...
        } else if distance == *dist_cache.offset(1 as libc::c_int as isize) as size_t {
            return 1 as libc::c_int as size_t
        } else if offset0 < 7 as libc::c_int as size_t {
            return (0x9750468 as libc::c_int >> 4 as libc::c_int as size_t * offset0
                & 0xf as libc::c_int) as size_t
        } else if offset1 < 7 as libc::c_int as size_t {
            return (0xfdb1ace as libc::c_int >> 4 as libc::c_int as size_t * offset1
                & 0xf as libc::c_int) as size_t
        } else if distance == *dist_cache.offset(2 as libc::c_int as isize) as size_t {
            return 2 as libc::c_int as size_t
        } else if distance == *dist_cache.offset(3 as libc::c_int as isize) as size_t {
...
unsafe extern "C" fn CreateBackwardReferencesNH2(
    ...
    let random_heuristics_window_size: size_t = LiteralSpreeLengthForSparseSearch(
        params,
    );
    let mut apply_random_heuristics: size_t = position
        .wrapping_add(random_heuristics_window_size);
    let gap: size_t = 0 as libc::c_int as size_t;
    let kMinScore: size_t = ((30 as libc::c_int * 8 as libc::c_int) as libc::c_ulong)
        .wrapping_mul(::core::mem::size_of::<size_t>() as libc::c_ulong)
    ...
    while position.wrapping_add(HashTypeLengthH2()) < pos_end {
        ...
        if sr.score > kMinScore {
            let mut delayed_backward_references_in_row: libc::c_int = 0 as libc::c_int;
            ...
            loop {
                ...
                sr2
                    ...
                    brotli_min_size_t(
                        (sr.len).wrapping_sub(1 as libc::c_int as size_t),
                        max_length,
                    )
                } else {
                    0 as libc::c_int as size_t
                ...
                max_distance = brotli_min_size_t(
                    position.wrapping_add(1 as libc::c_int as size_t),
                    max_backward_limit,
                );
            ...
            apply_random_heuristics = position
                .wrapping_add(2 as libc::c_int as size_t * sr.len)
                .wrapping_add(random_heuristics_window_size);
            dictionary_start = brotli_min_size_t(
                position.wrapping_add(position_offset),
                max_backward_limit,
            ...
            if sr.distance <= dictionary_start.wrapping_add(gap)
                && distance_code > 0 as libc::c_int as size_t
            {
                *dist_cache
                    .offset(
            ...
            *num_literals = (*num_literals).wrapping_add(insert_length);
            ...
            let mut range_start: size_t = position
                .wrapping_add(2 as libc::c_int as size_t);
            let mut range_end: size_t = brotli_min_size_t(
            ...
            if position > apply_random_heuristics {
                if position
                    > apply_random_heuristics
                        .wrapping_add(
                            4 as libc::c_int as size_t * random_heuristics_window_size,
                        )
                {
                    let kMargin: size_t = brotli_max_size_t(
                        (StoreLookaheadH2()).wrapping_sub(1 as libc::c_int as size_t),
                        4 as libc::c_int as size_t,
                    );
                    let mut pos_jump: size_t = brotli_min_size_t(
                        position.wrapping_add(16 as libc::c_int as size_t),
                    ...
                    while position < pos_jump {
                        ...
                        position = position.wrapping_add(4 as libc::c_int as size_t);
                    }
                } else {
                    ...
                    let mut pos_jump_0: size_t = brotli_min_size_t(
                        position.wrapping_add(8 as libc::c_int as size_t),
                    ...
                    while position < pos_jump_0 {
                        ...
                        insert_length = insert_length
                            .wrapping_add(2 as libc::c_int as size_t);
                        position = position.wrapping_add(2 as libc::c_int as size_t);
                    }
                }
            }
        }
        ...
        if sr.score > kMinScore {
            ...
            *num_literals = (*num_literals).wrapping_add(insert_length);
            ...
            if position > apply_random_heuristics {
                ...
                {
                    let kMargin: size_t = brotli_max_size_t(
                        (StoreLookaheadH3()).wrapping_sub(1 as libc::c_int as size_t),
                        4 as libc::c_int as size_t,
                    );
                    let mut pos_jump: size_t = brotli_min_size_t(
                        position.wrapping_add(16 as libc::c_int as size_t),
        ...
        if sr.score > kMinScore {
            ...
            *num_literals = (*num_literals).wrapping_add(insert_length);
            ...
            if position > apply_random_heuristics {
                ...
                {
                    let kMargin: size_t = brotli_max_size_t(
                        (StoreLookaheadH4()).wrapping_sub(1 as libc::c_int as size_t),
                        4 as libc::c_int as size_t,
                    );
                    let mut pos_jump: size_t = brotli_min_size_t(
                        position.wrapping_add(16 as libc::c_int as size_t),
        ...
        if sr.score > kMinScore {
            ...
            *num_literals = (*num_literals).wrapping_add(insert_length);
            ...
            if position > apply_random_heuristics {
                ...
                {
                    let kMargin: size_t = brotli_max_size_t(
                        (StoreLookaheadH5()).wrapping_sub(1 as libc::c_int as size_t),
                        4 as libc::c_int as size_t,
                    );
                    let mut pos_jump: size_t = brotli_min_size_t(
                        position.wrapping_add(16 as libc::c_int as size_t),
        ...
        if sr.score > kMinScore {
            ...
            *num_literals = (*num_literals).wrapping_add(insert_length);
            ...
            if position > apply_random_heuristics {
                ...
                {
                    let kMargin: size_t = brotli_max_size_t(
                        (StoreLookaheadH6()).wrapping_sub(1 as libc::c_int as size_t),
                        4 as libc::c_int as size_t,
                    );
                    let mut pos_jump: size_t = brotli_min_size_t(
                        position.wrapping_add(16 as libc::c_int as size_t),
        ...
        if sr.score > kMinScore {
            ...
            *num_literals = (*num_literals).wrapping_add(insert_length);
            ...
            if position > apply_random_heuristics {
                ...
                {
                    let kMargin: size_t = brotli_max_size_t(
                        (StoreLookaheadH40()).wrapping_sub(1 as libc::c_int as size_t),
                        4 as libc::c_int as size_t,
                    );
                    let mut pos_jump: size_t = brotli_min_size_t(
                        position.wrapping_add(16 as libc::c_int as size_t),
        ...
        if sr.score > kMinScore {
            ...
            *num_literals = (*num_literals).wrapping_add(insert_length);
            ...
            if position > apply_random_heuristics {
                ...
                {
                    let kMargin: size_t = brotli_max_size_t(
                        (StoreLookaheadH41()).wrapping_sub(1 as libc::c_int as size_t),
                        4 as libc::c_int as size_t,
                    );
                    let mut pos_jump: size_t = brotli_min_size_t(
                        position.wrapping_add(16 as libc::c_int as size_t),
        ...
        if sr.score > kMinScore {
            ...
            *num_literals = (*num_literals).wrapping_add(insert_length);
            ...
            if position > apply_random_heuristics {
                ...
                {
                    let kMargin: size_t = brotli_max_size_t(
                        (StoreLookaheadH42()).wrapping_sub(1 as libc::c_int as size_t),
                        4 as libc::c_int as size_t,
                    );
                    let mut pos_jump: size_t = brotli_min_size_t(
                        position.wrapping_add(16 as libc::c_int as size_t),
        ...
        if sr.score > kMinScore {
            ...
            *num_literals = (*num_literals).wrapping_add(insert_length);
            ...
            if position > apply_random_heuristics {
                ...
                {
                    let kMargin: size_t = brotli_max_size_t(
                        (StoreLookaheadH54()).wrapping_sub(1 as libc::c_int as size_t),
                        4 as libc::c_int as size_t,
                    );
                    let mut pos_jump: size_t = brotli_min_size_t(
                        position.wrapping_add(16 as libc::c_int as size_t),
        ...
        if sr.score > kMinScore {
            ...
            *num_literals = (*num_literals).wrapping_add(insert_length);
            ...
            if position > apply_random_heuristics {
                ...
                {
                    let kMargin: size_t = brotli_max_size_t(
                        (StoreLookaheadH35()).wrapping_sub(1 as libc::c_int as size_t),
                        4 as libc::c_int as size_t,
                    );
                    let mut pos_jump: size_t = brotli_min_size_t(
                        position.wrapping_add(16 as libc::c_int as size_t),
        ...
        if sr.score > kMinScore {
            ...
            *num_literals = (*num_literals).wrapping_add(insert_length);
            ...
            if position > apply_random_heuristics {
                ...
                {
                    let kMargin: size_t = brotli_max_size_t(
                        (StoreLookaheadH55()).wrapping_sub(1 as libc::c_int as size_t),
                        4 as libc::c_int as size_t,
                    );
                    let mut pos_jump: size_t = brotli_min_size_t(
                        position.wrapping_add(16 as libc::c_int as size_t),
        ...
        if sr.score > kMinScore {
            ...
            *num_literals = (*num_literals).wrapping_add(insert_length);
            ...
            if position > apply_random_heuristics {
                ...
                {
                    let kMargin: size_t = brotli_max_size_t(
                        (StoreLookaheadH65()).wrapping_sub(1 as libc::c_int as size_t),
                        4 as libc::c_int as size_t,
                    );
                    let mut pos_jump: size_t = brotli_min_size_t(
                        position.wrapping_add(16 as libc::c_int as size_t),
