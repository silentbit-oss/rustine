...
pub unsafe extern "C" fn test_named() {
    ...
    if ok as libc::c_int != 0 {} else {
        __assert_fail(
            ...
            b"void test_named()\0" as *const u8 as *const libc::c_char,
        );
    };
...
pub unsafe extern "C" fn test_rgb() {
    ...
    if ok as libc::c_int != 0 {} else {
        __assert_fail(
            ...
            b"void test_rgb()\0" as *const u8 as *const libc::c_char,
        );
    };
...
pub unsafe extern "C" fn test_rgba() {
    ...
    if ok as libc::c_int != 0 {} else {
        __assert_fail(
            ...
            b"void test_rgba()\0" as *const u8 as *const libc::c_char,
        );
    };
...
pub unsafe extern "C" fn test_hex() {
    ...
    if ok as libc::c_int != 0 {} else {
        __assert_fail(
            ...
            b"void test_hex()\0" as *const u8 as *const libc::c_char,
        );
    };
    if 0xff1e00ff as libc::c_uint == val as libc::c_uint {} else {
        __assert_fail(
...
pub unsafe extern "C" fn test_to_string() {
    ...
    {} else {
        __assert_fail(
            ...
            b"void test_to_string()\0" as *const u8 as *const libc::c_char,
        );
    };
