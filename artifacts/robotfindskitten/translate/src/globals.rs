...
lazy_static::lazy_static! {
    pub static ref MESSAGES: [&'static str; 288] = [
...
lazy_static! {
    pub static ref BOGUS_MESSAGES: std::sync::Mutex<[i32; 288]> =
        std::sync::Mutex::new([0; 288]);
}

lazy_static! {
    pub static ref USED_MESSAGES: std::sync::Mutex<Vec<i32>> = 
        std::sync::Mutex::new(vec![0; MESSAGES.len()]);
}
...
lazy_static! {
    pub static ref ROBOT: std::sync::Mutex<ScreenObject> = std::sync::Mutex::new(ScreenObject {
        x: 0,
        y: 0,
        color: 0,
        bold: false,
...
const MESSAGES_COUNT: usize = 288; // This should match the actual count of MESSAGES

lazy_static! {
    pub static ref BOGUS: std::sync::Mutex<[ScreenObject; MESSAGES_COUNT]> =
        std::sync::Mutex::new(std::array::from_fn(|_| ScreenObject {
            x: 0,
            y: 0,
            color: 0,
            bold: false,
