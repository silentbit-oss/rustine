 ...
 */
#[no_mangle]
pub extern "C" fn ti_hma_start(options: *const f64) -> i32 {
    let period: i32 = unsafe { *options } as i32;
    let periodsqrt: i32 = (period as f64).sqrt() as i32;
    period + periodsqrt - 2
}
...
pub unsafe extern "C" fn ti_hma(mut size: std::os::raw::c_int,
 ...
 -> std::os::raw::c_int {
    ...
    let buff_box = Box::from_raw(buff);
ti_buffer_free(buff_box);
