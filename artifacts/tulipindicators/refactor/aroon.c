...
int ti_aroon(int size, const double * const *inputs, const double *options, double * const *outputs)
{
  ...
  {
    helper_ti_aroon_1(&adown_idx, &aup_idx, &maxi, &mini, &max, &min, &bar, &j, high, low, adown, aup, period, scale, trail, i);
  }
