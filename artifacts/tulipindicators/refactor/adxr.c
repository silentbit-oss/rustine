...
int ti_adxr(int size, const double * const *inputs, const double *options, double * const *outputs)
{
  ...
  {
    helper_ti_adxr_1(&dmup, &dmdown, high, low, i);
  }
  ...
  {
    helper_ti_adxr_2(&output_idx, &dmup, &dmdown, &adx, high, low, period, output, per, invper, i, adxr, first_adxr);
  }
...
void helper_ti_adxr_1(double * const dmup_ref, double * const dmdown_ref, const double * const high, const double * const low, int i)
{
...
void helper_ti_adxr_2(unsigned int * const output_idx_ref, double * const dmup_ref, double * const dmdown_ref, double * const adx_ref, const double * const high, const double * const low, const int period, double * const output, const double per, const double invper, int i, ti_buffer * const adxr, const int first_adxr)
{
