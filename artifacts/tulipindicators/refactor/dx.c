...
int ti_dx(int size, const double * const *inputs, const double *options, double * const *outputs)
{
  ...
  {
    helper_ti_dx_1(&dmup, &dmdown, high, low, i);
  }
  ...
  {
    helper_ti_dx_2(&output_idx, &dmup, &dmdown, high, low, output, per, i);
  }
...
void helper_ti_dx_1(double * const dmup_ref, double * const dmdown_ref, const double * const high, const double * const low, int i)
{
...
void helper_ti_dx_2(unsigned int * const output_idx_ref, double * const dmup_ref, double * const dmdown_ref, const double * const high, const double * const low, double * const output, const double per, int i)
{
