...
int ti_fisher(int size, const double * const *inputs, const double *options, double * const *outputs)
{
  ...
  {
    helper_ti_fisher_1(&fisher_idx, &signal_idx, &maxi, &mini, &max, &min, &val1, &bar, &fish, &j, high, low, fisher, signal, trail, i);
  }
