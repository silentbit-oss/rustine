# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c"
# 24 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c"
...
# 25 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c" 2
...
# 26 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/utils/minctest.h" 1
# 59 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/utils/minctest.h"
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/stdio.h" 1
# 60 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/utils/minctest.h" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/math.h" 1
# 61 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/utils/minctest.h" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/time.h" 1
# 62 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/utils/minctest.h" 2
# 70 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/utils/minctest.h"
static int ltests = 0;
static int lfails = 0;
# 27 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/utils/buffer.h" 1
# 28 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/utils/buffer.h"
typedef struct {
...
# 28 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/utils/localbuffer.h" 1
# 29 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/string.h" 1
# 30 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c" 2
# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/stdlib.h" 1
# 31 "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c" 2
...
void compare_arrays(double *a, double *b, int size_a, int size_b) {
    ...
    do { ++ltests; if ((size_a) != (size_b)) { ++lfails; printf("%s:%d (%d != %d)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 42, (size_a), (size_b)); }} while (0);
    if (size_a != size_b) {
    ...
    for (i = 0; i < size_a; ++i) {
        do { ++ltests; if (fabs((double)(a[i])-(double)(b[i])) > 0.001) { ++lfails; printf("%s:%d (%f != %f)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 50, (double)(a[i]), (double)(b[i])); }} while (0);
    }
...
int get_array(FILE *fp, double *s) {
    ...
    if (line[0] != '{') {
        printf("Bad input\n");
        do { ++ltests; if (!(0)) { ++lfails; printf("%s:%d error \n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 85); }} while (0);
        return 0;
    }
...
void test_ind_name(FILE *fp, const char *name, int count) {
    ...
    do { ++ltests; if (((int)(o-options)) != (info->options)) { ++lfails; printf("%s:%d (%d != %d)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 137, ((int)(o-options)), (info->options)); }} while (0);
    ...
    {
        const int ret = info->indicator(input_size, (double const *const *)inputs, options, outputs);
        do { ++ltests; if (!(ret == 0)) { ++lfails; printf("%s:%d error \n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 160); }} while (0);
    ...
    if (info->indicator_ref) {
        ...
        const int ret = info->indicator_ref(input_size, (double const *const *)inputs, options, outputs);
        do { ++ltests; if (!(ret == 0)) { ++lfails; printf("%s:%d error \n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 176); }} while (0);
    ...
    if (info->stream_new) {
        ...
        for (int step_i = 0; step_i < step_count; ++step_i) {
            ...
            do { ++ltests; if (!(stream_ret == 0)) { ++lfails; printf("%s:%d error \n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 201); }} while (0);
            do { ++ltests; if (!(stream != 0)) { ++lfails; printf("%s:%d error \n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 202); }} while (0);
            ...
            for (int bar = 0; bar < input_size; bar += step) {
                ...
                do { ++ltests; if (!(ret == 0)) { ++lfails; printf("%s:%d error \n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 222); }} while (0);
            }

            int output_size = input_size - info->start(options);
            if (output_size < 0) output_size = 0;
            do { ++ltests; if ((ti_stream_get_progress(stream)) != (output_size)) { ++lfails; printf("%s:%d (%d != %d)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 227, (ti_stream_get_progress(stream)), (output_size)); }} while (0);
            for (i = 0; i < info->outputs; ++i) {
                compare_arrays(answers[i], outputs[i], answer_size, output_size);
            }
...
void test_candles(FILE *fp, int count) {
    ...
    tc_run(((1L<<26)-1), input_size, (TC_REAL const *const *)inputs, &config, output);
    ...
    do {
        ...
        do { ++ltests; if (!(info)) { ++lfails; printf("%s:%d error \n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 282); }} while (0);
        ...
        while ((num = strtok(0, " "))) {
            ...
            if (negate)
                do { ++ltests; if (!(!(tc_result_at(output, pos) & info->pattern))) { ++lfails; printf("%s:%d error \n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 290); }} while (0);
            else
                do { ++ltests; if (!((tc_result_at(output, pos) & info->pattern))) { ++lfails; printf("%s:%d error \n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 292); }} while (0);
        }
...
void test(const char *fname, int count) {
    ...
    if (!fp) {
        do { ++ltests; if (!(0)) { ++lfails; printf("%s:%d error \n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 316); }} while (0);
        return;
    }
    ...
    while ((line = next_line(fp))) {
        ...
        if (line[0] < 'a' || line[0] > 'z') {
            do { ++ltests; if (!(0)) { ++lfails; printf("%s:%d error \n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 326); }} while (0);
            continue;
        }
...
void test_version() {
    do { ++ltests; if (!(strcmp("0.9.2", ti_version()) == 0)) { ++lfails; printf("%s:%d error \n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 345); }} while (0);
    do { ++ltests; if (!(1746800254 == ti_build())) { ++lfails; printf("%s:%d error \n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 346); }} while (0);
    do { ++ltests; if (!(104 == ti_indicator_count())) { ++lfails; printf("%s:%d error \n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 347); }} while (0);

    do { ++ltests; if (!(strcmp("0.9.2", tc_version()) == 0)) { ++lfails; printf("%s:%d error \n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 349); }} while (0);
    do { ++ltests; if (!(1746800254 == tc_build())) { ++lfails; printf("%s:%d error \n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 350); }} while (0);
    do { ++ltests; if (!(26 == tc_candle_count())) { ++lfails; printf("%s:%d error \n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 351); }} while (0);

    do { ++ltests; if (!(strcmp("0.9.2", "0.9.2") == 0)) { ++lfails; printf("%s:%d error \n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 353); }} while (0);
    do { ++ltests; if ((1746800254) != (1746800254)) { ++lfails; printf("%s:%d (%d != %d)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 354, (1746800254), (1746800254)); }} while (0);
}


void test_buffer() {
    ti_buffer *b = ti_buffer_new(3);
    do { if ((b)->pushes >= (b)->size) { (b)->sum -= (b)->vals[(b)->index]; } (b)->sum += (5.0); (b)->vals[(b)->index] = (5.0); (b)->pushes += 1; (b)->index = ((b)->index + 1); if ((b)->index >= (b)->size) (b)->index = 0; } while (0); do { ++ltests; if (fabs((double)(b->sum)-(double)(5.0)) > 0.001) { ++lfails; printf("%s:%d (%f != %f)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 360, (double)(b->sum), (double)(5.0)); }} while (0);
    do { if ((b)->pushes >= (b)->size) { (b)->sum -= (b)->vals[(b)->index]; } (b)->sum += (5.0); (b)->vals[(b)->index] = (5.0); (b)->pushes += 1; (b)->index = ((b)->index + 1); if ((b)->index >= (b)->size) (b)->index = 0; } while (0); do { ++ltests; if (fabs((double)(b->sum)-(double)(10.0)) > 0.001) { ++lfails; printf("%s:%d (%f != %f)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 361, (double)(b->sum), (double)(10.0)); }} while (0);
    do { if ((b)->pushes >= (b)->size) { (b)->sum -= (b)->vals[(b)->index]; } (b)->sum += (1.0); (b)->vals[(b)->index] = (1.0); (b)->pushes += 1; (b)->index = ((b)->index + 1); if ((b)->index >= (b)->size) (b)->index = 0; } while (0); do { ++ltests; if (fabs((double)(b->sum)-(double)(11.0)) > 0.001) { ++lfails; printf("%s:%d (%f != %f)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 362, (double)(b->sum), (double)(11.0)); }} while (0);
    do { if ((b)->pushes >= (b)->size) { (b)->sum -= (b)->vals[(b)->index]; } (b)->sum += (1.0); (b)->vals[(b)->index] = (1.0); (b)->pushes += 1; (b)->index = ((b)->index + 1); if ((b)->index >= (b)->size) (b)->index = 0; } while (0); do { ++ltests; if (fabs((double)(b->sum)-(double)(7.0)) > 0.001) { ++lfails; printf("%s:%d (%f != %f)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 363, (double)(b->sum), (double)(7.0)); }} while (0);
    do { if ((b)->pushes >= (b)->size) { (b)->sum -= (b)->vals[(b)->index]; } (b)->sum += (3.0); (b)->vals[(b)->index] = (3.0); (b)->pushes += 1; (b)->index = ((b)->index + 1); if ((b)->index >= (b)->size) (b)->index = 0; } while (0); do { ++ltests; if (fabs((double)(b->sum)-(double)(5.0)) > 0.001) { ++lfails; printf("%s:%d (%f != %f)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 364, (double)(b->sum), (double)(5.0)); }} while (0);
    do { if ((b)->pushes >= (b)->size) { (b)->sum -= (b)->vals[(b)->index]; } (b)->sum += (1.0); (b)->vals[(b)->index] = (1.0); (b)->pushes += 1; (b)->index = ((b)->index + 1); if ((b)->index >= (b)->size) (b)->index = 0; } while (0); do { ++ltests; if (fabs((double)(b->sum)-(double)(5.0)) > 0.001) { ++lfails; printf("%s:%d (%f != %f)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 365, (double)(b->sum), (double)(5.0)); }} while (0);
    do { if ((b)->pushes >= (b)->size) { (b)->sum -= (b)->vals[(b)->index]; } (b)->sum += (2.0); (b)->vals[(b)->index] = (2.0); (b)->pushes += 1; (b)->index = ((b)->index + 1); if ((b)->index >= (b)->size) (b)->index = 0; } while (0); do { ++ltests; if (fabs((double)(b->sum)-(double)(6.0)) > 0.001) { ++lfails; printf("%s:%d (%f != %f)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 366, (double)(b->sum), (double)(6.0)); }} while (0);
    do { if ((b)->pushes >= (b)->size) { (b)->sum -= (b)->vals[(b)->index]; } (b)->sum += (3.0); (b)->vals[(b)->index] = (3.0); (b)->pushes += 1; (b)->index = ((b)->index + 1); if ((b)->index >= (b)->size) (b)->index = 0; } while (0); do { ++ltests; if (fabs((double)(b->sum)-(double)(6.0)) > 0.001) { ++lfails; printf("%s:%d (%f != %f)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 367, (double)(b->sum), (double)(6.0)); }} while (0);

    do { ++ltests; if (fabs((double)(((b)->vals[((b)->index + (b)->size - 1 + (0)) % (b)->size]))-(double)(3.0)) > 0.001) { ++lfails; printf("%s:%d (%f != %f)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 369, (double)(((b)->vals[((b)->index + (b)->size - 1 + (0)) % (b)->size])), (double)(3.0)); }} while (0);
    do { ++ltests; if (fabs((double)(((b)->vals[((b)->index + (b)->size - 1 + (-1)) % (b)->size]))-(double)(2.0)) > 0.001) { ++lfails; printf("%s:%d (%f != %f)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 370, (double)(((b)->vals[((b)->index + (b)->size - 1 + (-1)) % (b)->size])), (double)(2.0)); }} while (0);
    do { ++ltests; if (fabs((double)(((b)->vals[((b)->index + (b)->size - 1 + (-2)) % (b)->size]))-(double)(1.0)) > 0.001) { ++lfails; printf("%s:%d (%f != %f)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 371, (double)(((b)->vals[((b)->index + (b)->size - 1 + (-2)) % (b)->size])), (double)(1.0)); }} while (0);
    do { ++ltests; if (fabs((double)(((b)->vals[((b)->index + (b)->size - 1 + (-3)) % (b)->size]))-(double)(3.0)) > 0.001) { ++lfails; printf("%s:%d (%f != %f)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 372, (double)(((b)->vals[((b)->index + (b)->size - 1 + (-3)) % (b)->size])), (double)(3.0)); }} while (0);
...
void test_localbuffer() {
    ...
    typedef struct s {
        struct { double padding; int zero[4]; int offset_a; int size_a; int index_a; int padding_a; } buf_info;
    ...
    do { ((&stream)->buf_info).offset_a = *(&((&stream)->buf_info).offset_a-3) + *(&((&stream)->buf_info).offset_a-4); ((&stream)->buf_info).size_a = 5; ((&stream)->buf_info).index_a = -1; } while (0);

    do { ++ltests; if (((*((int*)(&((&stream)->buf_info)+1)-3) + *((int*)(&((&stream)->buf_info)+1)-4))) != (5)) { ++lfails; printf("%s:%d (%d != %d)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 395, ((*((int*)(&((&stream)->buf_info)+1)-3) + *((int*)(&((&stream)->buf_info)+1)-4))), (5)); }} while (0);

    do { int idx = ((&stream)->buf_info).index_a + 1; if (idx == ((&stream)->buf_info).size_a) { idx = 0; } *((double*)(&((&stream)->buf_info) + 1) + ((&stream)->buf_info).offset_a + idx) = 100; ((&stream)->buf_info).index_a = idx; } while (0);
    double get;
    do { int idx = ((&stream)->buf_info).index_a + 0; while (idx >= ((&stream)->buf_info).size_a) { idx -= ((&stream)->buf_info).size_a; } while (idx < 0) { idx += ((&stream)->buf_info).size_a; } get = *((double*)(&((&stream)->buf_info) + 1) + ((&stream)->buf_info).offset_a + idx); } while (0);
    do { ++ltests; if (fabs((double)(get)-(double)(100)) > 0.001) { ++lfails; printf("%s:%d (%f != %f)\n", "/home/enumclass/Documents/C2RustTranslation/bkp/tulipindicators/smoke.c", 400, (double)(get), (double)(100)); }} while (0);
...
int main() {
    ...
    do { const int ts = ltests; const int fs = lfails; const clock_t start = clock(); printf("\t%-16s", "buffer"); test_buffer(); printf("pass:%2d   fail:%2d   %4dms\n", (ltests-ts)-(lfails-fs), lfails-fs, (int)((clock() - start) * 1000 / CLOCKS_PER_SEC));} while (0);
    do { const int ts = ltests; const int fs = lfails; const clock_t start = clock(); printf("\t%-16s", "localbuffer"); test_localbuffer(); printf("pass:%2d   fail:%2d   %4dms\n", (ltests-ts)-(lfails-fs), lfails-fs, (int)((clock() - start) * 1000 / CLOCKS_PER_SEC));} while (0);
    do { const int ts = ltests; const int fs = lfails; const clock_t start = clock(); printf("\t%-16s", "version"); test_version(); printf("pass:%2d   fail:%2d   %4dms\n", (ltests-ts)-(lfails-fs), lfails-fs, (int)((clock() - start) * 1000 / CLOCKS_PER_SEC));} while (0);
