...
pub fn binn_int8(value: i8) -> Option<BinnStruct> {
	println!("\n* binn_int8");
    binn_value(0x21, Some(&[value as u8]), 0, None)
}
pub fn binn_int16(value: i16) -> Option<BinnStruct> {
	println!("\n* binn_int16");
    binn_value(0x41, Some(&value.to_ne_bytes()), 0, None)
}
pub fn binn_int32(value: i32) -> Option<BinnStruct> {
	println!("\n* binn_int32");
    binn_value(0x61, Some(&value.to_ne_bytes()), 0, None)
}
pub fn binn_uint8(value: u8) -> Option<BinnStruct> {
	println!("\n* binn_uint8");
    binn_value(0x20, Some(&[value]), 0, None)
}
pub fn binn_uint16(value: u16) -> Option<BinnStruct> {
	println!("\n* binn_uint16");
    let value_bytes = value.to_le_bytes();
    binn_value(0x40, Some(&value_bytes), 0, None)
}
pub fn binn_uint32(value: u32) -> Option<BinnStruct> {
	println!("\n* binn_uint32");
    binn_value(0x60, Some(&value.to_ne_bytes()), 0, None)
}
pub fn binn_float(value: f32) -> Option<BinnStruct> {
	println!("\n* binn_float");
    // Convert the float to bytes for safe handling
    let bytes = value.to_ne_bytes();
    binn_value(0x62, Some(&bytes), 0, None)
}
pub fn binn_double(value: f64) -> Option<BinnStruct> {
	println!("\n* binn_double");
    // Convert the f64 to bytes to pass to binn_value
    let bytes = value.to_ne_bytes();
    binn_value(0x82, Some(&bytes), 0, None)
}
pub fn binn_null() -> Option<BinnStruct> {
	println!("\n* binn_null");
    binn_value(0x00, None, 0, None)
}
pub fn binn_list_add_int8(list: &mut Option<BinnStruct>, value: i8) -> BOOL {
	println!("\n* binn_list_add_int8");
...
pub fn binn_list_add_int16(list: &mut Option<BinnStruct>, value: i16) -> BOOL {
	println!("\n* binn_list_add_int16");
    binn_list_add(list, 0x41, Some(&mut Some(Box::new(value))), 0)
}
pub fn binn_list_add_int32(list: &mut Option<BinnStruct>, value: i32) -> BOOL {
	println!("\n* binn_list_add_int32");
    binn_list_add(list, 0x61, Some(&mut Some(Box::new(value))), 0)
}
pub fn binn_list_add_uint8(list: &mut Option<BinnStruct>, value: u8) -> BOOL {
	println!("\n* binn_list_add_uint8");
    binn_list_add(list, 0x20, Some(&mut Some(Box::new(value))), 0)
}
pub fn binn_list_add_uint16(list: &mut Option<BinnStruct>, value: u16) -> BOOL {
...
pub fn binn_list_add_uint32(list: &mut Option<BinnStruct>, value: u32) -> BOOL {
	println!("\n* binn_list_add_uint32");
    binn_list_add(list, 0x60, Some(&mut Some(Box::new(value))), 0)
}
pub fn binn_list_add_float(list: &mut Option<BinnStruct>, value: f32) -> BOOL {
	println!("\n* binn_list_add_float");
    binn_list_add(list, 0x62, Some(&mut Some(Box::new(value))), 0)
}
pub fn binn_list_add_double(list: &mut Option<BinnStruct>, value: f64) -> BOOL {
	println!("\n* binn_list_add_double");
    binn_list_add(list, 0x82, Some(&mut Some(Box::new(value))), 0)
}
pub fn binn_list_add_null(list: &mut Option<BinnStruct>) -> BOOL {
	println!("\n* binn_list_add_null");
    binn_list_add(list, 0x00, None, 0)
}
pub fn binn_list_add_str(list: &mut Option<BinnStruct>, str: Option<&mut Option<Box<dyn std::any::Any>>>) -> BOOL {
	println!("\n* binn_list_add_str");
...
pub fn binn_map_set_int8(map: &mut Option<BinnStruct>, id: i32, value: i8) -> BOOL {
	println!("\n* binn_map_set_int8");
    let mut boxed_value = Box::new(value);
    binn_map_set(map, id, 0x21, Some(&mut Some(boxed_value)), 0)
}
pub fn binn_map_set_int16(map: &mut Option<BinnStruct>, id: i32, value: i16) -> BOOL {
	println!("\n* binn_map_set_int16");
...
pub fn binn_map_set_uint8(map: &mut Option<BinnStruct>, id: i32, value: u8) -> BOOL {
	println!("\n* binn_map_set_uint8");
    let mut boxed_value = Box::new(value) as Box<dyn std::any::Any>;
    binn_map_set(map, id, 0x20, Some(&mut Some(boxed_value)), 0)
}
pub fn binn_map_set_uint16(map: &mut Option<BinnStruct>, id: i32, value: u16) -> BOOL {
	println!("\n* binn_map_set_uint16");
    let mut boxed_value = Box::new(value);
...
pub fn binn_map_set_float(map: &mut Option<BinnStruct>, id: i32, value: f32) -> BOOL {
	println!("\n* binn_map_set_float");
    binn_map_set(map, id, 0x62, Some(&mut Some(Box::new(value))), 0)
}
pub fn binn_map_set_double(map: &mut Option<BinnStruct>, id: i32, value: f64) -> BOOL {
	println!("\n* binn_map_set_double");
    binn_map_set(map, id, 0x82, Some(&mut Some(Box::new(value))), 0)
}
pub fn binn_map_set_null(map: &mut Option<BinnStruct>, id: i32) -> BOOL {
	println!("\n* binn_map_set_null");
    binn_map_set(map, id, 0x00, Option::None, 0)
}
pub fn binn_map_set_str(map: &mut Option<BinnStruct>, id: i32, str: Option<&mut Option<Box<dyn std::any::Any>>>) -> BOOL {
...
pub fn binn_object_set_null(obj: &mut Option<BinnStruct>, key: Option<&str>) -> BOOL {
...
pub fn binn_int64(value: int64) -> Option<BinnStruct> {
	println!("\n* binn_int64");
    binn_value(0x81, Some(&value.to_ne_bytes()), 0, None)
}
pub fn binn_bool(value: BOOL) -> Option<BinnStruct> {
	println!("\n* binn_bool");
    binn_value(0x80061, Some(&value.to_ne_bytes()), 0, None)
}
pub fn binn_string(str: Option<&str>, freefn: Option<Box<dyn FnMut(Option<Box<()>>)>>) -> Option<BinnStruct> {
	println!("\n* binn_string");
...
pub fn binn_list_add_int64(list: &mut Option<BinnStruct>, value: int64) -> BOOL {
	println!("\n* binn_list_add_int64");
    binn_list_add(list, 0x81, Some(&mut Some(Box::new(value))), 0)
}
pub fn binn_list_add_bool(list: &mut Option<BinnStruct>, value: BOOL) -> BOOL {
    binn_list_add(list, 0x80061, Some(&mut Some(Box::new(value))), 0)
}
pub fn binn_map_set_int64(map: &mut Option<BinnStruct>, id: i32, value: i64) -> BOOL {
	println!("\n* binn_map_set_int64");
    binn_map_set(map, id, 0x81, Some(&mut Some(Box::new(value))), 0)
}
pub fn binn_map_set_bool(map: &mut Option<BinnStruct>, id: i32, value: BOOL) -> BOOL {
	println!("\n* binn_map_set_bool");
    let mut boxed_value = Some(Box::new(value) as Box<dyn std::any::Any>);
...
pub fn print_binn(map: Option<BinnStruct>) {
	println!("\n* print_binn");
...
pub fn binn_uint64(value: uint64) -> Option<BinnStruct> {
	println!("\n* binn_uint64");
    // Convert the uint64 value to bytes for safe passing to binn_value
    let value_bytes = value.to_le_bytes();
    binn_value(0x80, Some(&value_bytes), 0, None)
}
pub fn binn_list_add_uint64(list: &mut Option<BinnStruct>, value: u64) -> BOOL {
	println!("\n* binn_list_add_uint64");
    let mut boxed_value = Some(Box::new(value) as Box<dyn std::any::Any>);
    binn_list_add(list, 0x80, Some(&mut boxed_value), 0)
}
pub fn binn_list_add_list(list: &mut Option<BinnStruct>, list2: Option<&mut Option<BinnStruct>>) -> BOOL {
	println!("\n* binn_list_add_list");
    //let pvalue: Option<*mut u8> = list2.as_ref().and_then(|l| Some(l.as_mut().unwrap() as *mut BinnStruct as *mut u8));
    ...
    binn_list_add(
        list,
        0xE0,
        None,//.map(|v| unsafe { v as *mut Box<dyn std::any::Any>> }),
        list.as_ref().unwrap().size,
    )
}
pub fn binn_list_add_map(list: &mut Option<BinnStruct>, map: Option<*mut u8>) -> BOOL {
	println!("\n* binn_list_add_map");
...
pub fn binn_list_add_object(list: &mut Option<BinnStruct>, obj: Option<*mut u8>) -> BOOL {
...
pub fn binn_list_add_value(list: &mut Option<BinnStruct>, value: &mut Option<BinnStruct>) -> BOOL {
	println!("\n* binn_list_add_value");
    ...
    let mut temp_any: Option<Box<dyn std::any::Any>> = temp.map(|bx| Box::new(bx) as Box<dyn std::any::Any>);
    ...
    // Convert temp_any back to Option<BinnStruct>
...
pub fn binn_map_set_uint64(map: &mut Option<BinnStruct>, id: i32, value: u64) -> BOOL {
	println!("\n* binn_map_set_uint64");
    binn_map_set(map, id, 0x80, Some(&mut Some(Box::new(value))), 0)
}
pub fn binn_map_set_list(
    map: &mut Option<BinnStruct>,
    id: i32,
    list: Option<*mut u8>,
) -> BOOL {
	println!("\n* binn_map_set_list");
...
pub fn binn_object_set_value(
    ...
    let mut temp_any: Option<Box<dyn std::any::Any>> = value.take().map(|b| Box::new(b) as Box<dyn std::any::Any>);
...
pub fn test3() {
    ...
    let mut list: Option<BinnStruct> = None;
    let mut list_idx: usize = 0;
    let mut map: Option<BinnStruct> = None;
    let mut map_idx: usize = 0;
    let mut obj: Option<BinnStruct> = None;
    let mut obj_idx: usize = 0;
    let mut obj1: Option<BinnStruct> = None;
...
pub fn test2(use_int_compression: BOOL) {
    ...
    assert_eq!(binn_count(list.as_ref().map(|b| b as *const _ as *mut u8)), 0);
    assert_eq!(binn_count(map.as_ref().map(|b| b as *const _ as *mut u8)), 0);
    assert_eq!(binn_count(obj.as_ref().map(|b| b as *const _ as *mut u8)), 0);
    ...
    assert_eq!(binn_type(list.as_ref().map(|b| b as *const _ as *mut u8)), 0x0);
    assert_eq!(binn_type(map.as_ref().map(|b| b as *const _ as *mut u8)), 0x0);
    assert_eq!(binn_type(obj.as_ref().map(|b| b as *const _ as *mut u8)), 0x0);
    
    let mut binn_ptr: Option<BinnStruct> = None;
    assert_eq!(binn_list_get_value(list.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), 1, Some(&mut binn_ptr)), 0);
    ...
    assert_eq!(binn_map_get_value(map.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), 1001, Some(&mut binn_ptr)), 0);
    ...
    assert_eq!(binn_object_get_value(obj.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), Some("int"), Some(&mut binn_ptr)), 0);
    ...
    assert_eq!(binn_list_get_int32(list.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), 1, Some(&mut vint32)), 0);
    //assert_eq!(vint32, 123);
    
    assert_eq!(binn_map_get_int32(map.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), 1001, Some(&mut vint32)), 0);
    //assert_eq!(vint32, 456);
    
    assert_eq!(binn_object_get_int32(obj.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), Some("int"), Some(&mut vint32)), false);
    //assert_eq!(vint32, 789);
    
    assert_eq!(binn_list_get_double(list.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), 2, Some(&mut vdouble)), 0);
    //assert_eq!(vdouble, 1.23);
    
    assert_eq!(binn_map_get_double(map.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), 1002, Some(&mut vdouble)), 0);
    //assert_eq!(vdouble, 4.56);
    
    assert_eq!(binn_object_get_double(obj.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), Some("double"), Some(&mut vdouble)), false);
    //assert_eq!(vdouble, 7.89);
    
    assert_eq!(binn_list_get_bool(list.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), 3, Some(&mut vbool_value)), 0);
    //assert_eq!(vbool_value, 1);
    
    assert_eq!(binn_map_get_bool(map.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), 1003, Some(&mut vbool_value)), 0);
    //assert_eq!(vbool_value, 1);
    
    assert_eq!(binn_object_get_bool(obj.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), Some("bool"), Some(&mut vbool_value)), 0);
    //assert_eq!(vbool_value, 1);
    
    let mut pstr_ptr: Option<String> = None;
    assert_eq!(binn_list_get_str(list.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), 4, Some(&mut pstr_ptr)), 0);
    assert!(pstr_ptr.is_none());
    //assert_eq!(pstr_ptr.as_ref().unwrap(), str_list);
    
    pstr_ptr = None;
    assert_eq!(binn_map_get_str(map.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), 1004, Some(&mut pstr_ptr)), 0);
    assert!(pstr_ptr.is_none());
    //assert_eq!(pstr_ptr.as_ref().unwrap(), str_map);
    
    pstr_ptr = None;
    assert_eq!(binn_object_get_str(obj.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), Some("text"), Some(&mut pstr_ptr)), 0);
    assert!(pstr_ptr.is_none());
    //assert_eq!(pstr_ptr.as_ref().unwrap(), str_obj);
    
    let mut blob_ptr: Option<Box<dyn Any>> = None;
    let mut blob_size = 0;
    assert_eq!(binn_list_get_blob(list.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), 5, Some(&mut blob_ptr), Some(&mut blob_size)), 0);
    assert!(blob_ptr.is_none());
    assert_eq!(blob_size, blobsize);
    
    blob_ptr = None;
    blob_size = 0;
    assert_eq!(binn_map_get_blob(map.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), 1005, Some(&mut blob_ptr), Some(&mut blob_size)), 0);
    assert!(blob_ptr.is_none());
    assert_eq!(blob_size, blobsize);
    
    blob_ptr = None;
    blob_size = 0;
    assert_eq!(binn_object_get_blob(obj.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), Some("blob"), Some(&mut blob_ptr), Some(&mut blob_size)), false);
    assert!(blob_ptr.is_none());
    assert_eq!(blob_size, blobsize);
    
    assert_eq!(binn_list_int32(list.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), 1), 0);
    assert_eq!(binn_map_int32(map.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), 1001), 0);
    assert_eq!(binn_object_int32(obj.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), Some("int")), 0);
    
    assert_eq!(binn_list_double(list.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), 2), 0.);
    assert_eq!(binn_map_double(map.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), 1002), 0.);
    assert_eq!(binn_object_double(obj.as_ref().map(|b| unsafe { std::slice::from_raw_parts(b as *const _ as *const u8, b.size as usize) }), Some("double")), 0.);
}
pub fn test1() {
	println!("\n* test1");
    let fix_size = 512;
    ...
    assert!(binn_new(0xE1, -1, None).is_none());
    assert!(binn_new(0xE1, 3 - 1, None).is_some());
    ...
    let mut temp_value: Option<BinnStruct> = None;
