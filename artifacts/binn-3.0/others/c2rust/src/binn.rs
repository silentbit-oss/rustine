...
pub unsafe extern "C" fn binn_get_type_info(
    ...
    loop {
        if long_type < 0 as libc::c_int {
            current_block_11 = 16246375042792146512;
            break;
        }
        ...
        224 | 225 | 226 => {
            if !(item.is_null() || size < 0 as libc::c_int) {
                if size < 3 as libc::c_int {
                    if !pointer.is_null() {
                        current_block = 6187101307713533361;
                    } else {
...
#[no_mangle]
pub unsafe extern "C" fn binn_get_ptr_type(mut ptr: *mut libc::c_void) -> libc::c_int {
    if ptr.is_null() {
        return 0 as libc::c_int;
    }
...
pub unsafe extern "C" fn compress_int(
    ...
    match type_0 {
        129 => {
            ...
            current_block = 16757384531215063379;
        }
        97 => {
        ...
        128 => {
            ...
            current_block = 5144099900914422942;
        }
        96 => {
    ...
    match current_block {
        16757384531215063379 => {
            if vint >= 0 as libc::c_int as int64 {
                ...
                current_block = 10298496546068751698;
            }
        }
        _ => {}
    }
...
pub unsafe extern "C" fn AddValue(
    ...
    if pvalue.is_null() {
        ...
        match storage_type {
            ...
            192 | 160 => {
                if size == 0 as libc::c_int {
                    ...
                    current_block_1 = 2333729166368543583;
                }
            }
            _ => {
                current_block_1 = 2333729166368543583;
        ...
        match current_block_1 {
            2333729166368543583 => return 0 as libc::c_int,
            _ => {}
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn binn_buf_type(mut pbuf: *mut libc::c_void) -> libc::c_int {
    let mut type_0: libc::c_int = 0;
    if IsValidBinnHeader(
        pbuf,
        &mut type_0,
...
#[no_mangle]
pub unsafe extern "C" fn binn_buf_count(mut pbuf: *mut libc::c_void) -> libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn binn_buf_size(mut pbuf: *mut libc::c_void) -> libc::c_int {
...
pub unsafe extern "C" fn binn_is_valid_ex(
    ...
    loop {
        ...
        p = AdvanceDataPos(p, plimit);
        if p.is_null() || p < base {
            current_block = 8154522637798556438;
            break;
        }
        i += 1;
        i;
    ...
    match current_block {
        8154522637798556438 => return 0 as libc::c_int,
        _ => {
            if !ptype.is_null() && *ptype == 0 as libc::c_int {
                *ptype = type_0;
            }
...
pub unsafe extern "C" fn binn_read_pair(
    ...
    loop {
        ...
        counter;
        if counter == pos {
            current_block = 7619156784685012706;
            break;
        }
        p = AdvanceDataPos(p, plimit);
        if p.is_null() || p < base {
...
pub unsafe extern "C" fn GetWriteConvertedData(
    ...
    if (*ppvalue).is_null() {
        ...
        match type_0 {
            ...
            160 | 192 => {
                if *psize == 0 as libc::c_int {
                    ...
                    current_block_4 = 7919806596259138728;
                }
            }
            _ => {
                current_block_4 = 7919806596259138728;
        ...
        match current_block_4 {
            7919806596259138728 => return 0 as libc::c_int,
            _ => {}
        }
    }
    match type_0 {
    ...
    if !item.is_null() {
        ...
        match storage_type {
            ...
            160 => {
                ...
                current_block_19 = 1350687994066923870;
            }
            192 | 224 => {
                current_block_19 = 1350687994066923870;
            }
    ...
    if type_family((*value).type_0) == 0xf2 as libc::c_int {
        ...
        match (*value).type_0 {
            98 => {
                ...
                current_block = 17857968898109395173;
            }
            130 => {
                current_block = 17857968898109395173;
            }
            ...
            524385 => {
                ...
                current_block = 10514707514056120675;
            }
            _ => return 0 as *mut libc::c_char,
        }
        match current_block {
            10514707514056120675 => {}
            _ => {
                snprintf(
                    buf.as_mut_ptr(),
                    ::core::mem::size_of::<[libc::c_char; 128]>() as libc::c_ulong,
