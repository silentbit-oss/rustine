...
unsafe extern "C" fn lodepng_mulofl(
    ...
    *result = a * b;
    return (a != 0 as libc::c_int as size_t && *result / a != b) as libc::c_int;
}
...
unsafe extern "C" fn uivector_resize(
    ...
    if allocsize > (*p).allocsize {
        let mut newsize: size_t = allocsize
            .wrapping_add((*p).allocsize >> 1 as libc::c_uint);
        let mut data: *mut libc::c_void = lodepng_realloc(
            (*p).data as *mut libc::c_void,
            newsize,
        );
        if !data.is_null() {
            (*p).allocsize = newsize;
...
unsafe extern "C" fn uivector_push_back(
    ...
    if uivector_resize(p, ((*p).size).wrapping_add(1 as libc::c_int as size_t)) == 0 {
        return 0 as libc::c_int as libc::c_uint;
    }
    *((*p).data)
        .offset(((*p).size).wrapping_sub(1 as libc::c_int as size_t) as isize) = c;
    return 1 as libc::c_int as libc::c_uint;
}
unsafe extern "C" fn ucvector_reserve(
    ...
    if size > (*p).allocsize {
        let mut newsize: size_t = size.wrapping_add((*p).allocsize >> 1 as libc::c_uint);
        let mut data: *mut libc::c_void = lodepng_realloc(
            (*p).data as *mut libc::c_void,
            newsize,
        );
...
unsafe extern "C" fn alloc_string_sized(
    ...
    let mut out: *mut libc::c_char = lodepng_malloc(
        insize.wrapping_add(1 as libc::c_int as size_t),
    ) as *mut libc::c_char;
    if !out.is_null() {
...
unsafe extern "C" fn writeBits(
    ...
    if nbits == 1 as libc::c_int as size_t {
        if (*writer).bp as libc::c_uint & 7 as libc::c_uint
            == 0 as libc::c_int as libc::c_uint
        {
            if ucvector_resize(
                (*writer).data,
                ((*(*writer).data).size).wrapping_add(1 as libc::c_int as size_t),
            ) == 0
            {
                return;
            }
            *((*(*writer).data).data)
                .offset(
                    ((*(*writer).data).size).wrapping_sub(1 as libc::c_int as size_t)
                        as isize,
                ) = 0 as libc::c_int as libc::c_uchar;
        }
        let ref mut fresh2 = *((*(*writer).data).data)
            .offset(
                ((*(*writer).data).size).wrapping_sub(1 as libc::c_int as size_t)
                    as isize,
            );
        *fresh2 = (*fresh2 as libc::c_uint
        ...
        while i != nbits {
            ...
            let ref mut fresh3 = *((*(*writer).data).data)
                .offset(
                    ((*(*writer).data).size).wrapping_sub(1 as libc::c_int as size_t)
                        as isize,
                );
...
unsafe extern "C" fn writeBitsReversed(
    ...
    while i != nbits {
        ...
        let ref mut fresh4 = *((*(*writer).data).data)
            .offset(
                ((*(*writer).data).size).wrapping_sub(1 as libc::c_int as size_t)
                    as isize,
            );
        *fresh4 = (*fresh4 as libc::c_int
            | ((value >> nbits.wrapping_sub(1 as libc::c_uint as size_t).wrapping_sub(i)
...
unsafe extern "C" fn ensureBits9(mut reader: *mut LodePNGBitReader, mut nbits: size_t) {
    ...
    if start.wrapping_add(1 as libc::c_uint as size_t) < size {
        (*reader)
            .buffer = *((*reader).data)
            .offset(start.wrapping_add(0 as libc::c_int as size_t) as isize)
            as libc::c_uint
            | (*((*reader).data)
                .offset(start.wrapping_add(1 as libc::c_int as size_t) as isize)
                as libc::c_uint) << 8 as libc::c_uint;
        (*reader).buffer >>= (*reader).bp & 7 as libc::c_uint as size_t;
    } else {
        (*reader).buffer = 0 as libc::c_int as libc::c_uint;
        if start.wrapping_add(0 as libc::c_uint as size_t) < size {
            (*reader)
                .buffer = *((*reader).data)
                .offset(start.wrapping_add(0 as libc::c_int as size_t) as isize)
                as libc::c_uint;
...
unsafe extern "C" fn ensureBits17(mut reader: *mut LodePNGBitReader, mut nbits: size_t) {
    let mut start: size_t = (*reader).bp >> 3 as libc::c_uint;
    let mut size: size_t = (*reader).size;
    if start.wrapping_add(2 as libc::c_uint as size_t) < size {
        (*reader)
            .buffer = *((*reader).data)
            .offset(start.wrapping_add(0 as libc::c_int as size_t) as isize)
            as libc::c_uint
            | (*((*reader).data)
                ...
                as libc::c_uint) << 8 as libc::c_uint
            | (*((*reader).data)
                .offset(start.wrapping_add(2 as libc::c_int as size_t) as isize)
...
unsafe extern "C" fn ensureBits25(mut reader: *mut LodePNGBitReader, mut nbits: size_t) {
    let mut start: size_t = (*reader).bp >> 3 as libc::c_uint;
    let mut size: size_t = (*reader).size;
    if start.wrapping_add(3 as libc::c_uint as size_t) < size {
        (*reader)
            .buffer = *((*reader).data)
            .offset(start.wrapping_add(0 as libc::c_int as size_t) as isize)
            as libc::c_uint
            ...
            | (*((*reader).data)
                ...
                as libc::c_uint) << 16 as libc::c_uint
            | (*((*reader).data)
                .offset(start.wrapping_add(3 as libc::c_int as size_t) as isize)
...
unsafe extern "C" fn ensureBits32(mut reader: *mut LodePNGBitReader, mut nbits: size_t) {
    let mut start: size_t = (*reader).bp >> 3 as libc::c_uint;
    let mut size: size_t = (*reader).size;
    if start.wrapping_add(4 as libc::c_uint as size_t) < size {
        (*reader)
            .buffer = *((*reader).data)
            .offset(start.wrapping_add(0 as libc::c_int as size_t) as isize)
            as libc::c_uint
        ...
        (*reader).buffer
            |= ((*((*reader).data)
                .offset(start.wrapping_add(4 as libc::c_int as size_t) as isize)
                as libc::c_uint) << 24 as libc::c_uint)
                << (8 as libc::c_uint as size_t)
                    .wrapping_sub((*reader).bp & 7 as libc::c_uint as size_t);
    } else {
        (*reader).buffer = 0 as libc::c_int as libc::c_uint;
        if start.wrapping_add(0 as libc::c_uint as size_t) < size {
            (*reader).buffer
...
unsafe extern "C" fn HuffmanTree_makeTable(mut tree: *mut HuffmanTree) -> libc::c_uint {
    ...
    let mut maxlens: *mut libc::c_uint = lodepng_malloc(
    ...
    (*tree)
        .table_len = lodepng_malloc(
        size.wrapping_mul(::core::mem::size_of::<libc::c_uchar>() as libc::c_ulong),
    ) as *mut libc::c_uchar;
    (*tree)
        .table_value = lodepng_malloc(
        size.wrapping_mul(::core::mem::size_of::<libc::c_ushort>() as libc::c_ulong),
        ...
        if !(l_2 == 0 as libc::c_int as libc::c_uint) {
            ...
            if l_2 <= 9 as libc::c_uint {
                ...
                let mut maxlen: libc::c_uint = *((*tree).table_len)
                    .offset(index_1 as isize) as libc::c_uint;
                let mut tablelen: libc::c_uint = maxlen.wrapping_sub(9 as libc::c_uint);
                ...
                while j_0 < num_0 {
                    let mut reverse2: libc::c_uint = reverse >> 9 as libc::c_uint;
                    let mut index2: libc::c_uint = start
                        .wrapping_add(
    ...
    if numpresent < 2 as libc::c_int as size_t {
        i = 0 as libc::c_int as size_t;
        while i < size {
...
unsafe extern "C" fn HuffmanTree_makeFromLengths(
    ...
    let mut i: libc::c_uint = 0;
    (*tree)
        .lengths = lodepng_malloc(
        numcodes.wrapping_mul(::core::mem::size_of::<libc::c_uint>() as libc::c_ulong),
    ) as *mut libc::c_uint;
    ...
    if (*lists).nextfree >= (*lists).numfree {
        ...
        while i != (*lists).memsize {
            if (*((*lists).memory).offset(i as isize)).in_use == 0 {
                ...
                let ref mut fresh10 = *((*lists).freelist).offset(fresh9 as isize);
                *fresh10 = &mut *((*lists).memory).offset(i as isize) as *mut BPMNode;
            }
            i = i.wrapping_add(1);
            i;
        }
...
unsafe extern "C" fn bpmnode_sort(mut leaves: *mut BPMNode, mut num: size_t) {
    ...
    while width < num {
        let mut a: *mut BPMNode = if counter & 1 as libc::c_int as size_t != 0 {
            mem
        } else {
            leaves
        };
        let mut b: *mut BPMNode = if counter & 1 as libc::c_int as size_t != 0 {
            leaves
        } else {
            mem
        };
        ...
        while p < num {
            ...
            let mut r: size_t = if p.wrapping_add(2 as libc::c_int as size_t * width)
                > num
            {
                num
            } else {
                p.wrapping_add(2 as libc::c_int as size_t * width)
            };
            let mut i: size_t = p;
            let mut j: size_t = q;
            let mut k: size_t = 0;
            ...
            p = p.wrapping_add(2 as libc::c_int as size_t * width);
        }
        counter = counter.wrapping_add(1);
        counter;
        width = width * 2 as libc::c_int as size_t;
    }
    if counter & 1 as libc::c_int as size_t != 0 {
        lodepng_memcpy(
...
unsafe extern "C" fn boundaryPM(
    ...
    let mut lastindex: libc::c_uint = (**((*lists).chains1).offset(c as isize)).index;
    if c == 0 as libc::c_int {
        ...
        *fresh18 = bpmnode_create(
        ...
        if (num + 1 as libc::c_int)
            < (2 as libc::c_int as size_t * numpresent)
...
pub unsafe extern "C" fn lodepng_huffman_code_lengths(
    ...
    if numcodes == 0 as libc::c_int as size_t {
    ...
    leaves = lodepng_malloc(
        numcodes.wrapping_mul(::core::mem::size_of::<BPMNode>() as libc::c_ulong),
    ) as *mut BPMNode;
    if leaves.is_null() {
        return 83 as libc::c_int as libc::c_uint;
    }
    ...
    if numpresent == 0 as libc::c_int as size_t {
    ...
    } else if numpresent == 1 as libc::c_int as size_t {
        *lengths
            .offset(
        ...
        *lengths
        ...
        lists
            ...
            (lists.memsize as libc::c_ulong)
                .wrapping_mul(::core::mem::size_of::<*mut BPMNode>() as libc::c_ulong),
        ) as *mut *mut BPMNode;
        lists
        ...
        if error == 0 {
            ...
            while i != lists.memsize {
                ...
                *fresh20 = &mut *(lists.memory).offset(i as isize) as *mut BPMNode;
                i = i.wrapping_add(1);
                i;
            }
            bpmnode_create(
            ...
            while i != lists.listsize {
                ...
                *fresh21 = &mut *(lists.memory).offset(0 as libc::c_int as isize)
                    as *mut BPMNode;
                let ref mut fresh22 = *(lists.chains1).offset(i as isize);
                *fresh22 = &mut *(lists.memory).offset(1 as libc::c_int as isize)
                    as *mut BPMNode;
                i = i.wrapping_add(1);
                i;
            }
...
unsafe extern "C" fn HuffmanTree_makeFromFrequencies(
    ...
    let mut error: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    while *frequencies.offset(numcodes.wrapping_sub(1 as libc::c_int as size_t) as isize)
        == 0 && numcodes > mincodes
    {
...
unsafe extern "C" fn generateFixedLitLenTree(
    ...
    let mut i: libc::c_uint = 0;
    let mut error: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut bitlen: *mut libc::c_uint = lodepng_malloc(
...
unsafe extern "C" fn huffmanDecodeSymbol(
    ...
    let mut code: libc::c_ushort = peekBits(reader, 9 as libc::c_uint as size_t)
        as libc::c_ushort;
    let mut l: libc::c_ushort = *((*codetree).table_len).offset(code as isize)
        as libc::c_ushort;
    let mut value: libc::c_ushort = *((*codetree).table_value).offset(code as isize);
...
unsafe extern "C" fn getTreeInflateDynamic(
    ...
    if ((*reader).bitsize).wrapping_sub((*reader).bp) < 14 as libc::c_int as size_t {
                ...
                if bitlen_ll.is_null() || bitlen_d.is_null() {
                    ...
                    while i < HLIT.wrapping_add(HDIST) {
                        ...
                        if code <= 15 as libc::c_int as libc::c_uint {
                            ...
                            let mut replength: libc::c_uint = 3 as libc::c_int
                                as libc::c_uint;
                            ...
                            let mut replength_0: libc::c_uint = 3 as libc::c_int
                                as libc::c_uint;
                            ...
                            let mut replength_1: libc::c_uint = 11 as libc::c_int
                                as libc::c_uint;
    ...
    while error == 0 && done == 0 {
            ...
            && code_ll <= 285 as libc::c_int as libc::c_uint
        {
            ...
            if numextrabits_l != 0 as libc::c_int as libc::c_uint {
                ...
                length = length
                    .wrapping_add(readBits(reader, numextrabits_l as size_t) as size_t);
            }
            ...
            if code_d > 29 as libc::c_int as libc::c_uint {
                ...
                if distance as size_t > start {
                    ...
                    (*out).size = ((*out).size).wrapping_add(length);
                    if (distance as size_t) < length {
                        ...
                        start = start.wrapping_add(distance as size_t);
...
unsafe extern "C" fn inflateNoCompression(
    ...
    let mut error: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    bytepos = ((*reader).bp).wrapping_add(7 as libc::c_uint as size_t)
        >> 3 as libc::c_uint;
    if bytepos.wrapping_add(4 as libc::c_int as size_t) >= size {
        return 52 as libc::c_int as libc::c_uint;
    }
    LEN = (*((*reader).data).offset(bytepos as isize) as libc::c_uint)
        .wrapping_add(
            (*((*reader).data)
                .offset(bytepos.wrapping_add(1 as libc::c_int as size_t) as isize)
                as libc::c_uint) << 8 as libc::c_uint,
        );
    bytepos = bytepos.wrapping_add(2 as libc::c_int as size_t);
    ...
    if LEN != 0 {
        ...
        bytepos = bytepos.wrapping_add(LEN as size_t);
    }
...
unsafe extern "C" fn lodepng_inflatev(
    ...
    let mut error: libc::c_uint = LodePNGBitReader_init(&mut reader, in_0, insize);
    if error != 0 {
        return error;
    }
    while BFINAL == 0 {
        let mut BTYPE: libc::c_uint = 0;
        if (reader.bitsize).wrapping_sub(reader.bp) < 3 as libc::c_int as size_t {
            return 52 as libc::c_int as libc::c_uint;
        }
...
pub unsafe extern "C" fn lodepng_inflate(
    ...
    let mut error: libc::c_uint = lodepng_inflatev(&mut v, in_0, insize, settings);
    *out = v.data;
    *outsize = v.size;
    return error;
}
...
unsafe extern "C" fn searchCodeIndex(
    ...
    let mut right: size_t = array_size.wrapping_sub(1 as libc::c_int as size_t);
    while left <= right {
        let mut mid: size_t = left.wrapping_add(right) >> 1 as libc::c_int;
        if *array.offset(mid as isize) as size_t >= value {
            right = mid.wrapping_sub(1 as libc::c_int as size_t);
        } else {
            left = mid.wrapping_add(1 as libc::c_int as size_t);
        }
    }
...
unsafe extern "C" fn addLengthDistance(
    ...
    let mut extra_length: libc::c_uint = length
        .wrapping_sub(LENGTHBASE[length_code as usize] as size_t) as libc::c_uint;
    ...
    let mut extra_distance: libc::c_uint = distance
        .wrapping_sub(DISTANCEBASE[dist_code as usize] as size_t) as libc::c_uint;
    let mut pos: size_t = (*values).size;
    let mut ok: libc::c_uint = uivector_resize(
        values,
        ((*values).size).wrapping_add(4 as libc::c_int as size_t),
    );
    if ok != 0 {
        *((*values).data)
            .offset(
                pos.wrapping_add(0 as libc::c_int as size_t) as isize,
            ) = length_code.wrapping_add(257 as libc::c_int as libc::c_uint);
        *((*values).data)
            .offset(
                pos.wrapping_add(1 as libc::c_int as size_t) as isize,
            ) = extra_length;
        *((*values).data)
            .offset(pos.wrapping_add(2 as libc::c_int as size_t) as isize) = dist_code;
        *((*values).data)
            .offset(
                pos.wrapping_add(3 as libc::c_int as size_t) as isize,
            ) = extra_distance;
    }
}
...
unsafe extern "C" fn hash_init(
    ...
    (*hash)
        .chain = lodepng_malloc(
        (::core::mem::size_of::<libc::c_ushort>() as libc::c_ulong)
            .wrapping_mul(windowsize as libc::c_ulong),
    ) as *mut libc::c_ushort;
    (*hash)
        .zeros = lodepng_malloc(
        (::core::mem::size_of::<libc::c_ushort>() as libc::c_ulong)
            .wrapping_mul(windowsize as libc::c_ulong),
    ) as *mut libc::c_ushort;
    (*hash)
        .headz = lodepng_malloc(
        (::core::mem::size_of::<libc::c_int>() as libc::c_ulong)
            .wrapping_mul(
                MAX_SUPPORTED_DEFLATE_LENGTH.wrapping_add(1 as libc::c_int as size_t),
            ),
    ) as *mut libc::c_int;
    (*hash)
        .chainz = lodepng_malloc(
        (::core::mem::size_of::<libc::c_ushort>() as libc::c_ulong)
            .wrapping_mul(windowsize as libc::c_ulong),
    ) as *mut libc::c_ushort;
    ...
    i = 0 as libc::c_int as libc::c_uint;
    while i as size_t <= MAX_SUPPORTED_DEFLATE_LENGTH {
...
unsafe extern "C" fn getHash(
    ...
    let mut result: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    if pos.wrapping_add(2 as libc::c_int as size_t) < size {
        result
            ^= (*data.offset(pos.wrapping_add(0 as libc::c_int as size_t) as isize)
                as libc::c_uint) << 0 as libc::c_uint;
        result
            ^= (*data.offset(pos.wrapping_add(1 as libc::c_int as size_t) as isize)
                as libc::c_uint) << 4 as libc::c_uint;
        result
            ^= (*data.offset(pos.wrapping_add(2 as libc::c_int as size_t) as isize)
                as libc::c_uint) << 8 as libc::c_uint;
    } else {
...
unsafe extern "C" fn countZeros(
    ...
    let mut end: *const libc::c_uchar = start
        .offset(MAX_SUPPORTED_DEFLATE_LENGTH as isize);
...
unsafe extern "C" fn encodeLZ77(
    ...
    let mut i: libc::c_uint = 0;
    let mut error: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut maxchainlength: libc::c_uint = if windowsize
    ...
    let mut maxlazymatch: libc::c_uint = (if windowsize
        >= 8192 as libc::c_int as libc::c_uint
    {
    ...
    if nicematch as size_t > MAX_SUPPORTED_DEFLATE_LENGTH {
    ...
    while pos < insize {
        let mut wpos: size_t = pos
            & windowsize.wrapping_sub(1 as libc::c_int as libc::c_uint) as size_t;
        ...
        if usezeros != 0 && hashval == 0 as libc::c_int as libc::c_uint {
            if numzeros == 0 as libc::c_int as libc::c_uint {
                ...
                || *in_0
                    .offset(
                        pos
                            .wrapping_add(numzeros as size_t)
        ...
        loop {
            ...
            current_offset = (if hashpos as size_t <= wpos {
                ...
                wpos.wrapping_sub(hashpos as size_t).wrapping_add(windowsize as size_t)
            }) as libc::c_uint;
            ...
            if current_offset > 0 as libc::c_int as libc::c_uint {
                ...
                backptr = &*in_0
                    .offset(pos.wrapping_sub(current_offset as size_t) as isize)
                    as *const libc::c_uchar;
                if numzeros >= 3 as libc::c_int as libc::c_uint {
                    let mut skip: libc::c_uint = *((*hash).zeros)
                        .offset(hashpos as isize) as libc::c_uint;
                    if skip > numzeros {
                        skip = numzeros;
                    }
        ...
        if lazymatching != 0 {
            if lazy == 0 && length >= 3 as libc::c_int as libc::c_uint
                && length <= maxlazymatch
                && (length as size_t) < MAX_SUPPORTED_DEFLATE_LENGTH
            {
                    ...
                    > lazylength.wrapping_add(1 as libc::c_int as libc::c_uint)
                {
                    if uivector_push_back(
                        ...
                        *in_0
                            .offset(
                                pos.wrapping_sub(1 as libc::c_int as size_t) as isize,
                            ) as libc::c_uint,
                    ) == 0
                    {
                        error = 83 as libc::c_int as libc::c_uint;
...
unsafe extern "C" fn deflateNoCompression(
    ...
    let mut numdeflateblocks: size_t = datasize
        .wrapping_add(65534 as libc::c_uint as size_t) / 65535 as libc::c_uint as size_t;
    ...
    while i != numdeflateblocks {
        ...
        BFINAL = (i == numdeflateblocks.wrapping_sub(1 as libc::c_int as size_t))
            as libc::c_int as libc::c_uint;
        BTYPE = 0 as libc::c_int as libc::c_uint;
        LEN = 65535 as libc::c_int as libc::c_uint;
        if datasize.wrapping_sub(datapos as size_t) < 65535 as libc::c_uint as size_t {
        ...
        firstbyte = BFINAL
            ...
            as libc::c_uchar;
        *((*out).data)
            .offset(pos.wrapping_add(0 as libc::c_int as size_t) as isize) = firstbyte;
        *((*out).data)
            .offset(
                pos.wrapping_add(1 as libc::c_int as size_t) as isize,
        ...
        *((*out).data)
            .offset(
                pos.wrapping_add(2 as libc::c_int as size_t) as isize,
        ...
        *((*out).data)
            .offset(
                pos.wrapping_add(4 as libc::c_int as size_t) as isize,
...
unsafe extern "C" fn writeLZ77data(
    ...
    while i != (*lz77_encoded).size {
        ...
        if val > 256 as libc::c_int as libc::c_uint {
            let mut length_index: libc::c_uint = val
                .wrapping_sub(257 as libc::c_int as libc::c_uint);
            let mut n_length_extra_bits: libc::c_uint = LENGTHEXTRA[length_index
                as usize];
            i = i.wrapping_add(1);
            let mut length_extra_bits: libc::c_uint = *((*lz77_encoded).data)
                .offset(i as isize);
            i = i.wrapping_add(1);
            let mut distance_code: libc::c_uint = *((*lz77_encoded).data)
                .offset(i as isize);
            let mut distance_index: libc::c_uint = distance_code;
            let mut n_distance_extra_bits: libc::c_uint = DISTANCEEXTRA[distance_index
                as usize];
            i = i.wrapping_add(1);
            let mut distance_extra_bits: libc::c_uint = *((*lz77_encoded).data)
                .offset(i as isize);
    ...
    if error == 0 {
        ...
        match current_block_113 {
            ...
            _ => {
                i = 0 as libc::c_int as size_t;
                while i != lz77_encoded.size {
                    let mut symbol: libc::c_uint = *(lz77_encoded.data)
                        .offset(i as isize);
                    let ref mut fresh29 = *frequencies_ll.offset(symbol as isize);
                    ...
                    *fresh29;
                    if symbol > 256 as libc::c_int as libc::c_uint {
                        ...
                        let ref mut fresh30 = *frequencies_d.offset(dist as isize);
                    ...
                    if !(error != 0) {
                        ...
                        if bitlen_lld.is_null() || bitlen_lld_e.is_null() {
                            ...
                            while i != numcodes_lld {
                                ...
                                while i
                                    .wrapping_add(j as size_t)
                                    .wrapping_add(1 as libc::c_int as size_t) < numcodes_lld
                                    && *bitlen_lld
                                        .offset(
                                            i
                                                .wrapping_add(j as size_t)
                                    ...
                                    && j >= 2 as libc::c_int as libc::c_uint
                                {
                                    ...
                                    let mut k: size_t = 0;
                                    let mut num: libc::c_uint = j
                                        .wrapping_div(6 as libc::c_uint);
                                    let mut rest: libc::c_uint = j
                                        .wrapping_rem(6 as libc::c_uint);
                                    let fresh35 = numcodes_lld_e;
                                    numcodes_lld_e = numcodes_lld_e.wrapping_add(1);
                                    *bitlen_lld_e
                                        .offset(fresh35 as isize) = *bitlen_lld.offset(i as isize);
                                    ...
                                    i = i.wrapping_add(j as size_t);
                                } else {
                                    let fresh40 = numcodes_lld_e;
                                    numcodes_lld_e = numcodes_lld_e.wrapping_add(1);
                                    *bitlen_lld_e
                                        .offset(fresh40 as isize) = *bitlen_lld.offset(i as isize);
                                }
                                i = i.wrapping_add(1);
                                i;
                            }
                            ...
                            if !(error != 0) {
                                ...
                                while numcodes_cl > 4 as libc::c_uint as size_t
                                    && *(tree_cl.lengths)
                                        .offset(
                                            CLCL_ORDER[numcodes_cl
                                                .wrapping_sub(1 as libc::c_uint as size_t) as usize]
                                                as isize,
                                        ) == 0 as libc::c_int as libc::c_uint
                                {
                                ...
                                HLIT = numcodes_ll
                                    .wrapping_sub(257 as libc::c_int as size_t) as libc::c_uint;
                                HDIST = numcodes_d.wrapping_sub(1 as libc::c_int as size_t)
                                    as libc::c_uint;
                                HCLEN = numcodes_cl.wrapping_sub(4 as libc::c_int as size_t)
                                    as libc::c_uint;
...
unsafe extern "C" fn lodepng_deflatev(
    ...
    if (*settings).btype > 2 as libc::c_int as libc::c_uint {
        ...
        blocksize = (insize / 8 as libc::c_uint as size_t)
            .wrapping_add(8 as libc::c_int as size_t);
        if blocksize < 65536 as libc::c_int as size_t {
            blocksize = 65536 as libc::c_int as size_t;
        }
        if blocksize > 262144 as libc::c_int as size_t {
            blocksize = 262144 as libc::c_int as size_t;
        }
    }
    numdeflateblocks = insize
        .wrapping_add(blocksize)
        .wrapping_sub(1 as libc::c_int as size_t) / blocksize;
    if numdeflateblocks == 0 as libc::c_int as size_t {
    ...
    if error == 0 {
        ...
        while i != numdeflateblocks && error == 0 {
            let mut final_0: libc::c_uint = (i
                == numdeflateblocks.wrapping_sub(1 as libc::c_int as size_t))
                as libc::c_int as libc::c_uint;
            let mut start: size_t = i * blocksize;
...
pub unsafe extern "C" fn lodepng_deflate(
    ...
    let mut v: ucvector = ucvector_init(*out, *outsize);
    let mut error: libc::c_uint = lodepng_deflatev(&mut v, in_0, insize, settings);
    *out = v.data;
    *outsize = v.size;
    return error;
}
...
unsafe extern "C" fn update_adler32(
    ...
    let mut s2: libc::c_uint = adler >> 16 as libc::c_uint & 0xffff as libc::c_uint;
...
unsafe extern "C" fn lodepng_zlib_decompressv(
    ...
    if insize < 2 as libc::c_int as size_t {
    ...
    error = inflatev(
        ...
        insize.wrapping_sub(2 as libc::c_int as size_t),
        settings,
    );
    if error != 0 {
        return error;
    ...
    if (*settings).ignore_adler32 == 0 {
        let mut ADLER32: libc::c_uint = lodepng_read32bitInt(
            &*in_0.offset(insize.wrapping_sub(4 as libc::c_int as size_t) as isize),
        );
        let mut checksum: libc::c_uint = adler32(
            (*out).data,
            (*out).size as libc::c_uint,
        );
        if checksum != ADLER32 {
...
pub unsafe extern "C" fn lodepng_zlib_decompress(
    ...
    let mut v: ucvector = ucvector_init(*out, *outsize);
    let mut error: libc::c_uint = lodepng_zlib_decompressv(
        &mut v,
        in_0,
        insize,
        settings,
...
pub unsafe extern "C" fn lodepng_zlib_compress(
    ...
    *outsize = 0 as libc::c_int as size_t;
    if error == 0 {
        *outsize = deflatesize.wrapping_add(6 as libc::c_int as size_t);
    ...
    if error == 0 {
        ...
        *(*out)
        ...
        lodepng_set32bitInt(
            &mut *(*out)
                .offset((*outsize).wrapping_sub(4 as libc::c_int as size_t) as isize),
            ADLER32,
        );
    }
...
unsafe extern "C" fn readBitFromReversedStream(
    ...
    let mut result: libc::c_uchar = (*bitstream
        .offset((*bitpointer >> 3 as libc::c_int) as isize) as libc::c_int
        >> (7 as libc::c_int as size_t)
            .wrapping_sub(*bitpointer & 0x7 as libc::c_int as size_t) & 1 as libc::c_int)
        as libc::c_uchar;
...
pub unsafe extern "C" fn lodepng_chunk_type_equals(
    ...
    if lodepng_strlen(type_0) != 4 as libc::c_int as size_t {
...
pub unsafe extern "C" fn lodepng_chunk_check_crc(
    ...
    let mut CRC: libc::c_uint = lodepng_read32bitInt(
...
pub unsafe extern "C" fn lodepng_chunk_next(
    ...
    let mut available_size: size_t = end.offset_from(chunk) as libc::c_long as size_t;
    if chunk >= end || available_size < 12 as libc::c_int as size_t {
        return end;
    }
...
unsafe extern "C" fn lodepng_chunk_createv(
    ...
    let mut error: libc::c_uint = lodepng_chunk_init(&mut chunk, out, length, type_0);
    if error != 0 {
        return error;
    }
    lodepng_memcpy(
...
pub unsafe extern "C" fn lodepng_chunk_create(
    ...
    let mut v: ucvector = ucvector_init(*out, *outsize);
    let mut error: libc::c_uint = lodepng_chunk_createv(&mut v, length, type_0, data);
    *out = v.data;
    *outsize = v.size;
    return error;
}
...
unsafe extern "C" fn lodepng_color_mode_alloc_palette(mut info: *mut LodePNGColorMode) {
    ...
    if ((*info).palette).is_null() {
        (*info)
            .palette = lodepng_malloc(1024 as libc::c_int as size_t)
            as *mut libc::c_uchar;
    }
    if ((*info).palette).is_null() {
        return;
    ...
    while i != 256 as libc::c_int as size_t {
        *((*info).palette)
            .offset(
                (i * 4 as libc::c_int as size_t).wrapping_add(0 as libc::c_int as size_t)
                    as isize,
            ) = 0 as libc::c_int as libc::c_uchar;
        *((*info).palette)
            .offset(
                (i * 4 as libc::c_int as size_t).wrapping_add(1 as libc::c_int as size_t)
                    as isize,
            ) = 0 as libc::c_int as libc::c_uchar;
        *((*info).palette)
            .offset(
                (i * 4 as libc::c_int as size_t).wrapping_add(2 as libc::c_int as size_t)
                    as isize,
            ) = 0 as libc::c_int as libc::c_uchar;
        *((*info).palette)
            .offset(
                (i * 4 as libc::c_int as size_t).wrapping_add(3 as libc::c_int as size_t)
                    as isize,
...
pub unsafe extern "C" fn lodepng_color_mode_copy(
    ...
    if !((*source).palette).is_null() {
        ...
        lodepng_memcpy(
            ...
            (*source).palettesize * 4 as libc::c_int as size_t,
        );
    }
    return 0 as libc::c_int as libc::c_uint;
}
...
unsafe extern "C" fn lodepng_color_mode_equal(
    ...
    i = 0 as libc::c_int as size_t;
    while i != (*a).palettesize * 4 as libc::c_int as size_t {
...
pub unsafe extern "C" fn lodepng_palette_add(
    ...
    if (*info).palettesize >= 256 as libc::c_int as size_t {
        return 108 as libc::c_int as libc::c_uint;
    }
    *((*info).palette)
        .offset(
            (4 as libc::c_int as size_t * (*info).palettesize)
...
unsafe extern "C" fn lodepng_get_raw_size_lct(
    ...
    let mut n: size_t = w as size_t * h as size_t;
    return (n / 8 as libc::c_uint as size_t * bpp)
        .wrapping_add(
            ((n & 7 as libc::c_uint as size_t) * bpp)
                .wrapping_add(7 as libc::c_uint as size_t) / 8 as libc::c_uint as size_t,
        );
}
#[no_mangle]
...
unsafe extern "C" fn lodepng_get_raw_size_idat(
    ...
    let mut line: size_t = (w.wrapping_div(8 as libc::c_uint) as size_t * bpp as size_t)
...
unsafe extern "C" fn lodepng_pixel_overflow(
    ...
    if lodepng_addofl(
        line,
        ((w & 7 as libc::c_uint) as size_t * bpp)
            .wrapping_add(7 as libc::c_uint as size_t) / 8 as libc::c_uint as size_t,
        &mut line,
    ) != 0
    {
...
unsafe extern "C" fn LodePNGUnknownChunks_copy(
    ...
    while i != 3 as libc::c_int as libc::c_uint {
        ...
        (*dest)
            .unknown_chunks_data[i
            as usize] = lodepng_malloc((*src).unknown_chunks_size[i as usize])
            as *mut libc::c_uchar;
...
unsafe extern "C" fn lodepng_add_text_sized(
    ...
    let mut new_keys: *mut *mut libc::c_char = lodepng_realloc(
        ...
        (::core::mem::size_of::<*mut libc::c_char>() as libc::c_ulong)
            .wrapping_mul(((*info).text_num).wrapping_add(1 as libc::c_int as size_t)),
    ...
    (*info).text_num;
    let ref mut fresh45 = *((*info).text_keys)
        .offset(((*info).text_num).wrapping_sub(1 as libc::c_int as size_t) as isize);
    *fresh45 = alloc_string(key);
    let ref mut fresh46 = *((*info).text_strings)
        .offset(((*info).text_num).wrapping_sub(1 as libc::c_int as size_t) as isize);
    *fresh46 = alloc_string_sized(str, size);
    if (*((*info).text_keys)
        ...
        || (*((*info).text_strings)
            .offset(
                ((*info).text_num).wrapping_sub(1 as libc::c_int as size_t) as isize,
            ))
            .is_null()
    {
        return 83 as libc::c_int as libc::c_uint;
...
unsafe extern "C" fn lodepng_add_itext_sized(
    ...
    let mut new_keys: *mut *mut libc::c_char = lodepng_realloc(
        ...
        (::core::mem::size_of::<*mut libc::c_char>() as libc::c_ulong)
            .wrapping_mul(((*info).itext_num).wrapping_add(1 as libc::c_int as size_t)),
    ) as *mut *mut libc::c_char;
    ...
    (*info).itext_num;
    let ref mut fresh47 = *((*info).itext_keys)
        .offset(((*info).itext_num).wrapping_sub(1 as libc::c_int as size_t) as isize);
    *fresh47 = alloc_string(key);
    let ref mut fresh48 = *((*info).itext_langtags)
        .offset(((*info).itext_num).wrapping_sub(1 as libc::c_int as size_t) as isize);
    *fresh48 = alloc_string(langtag);
    let ref mut fresh49 = *((*info).itext_transkeys)
        .offset(((*info).itext_num).wrapping_sub(1 as libc::c_int as size_t) as isize);
    *fresh49 = alloc_string(transkey);
    let ref mut fresh50 = *((*info).itext_strings)
        .offset(((*info).itext_num).wrapping_sub(1 as libc::c_int as size_t) as isize);
...
pub unsafe extern "C" fn lodepng_info_copy(
    ...
    let mut error: libc::c_uint = lodepng_color_mode_copy(
        &mut (*dest).color,
        &(*source).color,
    );
    if error != 0 {
...
unsafe extern "C" fn addColorBits(
    ...
    let mut p: libc::c_uint = (index & m as size_t) as libc::c_uint;
    ...
    if p == 0 as libc::c_int as libc::c_uint {
        *out
            .offset(
                (index * bits as size_t / 8 as libc::c_uint as size_t) as isize,
            ) = in_0 as libc::c_uchar;
    } else {
        let ref mut fresh51 = *out
            .offset((index * bits as size_t / 8 as libc::c_uint as size_t) as isize);
...
unsafe extern "C" fn color_tree_init(mut tree: *mut ColorTree) {
    lodepng_memset(
        ...
        (16 as libc::c_int as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<*mut ColorTree>() as libc::c_ulong),
    );
    ...
    } else if (*mode).colortype as libc::c_uint == LCT_RGB as libc::c_int as libc::c_uint
    {
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            ...
            *out
            ...
            let ref mut fresh55 = *out
                .offset(
                    (i * 6 as libc::c_int as size_t)
                        .wrapping_add(5 as libc::c_int as size_t) as isize,
                );
            *fresh55 = b;
            *out
                .offset(
                    (i * 6 as libc::c_int as size_t)
                        .wrapping_add(4 as libc::c_int as size_t) as isize,
                ) = *fresh55;
        }
        ...
        == LCT_RGBA as libc::c_int as libc::c_uint
    {
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            ...
            *out
            ...
            let ref mut fresh61 = *out
                .offset(
                    (i * 8 as libc::c_int as size_t)
                        .wrapping_add(7 as libc::c_int as size_t) as isize,
                );
            *fresh61 = a;
            *out
                .offset(
                    (i * 8 as libc::c_int as size_t)
                        .wrapping_add(6 as libc::c_int as size_t) as isize,
                ) = *fresh61;
        }
    }
    return 0 as libc::c_int as libc::c_uint;
...
unsafe extern "C" fn rgba16ToPixel(
    ...
    if (*mode).colortype as libc::c_uint == LCT_GREY as libc::c_int as libc::c_uint {
        ...
        *out
            .offset(
                (i * 2 as libc::c_int as size_t).wrapping_add(0 as libc::c_int as size_t)
                    as isize,
    ...
    } else if (*mode).colortype as libc::c_uint == LCT_RGB as libc::c_int as libc::c_uint
    {
        *out
            .offset(
                (i * 6 as libc::c_int as size_t).wrapping_add(0 as libc::c_int as size_t)
                    as isize,
            ) = (r as libc::c_int >> 8 as libc::c_int & 255 as libc::c_int)
            as libc::c_uchar;
        *out
            .offset(
                (i * 6 as libc::c_int as size_t).wrapping_add(1 as libc::c_int as size_t)
                    as isize,
            ) = (r as libc::c_int & 255 as libc::c_int) as libc::c_uchar;
        *out
            .offset(
                (i * 6 as libc::c_int as size_t).wrapping_add(2 as libc::c_int as size_t)
                    as isize,
            ) = (g as libc::c_int >> 8 as libc::c_int & 255 as libc::c_int)
            as libc::c_uchar;
        *out
            .offset(
                (i * 6 as libc::c_int as size_t).wrapping_add(3 as libc::c_int as size_t)
                    as isize,
            ) = (g as libc::c_int & 255 as libc::c_int) as libc::c_uchar;
        *out
            .offset(
                (i * 6 as libc::c_int as size_t).wrapping_add(4 as libc::c_int as size_t)
                    as isize,
            ) = (b as libc::c_int >> 8 as libc::c_int & 255 as libc::c_int)
            as libc::c_uchar;
        *out
            .offset(
                (i * 6 as libc::c_int as size_t).wrapping_add(5 as libc::c_int as size_t)
                    as isize,
        ...
        == LCT_RGBA as libc::c_int as libc::c_uint
    {
        *out
            .offset(
                (i * 8 as libc::c_int as size_t).wrapping_add(0 as libc::c_int as size_t)
                    as isize,
            ) = (r as libc::c_int >> 8 as libc::c_int & 255 as libc::c_int)
            as libc::c_uchar;
        *out
            .offset(
                (i * 8 as libc::c_int as size_t).wrapping_add(1 as libc::c_int as size_t)
                    as isize,
            ) = (r as libc::c_int & 255 as libc::c_int) as libc::c_uchar;
        *out
            .offset(
                (i * 8 as libc::c_int as size_t).wrapping_add(2 as libc::c_int as size_t)
                    as isize,
            ) = (g as libc::c_int >> 8 as libc::c_int & 255 as libc::c_int)
            as libc::c_uchar;
        *out
            .offset(
                (i * 8 as libc::c_int as size_t).wrapping_add(3 as libc::c_int as size_t)
                    as isize,
            ) = (g as libc::c_int & 255 as libc::c_int) as libc::c_uchar;
        *out
            .offset(
                (i * 8 as libc::c_int as size_t).wrapping_add(4 as libc::c_int as size_t)
                    as isize,
            ) = (b as libc::c_int >> 8 as libc::c_int & 255 as libc::c_int)
            as libc::c_uchar;
        *out
            .offset(
                (i * 8 as libc::c_int as size_t).wrapping_add(5 as libc::c_int as size_t)
                    as isize,
            ) = (b as libc::c_int & 255 as libc::c_int) as libc::c_uchar;
        *out
            .offset(
                (i * 8 as libc::c_int as size_t).wrapping_add(6 as libc::c_int as size_t)
                    as isize,
            ) = (a as libc::c_int >> 8 as libc::c_int & 255 as libc::c_int)
            as libc::c_uchar;
        *out
            .offset(
                (i * 8 as libc::c_int as size_t).wrapping_add(7 as libc::c_int as size_t)
                    as isize,
            ) = (a as libc::c_int & 255 as libc::c_int) as libc::c_uchar;
    }
}
unsafe extern "C" fn getPixelColorRGBA8(
    ...
    if (*mode).colortype as libc::c_uint == LCT_GREY as libc::c_int as libc::c_uint {
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            ...
            *r = *g;
            ...
            let mut highest: libc::c_uint = ((1 as libc::c_uint) << (*mode).bitdepth)
                .wrapping_sub(1 as libc::c_uint);
            let mut j: size_t = i * (*mode).bitdepth as size_t;
        ...
        == LCT_PALETTE as libc::c_int as libc::c_uint
    {
        ...
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            ...
            let mut j_0: size_t = i * (*mode).bitdepth as size_t;
...
unsafe extern "C" fn getPixelColorsRGBA8(
    ...
    if (*mode).colortype as libc::c_uint == LCT_GREY as libc::c_int as libc::c_uint {
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            ...
            if (*mode).key_defined != 0 {
                buffer = buffer.offset(-((numpixels * num_channels as size_t) as isize));
                i = 0 as libc::c_int as size_t;
                while i != numpixels {
            ...
            while i != numpixels {
                ...
                *fresh64 = *in_0.offset((i * 2 as libc::c_int as size_t) as isize);
        ...
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            ...
            while i != numpixels {
                lodepng_memcpy(
                    ...
                    &*in_0.offset((i * 3 as libc::c_int as size_t) as isize)
        ...
        == LCT_PALETTE as libc::c_int as libc::c_uint
    {
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            i = 0 as libc::c_int as size_t;
            while i != numpixels {
                let mut index: libc::c_uint = *in_0.offset(i as isize) as libc::c_uint;
                lodepng_memcpy(
                    buffer as *mut libc::c_void,
                    &mut *((*mode).palette)
                        .offset(
        ...
        == LCT_RGBA as libc::c_int as libc::c_uint
    {
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            lodepng_memcpy(
                ...
                numpixels * 4 as libc::c_int as size_t,
            );
        } else {
            i = 0 as libc::c_int as size_t;
            while i != numpixels {
    ...
    if (*mode).colortype as libc::c_uint == LCT_GREY as libc::c_int as libc::c_uint {
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            ...
            while i != numpixels {
                ...
                *fresh74 = *in_0.offset((i * 2 as libc::c_int as size_t) as isize);
    ...
    } else if (*mode).colortype as libc::c_uint == LCT_RGB as libc::c_int as libc::c_uint
    {
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            lodepng_memcpy(
                buffer as *mut libc::c_void,
                in_0 as *const libc::c_void,
                numpixels * 3 as libc::c_int as size_t,
            );
        } else {
            i = 0 as libc::c_int as size_t;
            while i != numpixels {
        ...
        == LCT_RGBA as libc::c_int as libc::c_uint
    {
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            ...
            while i != numpixels {
                lodepng_memcpy(
                    buffer as *mut libc::c_void,
                    &*in_0.offset((i * 4 as libc::c_int as size_t) as isize)
                        as *const libc::c_uchar as *const libc::c_void,
                    3 as libc::c_int as size_t,
                );
                i = i.wrapping_add(1);
...
pub unsafe extern "C" fn lodepng_convert(
    ...
    let mut numpixels: size_t = w as size_t * h as size_t;
    let mut error: libc::c_uint = 0 as libc::c_int as libc::c_uint;
        ...
        == LCT_PALETTE as libc::c_int as libc::c_uint
    {
        ...
        let mut palsize: size_t = (1 as libc::c_uint as size_t) << (*mode_out).bitdepth;
        if palettesize == 0 as libc::c_int as size_t {
        ...
        while i != palsize {
            let mut p: *const libc::c_uchar = &*palette
                .offset((i * 4 as libc::c_int as size_t) as isize)
                as *const libc::c_uchar;
...
pub unsafe extern "C" fn lodepng_convert_rgb(
    ...
    let mut shift: libc::c_uint = (16 as libc::c_int as libc::c_uint)
...
pub unsafe extern "C" fn lodepng_compute_color_stats(
    ...
    let mut numpixels: size_t = w as size_t * h as size_t;
    let mut error: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut colored_done: libc::c_uint = (if lodepng_is_greyscale_type(mode_in) != 0 {
        1 as libc::c_int
    } else {
        0 as libc::c_int
    }) as libc::c_uint;
    ...
    let mut bits_done: libc::c_uint = (if (*stats).bits
        == 1 as libc::c_int as libc::c_uint && bpp == 1 as libc::c_int as libc::c_uint
    {
        1 as libc::c_int
    } else {
        0 as libc::c_int
    ...
    (*stats).numpixels = ((*stats).numpixels).wrapping_add(numpixels);
    ...
    if numcolors_done == 0 {
        ...
        loop {
            ...
            let mut color: *const libc::c_uchar = &mut *((*stats).palette)
                .as_mut_ptr()
                .offset((i * 4 as libc::c_int as size_t) as isize) as *mut libc::c_uchar;
            error = color_tree_add(
                &mut tree,
            ...
            if error != 0 {
                current_block = 3870426963414752745;
                break;
            }
            i = i.wrapping_add(1);
            i;
    ...
    match current_block {
        14576567515993809846 => {
            ...
            if sixteen != 0 {
                let mut r_0: libc::c_ushort = 0 as libc::c_int as libc::c_ushort;
                let mut g_0: libc::c_ushort = 0 as libc::c_int as libc::c_ushort;
                let mut b_0: libc::c_ushort = 0 as libc::c_int as libc::c_ushort;
                let mut a_0: libc::c_ushort = 0 as libc::c_int as libc::c_ushort;
                i = 0 as libc::c_int as size_t;
                while i != numpixels {
                    getPixelColorRGBA16(
                        &mut r_0,
                    ...
                    if numcolors_done == 0 {
                        if color_tree_has(&mut tree, r_1, g_1, b_1, a_1) == 0 {
                            ...
                            if (*stats).numcolors < 256 as libc::c_int as libc::c_uint {
                                let mut p: *mut libc::c_uchar = ((*stats).palette)
                                    .as_mut_ptr();
                ...
                match current_block {
                    ...
                    _ => {
                        ...
                        (*stats)
                            .key_r = ((*stats).key_r as libc::c_int
                            + (((*stats).key_r as libc::c_int) << 8 as libc::c_int))
                            as libc::c_ushort;
                        (*stats)
                            .key_g = ((*stats).key_g as libc::c_int
                            + (((*stats).key_g as libc::c_int) << 8 as libc::c_int))
                            as libc::c_ushort;
                        (*stats)
                            .key_b = ((*stats).key_b as libc::c_int
...
unsafe extern "C" fn auto_choose_color(
    ...
    if key != 0 && numpixels <= 16 as libc::c_int as size_t {
    ...
    palettebits = (if n <= 2 as libc::c_int as size_t {
        1 as libc::c_int
    } else if n <= 4 as libc::c_int as size_t {
        2 as libc::c_int
    } else if n <= 16 as libc::c_int as size_t {
        4 as libc::c_int
    } else {
        8 as libc::c_int
    }) as libc::c_uint;
    palette_ok = (n <= 256 as libc::c_int as size_t
        && bits <= 8 as libc::c_int as libc::c_uint && n != 0 as libc::c_int as size_t)
        as libc::c_int as libc::c_uint;
    if numpixels < n * 2 as libc::c_int as size_t {
    ...
    if palette_ok != 0 {
        ...
        if key != 0 {
            let mut mask_0: libc::c_uint = ((1 as libc::c_uint) << (*mode_out).bitdepth)
                .wrapping_sub(1 as libc::c_uint);
...
unsafe extern "C" fn paethPredictor(
    ...
    let mut pa: libc::c_short = (if (b as libc::c_int - c as libc::c_int)
        < 0 as libc::c_int
    {
    ...
    let mut pb: libc::c_short = (if (a as libc::c_int - c as libc::c_int)
        < 0 as libc::c_int
    {
    ...
    let mut pc: libc::c_short = (if (a as libc::c_int + b as libc::c_int
        - c as libc::c_int - c as libc::c_int) < 0 as libc::c_int
    {
...
pub unsafe extern "C" fn lodepng_inspect(
    ...
    if insize == 0 as libc::c_int as size_t || in_0.is_null() {
        (*state).error = 48 as libc::c_int as libc::c_uint;
        return 48 as libc::c_int as libc::c_uint;
    }
    if insize < 33 as libc::c_int as size_t {
    ...
    if (*state).decoder.ignore_crc == 0 {
        let mut CRC: libc::c_uint = lodepng_read32bitInt(
            &*in_0.offset(29 as libc::c_int as isize),
        );
        let mut checksum: libc::c_uint = lodepng_crc32(
    ...
    match filterType as libc::c_int {
        ...
        3 => {
            if !precon.is_null() {
                ...
                if bytewidth >= 4 as libc::c_int as size_t {
                    while i.wrapping_add(3 as libc::c_int as size_t) < length {
                        let mut s0: libc::c_uchar = *scanline
                            .offset(i.wrapping_add(0 as libc::c_int as size_t) as isize);
                        let mut s1: libc::c_uchar = *scanline
                            .offset(i.wrapping_add(1 as libc::c_int as size_t) as isize);
                        let mut s2: libc::c_uchar = *scanline
                            .offset(i.wrapping_add(2 as libc::c_int as size_t) as isize);
                        let mut s3: libc::c_uchar = *scanline
                            .offset(i.wrapping_add(3 as libc::c_int as size_t) as isize);
                        let mut r0: libc::c_uchar = *recon
                            .offset(
                                j_0.wrapping_add(0 as libc::c_int as size_t) as isize,
                            );
                        let mut r1: libc::c_uchar = *recon
                            .offset(
                                j_0.wrapping_add(1 as libc::c_int as size_t) as isize,
                            );
                        let mut r2: libc::c_uchar = *recon
                            .offset(
                                j_0.wrapping_add(2 as libc::c_int as size_t) as isize,
                            );
                        let mut r3: libc::c_uchar = *recon
                            .offset(
                                j_0.wrapping_add(3 as libc::c_int as size_t) as isize,
                            );
                        let mut p0: libc::c_uchar = *precon
                            .offset(i.wrapping_add(0 as libc::c_int as size_t) as isize);
                        let mut p1: libc::c_uchar = *precon
                            .offset(i.wrapping_add(1 as libc::c_int as size_t) as isize);
                        let mut p2: libc::c_uchar = *precon
                            .offset(i.wrapping_add(2 as libc::c_int as size_t) as isize);
                        let mut p3: libc::c_uchar = *precon
                            .offset(i.wrapping_add(3 as libc::c_int as size_t) as isize);
                        *recon
                            .offset(
                        ...
                        *recon
                        ...
                        j_0 = j_0.wrapping_add(4 as libc::c_int as size_t);
                    }
                } else if bytewidth >= 3 as libc::c_int as size_t {
                    while i.wrapping_add(2 as libc::c_int as size_t) < length {
                        let mut s0_0: libc::c_uchar = *scanline
                            .offset(i.wrapping_add(0 as libc::c_int as size_t) as isize);
                        let mut s1_0: libc::c_uchar = *scanline
                            .offset(i.wrapping_add(1 as libc::c_int as size_t) as isize);
                        let mut s2_0: libc::c_uchar = *scanline
                            .offset(i.wrapping_add(2 as libc::c_int as size_t) as isize);
                        let mut r0_0: libc::c_uchar = *recon
                            .offset(
                                j_0.wrapping_add(0 as libc::c_int as size_t) as isize,
                            );
                        let mut r1_0: libc::c_uchar = *recon
                            .offset(
                                j_0.wrapping_add(1 as libc::c_int as size_t) as isize,
                            );
                        let mut r2_0: libc::c_uchar = *recon
                            .offset(
                                j_0.wrapping_add(2 as libc::c_int as size_t) as isize,
                            );
                        let mut p0_0: libc::c_uchar = *precon
                            .offset(i.wrapping_add(0 as libc::c_int as size_t) as isize);
                        let mut p1_0: libc::c_uchar = *precon
                            .offset(i.wrapping_add(1 as libc::c_int as size_t) as isize);
                        let mut p2_0: libc::c_uchar = *precon
                            .offset(i.wrapping_add(2 as libc::c_int as size_t) as isize);
                        *recon
                            .offset(
                                i.wrapping_add(0 as libc::c_int as size_t) as isize,
                        ...
                        *recon
                            ...
                            + (r2_0 as libc::c_int + p2_0 as libc::c_int
                                >> 1 as libc::c_uint)) as libc::c_uchar;
                        i = i.wrapping_add(3 as libc::c_int as size_t);
                        j_0 = j_0.wrapping_add(3 as libc::c_int as size_t);
                    }
                } else if bytewidth >= 2 as libc::c_int as size_t {
                    while i.wrapping_add(1 as libc::c_int as size_t) < length {
                        let mut s0_1: libc::c_uchar = *scanline
                            .offset(i.wrapping_add(0 as libc::c_int as size_t) as isize);
                        let mut s1_1: libc::c_uchar = *scanline
                            .offset(i.wrapping_add(1 as libc::c_int as size_t) as isize);
                        let mut r0_1: libc::c_uchar = *recon
                            .offset(
                                j_0.wrapping_add(0 as libc::c_int as size_t) as isize,
                            );
                        let mut r1_1: libc::c_uchar = *recon
                            .offset(
                                j_0.wrapping_add(1 as libc::c_int as size_t) as isize,
                            );
                        let mut p0_1: libc::c_uchar = *precon
                            .offset(i.wrapping_add(0 as libc::c_int as size_t) as isize);
                        let mut p1_1: libc::c_uchar = *precon
                            .offset(i.wrapping_add(1 as libc::c_int as size_t) as isize);
                        *recon
                            .offset(
                                i.wrapping_add(0 as libc::c_int as size_t) as isize,
                        ...
                        *recon
                        ...
                        j_0 = j_0.wrapping_add(2 as libc::c_int as size_t);
                    }
                }
                while i != length {
                    *recon
        ...
        4 => {
            if !precon.is_null() {
                ...
                if bytewidth >= 4 as libc::c_int as size_t {
                    while i.wrapping_add(3 as libc::c_int as size_t) < length {
                        let mut s0_2: libc::c_uchar = *scanline
                            .offset(i.wrapping_add(0 as libc::c_int as size_t) as isize);
                        let mut s1_2: libc::c_uchar = *scanline
                            .offset(i.wrapping_add(1 as libc::c_int as size_t) as isize);
                        let mut s2_1: libc::c_uchar = *scanline
                            .offset(i.wrapping_add(2 as libc::c_int as size_t) as isize);
                        let mut s3_0: libc::c_uchar = *scanline
                            .offset(i.wrapping_add(3 as libc::c_int as size_t) as isize);
                        let mut r0_2: libc::c_uchar = *recon
                            .offset(
                                j_2.wrapping_add(0 as libc::c_int as size_t) as isize,
                            );
                        let mut r1_2: libc::c_uchar = *recon
                            .offset(
                                j_2.wrapping_add(1 as libc::c_int as size_t) as isize,
                            );
                        let mut r2_1: libc::c_uchar = *recon
                            .offset(
                                j_2.wrapping_add(2 as libc::c_int as size_t) as isize,
                            );
                        let mut r3_0: libc::c_uchar = *recon
                            .offset(
                                j_2.wrapping_add(3 as libc::c_int as size_t) as isize,
                            );
                        let mut p0_2: libc::c_uchar = *precon
                            .offset(i.wrapping_add(0 as libc::c_int as size_t) as isize);
                        let mut p1_2: libc::c_uchar = *precon
                            .offset(i.wrapping_add(1 as libc::c_int as size_t) as isize);
                        let mut p2_1: libc::c_uchar = *precon
                            .offset(i.wrapping_add(2 as libc::c_int as size_t) as isize);
                        let mut p3_0: libc::c_uchar = *precon
                            .offset(i.wrapping_add(3 as libc::c_int as size_t) as isize);
                        let mut q0: libc::c_uchar = *precon
                            .offset(
                                j_2.wrapping_add(0 as libc::c_int as size_t) as isize,
                            );
                        let mut q1: libc::c_uchar = *precon
                            .offset(
                                j_2.wrapping_add(1 as libc::c_int as size_t) as isize,
                            );
                        let mut q2: libc::c_uchar = *precon
                            .offset(
                                j_2.wrapping_add(2 as libc::c_int as size_t) as isize,
                            );
                        let mut q3: libc::c_uchar = *precon
                            .offset(
                                j_2.wrapping_add(3 as libc::c_int as size_t) as isize,
                            );
                        *recon
                        ...
                        *recon
                        ...
                        i = i.wrapping_add(4 as libc::c_int as size_t);
                        j_2 = j_2.wrapping_add(4 as libc::c_int as size_t);
                    }
                } else if bytewidth >= 3 as libc::c_int as size_t {
                    while i.wrapping_add(2 as libc::c_int as size_t) < length {
                        let mut s0_3: libc::c_uchar = *scanline
                            .offset(i.wrapping_add(0 as libc::c_int as size_t) as isize);
                        let mut s1_3: libc::c_uchar = *scanline
                            .offset(i.wrapping_add(1 as libc::c_int as size_t) as isize);
                        let mut s2_2: libc::c_uchar = *scanline
                            .offset(i.wrapping_add(2 as libc::c_int as size_t) as isize);
                        let mut r0_3: libc::c_uchar = *recon
                            .offset(
                                j_2.wrapping_add(0 as libc::c_int as size_t) as isize,
                            );
                        let mut r1_3: libc::c_uchar = *recon
                            .offset(
                                j_2.wrapping_add(1 as libc::c_int as size_t) as isize,
                            );
                        let mut r2_2: libc::c_uchar = *recon
                            .offset(
                                j_2.wrapping_add(2 as libc::c_int as size_t) as isize,
                            );
                        let mut p0_3: libc::c_uchar = *precon
                            .offset(i.wrapping_add(0 as libc::c_int as size_t) as isize);
                        let mut p1_3: libc::c_uchar = *precon
                            .offset(i.wrapping_add(1 as libc::c_int as size_t) as isize);
                        let mut p2_2: libc::c_uchar = *precon
                            .offset(i.wrapping_add(2 as libc::c_int as size_t) as isize);
                        let mut q0_0: libc::c_uchar = *precon
                            .offset(
                                j_2.wrapping_add(0 as libc::c_int as size_t) as isize,
                            );
                        let mut q1_0: libc::c_uchar = *precon
                            .offset(
                                j_2.wrapping_add(1 as libc::c_int as size_t) as isize,
                            );
                        let mut q2_0: libc::c_uchar = *precon
                            .offset(
                                j_2.wrapping_add(2 as libc::c_int as size_t) as isize,
                            );
                        *recon
                        ...
                        *recon
                        ...
                        i = i.wrapping_add(3 as libc::c_int as size_t);
                        j_2 = j_2.wrapping_add(3 as libc::c_int as size_t);
                    }
                } else if bytewidth >= 2 as libc::c_int as size_t {
                    while i.wrapping_add(1 as libc::c_int as size_t) < length {
                        let mut s0_4: libc::c_uchar = *scanline
                            .offset(i.wrapping_add(0 as libc::c_int as size_t) as isize);
                        let mut s1_4: libc::c_uchar = *scanline
                            .offset(i.wrapping_add(1 as libc::c_int as size_t) as isize);
                        let mut r0_4: libc::c_uchar = *recon
                            .offset(
                                j_2.wrapping_add(0 as libc::c_int as size_t) as isize,
                            );
                        let mut r1_4: libc::c_uchar = *recon
                            .offset(
                                j_2.wrapping_add(1 as libc::c_int as size_t) as isize,
                            );
                        let mut p0_4: libc::c_uchar = *precon
                            .offset(i.wrapping_add(0 as libc::c_int as size_t) as isize);
                        let mut p1_4: libc::c_uchar = *precon
                            .offset(i.wrapping_add(1 as libc::c_int as size_t) as isize);
                        let mut q0_1: libc::c_uchar = *precon
                            .offset(
                                j_2.wrapping_add(0 as libc::c_int as size_t) as isize,
                            );
                        let mut q1_1: libc::c_uchar = *precon
                            .offset(
                                j_2.wrapping_add(1 as libc::c_int as size_t) as isize,
                            );
                        *recon
                        ...
                        *recon
                        ...
                        i = i.wrapping_add(2 as libc::c_int as size_t);
                        j_2 = j_2.wrapping_add(2 as libc::c_int as size_t);
                    }
                }
                while i != length {
                    *recon
...
unsafe extern "C" fn unfilter(
    ...
    let mut bytewidth: size_t = bpp
        .wrapping_add(7 as libc::c_uint)
        .wrapping_div(8 as libc::c_uint) as size_t;
    let mut linebytes: size_t = (lodepng_get_raw_size_idat(
        w,
        1 as libc::c_int as libc::c_uint,
        bpp,
    ))
    ...
    while y < h {
        let mut outindex: size_t = linebytes * y as size_t;
        let mut inindex: size_t = (1 as libc::c_int as size_t).wrapping_add(linebytes)
            * y as size_t;
        ...
        let mut error: libc::c_uint = unfilterScanline(
            ...
            &*in_0.offset(inindex.wrapping_add(1 as libc::c_int as size_t) as isize),
            prevline,
            bytewidth,
            filterType,
            linebytes,
...
unsafe extern "C" fn Adam7_deinterlace(
    ...
    if bpp >= 8 as libc::c_int as libc::c_uint {
        ...
        while i != 7 as libc::c_int as libc::c_uint {
            ...
            let mut bytewidth: size_t = bpp.wrapping_div(8 as libc::c_uint) as size_t;
            y = 0 as libc::c_int as libc::c_uint;
            while y < passh[i as usize] {
                ...
                while x < passw[i as usize] {
                    ...
                    let mut pixeloutstart: size_t = ((ADAM7_IY[i as usize] as size_t)
                        .wrapping_add(y as size_t * ADAM7_DY[i as usize] as size_t)
                        * w as size_t)
                        .wrapping_add(ADAM7_IX[i as usize] as size_t)
                        .wrapping_add(x as size_t * ADAM7_DX[i as usize] as size_t)
                        * bytewidth;
                    b = 0 as libc::c_int as libc::c_uint;
                    while (b as size_t) < bytewidth {
                        *out
                            .offset(
                                pixeloutstart.wrapping_add(b as size_t) as isize,
                            ) = *in_0
                            .offset(pixelinstart.wrapping_add(b as size_t) as isize);
                        b = b.wrapping_add(1);
                        b;
                    }
                    x = x.wrapping_add(1);
        ...
        while i != 7 as libc::c_int as libc::c_uint {
            ...
            let mut ilinebits: libc::c_uint = bpp.wrapping_mul(passw[i as usize]);
            ...
            while y_0 < passh[i as usize] {
                ...
                while x_0 < passw[i as usize] {
                    ibp = (8 as libc::c_int as size_t * passstart[i as usize])
                        .wrapping_add(
                            y_0
                                .wrapping_mul(ilinebits)
                                .wrapping_add(x_0.wrapping_mul(bpp)) as size_t,
                        );
                    obp = ((ADAM7_IY[i as usize] as size_t)
                        .wrapping_add(y_0 as size_t * ADAM7_DY[i as usize] as size_t)
                        * olinebits as size_t)
                        .wrapping_add(
                            (ADAM7_IX[i as usize] as size_t)
                                .wrapping_add(
                                    x_0 as size_t * ADAM7_DX[i as usize] as size_t,
                                ) * bpp as size_t,
                        );
                    b_0 = 0 as libc::c_int as libc::c_uint;
                    while b_0 < bpp {
                        let mut bit: libc::c_uchar = readBitFromReversedStream(
                            &mut ibp,
                            in_0,
                        );
...
unsafe extern "C" fn removePaddingBits(
    ...
    while y < h {
        ...
        while x < olinebits {
            let mut bit: libc::c_uchar = readBitFromReversedStream(&mut ibp, in_0);
            setBitOfReversedStream(&mut obp, out, bit);
            x = x.wrapping_add(1);
            x;
        }
        ibp = ibp.wrapping_add(diff);
        y = y.wrapping_add(1);
        y;
    }
}
...
unsafe extern "C" fn readChunk_PLTE(
    ...
    let mut i: libc::c_uint = 0;
    (*color).palettesize = chunkLength / 3 as libc::c_uint as size_t;
    if (*color).palettesize == 0 as libc::c_int as size_t
        || (*color).palettesize > 256 as libc::c_int as size_t
    {
...
unsafe extern "C" fn readChunk_tRNS(
    ...
    {
        if chunkLength != 2 as libc::c_int as size_t {
        ...
        == LCT_RGB as libc::c_int as libc::c_uint
    {
        if chunkLength != 6 as libc::c_int as size_t {
...
unsafe extern "C" fn readChunk_bKGD(
    ...
    if (*info).color.colortype as libc::c_uint
        == LCT_PALETTE as libc::c_int as libc::c_uint
    {
        if chunkLength != 1 as libc::c_int as size_t {
            return 43 as libc::c_int as libc::c_uint;
        }
        if *data.offset(0 as libc::c_int as isize) as size_t >= (*info).color.palettesize
        {
            return 103 as libc::c_int as libc::c_uint;
        }
        (*info).background_defined = 1 as libc::c_int as libc::c_uint;
        (*info).background_b = *data.offset(0 as libc::c_int as isize) as libc::c_uint;
        (*info).background_g = (*info).background_b;
        (*info).background_r = (*info).background_g;
...
unsafe extern "C" fn readChunk_zTXt(
    ...
    if error == 0 {
        ...
        if length.wrapping_add(2 as libc::c_int as libc::c_uint) as size_t >= chunkLength
        {
...
unsafe extern "C" fn readChunk_iTXt(
    ...
    if error == 0 {
        if chunkLength < 5 as libc::c_int as size_t {
            ...
            if length.wrapping_add(3 as libc::c_int as libc::c_uint) as size_t
                >= chunkLength
            {
                error = 75 as libc::c_int as libc::c_uint;
            } else if length < 1 as libc::c_int as libc::c_uint
...
unsafe extern "C" fn readChunk_tIME(
    ...
    if chunkLength != 7 as libc::c_int as size_t {
...
unsafe extern "C" fn readChunk_pHYs(
    ...
    if chunkLength != 9 as libc::c_int as size_t {
...
unsafe extern "C" fn readChunk_gAMA(
    ...
    if chunkLength != 4 as libc::c_int as size_t {
...
unsafe extern "C" fn readChunk_cHRM(
    ...
    if chunkLength != 32 as libc::c_int as size_t {
...
unsafe extern "C" fn readChunk_sBIT(
    ...
    if (*info).color.colortype as libc::c_uint == LCT_GREY as libc::c_int as libc::c_uint
    {
        ...
        (*info).sbit_b = *data.offset(0 as libc::c_int as isize) as libc::c_uint;
        (*info).sbit_g = (*info).sbit_b;
        (*info).sbit_r = (*info).sbit_g;
    } else if (*info).color.colortype as libc::c_uint
        == LCT_RGB as libc::c_int as libc::c_uint
        || (*info).color.colortype as libc::c_uint
            == LCT_PALETTE as libc::c_int as libc::c_uint
    {
        if chunkLength != 3 as libc::c_int as size_t {
            return 114 as libc::c_int as libc::c_uint;
        }
        if *data.offset(0 as libc::c_int as isize) as libc::c_int == 0 as libc::c_int
...
pub unsafe extern "C" fn lodepng_inspect_chunk(
    ...
    let mut error: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    if pos.wrapping_add(4 as libc::c_int as size_t) > insize {
        return 30 as libc::c_int as libc::c_uint;
    }
    ...
    if chunkLength.wrapping_add(12 as libc::c_int as libc::c_uint) as size_t
...
unsafe extern "C" fn decodeGeneric(
    ...
    *w = *h;
    ...
    while IEND == 0 && (*state).error == 0 {
        ...
        if chunk < in_0 || pos.wrapping_add(12 as libc::c_int as size_t) > insize {
            ...
            if chunkLength > 2147483647 as libc::c_int as libc::c_uint {
                ...
                .wrapping_add(12 as libc::c_int as size_t) > insize
                || pos
                    .wrapping_add(chunkLength as size_t)
                    .wrapping_add(12 as libc::c_int as size_t) < pos
            {
                ...
                ) != 0
                {
                    ...
                    if lodepng_addofl(idatsize, chunkLength as size_t, &mut newsize) != 0
                    {
                        ...
                        idatsize = idatsize.wrapping_add(chunkLength as size_t);
    ...
    if (*state).error == 0 {
        if (*state).info_png.interlace_method == 0 as libc::c_int as libc::c_uint {
            let mut bpp: size_t = lodepng_get_bpp(&mut (*state).info_png.color)
                as size_t;
            expected_size = lodepng_get_raw_size_idat(*w, *h, bpp as libc::c_uint);
        } else {
            let mut bpp_0: size_t = lodepng_get_bpp(&mut (*state).info_png.color)
                as size_t;
...
unsafe extern "C" fn writeSignature(mut out: *mut ucvector) -> libc::c_uint {
    ...
    if ucvector_resize(out, ((*out).size).wrapping_add(8 as libc::c_int as size_t)) == 0
    {
        return 83 as libc::c_int as libc::c_uint;
    }
    lodepng_memcpy(
...
unsafe extern "C" fn addChunk_PLTE(
    ...
    if (*info).palettesize == 0 as libc::c_int as size_t
        || (*info).palettesize > 256 as libc::c_int as size_t
    {
    ...
    let mut error: libc::c_uint = lodepng_chunk_init(
        &mut chunk,
        out,
        ((*info).palettesize * 3 as libc::c_int as size_t) as libc::c_uint,
        b"PLTE\0" as *const u8 as *const libc::c_char,
    );
    if error != 0 {
        return error;
    ...
    if (*info).colortype as libc::c_uint == LCT_PALETTE as libc::c_int as libc::c_uint {
        ...
        if amount != 0 {
            ...
            while i != amount {
                *chunk
                    .offset(
                        (8 as libc::c_int as size_t).wrapping_add(i) as isize,
                    ) = *((*info).palette)
                    .offset(
...
unsafe extern "C" fn addChunk_tEXt(
    ...
    if keysize < 1 as libc::c_int as size_t || keysize > 79 as libc::c_int as size_t {
        return 89 as libc::c_int as libc::c_uint;
    }
    let mut error: libc::c_uint = lodepng_chunk_init(
        &mut chunk,
    ...
    *chunk
        .offset(
            (8 as libc::c_int as size_t).wrapping_add(keysize) as isize,
        ) = 0 as libc::c_int as libc::c_uchar;
    lodepng_memcpy(
...
unsafe extern "C" fn addChunk_zTXt(
    ...
    if error == 0 {
        ...
        *chunk
            .offset(
                (9 as libc::c_int as size_t).wrapping_add(keysize) as isize,
            ) = 0 as libc::c_int as libc::c_uchar;
        lodepng_memcpy(
...
unsafe extern "C" fn addChunk_iTXt(
    ...
    if error == 0 {
        ...
        *chunk.offset(fresh93 as isize) = 0 as libc::c_int as libc::c_uchar;
        ...
        pos = pos.wrapping_add(transsize);
        let fresh94 = pos;
        pos = pos.wrapping_add(1);
...
unsafe extern "C" fn ilog2(mut i: size_t) -> size_t {
    ...
    if i >= 65536 as libc::c_int as size_t {
        result = result.wrapping_add(16 as libc::c_int as size_t);
        i >>= 16 as libc::c_int;
    }
    if i >= 256 as libc::c_int as size_t {
        result = result.wrapping_add(8 as libc::c_int as size_t);
        i >>= 8 as libc::c_int;
    }
    if i >= 16 as libc::c_int as size_t {
        result = result.wrapping_add(4 as libc::c_int as size_t);
        i >>= 4 as libc::c_int;
    }
    if i >= 4 as libc::c_int as size_t {
        result = result.wrapping_add(2 as libc::c_int as size_t);
        i >>= 2 as libc::c_int;
    }
    if i >= 2 as libc::c_int as size_t {
        result = result.wrapping_add(1 as libc::c_int as size_t);
    }
    return result;
}
unsafe extern "C" fn ilog2i(mut i: size_t) -> size_t {
    ...
    return (i * l)
        .wrapping_add(
            i.wrapping_sub(((1 as libc::c_uint) << l) as size_t) << 1 as libc::c_uint,
        );
}
unsafe extern "C" fn filter(
        ...
        && strategy as libc::c_uint <= LFS_FOUR as libc::c_int as libc::c_uint
    {
        ...
        y = 0 as libc::c_int as libc::c_uint;
        while y != h {
            let mut outindex: size_t = (1 as libc::c_int as size_t)
                .wrapping_add(linebytes) * y as size_t;
            let mut inindex: size_t = linebytes * y as size_t;
            *out.offset(outindex as isize) = type_0;
            filterScanline(
                &mut *out
                    .offset(outindex.wrapping_add(1 as libc::c_int as size_t) as isize),
            ...
            while y != h {
                ...
                while type_1 as libc::c_int != 5 as libc::c_int {
                    ...
                    filterScanline(
                        ...
                        &*in_0.offset((y as size_t * linebytes) as isize),
                        prevline,
                        linebytes,
                        bytewidth,
                        type_1,
                    ...
                    if type_1 as libc::c_int == 0 as libc::c_int {
                        ...
                        while x as size_t != linebytes {
                            sum = sum
                                .wrapping_add(
                                    *(attempt[type_1 as usize]).offset(x as isize) as size_t,
                                );
                            x = x.wrapping_add(1);
                            x;
                        }
                        ...
                        x = 0 as libc::c_int as libc::c_uint;
                        while x as size_t != linebytes {
                            let mut s: libc::c_uchar = *(attempt[type_1 as usize])
                                .offset(x as isize);
                            sum = sum
                                .wrapping_add(
                ...
                prevline = &*in_0.offset((y as size_t * linebytes) as isize)
                    as *const libc::c_uchar;
                *out
                    .offset(
                        (y as size_t
                            * linebytes.wrapping_add(1 as libc::c_int as size_t))
                            as isize,
                    ) = bestType;
                x = 0 as libc::c_int as libc::c_uint;
                while x as size_t != linebytes {
            ...
            while y != h {
                ...
                while type_2 != 5 as libc::c_int as libc::c_uint {
                    ...
                    while x != 256 as libc::c_int as libc::c_uint {
                        sum_0 = sum_0.wrapping_add(ilog2i(count[x as usize] as size_t));
                        x = x.wrapping_add(1);
                        x;
                    }
        ...
        y = 0 as libc::c_int as libc::c_uint;
        while y != h {
            let mut outindex_0: size_t = (1 as libc::c_int as size_t)
                .wrapping_add(linebytes) * y as size_t;
            let mut inindex_0: size_t = linebytes * y as size_t;
            let mut type_3: libc::c_uchar = *((*settings).predefined_filters)
                .offset(y as isize);
            *out.offset(outindex_0 as isize) = type_3;
            filterScanline(
                &mut *out
                    .offset(
                        outindex_0.wrapping_add(1 as libc::c_int as size_t) as isize,
                    ),
            ...
            while y < passh[i as usize] {
                ...
                while x < passw[i as usize] {
                    let mut pixelinstart: size_t = (ADAM7_IY[i as usize])
                        ...
                        .wrapping_add(x.wrapping_mul(ADAM7_DX[i as usize])) as size_t
                        * bytewidth;
        ...
        while i != 7 as libc::c_int as libc::c_uint {
            ...
            while y_0 < passh[i as usize] {
                ...
                while x_0 < passw[i as usize] {
                    ...
                    obp = (8 as libc::c_int as size_t * passstart[i as usize])
                        .wrapping_add(
                            y_0
                                .wrapping_mul(ilinebits)
                                .wrapping_add(x_0.wrapping_mul(bpp)) as size_t,
...
unsafe extern "C" fn addUnknownChunks(
    ...
    while (inchunk.offset_from(data) as libc::c_long as size_t) < datasize {
        let mut error: libc::c_uint = lodepng_chunk_append(
            &mut (*out).data,
            &mut (*out).size,
            inchunk,
        );
...
pub unsafe extern "C" fn lodepng_encode(
    ...
    let mut outv: ucvector = ucvector_init(
    ...
    *outsize = 0 as libc::c_int as size_t;
    ...
    if ((*info_png).color.colortype as libc::c_uint
        ...
        && ((*info_png).color.palettesize == 0 as libc::c_int as size_t
            || (*info_png).color.palettesize > 256 as libc::c_int as size_t)
    {
        ...
        if !((*state).error != 0) {
            ...
            if !((*state).error != 0) {
                ...
                if (*state).encoder.auto_convert != 0 {
                    ...
                    let mut allow_convert: libc::c_uint = 1 as libc::c_int
                        as libc::c_uint;
                    ...
                    if (*state).error != 0 {
                        current_block = 3502319726715365775;
                    } else {
                        if (*info_png).background_defined != 0 {
                            let mut r: libc::c_uint = 0 as libc::c_int as libc::c_uint;
                            let mut g: libc::c_uint = 0 as libc::c_int as libc::c_uint;
                            let mut b: libc::c_uint = 0 as libc::c_int as libc::c_uint;
                            let mut mode16: LodePNGColorMode = lodepng_color_mode_make(
                                LCT_RGB,
                                16 as libc::c_int as libc::c_uint,
                            );
                            lodepng_convert_rgb(
                            ...
                            _ => {
                                ...
                                if (*state).error != 0 {
                                    ...
                                    if (*info_png).sbit_defined != 0 {
                                        let mut sbit_max: libc::c_uint = if (if (if (*info_png)
                                            .sbit_r > (*info_png).sbit_g
                                        {
                                            (*info_png).sbit_r
                                        } else {
                                            (*info_png).sbit_g
                                        ...
                                        let mut equal: libc::c_uint = (((*info_png).sbit_g == 0
                ...
                match current_block {
                    ...
                    _ => {
                        if (*info_png).iccp_defined != 0 {
                            ...
                            let mut gray_png: libc::c_uint = (info.color.colortype
                                as libc::c_uint == LCT_GREY as libc::c_int as libc::c_uint
                                || info.color.colortype as libc::c_uint
                                    == LCT_GREY_ALPHA as libc::c_int as libc::c_uint)
                                as libc::c_int as libc::c_uint;
                        ...
                        match current_block {
                            ...
                            _ => {
                                ...
                                {
                                    let mut converted: *mut libc::c_uchar = 0
                                        as *mut libc::c_uchar;
                                    let mut size: size_t = (w as size_t * h as size_t
                                        * lodepng_get_bpp(&mut info.color) as size_t)
                                        .wrapping_add(7 as libc::c_uint as size_t)
                                        / 8 as libc::c_uint as size_t;
