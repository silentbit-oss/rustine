...
pub static ADAM7_IY: [u32; 7] = [0, 0, 4, 0, 2, 0, 1];

pub static ADAM7_DX: [u32; 7] = [8, 8, 4, 4, 2, 2, 1];

pub static ADAM7_DY: [u32; 7] = [8, 8, 8, 4, 4, 2, 2];
...
pub const LODEPNG_FLT_INF: f32 = f32::INFINITY;

pub const LODEPNG_FLT_NAN: f32 = f32::NAN;

pub const LODEPNG_FLT_MAX: f32 = 3.40282346638528859811704183484516925e38_f32;

pub const LENBASE: [u64; 29] = [
    3, 4, 5, 6, 7, 8, 9, 10, 11, 13, // 10 elements
