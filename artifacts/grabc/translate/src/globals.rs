...
lazy_static! {
    pub static ref G_PRINT_IN_HEX: AtomicI32 = AtomicI32::new(1);
}


lazy_static! {
    pub static ref G_PRINT_IN_RGB: AtomicI32 = AtomicI32::new(0);
}
...
lazy_static! {
    pub static ref G_CROSS_CURSOR: std::sync::Mutex<Option<Cursor>> = 
