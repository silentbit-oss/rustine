...
pub struct _IO_FILE {
    ...
    pub _markers: *mut crate::src::gzip_container::_IO_marker,
    ...
    pub _codecvt: *mut crate::src::deflate::_IO_codecvt,
    pub _wide_data: *mut crate::src::cache::_IO_wide_data,
...
unsafe extern "C" fn EstimateCost(
    ...
    return crate::src::deflate::ZopfliCalculateBlockSizeAutoType(lz77, lstart, lend);
}
...
pub unsafe extern "C" fn ZopfliBlockSplitLZ77(
    ...
    if done.is_null() {std::intrinsics::assume((done).addr() == 0);
    ...
    loop {
        ...
        llpos = FindMinimum(
            ...
            &raw mut c as *mut SplitCostContext as *mut libc::c_void,
...
pub unsafe extern "C" fn ZopfliBlockSplit(
    ...
    crate::src::lz77::ZopfliInitBlockState(options, instart, inend, 0 as libc::c_int, &raw mut s);
    ...
    *splitpoints = 0 as *mut size_t;
    crate::src::lz77::ZopfliLZ77Greedy(&raw mut s, in_0, instart, inend, &raw mut store, h);
