...
#[no_mangle]
pub unsafe extern "C" fn ZopfliCleanHash(mut h: *mut crate::src::blocksplitter::ZopfliHash) {
...
unsafe extern "C" fn UpdateHashValue(mut h: *mut crate::src::blocksplitter::ZopfliHash, mut c: libc::c_uchar) {
