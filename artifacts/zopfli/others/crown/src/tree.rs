...
pub unsafe extern "C" fn ZopfliLengthsToSymbols(
    ...
    while (i as size_t) < n {
        ...
        *bl_count.offset(*lengths.offset(i as isize) as isize) = (*fresh0).wrapping_add(1); *bl_count.offset(*lengths.offset(i as isize) as isize);
        i = i.wrapping_add(1);
        i;
    }
    ...
    *bl_count.offset(0 as libc::c_int as isize) = 0 as libc::c_int as size_t;
    ...
    while (i as size_t) < n {
        ...
        if len != 0 as libc::c_int as libc::c_uint {
            ...
            *next_code.offset(len as isize) = (*fresh1).wrapping_add(1); *next_code.offset(len as isize);
        }
        i = i.wrapping_add(1);
        i;
    }
...
pub unsafe extern "C" fn ZopfliCalculateBitLengths(
    ...
    let mut error: libc::c_int = crate::src::katajainen::ZopfliLengthLimitedCodeLengths(
        count,
        n as libc::c_int,
        maxbits,
        bitlengths,
