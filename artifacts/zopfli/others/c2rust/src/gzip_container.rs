...
unsafe extern "C" fn CRC(
    ...
    let mut result: libc::c_ulong = 0xffffffff as libc::c_uint as libc::c_ulong;
    while size > 0 as libc::c_int as size_t {
        let fresh0 = data;
        data = data.offset(1);
        result = crc32_table[((result ^ *fresh0 as libc::c_ulong)
...
pub unsafe extern "C" fn ZopfliGzipCompress(
    ...
    *(*out)
        .offset(
            *outsize as isize,
        ) = crcvalue.wrapping_rem(256 as libc::c_int as libc::c_ulong) as libc::c_uchar;
    *outsize = (*outsize).wrapping_add(1);
    *outsize;
    if *outsize & (*outsize).wrapping_sub(1 as libc::c_int as size_t) == 0 {
        *out = (if *outsize == 0 as libc::c_int as size_t {
    ...
    *(*out)
        .offset(
            *outsize as isize,
        ) = (crcvalue >> 8 as libc::c_int)
        .wrapping_rem(256 as libc::c_int as libc::c_ulong) as libc::c_uchar;
    *outsize = (*outsize).wrapping_add(1);
    *outsize;
    if *outsize & (*outsize).wrapping_sub(1 as libc::c_int as size_t) == 0 {
        *out = (if *outsize == 0 as libc::c_int as size_t {
    ...
    *(*out)
        .offset(
            *outsize as isize,
        ) = (insize % 256 as libc::c_int as size_t) as libc::c_uchar;
    *outsize = (*outsize).wrapping_add(1);
    *outsize;
    if *outsize & (*outsize).wrapping_sub(1 as libc::c_int as size_t) == 0 {
        *out = (if *outsize == 0 as libc::c_int as size_t {
    ...
    *(*out)
        .offset(
            *outsize as isize,
        ) = ((insize >> 8 as libc::c_int) % 256 as libc::c_int as size_t)
        as libc::c_uchar;
    *outsize = (*outsize).wrapping_add(1);
    *outsize;
    if *outsize & (*outsize).wrapping_sub(1 as libc::c_int as size_t) == 0 {
    ...
    *(*out)
        .offset(
            *outsize as isize,
        ) = ((insize >> 16 as libc::c_int) % 256 as libc::c_int as size_t)
        as libc::c_uchar;
    *outsize = (*outsize).wrapping_add(1);
    *outsize;
    if *outsize & (*outsize).wrapping_sub(1 as libc::c_int as size_t) == 0 {
    ...
    *(*out)
        .offset(
            *outsize as isize,
        ) = ((insize >> 24 as libc::c_int) % 256 as libc::c_int as size_t)
        as libc::c_uchar;
    *outsize = (*outsize).wrapping_add(1);
    *outsize;
