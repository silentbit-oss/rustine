...
static lil_value_t fnc_reflect(lil_t lil, size_t argc, lil_value_t *argv)
{
  ...
  {
    helper_fnc_reflect_1(lil, argc, argv);
  }
...
static lil_value_t fnc_enveval(lil_t lil, size_t argc, lil_value_t *argv)
{
  ...
  if (invars)
  {
    helper_fnc_enveval_1(&i, lil, invars, outvars, varvalues, varvalues_idx);
  }
  return r;
}
...
void helper_next_word_2(lil_t * const lil_ref, lil_value_t * const val_ref)
{
  lil_t lil = *lil_ref;
  lil_value_t val = *val_ref;
...
void helper_ee_unary_1(expreval_t * const ee)
{
...
void helper_ee_bitand_1(expreval_t * const ee)
{
  double odval = ee->dval;
  lilint_t oival = ee->ival;
  ee->head += 1;
...
void helper_ee_bitor_1(expreval_t * const ee)
{
  double odval = ee->dval;
  lilint_t oival = ee->ival;
  ee->head += 1;
...
void helper_ee_logand_1(expreval_t * const ee)
{
  double odval = ee->dval;
  lilint_t oival = ee->ival;
  ee->head += 2;
...
void helper_ee_logor_1(expreval_t * const ee)
{
  double odval = ee->dval;
  lilint_t oival = ee->ival;
  ee->head += 2;
...
lil_value_t helper_fnc_reflect_1(lil_t lil, size_t argc, lil_value_t * const argv)
{
  const char *target;
  unsigned int target_idx = 0;
  lil_env_t env = lil->env;
...
void helper_fnc_enveval_1(size_t * const i_ref, lil_t lil, lil_list_t invars, lil_list_t outvars, lil_value_t * const varvalues, unsigned int varvalues_idx)
{
  size_t i = *i_ref;
  if (outvars)
  {
...
void helper_helper_next_word_2_1(lil_t * const lil_ref, lil_value_t val, char sc)
{
  lil_t lil = *lil_ref;
  if ((lil->code[lil->head] == '[') || (lil->code[lil->head] == '$'))
  {
...
void helper_helper_ee_bitand_1_1(expreval_t * const ee, double odval)
{
  ee_equals(ee);
  if (ee->error)
  {
...
void helper_helper_ee_bitand_1_2(expreval_t * const ee, lilint_t oival)
{
  ee_equals(ee);
  if (ee->error)
  {
...
void helper_helper_ee_bitor_1_1(expreval_t * const ee, double odval)
{
  ee_bitand(ee);
  if (ee->error)
  {
...
void helper_helper_ee_bitor_1_2(expreval_t * const ee, lilint_t oival)
{
  ee_bitand(ee);
  if (ee->error)
  {
...
void helper_helper_ee_logand_1_1(expreval_t * const ee, double odval)
{
  ee_bitor(ee);
  if (ee->error)
  {
...
void helper_helper_ee_logand_1_2(expreval_t * const ee, lilint_t oival)
{
  ee_bitor(ee);
  if (ee->error)
  {
...
void helper_helper_ee_logor_1_1(expreval_t * const ee, double odval)
{
  ee_logand(ee);
  if (ee->error)
  {
...
void helper_helper_ee_logor_1_2(expreval_t * const ee, lilint_t oival)
{
  ee_logand(ee);
  if (ee->error)
  {
...
void helper_helper_helper_next_word_2_1_1(lil_t * const lil_ref, lil_value_t val)
{
  lil_t lil = *lil_ref;
  lil->head += 1;
...
void helper_helper_helper_ee_muldiv_1_2_1(expreval_t * const ee, lilint_t oival)
{
  ee->head += 1;
  ee_unary(ee);
  if (ee->error)
...
void helper_helper_helper_ee_muldiv_1_2_2(expreval_t * const ee, double odval)
{
  ee->head += 1;
  ee_unary(ee);
  if (ee->error)
