...
// hint:  ['any_purged_ref is a mutable refrence to bool', 'full_purge_ref is a mutable refrence to bool']
...
// hint:  ['field_idx_ref is a mutable refrence to size_t', 'bit_idx_ref is a mutable refrence to size_t']
