...
{
  (size <= (PTRDIFF_MAX - (sizeof(mi_padding_t)))) ? ((void) 0) : (_mi_assert_fail("size <= (MI_MAX_ALLOC_SIZE - MI_PADDING_SIZE)", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/alloc-aligned.c", 58, __func__));
  ((alignment != 0) && _mi_is_power_of_two(alignment)) ? ((void) 0) : (_mi_assert_fail("alignment != 0 && _mi_is_power_of_two(alignment)", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/alloc-aligned.c", 59, __func__));
  void *p;
  ...
  (adjust < alignment) ? ((void) 0) : (_mi_assert_fail("adjust < alignment", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/alloc-aligned.c", 90, __func__));
  ...
  (mi_page_usable_block_size(page) >= (adjust + size)) ? ((void) 0) : (_mi_assert_fail("mi_page_usable_block_size(page) >= adjust + size", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/alloc-aligned.c", 111, __func__));
  (((((uintptr_t) aligned_p) + offset) % alignment) == 0) ? ((void) 0) : (_mi_assert_fail("((uintptr_t)aligned_p + offset) % alignment == 0", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/alloc-aligned.c", 112, __func__));
  (mi_usable_size(aligned_p) >= size) ? ((void) 0) : (_mi_assert_fail("mi_usable_size(aligned_p)>=size", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/alloc-aligned.c", 113, __func__));
  (mi_usable_size(p) == (mi_usable_size(aligned_p) + adjust)) ? ((void) 0) : (_mi_assert_fail("mi_usable_size(p) == mi_usable_size(aligned_p)+adjust", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/alloc-aligned.c", 114, __func__));
  mi_page_t * const apage = _mi_ptr_page(aligned_p);
  void *unalign_p = _mi_page_ptr_unalign(apage, aligned_p);
  ((&p[p_idx]) == unalign_p) ? ((void) 0) : (_mi_assert_fail("p == unalign_p", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/alloc-aligned.c", 118, __func__));
...
{
  (_mi_is_power_of_two(alignment) && (alignment > 0)) ? ((void) 0) : (_mi_assert_fail("_mi_is_power_of_two(alignment) && (alignment > 0)", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/alloc-aligned.c", 20, __func__));
  if (alignment > size)
  {
    return 0;
  }
  ...
  if (ok)
  {
    ((bsize & (alignment - 1)) == 0) ? ((void) 0) : (_mi_assert_fail("(bsize & (alignment-1)) == 0", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/alloc-aligned.c", 24, __func__));
  }
  return ok;
}
...
{
  ((alignment != 0) && _mi_is_power_of_two(alignment)) ? ((void) 0) : (_mi_assert_fail("alignment != 0 && _mi_is_power_of_two(alignment)", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/alloc-aligned.c", 142, __func__));
  ...
  if ((offset == 0) && mi_malloc_is_naturally_aligned(size, alignment))
  {
    ...
    ((p == 0) || ((((uintptr_t) p) % alignment) == 0)) ? ((void) 0) : (_mi_assert_fail("p == NULL || ((uintptr_t)p % alignment) == 0", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/alloc-aligned.c", 156, __func__));
    ...
    {
      (0) ? ((void) 0) : (_mi_assert_fail("false", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/alloc-aligned.c", 163, __func__));
      mi_free(p);
    }
  }
  ...
  if (__builtin_expect(!(!((size <= (128 * (sizeof(void *)))) && (alignment <= size))), 1))
  {
    ...
    if (__builtin_expect(!(!(page->free != 0)), 1))
    {
      ...
      if (__builtin_expect(!(!is_aligned), 1))
      {
        ...
        (p != 0) ? ((void) 0) : (_mi_assert_fail("p != NULL", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/alloc-aligned.c", 202, __func__));
        (((((uintptr_t) p) + offset) % alignment) == 0) ? ((void) 0) : (_mi_assert_fail("((uintptr_t)p + offset) % alignment == 0", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/alloc-aligned.c", 203, __func__));
        if (p != 0)
        {
          (mi_usable_size(p) == size) ? ((void) 0) : (_mi_assert_fail("mi_usable_size(p)==(size)", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/alloc-aligned.c", 204, __func__));
          ;
        }
        ;
        return p;
...
{
  (alignment > 0) ? ((void) 0) : (_mi_assert_fail("alignment > 0", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/alloc-aligned.c", 279, __func__));
...
{
  (alignment > 0) ? ((void) 0) : (_mi_assert_fail("alignment > 0", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/alloc-aligned.c", 304, __func__));
  if (alignment <= (sizeof(uintptr_t)))
  {
    return _mi_heap_realloc_zero(heap, p, newsize, zero);
  }
