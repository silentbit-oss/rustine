...
uintptr_t _mi_os_random_weak(uintptr_t extra_seed)
{
  ...
  (x != 0) ? ((void) 0) : (_mi_assert_fail("x != 0", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/random.c", 168, __func__));
  return x;
}
...
static void chacha_split(mi_random_ctx_t *ctx, uint64_t nonce, mi_random_ctx_t *ctx_new)
{
  ...
  ((ctx->input[14] != ctx_new->input[14]) || (ctx->input[15] != ctx_new->input[15])) ? ((void) 0) : (_mi_assert_fail("ctx->input[14] != ctx_new->input[14] || ctx->input[15] != ctx_new->input[15]", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/random.c", 118, __func__));
