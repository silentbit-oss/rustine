// element in merge of:  _mi_assert_fail,_mi_fprintf,_mi_fputs,_mi_vsnprintf,helper__mi_vsnprintf_1,helper_helper__mi_vsnprintf_1_2,mi_out_buf,mi_out_get_default,mi_vfprintf
...
static void mi_out_buf(const char *msg, void *arg)
{
  ...
  ((start + n) <= ((size_t) (16 * 1024))) ? ((void) 0) : (_mi_assert_fail("start + n <= MI_MAX_DELAY_OUTPUT", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/options.c", 357, __func__));
...
void helper__mi_vsnprintf_1(unsigned int * const in_idx_ref, va_list args, char * const end, const char * const in, char * const out)
{
  ...
  if (c != '%')
  {
    helper_helper__mi_vsnprintf_1_1(&in_idx, &c, end, in, out);
  }
  else
  {
    helper_helper__mi_vsnprintf_1_2(&in_idx, &c, args, end, in, out);
  }
  *in_idx_ref = in_idx;
}
...
/*** DEPENDENCIES:
void helper_helper__mi_vsnprintf_1_1(unsigned int * const in_idx_ref, char * const c_ref, char * const end, const char * const in, char * const out)
{
  unsigned int in_idx = *in_idx_ref;
  char c = *c_ref;
  if (c == '\\')
...
void helper_helper__mi_vsnprintf_1_2(unsigned int * const in_idx_ref, char * const c_ref, va_list args, char * const end, const char * const in, char * const out)
{
  unsigned int in_idx = *in_idx_ref;
  char c = *c_ref;
  c = in[in_idx];
  ...
  if ((c >= '1') && (c <= '9'))
  {
    helper_helper_helper__mi_vsnprintf_1_2_3(&in_idx, &c, &width, in);
  }
  if (((c == 'z') || (c == 't')) || (c == 'L'))
  {
    numtype = c;
    ...
    if (c == 'l')
  {
    helper_helper_helper__mi_vsnprintf_1_2_1(&in_idx, &c, &numtype, in);
  }
  char *start = out;
    ...
    if (c == 's')
  {
    ...
    if (((c == 'p') || (c == 'x')) || (c == 'u'))
  {
    helper_helper_helper__mi_vsnprintf_1_2_4(&fill, &width, &start_idx, args, end, out, c, numtype, numplus);
  }
  else
    if ((c == 'i') || (c == 'd'))
  {
    helper_helper_helper__mi_vsnprintf_1_2_2(args, end, out, numtype, numplus);
  }
  else
    if ((c >= ' ') && (c <= '~'))
  {
  ...
  (out <= end) ? ((void) 0) : (_mi_assert_fail("out <= end", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/libc.c", 269, __func__));
  (out >= (&start[start_idx])) ? ((void) 0) : (_mi_assert_fail("out >= start", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/libc.c", 270, __func__));
...
/*** DEPENDENCIES:
void helper_helper_helper__mi_vsnprintf_1_2_3(unsigned int * const in_idx_ref, char * const c_ref, size_t * const width_ref, const char * const in)
{
  unsigned int in_idx = *in_idx_ref;
  char c = *c_ref;
...
----------------------------
void helper_helper_helper__mi_vsnprintf_1_2_2(va_list args, char * const end, char * const out, char numtype, char numplus)
{
  intmax_t x = 0;
  if (numtype == 'z')
  {
...
----------------------------
void helper_helper_helper__mi_vsnprintf_1_2_1(unsigned int * const in_idx_ref, char * const c_ref, char * const numtype_ref, const char * const in)
{
  unsigned int in_idx = *in_idx_ref;
  char c = *c_ref;
...
----------------------------
void helper_helper_helper__mi_vsnprintf_1_2_4(char * const fill_ref, size_t * const width_ref, unsigned int * const start_idx_ref, va_list args, char * const end, char * const out, char c, char numtype, char numplus)
{
  char fill = *fill_ref;
  size_t width = *width_ref;
...
int _mi_vsnprintf(char *buf, size_t bufsize, const char *fmt, va_list args)
{
  ...
  (out <= end) ? ((void) 0) : (_mi_assert_fail("out <= end", "/home/ubuntu/tmp/Rustine-Dev/subjects/mimalloc/src/libc.c", 280, __func__));
  *out = 0;
  return (int) (out - buf);
}
