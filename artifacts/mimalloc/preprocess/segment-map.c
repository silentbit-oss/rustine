# 0 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/segment-map.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/segment-map.c"
# 15 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/segment-map.c"
...
# 16 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/segment-map.c" 2
...
# 17 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/segment-map.c" 2
# 42 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/segment-map.c"
...
static _Atomic(mi_segmap_part_t*) mi_segment_map[(((48*1024ULL*(((1024UL)*(1024UL))*(1024UL))) / ((8*((1<<(3))*(1024UL) - 128)) * ((1UL<<( 9 + (13 + (3))))))) + 1)];
...
static mi_segmap_part_t* mi_segment_map_index_of(const mi_segment_t* segment, bool create_on_demand, size_t* idx, size_t* bitidx) {
  ...
  *idx = 0;
  *bitidx = 0;
  if ((uintptr_t)segment >= (48*1024ULL*(((1024UL)*(1024UL))*(1024UL)))) return 0;
  const uintptr_t segindex = ((uintptr_t)segment) / ((8*((1<<(3))*(1024UL) - 128)) * ((1UL<<( 9 + (13 + (3))))));
  if (segindex >= (((48*1024ULL*(((1024UL)*(1024UL))*(1024UL))) / ((8*((1<<(3))*(1024UL) - 128)) * ((1UL<<( 9 + (13 + (3))))))) + 1)) return 0;
  mi_segmap_part_t* part = atomic_load_explicit(&mi_segment_map[segindex],memory_order_relaxed);


  if (__builtin_expect(!!(part == 0),0)) {
    if (!create_on_demand) return 0;
    mi_memid_t memid;
  ...
  ((part != 0) ? (void)0 : _mi_assert_fail("part != NULL","/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/segment-map.c",74,__func__));
...
static mi_segment_t* _mi_segment_of(const void* p) {
  ...
  if (__builtin_expect(!!((mask & ((uintptr_t)1 << bitidx)) != 0),1)) {
    ...
    ((cookie_ok) ? (void)0 : _mi_assert_fail("cookie_ok","/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/segment-map.c",119,__func__)); (void)(cookie_ok);
    return segment;
  }
  return 0;
}
...
void _mi_segment_map_unsafe_destroy(void) {
  for (size_t i = 0; i < (((48*1024ULL*(((1024UL)*(1024UL))*(1024UL))) / ((8*((1<<(3))*(1024UL) - 128)) * ((1UL<<( 9 + (13 + (3))))))) + 1); i++) {
