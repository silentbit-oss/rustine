...
# 35 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/os.c"
...
# 103 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/os.c"
static _Atomic(uintptr_t)aligned_base;
# 116 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/os.c"
void* _mi_os_get_aligned_hint(size_t try_alignment, size_t size)
{
  if (try_alignment <= 1 || try_alignment > (1UL<<( 9 + (13 + (3))))) return 0;
  if (mi_os_mem_config.virtual_address_bits < 46) return 0;
  size = _mi_align_up(size, (1UL<<( 9 + (13 + (3)))));
  if (size > 1*(((1024UL)*(1024UL))*(1024UL))) return 0;
  ...
  if (hint%try_alignment != 0) return 0;
  return (void*)hint;
}
# 151 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/os.c"
...
# 211 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/os.c"
...
static void* mi_os_prim_alloc_aligned(size_t size, size_t alignment, bool commit, bool allow_large, bool* is_large, bool* is_zero, void** base) {
  ...
  if (((uintptr_t)p % alignment) == 0) {
    *base = p;
    ...
    if (p != 0) { mi_os_prim_free(p, size, (commit ? size : 0)); }
  ...
  ((p == 0 || (p != 0 && *base != 0 && ((uintptr_t)p % alignment) == 0)) ? (void)0 : _mi_assert_fail("p == NULL || (p != NULL && *base != NULL && ((uintptr_t)p % alignment) == 0)","/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/os.c",314,__func__));
  return p;
}
...
void* _mi_os_alloc_aligned(size_t size, size_t alignment, bool commit, bool allow_large, mi_memid_t* memid)
{
  ...
  *memid = _mi_memid_create_os(p, size, commit, os_is_zero, os_is_large);
  ...
  if (commit) { ((memid->initially_committed) ? (void)0 : _mi_assert_fail("memid->initially_committed","/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/os.c",358,__func__)); }
  return p;
}
...
# 394 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/os.c"
...
# 608 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/os.c"
...
# 644 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/os.c"
