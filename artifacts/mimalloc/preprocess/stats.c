...
# 131 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/stats.c"
...
# 274 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/stats.c"
 ...
 void mi_process_info(size_t* elapsed_msecs, size_t* user_msecs, size_t* system_msecs, size_t* current_rss, size_t* peak_rss, size_t* current_commit, size_t* peak_commit, size_t* page_faults)
{
  ...
  pinfo.current_commit = (size_t)(atomic_load_explicit((_Atomic(int64_t)*)&_mi_stats_main.committed.current,memory_order_relaxed));
  pinfo.peak_commit = (size_t)(atomic_load_explicit((_Atomic(int64_t)*)&_mi_stats_main.committed.peak,memory_order_relaxed));
...
static void mi_heap_buf_print_count_bin(mi_heap_buf_t* hbuf, const char* prefix, mi_stat_count_t* stat, size_t bin, bool add_comma) {
  ...
  const size_t pagesize = (binsize <= ((1UL<<((13 + (3))))/8) ? (1UL<<((13 + (3)))) :
                            (binsize <= ((1UL<<( 3 + ((13 + (3)))))/8) ? (1UL<<( 3 + ((13 + (3))))) :
