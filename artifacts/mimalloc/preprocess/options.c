...
# 33 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/options.c"
...
# 106 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/options.c"
static mi_option_desc_t options[_mi_option_last] =
{


  { 1, UNINIT, mi_option_show_errors, "show_errors", 0 },



  { 0, UNINIT, mi_option_show_stats, "show_stats", 0 },
  { 0, UNINIT, mi_option_verbose, "verbose", 0 },


  { 1,
       UNINIT, mi_option_eager_commit, "eager_commit", 0 },
  { 2,
       UNINIT, mi_option_arena_eager_commit, "arena_eager_commit", "eager_region_commit" },
  { 1, UNINIT, mi_option_purge_decommits, "purge_decommits", "reset_decommits" },
  { 2,
       UNINIT, mi_option_allow_large_os_pages, "allow_large_os_pages", "large_os_pages" },
  { 0,
       UNINIT, mi_option_reserve_huge_os_pages, "reserve_huge_os_pages", 0 },
  {-1, UNINIT, mi_option_reserve_huge_os_pages_at, "reserve_huge_os_pages_at", 0 },
  { 0,
       UNINIT, mi_option_reserve_os_memory, "reserve_os_memory", 0 },
  { 0, UNINIT, mi_option_deprecated_segment_cache, "deprecated_segment_cache", 0 },
  { 0, UNINIT, mi_option_deprecated_page_reset, "deprecated_page_reset", 0 },
  { 0, UNINIT, mi_option_abandoned_page_purge, "abandoned_page_purge", "abandoned_page_reset" },
  { 0, UNINIT, mi_option_deprecated_segment_reset, "deprecated_segment_reset", 0 },



  { 1, UNINIT, mi_option_eager_commit_delay, "eager_commit_delay", 0 },

  { 10, UNINIT, mi_option_purge_delay, "purge_delay", "reset_delay" },
  { 0, UNINIT, mi_option_use_numa_nodes, "use_numa_nodes", 0 },
  { 0, UNINIT, mi_option_disallow_os_alloc, "disallow_os_alloc", "limit_os_alloc" },
  { 100, UNINIT, mi_option_os_tag, "os_tag", 0 },
  { 32, UNINIT, mi_option_max_errors, "max_errors", 0 },
  { 32, UNINIT, mi_option_max_warnings, "max_warnings", 0 },
  { 10, UNINIT, mi_option_max_segment_reclaim, "max_segment_reclaim", 0},
  { 0, UNINIT, mi_option_destroy_on_exit, "destroy_on_exit", 0},
  { 1024L*1024L, UNINIT, mi_option_arena_reserve, "arena_reserve", 0 },
  { 10, UNINIT, mi_option_arena_purge_mult, "arena_purge_mult", 0 },
  { 1, UNINIT, mi_option_purge_extend_delay, "purge_extend_delay", "decommit_extend_delay" },
  { 0, UNINIT, mi_option_abandoned_reclaim_on_free, "abandoned_reclaim_on_free", 0 },
  { 0, UNINIT, mi_option_disallow_arena_alloc, "disallow_arena_alloc", 0 },
  { 400, UNINIT, mi_option_retry_on_oom, "retry_on_oom", 0 },



  { 0, UNINIT, mi_option_visit_abandoned, "visit_abandoned", 0 },

  { 0, UNINIT, mi_option_guarded_min, "guarded_min", 0 },
  { (((1024UL)*(1024UL))*(1024UL)), UNINIT, mi_option_guarded_max, "guarded_max", 0 },
  { 0, UNINIT, mi_option_guarded_precise, "guarded_precise", 0 },
  { 0,
         UNINIT, mi_option_guarded_sample_rate, "guarded_sample_rate", 0},
  { 0, UNINIT, mi_option_guarded_sample_seed, "guarded_sample_seed", 0},
  { 0, UNINIT, mi_option_target_segments_per_thread, "target_segments_per_thread", 0 },
  { 10000, UNINIT, mi_option_generic_collect, "generic_collect", 0 },
};
...
# 191 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/options.c"
...
# 330 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/options.c"
...
# 378 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/options.c"
...
# 415 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/options.c"
...
# 561 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/options.c"
}
...
# 1 "/home/ubuntu/C2RustTranslation/pipeline/preprocess/fake_libc_include/stdlib.h" 1
# 589 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/options.c" 2
# 1 "/home/ubuntu/C2RustTranslation/pipeline/preprocess/fake_libc_include/string.h" 1
# 590 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/options.c" 2
