...
# 80 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/free.c"
...
static inline mi_segment_t* mi_checked_ptr_segment(const void* p, const char* msg)
{
  ...
  if (__builtin_expect(!!(segment==0),0)) return segment;
...
void mi_free(void* p)
{
  ...
  if (__builtin_expect(!!(segment==0),0)) return;
...
# 208 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/free.c"
...
static void mi_free_block_mt(mi_page_t* page, mi_segment_t* segment, mi_block_t* block)
{
  ...
  if (_mi_option_get_fast(mi_option_abandoned_reclaim_on_free) != 0 &&
      ...
      atomic_load_explicit(&segment->thread_id,memory_order_relaxed) == 0 &&
...
# 291 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/free.c"
...
static inline size_t _mi_usable_size(const void* p, const char* msg) {
  ...
  if (__builtin_expect(!!(segment==0),0)) return 0;
...
# 377 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/free.c"
...
# 426 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/free.c"
...
static size_t mi_page_usable_size_of(const mi_page_t* page, const mi_block_t* block) {
  ...
  ((ok) ? (void)0 : _mi_assert_fail("ok","/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/free.c",445,__func__)); ((delta <= bsize) ? (void)0 : _mi_assert_fail("delta <= bsize","/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/free.c",445,__func__));
...
# 483 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/free.c"
...
# 526 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/free.c"
static void mi_stat_free(const mi_page_t* page, const mi_block_t* block) {
  (void)(block);
...
# 58 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/alloc.c"
  ;
...
# 147 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/alloc.c"
  ...
  if ((p)!=0) { ((mi_usable_size(p)==(size)) ? (void)0 : _mi_assert_fail("mi_usable_size(p)==(size)","/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/alloc.c",149,__func__)); ; };
...
extern inline void* _mi_heap_malloc_zero_ex(mi_heap_t* heap, size_t size, bool zero, size_t huge_alignment) {
  ...
  if (__builtin_expect(!!(size <= ((128)*sizeof(void*))),1)) {
    ...
    if ((p)!=0) { ((mi_usable_size(p)==(size)) ? (void)0 : _mi_assert_fail("mi_usable_size(p)==(size)","/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/alloc.c",185,__func__)); ; };
...
# 346 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/alloc.c"
 char* mi_heap_strdup(mi_heap_t* heap, const char* s) {
  if (s == 0) return 0;
...
# 413 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/alloc.c"
char* mi_heap_realpath(mi_heap_t* heap, const char* fname, char* resolved_name) {
  if (resolved_name != 0) {
...
# 438 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/alloc.c"
}
...
# 481 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/alloc.c"
