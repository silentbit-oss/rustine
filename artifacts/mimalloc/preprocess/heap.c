...
# 12 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/heap.c" 2

# 1 "/home/ubuntu/C2RustTranslation/pipeline/preprocess/fake_libc_include/string.h" 1
# 14 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/heap.c" 2
# 24 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/heap.c"
...
# 85 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/heap.c"
...
static void mi_heap_free(mi_heap_t* heap) {
  ...
  ((curr == heap) ? (void)0 : _mi_assert_fail("curr == heap","/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/heap.c",297,__func__));
  if (curr == heap) {
...
# 383 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/heap.c"
void mi_heap_destroy(mi_heap_t* heap) {
...
static void mi_heap_absorb(mi_heap_t* heap, mi_heap_t* from) {
  ...
  if (from==0 || from->page_count == 0) return;
...
static bool mi_heaps_are_compatible(mi_heap_t* heap1, mi_heap_t* heap2) {
  return (heap1->tag == heap2->tag &&
          heap1->arena_id == heap2->arena_id);
}
...
# 511 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/heap.c"
