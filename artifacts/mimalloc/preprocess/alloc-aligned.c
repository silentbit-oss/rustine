...
# 49 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/alloc-aligned.c"
...
static void* mi_heap_malloc_zero_aligned_at_overalloc(mi_heap_t* const heap, const size_t size, const size_t alignment, const size_t offset, const bool zero)
{
  ...
  if (__builtin_expect(!!(alignment > ((1UL<<( 9 + (13 + (3)))) >> 1)),0)) {
    ...
    p = _mi_heap_malloc_zero_ex(heap, oversize, 0, alignment);
  ...
  ((p == unalign_p) ? (void)0 : _mi_assert_fail("p == unalign_p","/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/alloc-aligned.c",113,__func__));
...
# 186 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/alloc-aligned.c"
  if (__builtin_expect(!!(size <= ((128)*sizeof(void*)) && alignment <= size),1)) {
    ...
    if (__builtin_expect(!!(page->free != 0),1)) {
      ...
      if (__builtin_expect(!!(is_aligned),1))
      {
        ...
        if ((p)!=0) { ((mi_usable_size(p)==(size)) ? (void)0 : _mi_assert_fail("mi_usable_size(p)==(size)","/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/alloc-aligned.c",197,__func__)); ; };
        return p;
      }
    }
  }
...
# 229 "/home/ubuntu/C2RustTranslation/subjects/mimalloc/src/alloc-aligned.c"
 void* mi_heap_zalloc_aligned_at(mi_heap_t* heap, size_t size, size_t alignment, size_t offset) {
