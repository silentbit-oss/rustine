...
pub struct _IO_FILE {
    ...
    pub _codecvt: *mut crate::src::openaptxenc::_IO_codecvt,
...
unsafe fn main_0(
    ...
    let mut ctx: *mut crate::src::openaptx::aptx_context = 0 as *mut crate::src::openaptx::aptx_context;
    hd = 0 as libc::c_int;
    i = 1 as libc::c_int;
    while i < argc {
    ...
    ctx = crate::src::openaptx::aptx_init(hd);
    ...
    while length > 0 as libc::c_int as size_t {
        processed = crate::src::openaptx::aptx_decode_sync(
            ctx,
    ...
    dropped = crate::src::openaptx::aptx_decode_sync_finish(ctx);
    ...
    crate::src::openaptx::aptx_finish(ctx);
    return ret;
}
pub fn main() {
