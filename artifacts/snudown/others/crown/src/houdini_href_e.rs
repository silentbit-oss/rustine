...
static mut HREF_SAFE: [libc::c_char; 256] = [
...
#[no_mangle]
pub unsafe extern "C" fn houdini_escape_href(
    mut ob: *mut buf,
    mut src: *const uint8_t,
    mut size: size_t,
) {
    static mut hex_chars: [libc::c_char; 17] = unsafe {
        *::core::mem::transmute::<&[u8; 17], &[libc::c_char; 17]>(b"0123456789ABCDEF\0")
    };
    let mut i: size_t = 0 as libc::c_int as size_t;
    let mut org: size_t = 0;
    let mut hex_str: [libc::c_char; 3] = [0; 3];
    bufgrow(ob, size * 12 as libc::c_int as size_t / 10 as libc::c_int as size_t);
    hex_str[0 as libc::c_int as usize] = '%' as i32 as libc::c_char;
    while i < size {
        org = i;
        while i < size
            && HREF_SAFE[*src.offset(i as isize) as usize] as libc::c_int
                == 1 as libc::c_int
        {
            i = i.wrapping_add(1);
            i;
        ...
        if HREF_SAFE[*src.offset(i as isize) as usize] as libc::c_int == 2 as libc::c_int
        {
            i = i.wrapping_add(1);
            i;
        } else {
            match *src.offset(i as isize) as libc::c_int {
                ...
                _ => {
                    hex_str[1 as libc::c_int
                        as usize] = hex_chars[(*src.offset(i as isize) as libc::c_int
                        >> 4 as libc::c_int & 0xf as libc::c_int) as usize];
                    hex_str[2 as libc::c_int
                        as usize] = hex_chars[(*src.offset(i as isize) as libc::c_int
                        & 0xf as libc::c_int) as usize];
                    bufput(
                        ob,
                        hex_str.as_mut_ptr() as *const libc::c_void,
