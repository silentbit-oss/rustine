...
pub unsafe extern "C" fn csv_error(mut p: *const csv_parser) -> libc::c_int {
    ...
    {} else {
        __assert_fail(
            ...
            b"int csv_error(const struct csv_parser *)\0" as *const u8 as *const libc::c_char,
        );
    }
    return (*p).status;
}
...
pub unsafe extern "C" fn csv_get_delim(mut p: *const csv_parser) -> libc::c_uchar {
    ...
    {} else {
        __assert_fail(
            ...
            b"unsigned char csv_get_delim(const struct csv_parser *)\0" as *const u8 as *const libc::c_char,
        );
    }
    return (*p).delim_char;
}
...
pub unsafe extern "C" fn csv_get_quote(mut p: *const csv_parser) -> libc::c_uchar {
    ...
    {} else {
        __assert_fail(
            ...
            b"unsigned char csv_get_quote(const struct csv_parser *)\0" as *const u8 as *const libc::c_char,
        );
    }
    return (*p).quote_char;
}
...
pub unsafe extern "C" fn csv_parse(
    ...
    {} else {
        __assert_fail(
            ...
            b"size_t csv_parse(struct csv_parser *, const void *, size_t, void (*)(void *, size_t, void *), void (*)(int, void *), void *)\0" as *const u8 as *const libc::c_char,
        );
    }
    if s.is_null() {();
        return 0 as libc::c_int as size_t;
