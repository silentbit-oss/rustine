# 0 "/app/subjects/json-c/tests/test_parse.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/app/subjects/json-c/tests/test_parse.c"
...
# 11 "/app/subjects/json-c/tests/test_parse.c" 2

# 1 "/app/subjects/json-c/json_visit.h" 1
# 15 "/app/subjects/json-c/json_visit.h"
typedef int(json_c_visit_userfunc)(json_object *jso, int flags, json_object *parent_jso,
                                   const char *jso_key, size_t *jso_index, void *userarg);
# 37 "/app/subjects/json-c/json_visit.h"
extern int json_c_visit(json_object *jso, int future_flags, json_c_visit_userfunc *userfunc,
                             void *userarg);
# 13 "/app/subjects/json-c/tests/test_parse.c" 2
...
struct incremental_step
{
 ...
 int tok_flags;
    ...
    {"\"\xc3\xa4\"", -1, -1, json_tokener_success, 1, 0x01},
    ...
    {"{\"foo\":9}{\"bar\":8}", -1, 9, json_tokener_error_parse_unexpected, 1, 0x01},
    ...
    {"[02]", -1, 3, json_tokener_error_parse_number, 1, 0x01},
    ...
    {"0e", 3, 2, json_tokener_error_parse_eof, 1, 0x01},
    {"[0e]", -1, -1, json_tokener_success, 1, 0},
    {"[0e]", -1, 3, json_tokener_error_parse_number, 1, 0x01},

    {"0e+", 3, 3, json_tokener_continue, 1, 0},
    {"0e+", 4, 3, json_tokener_success, 1, 0},
    {"0e+", 4, 3, json_tokener_error_parse_eof, 1, 0x01},
    {"[0e+]", -1, -1, json_tokener_success, 1, 0},
    {"[0e+]", -1, 4, json_tokener_error_parse_number, 1, 0x01},
    ...
    {"0e+-", 5, 3, json_tokener_error_parse_number, 1, 0x01},
    ...
    {"infinity", 9, 8, json_tokener_success, 1, 0},
    {"infinity", 9, 0, json_tokener_error_parse_unexpected, 1, 0x01},
    {"-infinity", 10, 9, json_tokener_success, 1, 0},
    {"-infinity", 10, 1, json_tokener_error_parse_unexpected, 1, 0x01},
 ...
 {"[-9223372036854775809]", 23, 21, json_tokener_error_parse_number, 1, 0x01},
...
# 511 "/app/subjects/json-c/tests/test_parse.c"
    ...
    {"\'foo\'", -1, 0, json_tokener_error_parse_unexpected, 1, 0x01},
    ...
    {"[1,2,3,]", -1, -1, json_tokener_success, 0, 0},
    {"[1,2,3,]", -1, 7, json_tokener_error_parse_unexpected, 1, 0x01},
    {"[1,2,,3,]", -1, 5, json_tokener_error_parse_unexpected, 0, 0},
    {"[1,2,,3,]", -1, 5, json_tokener_error_parse_unexpected, 0, 0x01},

    {"{\"a\":1,}", -1, 7, json_tokener_error_parse_unexpected, 1, 0x01},
    ...
    {"\x22\xe4\xb8\x96\xe7\x95\x8c\x22", -1, -1, json_tokener_success, 1,
     0x10},
    {"\x22\xe4\xb8", -1, 3, json_tokener_error_parse_utf8_string, 0, 0x10},
    ...
    {"\x22\xcf\x80\xcf\x86\x22", -1, -1, json_tokener_success, 1, 0x10},
    {"\x22\xf0\xa5\x91\x95\x22", -1, -1, json_tokener_success, 1, 0x10},
    ...
    {"\x20\x20\x22\xe4\xb8\x96\x22", -1, -1, json_tokener_success, 1, 0x10},
    ...
    {"\x22\x5c\x75\x64\x38\x35\x35\xc0\x75\x64\x63\x35\x35\x22", -1, 8,
     json_tokener_error_parse_utf8_string, 1, 0x10},
    ...
    { "\"\x01\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x02\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x03\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x04\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x05\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x06\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x07\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x08\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x09\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x0a\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x0b\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x0c\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x0d\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x0e\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x0f\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x10\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x11\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x12\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x13\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x14\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x15\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x16\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x17\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x18\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x19\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x1a\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x1b\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x1c\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x1d\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x1e\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },
    { "\"\x1f\"", -1, 1, json_tokener_error_parse_string, 1, 0x01 },

    {0, -1, -1, json_tokener_success, 0, 0},
};
...
static void test_incremental_parse(void)
{
 ...
 tok = json_tokener_new();
 for (ii = 0; incremental_steps[ii].string_to_parse != 0; ii++)
 {
  int this_step_ok = 0;
