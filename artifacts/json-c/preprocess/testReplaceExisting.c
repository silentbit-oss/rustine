# 0 "/app/subjects/json-c/tests/testReplaceExisting.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/app/subjects/json-c/tests/testReplaceExisting.c"



# 1 "/app/pipeline/preprocess/fake_libc_include/stddef.h" 1
# 1 "/app/pipeline/preprocess/fake_libc_include/_fake_defines.h" 1
# 2 "/app/pipeline/preprocess/fake_libc_include/stddef.h" 2
...
# 3 "/app/pipeline/preprocess/fake_libc_include/stddef.h" 2
# 5 "/app/subjects/json-c/tests/testReplaceExisting.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/stdio.h" 1
# 6 "/app/subjects/json-c/tests/testReplaceExisting.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/stdlib.h" 1
# 7 "/app/subjects/json-c/tests/testReplaceExisting.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/string.h" 1
# 8 "/app/subjects/json-c/tests/testReplaceExisting.c" 2
...
# 10 "/app/subjects/json-c/tests/testReplaceExisting.c" 2
...
int main(int argc, char **argv)
{
 ...
 int orig_count = 0;
 char *key0 = 0; struct json_object *val0 = 0; for (struct lh_entry *entrykey0 = lh_table_head(json_object_get_object(my_object)), *entry_nextkey0 = 0; ({ if (entrykey0) { key0 = (char *)lh_entry_k(entrykey0); val0 = (struct json_object *)lh_entry_v(entrykey0); entry_nextkey0 = lh_entry_next(entrykey0); }; entrykey0; }); entrykey0 = entry_nextkey0)
 {
  printf("Key at index %d is [%s] %d", orig_count, key0, (val0 == 0));
 ...
 orig_count = 0;
 char *key = 0; struct json_object *val = 0; for (struct lh_entry *entrykey = lh_table_head(json_object_get_object(my_object)), *entry_nextkey = 0; ({ if (entrykey) { key = (char *)lh_entry_k(entrykey); val = (struct json_object *)lh_entry_v(entrykey); entry_nextkey = lh_entry_next(entrykey); }; entrykey; }); entrykey = entry_nextkey)
 {
  printf("Key at index %d is [%s] %d\n", orig_count, key, (val == 0));
  orig_count++;
 ...
 int new_count = 0;
 int retval = 0;
 char *key2 = 0; struct json_object *val2 = 0; for (struct lh_entry *entrykey2 = lh_table_head(json_object_get_object(my_object)), *entry_nextkey2 = 0; ({ if (entrykey2) { key2 = (char *)lh_entry_k(entrykey2); val2 = (struct json_object *)lh_entry_v(entrykey2); entry_nextkey2 = lh_entry_next(entrykey2); }; entrykey2; }); entrykey2 = entry_nextkey2)
 {
  printf("Key at index %d is [%s] %d\n", new_count, key2, (val2 == 0));
  new_count++;
