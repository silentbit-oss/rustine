# 0 "/app/subjects/json-c/tests/test_util_file.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/app/subjects/json-c/tests/test_util_file.c"
...
# 5 "/app/subjects/json-c/tests/test_util_file.c" 2





# 1 "/app/pipeline/preprocess/fake_libc_include/fcntl.h" 1
# 11 "/app/subjects/json-c/tests/test_util_file.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/limits.h" 1
# 12 "/app/subjects/json-c/tests/test_util_file.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/stddef.h" 1
# 13 "/app/subjects/json-c/tests/test_util_file.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/stdio.h" 1
# 14 "/app/subjects/json-c/tests/test_util_file.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/stdlib.h" 1
# 15 "/app/subjects/json-c/tests/test_util_file.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/string.h" 1
# 16 "/app/subjects/json-c/tests/test_util_file.c" 2

# 1 "/app/pipeline/preprocess/fake_libc_include/unistd.h" 1
# 18 "/app/subjects/json-c/tests/test_util_file.c" 2

# 1 "/app/pipeline/preprocess/fake_libc_include/assert.h" 1
# 20 "/app/subjects/json-c/tests/test_util_file.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/sys/stat.h" 1
# 1 "/app/pipeline/preprocess/fake_libc_include/_fake_defines.h" 1
# 2 "/app/pipeline/preprocess/fake_libc_include/sys/stat.h" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/_fake_typedefs.h" 1
# 3 "/app/pipeline/preprocess/fake_libc_include/sys/stat.h" 2
# 21 "/app/subjects/json-c/tests/test_util_file.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/sys/types.h" 1
# 22 "/app/subjects/json-c/tests/test_util_file.c" 2
...
# 24 "/app/subjects/json-c/tests/test_util_file.c" 2
...
# 26 "/app/subjects/json-c/tests/test_util_file.c" 2
...
int main(int argc, char **argv)
{
 ...
 if (json_c_version_num() != ((0 << 16) | (18 << 8) | 99))
 {
  printf("FAIL: Output from json_c_version_num(): %d "
         "does not match %d",
         json_c_version_num(), ((0 << 16) | (18 << 8) | 99));
  return 1;
 }
