# 0 "/app/subjects/json-c/strerror_override.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/app/subjects/json-c/strerror_override.c"
...
# 3 "/app/subjects/json-c/strerror_override.c" 2
...
static struct
{
 ...
 {EBADF, &"undef_EBADF"[6]},
 {ECHILD, &"undef_ECHILD"[6]},
 {EDEADLK, &"undef_EDEADLK"[6]},
 {ENOMEM, &"undef_ENOMEM"[6]},
 {EACCES, &"undef_EACCES"[6]},
 {EFAULT, &"undef_EFAULT"[6]},



 {EBUSY, &"undef_EBUSY"[6]},
 {EEXIST, &"undef_EEXIST"[6]},
 {EXDEV, &"undef_EXDEV"[6]},
 {ENODEV, &"undef_ENODEV"[6]},
 {ENOTDIR, &"undef_ENOTDIR"[6]},
 {EISDIR, &"undef_EISDIR"[6]},
 {EINVAL, &"undef_EINVAL"[6]},
 {ENFILE, &"undef_ENFILE"[6]},
 {EMFILE, &"undef_EMFILE"[6]},
 {ENOTTY, &"undef_ENOTTY"[6]},



 {EFBIG, &"undef_EFBIG"[6]},
 {ENOSPC, &"undef_ENOSPC"[6]},
 {ESPIPE, &"undef_ESPIPE"[6]},
 {EROFS, &"undef_EROFS"[6]},
 {EMLINK, &"undef_EMLINK"[6]},
 {EPIPE, &"undef_EPIPE"[6]},
 {EDOM, &"undef_EDOM"[6]},
 {ERANGE, &"undef_ERANGE"[6]},
 {EAGAIN, &"undef_EAGAIN"[6]},
 { 0, (char *)0 }
};
...
char *_json_c_strerror(int errno_in)
{
 ...
 for (ii = 0; errno_list[ii].errno_str != (char *)0; ii++)
 {
  ...
  for (start_idx = sizeof("ERRNO=") - 1, jj = 0; errno_str[jj] != '\0';
       jj++, start_idx++)
  {
 ...
 for (start_idx = sizeof("ERRNO=") - 1; ii >= 0; ii--, start_idx++)
 {
