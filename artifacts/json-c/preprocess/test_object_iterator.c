# 0 "/app/subjects/json-c/tests/test_object_iterator.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/app/subjects/json-c/tests/test_object_iterator.c"



# 1 "/app/subjects/json-c/build/config.h" 1
# 5 "/app/subjects/json-c/tests/test_object_iterator.c" 2
...
# 6 "/app/subjects/json-c/tests/test_object_iterator.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/stdlib.h" 1
# 7 "/app/subjects/json-c/tests/test_object_iterator.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/string.h" 1
# 8 "/app/subjects/json-c/tests/test_object_iterator.c" 2
...
# 10 "/app/subjects/json-c/tests/test_object_iterator.c" 2
...
# 11 "/app/subjects/json-c/tests/test_object_iterator.c" 2
...
extern struct json_object *json_tokener_parse_ex(struct json_tokener *tok, const char *str,
                                                      int len);
# 12 "/app/subjects/json-c/tests/test_object_iterator.c" 2

int main(int atgc, char **argv)
{
 const char *input = "{\n		\"string_of_digits\": \"123\",\n		\"regular_number\": 222,\n		\"decimal_number\": 99.55,\n		\"boolean_true\": true,\n		\"boolean_false\": false,\n		\"big_number\": 2147483649,\n		\"a_null\": null,\n		}";
# 25 "/app/subjects/json-c/tests/test_object_iterator.c"
