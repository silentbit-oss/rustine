# 0 "/app/subjects/json-c/tests/test1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/app/subjects/json-c/tests/test1.c"
...
# 14 "/app/subjects/json-c/tests/test1.c" 2
# 1 "/app/subjects/json-c/tests/parse_flags.h" 1


int parse_flags(int argc, char **argv);
# 15 "/app/subjects/json-c/tests/test1.c" 2
...
# 63 "/app/subjects/json-c/tests/test1.c"
...
int main(int argc, char **argv)
{
 ...
 json_object_put(my_array);
 my_array = json_object_new_array_ext(-2147483648 + 1);
 if (my_array != 0)
 {
...
# 380 "/app/subjects/json-c/tests/test1.c"
 json_object_put(my_string);
