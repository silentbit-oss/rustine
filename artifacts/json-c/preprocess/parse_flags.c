# 0 "/app/subjects/json-c/tests/parse_flags.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/app/subjects/json-c/tests/parse_flags.c"



# 1 "/app/subjects/json-c/build/config.h" 1
# 5 "/app/subjects/json-c/tests/parse_flags.c" 2
...
# 7 "/app/subjects/json-c/tests/parse_flags.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/string.h" 1
# 8 "/app/subjects/json-c/tests/parse_flags.c" 2
...
# 10 "/app/subjects/json-c/tests/parse_flags.c" 2
# 1 "/app/subjects/json-c/tests/parse_flags.h" 1


int parse_flags(int argc, char **argv);
# 11 "/app/subjects/json-c/tests/parse_flags.c" 2
...
int parse_flags(int argc, char **argv)
{
 ...
 {
  int jj;
  for (jj = 0; jj < (int)(sizeof(format_args) / sizeof(format_args[0])); jj++)
  {
