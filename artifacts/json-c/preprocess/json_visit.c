# 0 "/app/subjects/json-c/json_visit.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/app/subjects/json-c/json_visit.c"
...
# 9 "/app/subjects/json-c/json_visit.c" 2

# 1 "/app/subjects/json-c/build/config.h" 1
# 11 "/app/subjects/json-c/json_visit.c" 2
...
# 12 "/app/subjects/json-c/json_visit.c" 2
...
# 13 "/app/subjects/json-c/json_visit.c" 2
...
extern int json_c_visit(json_object *jso, int future_flags, json_c_visit_userfunc *userfunc,
                             void *userarg);
# 14 "/app/subjects/json-c/json_visit.c" 2
...
# 15 "/app/subjects/json-c/json_visit.c" 2
                         ...
                         size_t *jso_index, json_c_visit_userfunc *userfunc, void *userarg)
{
 ...
 {
  char *key = 0; struct json_object *child = 0; for (struct lh_entry *entrykey = lh_table_head(json_object_get_object(jso)), *entry_nextkey = 0; ({ if (entrykey) { key = (char *)lh_entry_k(entrykey); child = (struct json_object *)lh_entry_v(entrykey); entry_nextkey = lh_entry_next(entrykey); }; entrykey; }); entrykey = entry_nextkey)
  {
