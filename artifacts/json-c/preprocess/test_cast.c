# 0 "/app/subjects/json-c/tests/test_cast.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/app/subjects/json-c/tests/test_cast.c"
# 9 "/app/subjects/json-c/tests/test_cast.c"
# 1 "/app/subjects/json-c/build/config.h" 1
# 10 "/app/subjects/json-c/tests/test_cast.c" 2
...
# 11 "/app/subjects/json-c/tests/test_cast.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/stdlib.h" 1
# 12 "/app/subjects/json-c/tests/test_cast.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/string.h" 1
# 13 "/app/subjects/json-c/tests/test_cast.c" 2
...
# 15 "/app/subjects/json-c/tests/test_cast.c" 2
...
# 16 "/app/subjects/json-c/tests/test_cast.c" 2
...
extern struct json_object *json_tokener_parse_ex(struct json_tokener *tok, const char *str,
                                                      int len);
# 17 "/app/subjects/json-c/tests/test_cast.c" 2
...
# 18 "/app/subjects/json-c/tests/test_cast.c" 2
...
# 45 "/app/subjects/json-c/tests/test_cast.c"
 struct json_object *new_obj;

 new_obj = json_tokener_parse(input);
 printf("Parsed input: %s\n", input);
 printf("Result is %s\n", (new_obj == 0) ? "NULL (error!)" : "not NULL");
 if (!new_obj)
  return 1;
