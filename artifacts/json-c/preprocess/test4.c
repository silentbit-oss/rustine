# 0 "/app/subjects/json-c/tests/test4.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/app/subjects/json-c/tests/test4.c"
...
# 9 "/app/subjects/json-c/tests/test4.c" 2
...
# 15 "/app/subjects/json-c/tests/test4.c" 2
...
# 16 "/app/subjects/json-c/tests/test4.c" 2
...
extern struct json_object *json_tokener_parse_ex(struct json_tokener *tok, const char *str,
                                                      int len);
# 17 "/app/subjects/json-c/tests/test4.c" 2
...
# 18 "/app/subjects/json-c/tests/test4.c" 2
