# 0 "/app/subjects/json-c/tests/test_int_get.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/app/subjects/json-c/tests/test_int_get.c"
...
# 5 "/app/subjects/json-c/tests/test_int_get.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/stdio.h" 1
# 6 "/app/subjects/json-c/tests/test_int_get.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/errno.h" 1
# 7 "/app/subjects/json-c/tests/test_int_get.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/math.h" 1
# 8 "/app/subjects/json-c/tests/test_int_get.c" 2

# 1 "/app/subjects/json-c/build/json.h" 1
# 24 "/app/subjects/json-c/build/json.h"
...
# 25 "/app/subjects/json-c/build/json.h" 2
...
# 26 "/app/subjects/json-c/build/json.h" 2
...
# 27 "/app/subjects/json-c/build/json.h" 2
...
# 28 "/app/subjects/json-c/build/json.h" 2
# 1 "/app/subjects/json-c/json_object_iterator.h" 1
# 27 "/app/subjects/json-c/json_object_iterator.h"
# 1 "/app/pipeline/preprocess/fake_libc_include/stddef.h" 1
# 28 "/app/subjects/json-c/json_object_iterator.h" 2
# 36 "/app/subjects/json-c/json_object_iterator.h"
...
struct json_object;
# 74 "/app/subjects/json-c/json_object_iterator.h"
extern struct json_object_iterator json_object_iter_init_default(void);
# 107 "/app/subjects/json-c/json_object_iterator.h"
extern struct json_object_iterator json_object_iter_begin(struct json_object *obj);
# 137 "/app/subjects/json-c/json_object_iterator.h"
extern struct json_object_iterator json_object_iter_end(const struct json_object *obj);
# 154 "/app/subjects/json-c/json_object_iterator.h"
extern void json_object_iter_next(struct json_object_iterator *iter);
# 171 "/app/subjects/json-c/json_object_iterator.h"
extern const char *json_object_iter_peek_name(const struct json_object_iterator *iter);
# 192 "/app/subjects/json-c/json_object_iterator.h"
extern struct json_object *
json_object_iter_peek_value(const struct json_object_iterator *iter);
# 221 "/app/subjects/json-c/json_object_iterator.h"
extern json_bool json_object_iter_equal(const struct json_object_iterator *iter1,
                                             const struct json_object_iterator *iter2);
# 29 "/app/subjects/json-c/build/json.h" 2
# 1 "/app/subjects/json-c/json_patch.h" 1
# 16 "/app/subjects/json-c/json_patch.h"
# 1 "/app/subjects/json-c/json_pointer.h" 1
# 17 "/app/subjects/json-c/json_pointer.h"
# 1 "/app/subjects/json-c/json_object.h" 1
# 18 "/app/subjects/json-c/json_pointer.h" 2
# 42 "/app/subjects/json-c/json_pointer.h"
extern int json_pointer_get(struct json_object *obj, const char *path,
                                 struct json_object **res);
# 63 "/app/subjects/json-c/json_pointer.h"
extern int json_pointer_getf(struct json_object *obj, struct json_object **res,
                                  const char *path_fmt, ...);
# 90 "/app/subjects/json-c/json_pointer.h"
extern int json_pointer_set(struct json_object **obj, const char *path,
                                 struct json_object *value);
# 110 "/app/subjects/json-c/json_pointer.h"
extern int json_pointer_setf(struct json_object **obj, struct json_object *value,
                                  const char *path_fmt, ...);
# 17 "/app/subjects/json-c/json_patch.h" 2
# 25 "/app/subjects/json-c/json_patch.h"
struct json_patch_error {
# 35 "/app/subjects/json-c/json_patch.h"
 int errno_code;
...
# 73 "/app/subjects/json-c/json_patch.h"
extern int json_patch_apply(struct json_object *copy_from, struct json_object *patch,
                                 struct json_object **base, struct json_patch_error *patch_error);
# 30 "/app/subjects/json-c/build/json.h" 2
# 1 "/app/subjects/json-c/json_pointer.h" 1
# 31 "/app/subjects/json-c/build/json.h" 2
...
extern struct json_object *json_tokener_parse_ex(struct json_tokener *tok, const char *str,
                                                      int len);
# 32 "/app/subjects/json-c/build/json.h" 2
...
# 33 "/app/subjects/json-c/build/json.h" 2
...
# 34 "/app/subjects/json-c/build/json.h" 2
# 10 "/app/subjects/json-c/tests/test_int_get.c" 2
# 33 "/app/subjects/json-c/tests/test_int_get.c"
int main(int argc, char **argv)
{
 { struct json_object *jtmp = json_object_new_int(5); errno = 0; assert(json_object_get_int(jtmp) == 5); json_object_put(jtmp); }; { struct json_object *jtmp = json_object_new_int(5); errno = 0; assert(json_object_get_int64(jtmp) == 5); json_object_put(jtmp); }; { struct json_object *jtmp = json_object_new_int(5); errno = 0; assert(json_object_get_uint64(jtmp) == 5); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_int(0); errno = 0; assert(json_object_get_int(jtmp) == 0); json_object_put(jtmp); }; { struct json_object *jtmp = json_object_new_int(0); errno = 0; assert(json_object_get_int64(jtmp) == 0); json_object_put(jtmp); }; { struct json_object *jtmp = json_object_new_int(0); errno = 0; assert(json_object_get_uint64(jtmp) == 0); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_string("0"); errno = 0; assert(json_object_get_int(jtmp) == 0); json_object_put(jtmp); }; { struct json_object *jtmp = json_object_new_string("0"); errno = 0; assert(json_object_get_int64(jtmp) == 0); json_object_put(jtmp); }; { struct json_object *jtmp = json_object_new_string("0"); errno = 0; assert(json_object_get_uint64(jtmp) == 0); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_string("00000"); errno = 0; assert(json_object_get_int(jtmp) == 0); json_object_put(jtmp); }; { struct json_object *jtmp = json_object_new_string("00000"); errno = 0; assert(json_object_get_int64(jtmp) == 0); json_object_put(jtmp); }; { struct json_object *jtmp = json_object_new_string("00000"); errno = 0; assert(json_object_get_uint64(jtmp) == 0); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_string("000004568789"); errno = 0; assert(json_object_get_int(jtmp) == 4568789); json_object_put(jtmp); }; { struct json_object *jtmp = json_object_new_string("000004568789"); errno = 0; assert(json_object_get_int64(jtmp) == 4568789); json_object_put(jtmp); }; { struct json_object *jtmp = json_object_new_string("000004568789"); errno = 0; assert(json_object_get_uint64(jtmp) == 4568789); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_string("0xFF"); errno = 0; assert(json_object_get_int(jtmp) == 0 && errno == 0); json_object_put(jtmp); }; { struct json_object *jtmp = json_object_new_string("0xFF"); errno = 0; assert(json_object_get_int64(jtmp) == 0 && errno == 0); json_object_put(jtmp); }; { struct json_object *jtmp = json_object_new_string("0xFF"); errno = 0; assert(json_object_get_uint64(jtmp) == 0 && errno == 0); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_string("333this_seems_a_valid_string"); errno = 0; assert(json_object_get_int(jtmp) == 333); json_object_put(jtmp); }; { struct json_object *jtmp = json_object_new_string("333this_seems_a_valid_string"); errno = 0; assert(json_object_get_int64(jtmp) == 333); json_object_put(jtmp); }; { struct json_object *jtmp = json_object_new_string("333this_seems_a_valid_string"); errno = 0; assert(json_object_get_uint64(jtmp) == 333); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_string("this_is_not_a_number"); errno = 0; assert(json_object_get_int(jtmp) == 0 && errno == EINVAL); json_object_put(jtmp); }; { struct json_object *jtmp = json_object_new_string("this_is_not_a_number"); errno = 0; assert(json_object_get_int64(jtmp) == 0 && errno == EINVAL); json_object_put(jtmp); }; { struct json_object *jtmp = json_object_new_string("this_is_not_a_number"); errno = 0; assert(json_object_get_uint64(jtmp) == 0 && errno == EINVAL); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_string("B0"); errno = 0; assert(json_object_get_int(jtmp) == 0 && errno == EINVAL); json_object_put(jtmp); }; { struct json_object *jtmp = json_object_new_string("B0"); errno = 0; assert(json_object_get_int64(jtmp) == 0 && errno == EINVAL); json_object_put(jtmp); }; { struct json_object *jtmp = json_object_new_string("B0"); errno = 0; assert(json_object_get_uint64(jtmp) == 0 && errno == EINVAL); json_object_put(jtmp); };
 printf("BASE CHECK PASSED\n");

 { struct json_object *jtmp = json_object_new_int64(INT32_MAX); errno = 0; assert(json_object_get_int(jtmp) == INT32_MAX && errno == 0); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_int64(INT32_MIN); errno = 0; assert(json_object_get_int(jtmp) == INT32_MIN && errno == 0); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_int64(INT64_MAX); errno = 0; assert(json_object_get_int(jtmp) == INT32_MAX && errno == ERANGE); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_int64(INT64_MIN); errno = 0; assert(json_object_get_int(jtmp) == INT32_MIN && errno == ERANGE); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_string("2147483647"); errno = 0; assert(json_object_get_int(jtmp) == INT32_MAX && errno == 0); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_string("-2147483648"); errno = 0; assert(json_object_get_int(jtmp) == INT32_MIN && errno == 0); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_string("9223372036854775807"); errno = 0; assert(json_object_get_int(jtmp) == INT32_MAX && errno == ERANGE); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_string("-9223372036854775808"); errno = 0; assert(json_object_get_int(jtmp) == INT32_MIN && errno == ERANGE); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_double(INFINITY); errno = 0; assert(json_object_get_int(jtmp) == INT32_MAX && errno == ERANGE); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_double(-INFINITY); errno = 0; assert(json_object_get_int(jtmp) == INT32_MIN && errno == ERANGE); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_double(NAN); errno = 0; assert(json_object_get_int(jtmp) == INT32_MIN && errno == EINVAL); json_object_put(jtmp); };
 printf("INT GET PASSED\n");

 { struct json_object *jtmp = json_object_new_int64(INT64_MAX); errno = 0; assert(json_object_get_int64(jtmp) == INT64_MAX && errno == 0); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_int64(INT64_MIN); errno = 0; assert(json_object_get_int64(jtmp) == INT64_MIN && errno == 0); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_string("9223372036854775807"); errno = 0; assert(json_object_get_int64(jtmp) == INT64_MAX && errno == 0); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_string("-9223372036854775808"); errno = 0; assert(json_object_get_int64(jtmp) == INT64_MIN && errno == 0); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_string("9223372036854775808"); errno = 0; assert(json_object_get_int64(jtmp) == INT64_MAX && errno == ERANGE); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_string("-9223372036854775809"); errno = 0; assert(json_object_get_int64(jtmp) == INT64_MIN && errno == ERANGE); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_double(INFINITY); errno = 0; assert(json_object_get_int64(jtmp) == INT64_MAX && errno == ERANGE); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_double(-INFINITY); errno = 0; assert(json_object_get_int64(jtmp) == INT64_MIN && errno == ERANGE); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_double(NAN); errno = 0; assert(json_object_get_int64(jtmp) == INT64_MIN && errno == EINVAL); json_object_put(jtmp); };
 printf("INT64 GET PASSED\n");

 { struct json_object *jtmp = json_object_new_uint64(UINT64_MAX); errno = 0; assert(json_object_get_uint64(jtmp) == UINT64_MAX && errno == 0); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_uint64(-1); errno = 0; assert(json_object_get_uint64(jtmp) == UINT64_MAX && errno == 0); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_string("18446744073709551616"); errno = 0; assert(json_object_get_uint64(jtmp) == UINT64_MAX && errno == ERANGE); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_double(INFINITY); errno = 0; assert(json_object_get_uint64(jtmp) == UINT64_MAX && errno == ERANGE); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_double(-INFINITY); errno = 0; assert(json_object_get_uint64(jtmp) == 0 && errno == ERANGE); json_object_put(jtmp); };
 { struct json_object *jtmp = json_object_new_double(NAN); errno = 0; assert(json_object_get_uint64(jtmp) == 0 && errno == EINVAL); json_object_put(jtmp); };
