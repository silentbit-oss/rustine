# 0 "/app/subjects/json-c/json_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/app/subjects/json-c/json_util.c"
# 12 "/app/subjects/json-c/json_util.c"
# 1 "/app/subjects/json-c/build/config.h" 1
# 13 "/app/subjects/json-c/json_util.c" 2
...
# 16 "/app/subjects/json-c/json_util.c" 2

# 1 "/app/pipeline/preprocess/fake_libc_include/limits.h" 1
# 18 "/app/subjects/json-c/json_util.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/stdarg.h" 1
# 19 "/app/subjects/json-c/json_util.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/stddef.h" 1
# 20 "/app/subjects/json-c/json_util.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/stdio.h" 1
# 21 "/app/subjects/json-c/json_util.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/stdlib.h" 1
# 22 "/app/subjects/json-c/json_util.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/string.h" 1
# 23 "/app/subjects/json-c/json_util.c" 2
...
# 26 "/app/subjects/json-c/json_util.c" 2



# 1 "/app/pipeline/preprocess/fake_libc_include/sys/stat.h" 1
# 30 "/app/subjects/json-c/json_util.c" 2



# 1 "/app/pipeline/preprocess/fake_libc_include/fcntl.h" 1
# 34 "/app/subjects/json-c/json_util.c" 2



# 1 "/app/pipeline/preprocess/fake_libc_include/unistd.h" 1
# 38 "/app/subjects/json-c/json_util.c" 2
# 52 "/app/subjects/json-c/json_util.c"
...
# 53 "/app/subjects/json-c/json_util.c" 2
...
# 55 "/app/subjects/json-c/json_util.c" 2
...
extern struct json_object *json_tokener_parse_ex(struct json_tokener *tok, const char *str,
                                                      int len);
# 58 "/app/subjects/json-c/json_util.c" 2
...
# 59 "/app/subjects/json-c/json_util.c" 2
...
struct json_object *json_object_from_fd_ex(int fd, int in_depth)
{
 ...
 while ((ret = read(fd, buf, sizeof(buf))) > 0)
 {
  if (printbuf_memappend(pb, buf, ret) < 0)
  {
   ...
   _json_c_set_last_err(
       "json_object_from_fd_ex: failed to printbuf_memappend after reading %d+%d bytes: %s", ((pb)->bpos), (int)ret, _json_c_strerror(errno));
...
# 295 "/app/subjects/json-c/json_util.c"
...
const char *json_type_to_name(enum json_type o_type)
{
 ...
 if (o_type_int < 0 || o_type_int >= (int)(sizeof(json_type_name) / sizeof(json_type_name[0])))
 {
  _json_c_set_last_err("json_type_to_name: type %d is out of range [0,%u]\n", o_type,
                       (unsigned)(sizeof(json_type_name) / sizeof(json_type_name[0])));
  return 0;
 }
