# 0 "/app/subjects/json-c/tests/test_deep_copy.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/app/subjects/json-c/tests/test_deep_copy.c"
...
# 2 "/app/subjects/json-c/tests/test_deep_copy.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/stdio.h" 1
# 3 "/app/subjects/json-c/tests/test_deep_copy.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/stdlib.h" 1
# 4 "/app/subjects/json-c/tests/test_deep_copy.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/string.h" 1
# 5 "/app/subjects/json-c/tests/test_deep_copy.c" 2



# 1 "/app/pipeline/preprocess/fake_libc_include/assert.h" 1
# 9 "/app/subjects/json-c/tests/test_deep_copy.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/errno.h" 1
# 10 "/app/subjects/json-c/tests/test_deep_copy.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/time.h" 1
# 11 "/app/subjects/json-c/tests/test_deep_copy.c" 2
...
# 13 "/app/subjects/json-c/tests/test_deep_copy.c" 2
# 1 "/app/subjects/json-c/printbuf.h" 1
# 14 "/app/subjects/json-c/tests/test_deep_copy.c" 2
...
int main(int argc, char **argv)
{
 ...
 struct json_object *dst1 = 0, *dst2 = 0, *dst3 = 0;
 int benchmark = 0;
 ...
 assert(0 == json_object_deep_copy(src1, &dst1, 0));
 ...
 assert(-1 == json_object_deep_copy(src1, &dst1, 0));
 assert(errno == EINVAL);
 ...
 assert(0 == strcmp(json_object_to_json_string_ext(src1, (1 << 1)),
                    json_object_to_json_string_ext(dst1, (1 << 1))));
 assert(0 == strcmp(json_object_to_json_string_ext(src2, (1 << 1)),
                    json_object_to_json_string_ext(dst2, (1 << 1))));
 assert(0 == strcmp(json_object_to_json_string_ext(src3, (1 << 1)),
...
static void do_benchmark(json_object *src2)
{
 ...
 for (ii = 0; ii < iterations; ii++)
 {
  json_object_deep_copy(src2, &dst2, 0);
  json_object_put(dst2);
  dst2 = 0;
 }
