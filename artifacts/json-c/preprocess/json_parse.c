# 0 "/app/subjects/json-c/apps/json_parse.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/app/subjects/json-c/apps/json_parse.c"
...
# 2 "/app/subjects/json-c/apps/json_parse.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/errno.h" 1
# 3 "/app/subjects/json-c/apps/json_parse.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/fcntl.h" 1
# 4 "/app/subjects/json-c/apps/json_parse.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/getopt.h" 1
# 5 "/app/subjects/json-c/apps/json_parse.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/stddef.h" 1
# 6 "/app/subjects/json-c/apps/json_parse.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/stdio.h" 1
# 7 "/app/subjects/json-c/apps/json_parse.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/stdlib.h" 1
# 8 "/app/subjects/json-c/apps/json_parse.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/string.h" 1
# 9 "/app/subjects/json-c/apps/json_parse.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/unistd.h" 1
# 10 "/app/subjects/json-c/apps/json_parse.c" 2

# 1 "/app/subjects/json-c/build/apps_config.h" 1
# 12 "/app/subjects/json-c/apps/json_parse.c" 2
...
# 17 "/app/subjects/json-c/apps/json_parse.c" 2
# 1 "/app/subjects/json-c/json_tokener.h" 1
# 19 "/app/subjects/json-c/json_tokener.h"
# 1 "/app/subjects/json-c/json_object.h" 1
# 20 "/app/subjects/json-c/json_tokener.h" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/stddef.h" 1
...
extern struct json_object *json_tokener_parse_ex(struct json_tokener *tok, const char *str,
                                                      int len);
# 18 "/app/subjects/json-c/apps/json_parse.c" 2
...
# 19 "/app/subjects/json-c/apps/json_parse.c" 2


# 1 "/app/pipeline/preprocess/fake_libc_include/sys/resource.h" 1
# 1 "/app/pipeline/preprocess/fake_libc_include/_fake_defines.h" 1
# 2 "/app/pipeline/preprocess/fake_libc_include/sys/resource.h" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/_fake_typedefs.h" 1
# 3 "/app/pipeline/preprocess/fake_libc_include/sys/resource.h" 2
# 22 "/app/subjects/json-c/apps/json_parse.c" 2
# 1 "/app/pipeline/preprocess/fake_libc_include/sys/time.h" 1
# 23 "/app/subjects/json-c/apps/json_parse.c" 2
# 38 "/app/subjects/json-c/apps/json_parse.c"
...
static int parseit(int fd, int (*callback)(struct json_object *))
{
 ...
 while ((ret = read(fd, buf, sizeof(buf))) > 0)
 {
  ...
  while (start_pos != retu)
  {
   ...
   if (obj == 0 && jerr != json_tokener_continue)
   {
...
int main(int argc, char **argv)
{
 ...
 while ((opt = getopt(argc, argv, "fF:hnsc")) != -1)
 {
  switch (opt)
  {
  case 'f': formatted_output = (1 << 1); break;
  case 'F': formatted_output = atoi(optarg); break;
  case 'n': show_output = 0; break;
  case 's': strict_mode = 1; break;
  case 'c': color = (1 << 5); break;
