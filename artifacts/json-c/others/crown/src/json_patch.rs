...
pub struct json_pointer_get_result {
    pub parent: *mut crate::src::json_object::json_object,
    pub obj: *mut crate::src::json_object::json_object,
...
unsafe extern "C" fn json_patch_apply_test(
    ...
    mut patch_elem: *mut crate::src::json_object::json_object,
    mut path: *const libc::c_char,
    mut patch_error: *mut json_patch_error,
) -> libc::c_int {
    let mut value1: *mut crate::src::json_object::json_object = 0 as *mut crate::src::json_object::json_object;
    let mut value2: *mut crate::src::json_object::json_object = 0 as *mut crate::src::json_object::json_object;
    if crate::src::json_object::json_object_object_get_ex(
        patch_elem,
    ...
    if crate::src::json_pointer::json_pointer_get(*res, path, &raw mut value2) != 0 {
    ...
    if crate::src::json_object::json_object_equal(value1, value2) == 0 {
...
unsafe extern "C" fn __json_patch_apply_remove(
    ...
    if crate::src::json_object::json_object_is_type((*jpres).parent, json_type_array) != 0 {
        return crate::src::json_object::json_object_array_del_idx(
            (*jpres).parent,
            (*jpres).index_in_parent as size_t,
            1 as libc::c_int as size_t,
        )
    } else if !((*jpres).parent).is_null() && !((*jpres).key_in_parent).is_null() {
        crate::src::json_object::json_object_object_del((*jpres).parent, (*jpres).key_in_parent);
        return 0 as libc::c_int;
    } else {
        crate::src::json_object::json_object_put((*jpres).obj);
        (*jpres).obj = 0 as *mut crate::src::json_object::json_object;
        return 0 as libc::c_int;
    };
}
unsafe extern "C" fn json_patch_apply_remove(
    ...
    if crate::src::json_pointer::json_pointer_get_internal(*res, path, &raw mut jpres) != 0 {
        (*patch_error).errno_code = *__errno_location();
        (*patch_error)
            .errmsg = if *__errno_location() == 2 as libc::c_int {
            b"Did not find element referenced by path field\0" as *const u8
    ...
    if (jpres.parent).is_null() {std::intrinsics::assume((jpres.parent).addr() == 0);
...
unsafe extern "C" fn json_object_array_insert_idx_cb(
    ...
    if idx > crate::src::json_object::json_object_array_length(parent) {
        *__errno_location() = 22 as libc::c_int;
        return -(1 as libc::c_int);
    }
    if *add != 0 {
        rc = crate::src::json_object::json_object_array_insert_idx(parent, idx, value);
    } else {
        rc = crate::src::json_object::json_object_array_put_idx(parent, idx, value);
    }
    if rc < 0 as libc::c_int {
        *__errno_location() = 22 as libc::c_int;
    }
...
unsafe extern "C" fn json_patch_apply_add_replace(
    ...
    let mut value: *mut crate::src::json_object::json_object = 0 as *mut crate::src::json_object::json_object;
    let mut rc: libc::c_int = 0;
    if crate::src::json_object::json_object_object_get_ex(
        patch_elem,
        b"value\0" as *const u8 as *const libc::c_char,
    ...
    if add == 0 && crate::src::json_pointer::json_pointer_get(*res, path, 0 as *mut *mut crate::src::json_object::json_object) != 0 {
        (*patch_error).errno_code = *__errno_location();
        (*patch_error)
            .errmsg = if *__errno_location() == 2 as libc::c_int {
            b"Did not find element referenced by path field\0" as *const u8
    ...
    rc = crate::src::json_pointer::json_pointer_set_with_array_cb(
        res,
        path,
        crate::src::json_object::json_object_get(value),
        Some(
        ...
        &raw mut add as *mut libc::c_int as *mut libc::c_void,
    );
    if rc != 0 {
        (*patch_error).errno_code = *__errno_location();
        (*patch_error)
            ...
            as *const u8 as *const libc::c_char;
        *__errno_location() = 0 as libc::c_int;
        crate::src::json_object::json_object_put(value);
    }
    return rc;
}
unsafe extern "C" fn json_object_array_move_cb(
    ...
    let mut len: size_t = crate::src::json_object::json_object_array_length(parent);
...
unsafe extern "C" fn json_patch_apply_move_copy(
    ...
    let mut jfrom: *mut crate::src::json_object::json_object = 0 as *mut crate::src::json_object::json_object;
    ...
    from_s = crate::src::json_object::json_object_get_string(jfrom);
    ...
    rc = crate::src::json_pointer::json_pointer_get_internal(*res, from_s, &raw mut from);
    if rc != 0 {
        (*patch_error).errno_code = *__errno_location();
        (*patch_error)
            .errmsg = if *__errno_location() == 2 as libc::c_int {
    ...
    crate::src::json_object::json_object_get(from.obj);
    if move_0 == 0 {
        array_set_cb = Some(
            json_object_array_insert_idx_cb
                as unsafe extern "C" fn(
        ...
        if rc < 0 as libc::c_int {
            crate::src::json_object::json_object_put(from.obj);
            return rc;
        }
        array_set_cb = Some(
    ...
    rc = crate::src::json_pointer::json_pointer_set_with_array_cb(
        ...
        from.obj,
        array_set_cb,
        &raw mut from as *mut json_pointer_get_result as *mut libc::c_void,
    );
    if rc != 0 {
        (*patch_error).errno_code = *__errno_location();
        (*patch_error)
...
pub unsafe extern "C" fn json_patch_apply(
    mut copy_from: *mut crate::src::json_object::json_object,
    mut patch: *mut crate::src::json_object::json_object,
    mut base: *mut *mut crate::src::json_object::json_object,
    mut patch_error: *mut json_patch_error,
) -> libc::c_int {
    let mut ii: size_t = 0;
    ...
    if patch_error.is_null() {std::intrinsics::assume((patch_error).addr() == 0);
    ...
    if crate::src::json_object::json_object_is_type(patch, json_type_array) == 0 {
        (*patch_error).errno_code = 14 as libc::c_int;
        (*patch_error)
    ...
    if !copy_from.is_null() {
        if crate::src::json_object::json_object_deep_copy(copy_from, base, None) < 0 as libc::c_int {
    ...
    }else { std::intrinsics::assume((copy_from).addr() == 0); }
    ii = 0 as libc::c_int as size_t;
    while ii < crate::src::json_object::json_object_array_length(patch) {
        let mut jop: *mut crate::src::json_object::json_object = 0 as *mut crate::src::json_object::json_object;
        let mut jpath: *mut crate::src::json_object::json_object = 0 as *mut crate::src::json_object::json_object;
        let mut patch_elem: *mut crate::src::json_object::json_object = crate::src::json_object::json_object_array_get_idx(patch, ii);
        ...
        op = crate::src::json_object::json_object_get_string(jop);
        if crate::src::json_object::json_object_object_get_ex(
            patch_elem,
        ...
        path = crate::src::json_object::json_object_get_string(jpath);
