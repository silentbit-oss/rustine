...
pub unsafe extern "C" fn checkit(mut buf: *const libc::c_char) {
    ...
    let mut retval: libc::c_int = crate::src::json_util::json_parse_int64(buf, &raw mut cint64);
    printf(
...
pub unsafe extern "C" fn checkit_uint(mut buf: *const libc::c_char) {
    ...
    let mut retval: libc::c_int = crate::src::json_util::json_parse_uint64(buf, &raw mut cuint64);
    printf(
