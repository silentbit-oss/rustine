...
unsafe extern "C" fn freeit(mut jso: *mut crate::src::json_object::json_object, mut userdata: *mut libc::c_void) {
...
unsafe extern "C" fn custom_serializer(
    ...
    crate::src::printbuf::sprintbuf(pb, b"Custom Output\0" as *const u8 as *const libc::c_char);
...
unsafe fn main_0(
    ...
    let mut my_sub_object: *mut crate::src::json_object::json_object = 0 as *mut crate::src::json_object::json_object;
    printf(
    ...
    crate::src::json_object::json_object_set_serializer(
        ...
        &raw mut userdata as *mut myinfo as *mut libc::c_void,
        Some(freeit as unsafe extern "C" fn(*mut crate::src::json_object::json_object, *mut libc::c_void) -> ()),
    );
    printf(
    ...
    crate::src::json_object::json_object_set_serializer(my_object, None, 0 as *mut libc::c_void, None);
    if freeit_was_called != 0 {} else {
        __assert_fail(
            b"freeit_was_called\0" as *const u8 as *const libc::c_char,
            b"/home/enumclass/Documents/C2RustTranslation/bkp/json-c/tests/test_set_serializer.c\0"
                as *const u8 as *const libc::c_char,
    ...
    crate::src::json_object::json_object_get(my_object);
    crate::src::json_object::json_object_put(my_object);
    printf(
        b"my_object.to_string(custom serializer)=%s\n\0" as *const u8
            as *const libc::c_char,
    ...
    my_object = crate::src::json_object::json_object_new_object();
    my_sub_object = crate::src::json_object::json_object_new_double(1.0f64);
    crate::src::json_object::json_object_object_add(
        my_object,
    ...
    printf(
        b"my_object.to_string(custom serializer)=%s\n\0" as *const u8
            as *const libc::c_char,
        crate::src::json_object::json_object_to_json_string_ext(my_object, (1 as libc::c_int) << 2 as libc::c_int),
    );
    crate::src::json_object::json_object_put(my_object);
    return 0 as libc::c_int;
}
