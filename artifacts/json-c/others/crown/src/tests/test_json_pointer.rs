...
unsafe extern "C" fn test_example_int(
    ...
    let mut jo2: *mut crate::src::json_object::json_object = 0 as *mut crate::src::json_object::json_object;
    if 0 as libc::c_int
        == crate::src::json_pointer::json_pointer_get(jo1, json_pointer, 0 as *mut *mut crate::src::json_object::json_object)
    {} else {
        __assert_fail(
    ...
    if 0 as libc::c_int == crate::src::json_pointer::json_pointer_get(jo1, json_pointer, &raw mut jo2) {} else {
        __assert_fail(
    ...
    if crate::src::json_object::json_object_is_type(jo2, json_type_int) != 0 {} else {
        __assert_fail(
    ...
    if expected_int == crate::src::json_object::json_object_get_int(jo2) {} else {
        __assert_fail(
...
unsafe extern "C" fn test_example_get() {
    ...
    let mut jo2: *mut crate::src::json_object::json_object = 0 as *mut crate::src::json_object::json_object;
    let mut jo3: *mut crate::src::json_object::json_object = 0 as *mut crate::src::json_object::json_object;
    ...
    jo1 = crate::src::json_tokener::json_tokener_parse(input_json_str);
    if !jo1.is_null() {} else {std::intrinsics::assume((jo1).addr() == 0);
        __assert_fail(
    ...
    printf(b"%s\n\0" as *const u8 as *const libc::c_char, crate::src::json_object::json_object_get_string(jo1));
    jo2 = 0 as *mut crate::src::json_object::json_object;
    if 0 as libc::c_int
        == crate::src::json_pointer::json_pointer_get(
            jo1,
    ...
    if 0 as libc::c_int
        == crate::src::json_pointer::json_pointer_get(jo1, b"\0" as *const u8 as *const libc::c_char, &raw mut jo2)
    {} else {
        __assert_fail(
    ...
    if crate::src::json_object::json_object_equal(jo2, jo1) != 0 {} else {
        __assert_fail(
    ...
    jo3 = crate::src::json_object::json_object_new_array();
    ...
    crate::src::json_object::json_object_array_add(
        jo3,
        crate::src::json_object::json_object_new_string(b"baz\0" as *const u8 as *const libc::c_char),
    );
    jo2 = 0 as *mut crate::src::json_object::json_object;
    if 0 as libc::c_int
        == crate::src::json_pointer::json_pointer_get(
    ...
    if 0 as libc::c_int
        == crate::src::json_pointer::json_pointer_get(jo1, b"/foo\0" as *const u8 as *const libc::c_char, &raw mut jo2)
    {} else {
        __assert_fail(
    ...
    if !jo2.is_null() {} else {std::intrinsics::assume((jo2).addr() == 0);
        __assert_fail(
    ...
    if crate::src::json_object::json_object_equal(jo2, jo3) != 0 {} else {
        __assert_fail(
    ...
    crate::src::json_object::json_object_put(jo3);
    printf(
    ...
    if 0 as libc::c_int
        == strcmp(
            ...
            crate::src::json_object::json_object_get_string(jo2),
        )
    {} else {
        __assert_fail(
    ...
    while !(json_pointers[i as usize].s).is_null() {
        ...
        i += 1;
        i;
    }std::intrinsics::assume((json_pointers[i as usize].s).addr() == 0);
    crate::src::json_object::json_object_put(jo1);
}
unsafe extern "C" fn test_recursion_get() {
    let mut jo2: *mut crate::src::json_object::json_object = 0 as *mut crate::src::json_object::json_object;
    let mut jo1: *mut crate::src::json_object::json_object = crate::src::json_tokener::json_tokener_parse(rec_input_json_str);
    jo2 = 0 as *mut crate::src::json_object::json_object;
    if !jo1.is_null() {} else {std::intrinsics::assume((jo1).addr() == 0);
        __assert_fail(
    ...
    if 0 as libc::c_int == crate::src::json_object::json_object_get_int(jo2) {} else {
        __assert_fail(
    ...
    if crate::src::json_object::json_object_is_type(jo2, json_type_string) != 0 {} else {
        __assert_fail(
    ...
    if 0 as libc::c_int
        == crate::src::json_pointer::json_pointer_getf(
            jo1,
            &raw mut jo2 as *mut *mut crate::src::json_object::json_object,
...
unsafe extern "C" fn test_wrong_inputs_get() {
    let mut jo2: *mut crate::src::json_object::json_object = 0 as *mut crate::src::json_object::json_object;
    let mut jo1: *mut crate::src::json_object::json_object = crate::src::json_tokener::json_tokener_parse(input_json_str);
    if !jo1.is_null() {} else {std::intrinsics::assume((jo1).addr() == 0);
        __assert_fail(
            b"NULL != jo1\0" as *const u8 as *const libc::c_char,
            b"/home/enumclass/Documents/C2RustTranslation/bkp/json-c/tests/test_json_pointer.c\0"
    ...
    *__errno_location() = 0 as libc::c_int;
    ...
    if jo2.is_null() {std::intrinsics::assume((jo2).addr() == 0);} else {
        __assert_fail(
    ...
    *__errno_location() = 0 as libc::c_int;
    if 0 as libc::c_int
        != crate::src::json_pointer::json_pointer_get(jo1, 0 as *const libc::c_char, 0 as *mut *mut crate::src::json_object::json_object)
    {} else {
        __assert_fail(
    ...
    *__errno_location() = 0 as libc::c_int;
    if 0 as libc::c_int
        != crate::src::json_pointer::json_pointer_getf(jo1, 0 as *mut *mut crate::src::json_object::json_object, 0 as *const libc::c_char)
    {} else {
        __assert_fail(
...
unsafe extern "C" fn test_example_set() {
    ...
    printf(b"%s\n\0" as *const u8 as *const libc::c_char, crate::src::json_object::json_object_get_string(jo1));
    if 0 as libc::c_int
        == crate::src::json_pointer::json_pointer_set(
            &raw mut jo1,
            b"/foo/1\0" as *const u8 as *const libc::c_char,
            crate::src::json_object::json_object_new_string(b"cod\0" as *const u8 as *const libc::c_char),
        )
    {} else {
        __assert_fail(
    ...
    if 0 as libc::c_int
        == strcmp(
            ...
            crate::src::json_object::json_object_get_string(
                crate::src::json_object::json_object_array_get_idx(
                    crate::src::json_object::json_object_object_get(
                        jo1,
                        b"foo\0" as *const u8 as *const libc::c_char,
                    ),
    ...
    jo2 = crate::src::json_tokener::json_tokener_parse(b"[1,2,3]\0" as *const u8 as *const libc::c_char);
    if 0 as libc::c_int
        != crate::src::json_pointer::json_pointer_set(
            &raw mut jo1,
    ...
    if 0 as libc::c_int
        == crate::src::json_pointer::json_pointer_set(
            ...
            crate::src::json_object::json_object_new_object(),
        )
    {} else {
        __assert_fail(
    ...
    if 0 as libc::c_int
        == crate::src::json_pointer::json_pointer_setf(
            &raw mut jo1 as *mut *mut crate::src::json_object::json_object,
            crate::src::json_object::json_object_new_int(0 as libc::c_int),
    ...
    if 0 as libc::c_int
        == crate::src::json_pointer::json_pointer_set(
            &raw mut jo1,
            b"/\0" as *const u8 as *const libc::c_char,
            crate::src::json_object::json_object_new_int(9 as libc::c_int),
        )
    {} else {
        __assert_fail(
    ...
    jo2 = crate::src::json_tokener::json_tokener_parse(
    ...
    printf(
        ...
        crate::src::json_object::json_object_get_string(jo1),
    );
    crate::src::json_object::json_object_put(jo2);
    if 0 as libc::c_int
        == crate::src::json_pointer::json_pointer_set(
            &raw mut jo1,
            b"\0" as *const u8 as *const libc::c_char,
            crate::src::json_object::json_object_new_int(10 as libc::c_int),
        )
    {} else {
        __assert_fail(
    ...
    if 10 as libc::c_int == crate::src::json_object::json_object_get_int(jo1) {} else {
        __assert_fail(
    ...
    printf(b"%s\n\0" as *const u8 as *const libc::c_char, crate::src::json_object::json_object_get_string(jo1));
    crate::src::json_object::json_object_put(jo1);
    jo1 = crate::src::json_tokener::json_tokener_parse(b"[0, 1, 2, 3]\0" as *const u8 as *const libc::c_char);
    jo2 = crate::src::json_tokener::json_tokener_parse(
    ...
    if 1 as libc::c_int == crate::src::json_object::json_object_equal(jo1, jo2) {} else {
        __assert_fail(
...
unsafe extern "C" fn test_wrong_inputs_set() {
    ...
    if 0 as libc::c_int
        != crate::src::json_pointer::json_pointer_set(&raw mut jo1, 0 as *const libc::c_char, 0 as *mut crate::src::json_object::json_object)
    {} else {
        __assert_fail(
    ...
    jo2 = crate::src::json_object::json_object_new_string(b"cod\0" as *const u8 as *const libc::c_char);
    if 0 as libc::c_int
        != crate::src::json_pointer::json_pointer_set(
            &raw mut jo1,
            b"foo/bar\0" as *const u8 as *const libc::c_char,
    ...
    jo2 = crate::src::json_object::json_object_new_string(b"cod\0" as *const u8 as *const libc::c_char);
    if 0 as libc::c_int
        != crate::src::json_pointer::json_pointer_set(&raw mut jo1, b"0\0" as *const u8 as *const libc::c_char, jo2)
    {} else {
        __assert_fail(
    ...
    crate::src::json_object::json_object_put(jo2);
    jo2 = crate::src::json_object::json_object_new_string(b"whatever\0" as *const u8 as *const libc::c_char);
    if 0 as libc::c_int
        != crate::src::json_pointer::json_pointer_set(
            &raw mut jo1,
            b"/fud/gaw\0" as *const u8 as *const libc::c_char,
    ...
    jo2 = crate::src::json_object::json_object_new_int(0 as libc::c_int);
    if 0 as libc::c_int
        != crate::src::json_pointer::json_pointer_set(
            &raw mut jo1,
            b"/fud/gaw/0\0" as *const u8 as *const libc::c_char,
