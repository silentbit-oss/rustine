...
unsafe fn main_0() -> libc::c_int {
    ...
    let mut string: *mut crate::src::json_object::json_object = crate::src::json_object::json_object_new_string_len(
        input,
        3 as libc::c_int,
    );
    let mut json: *const libc::c_char = crate::src::json_object::json_object_to_json_string(string);
    ...
    crate::src::json_object::json_object_put(string);
    let mut parsed_str: *mut crate::src::json_object::json_object = crate::src::json_tokener::json_tokener_parse(expected);
    if !parsed_str.is_null() {
        let mut parsed_len: libc::c_int = crate::src::json_object::json_object_get_string_len(parsed_str);
        let mut parsed_cstr: *const libc::c_char = crate::src::json_object::json_object_get_string(parsed_str);
        ...
        crate::src::json_object::json_object_put(parsed_str);
    } else {std::intrinsics::assume((parsed_str).addr() == 0);
