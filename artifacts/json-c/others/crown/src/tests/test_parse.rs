...
unsafe extern "C" fn single_incremental_parse(
    ...
    let mut all_at_once_obj: *mut crate::src::json_object::json_object = 0 as *mut crate::src::json_object::json_object;
    ...
    new_obj = 0 as *mut crate::src::json_object::json_object;
    if chunksize > 0 as libc::c_int {} else {
        __assert_fail(
            b"chunksize > 0\0" as *const u8 as *const libc::c_char,
            b"/home/enumclass/Documents/C2RustTranslation/bkp/json-c/tests/test_parse.c\0"
    ...
    all_at_once_obj = crate::src::json_tokener::json_tokener_parse(test_string);
    if clear_serializer_0 != 0 {
        do_clear_serializer(all_at_once_obj);
    }
    all_at_once_str = crate::src::json_object::json_object_to_json_string(all_at_once_obj);
    tok = crate::src::json_tokener::json_tokener_new();
    ...
    while ii < test_string_len {
        ...
        if ii.wrapping_add(chunksize as size_t) > test_string_len {
        ...
        }else { std::intrinsics::assume((getenv(b"TEST_PARSE_DEBUG\x00" as *const u8 as *const libc::c_char)).addr() == 0); }
        new_obj = crate::src::json_tokener::json_tokener_parse_ex(
            tok,
            &*test_string.offset(ii as isize),
            len_to_parse,
        );
        jerr = crate::src::json_tokener::json_tokener_get_error(tok);
        if jerr as libc::c_uint != json_tokener_continue as libc::c_int as libc::c_uint
            || !new_obj.is_null()
        {
            break;
        }
        ii = ii.wrapping_add(chunksize as size_t);
    }
    if clear_serializer_0 != 0 && !new_obj.is_null() {
        do_clear_serializer(new_obj);
    }
    new_str = crate::src::json_object::json_object_to_json_string(new_obj);
    ...
    crate::src::json_tokener::json_tokener_free(tok);
    if !all_at_once_obj.is_null() {
        crate::src::json_object::json_object_put(all_at_once_obj);
    }else { std::intrinsics::assume((all_at_once_obj).addr() == 0); }
    if !new_obj.is_null() {
        crate::src::json_object::json_object_put(new_obj);
    }else { std::intrinsics::assume((new_obj).addr() == 0); }
}
unsafe extern "C" fn single_basic_parse(
    ...
    let mut new_obj: *mut crate::src::json_object::json_object = 0 as *mut crate::src::json_object::json_object;
    new_obj = crate::src::json_tokener::json_tokener_parse(test_string);
    if clear_serializer_0 != 0 {
        do_clear_serializer(new_obj);
    }
    printf(
    ...
    }else { std::intrinsics::assume((getenv(b"TEST_PARSE_CHUNKSIZE\x00" as *const u8 as *const libc::c_char)).addr() == 0); }
}
...
unsafe extern "C" fn do_clear_serializer(mut jso: *mut crate::src::json_object::json_object) {
    crate::src::json_visit::json_c_visit(
        jso,
        0 as libc::c_int,
...
unsafe extern "C" fn clear_serializer(
    ...
    if !jso.is_null() {
        crate::src::json_object::json_object_set_serializer(jso, None, 0 as *mut libc::c_void, None);
...
unsafe extern "C" fn test_verbose_parse() {
    ...
    new_obj = crate::src::json_tokener::json_tokener_parse_verbose(
    ...
    if new_obj.is_null() {std::intrinsics::assume((new_obj).addr() == 0);} else {
        __assert_fail(
    ...
    new_obj = crate::src::json_tokener::json_tokener_parse(b"{ foo }\0" as *const u8 as *const libc::c_char);
    if new_obj.is_null() {std::intrinsics::assume((new_obj).addr() == 0);} else {
        __assert_fail(
            b"new_obj == NULL\0" as *const u8 as *const libc::c_char,
            b"/home/enumclass/Documents/C2RustTranslation/bkp/json-c/tests/test_parse.c\0"
...
#[no_mangle]
pub static mut incremental_steps: [incremental_step; 238] = [incremental_step {
...
unsafe extern "C" fn test_incremental_parse() {
    ...
    new_obj = crate::src::json_tokener::json_tokener_parse(string_to_parse);
    if new_obj.is_null() {std::intrinsics::assume((new_obj).addr() == 0);
        printf(
            b"%s\0" as *const u8 as *const libc::c_char,
            b"got error as expected\n\0" as *const u8 as *const libc::c_char,
        );
    }
    tok = crate::src::json_tokener::json_tokener_new();
    ii = 0 as libc::c_int;
    while !(incremental_steps[ii as usize].string_to_parse).is_null() {
        ...
        let mut step: *mut incremental_step = &raw mut *incremental_steps
            .as_mut_ptr()
            .offset(ii as isize) as *mut incremental_step;
        let mut length: libc::c_int = (*step).length;
        let mut expected_char_offset: size_t = 0;
        crate::src::json_tokener::json_tokener_set_flags(tok, (*step).tok_flags);
        ...
        new_obj = crate::src::json_tokener::json_tokener_parse_ex(tok, (*step).string_to_parse, length);
        jerr = crate::src::json_tokener::json_tokener_get_error(tok);
            ...
            if !new_obj.is_null() {
                ...
                printf(
                    b"ERROR: got wrong error: %s\n\0" as *const u8
                        as *const libc::c_char,
                    crate::src::json_tokener::json_tokener_error_desc(jerr),
                );
            } else if crate::src::json_tokener::json_tokener_get_parse_end(tok) != expected_char_offset {
                printf(
                    b"ERROR: wrong char_offset %zu != expected %zu\n\0" as *const u8
                        as *const libc::c_char,
                    crate::src::json_tokener::json_tokener_get_parse_end(tok),
                ...
                ) == 0 as libc::c_int)
        {
            ...
            printf(
                b"OK: got object of type [%s]: %s\n\0" as *const u8
                    as *const libc::c_char,
                crate::src::json_util::json_type_to_name(crate::src::json_object::json_object_get_type(new_obj)),
                crate::src::json_object::json_object_to_json_string(new_obj),
            );
            this_step_ok = 1 as libc::c_int;
        }
        ...
        if (*step).reset_tokener & 1 as libc::c_int != 0 {
            crate::src::json_tokener::json_tokener_reset(tok);
        }
        if this_step_ok != 0 {
            num_ok += 1;
            num_ok;
        ...
        ii += 1;
        ii;
    }std::intrinsics::assume((incremental_steps[ii as usize].string_to_parse).addr() == 0);
    crate::src::json_tokener::json_tokener_free(tok);
    printf(
...
unsafe extern "C" fn run_static_initializers() {
    incremental_steps = [
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\xC3\xA4\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: -(1 as libc::c_int),
                expected_error: json_tokener_success,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"0\x01\x02\x02\x03\x04\x05\x06\x07\x08\t\n\x0B\x0C\r\x0E\x0F\x10\x11\x12\x12\x13\x14\x15\x16\x17\x18\x19\x1A\x1B\x1C\x1D\x1E\x1F\"\0"
                    as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: -(1 as libc::c_int),
                expected_error: json_tokener_success,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x01\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x02\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x03\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x04\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x05\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x06\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x07\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x08\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x0B\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x0C\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x0E\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x0F\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x10\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x11\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x12\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x13\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x14\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x15\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x16\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x17\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x18\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x19\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x1A\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x1B\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x1C\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x1D\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x1E\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
        ...
        {
            let mut init = incremental_step {
                string_to_parse: b"\"\x1F\"\0" as *const u8 as *const libc::c_char,
                length: -(1 as libc::c_int),
                char_offset: 1 as libc::c_int,
                expected_error: json_tokener_error_parse_string,
                reset_tokener: 1 as libc::c_int,
