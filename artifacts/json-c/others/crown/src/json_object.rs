...
#[no_mangle]
pub static mut json_number_chars: *const libc::c_char = b"0123456789.+-eE\0" as *const u8
...
unsafe extern "C" fn get_string_component_mutable(
    ...
    if (*JC_STRING_C(jso)).len < 0 as libc::c_int as ssize_t {
            ...
            _ => {
                if (c as libc::c_int) < ' ' as i32 {
                            ...
                            as libc::c_int - 1 as libc::c_int
                    {
                        ...
                        *((*pb).buf)
                            .offset((*pb).bpos as isize) = '\0' as i32 as libc::c_char;
                    } else {
                        crate::src::printbuf::printbuf_memappend(
                            pb,
                            sbuf.as_mut_ptr(),
...
pub unsafe extern "C" fn json_object_get(mut jso: *mut json_object) -> *mut json_object {
    if jso.is_null() {std::intrinsics::assume((jso).addr() == 0);
        return jso;
    }
    if (*jso)._ref_count < 4294967295 as libc::c_uint {} else {
        __assert_fail(
            b"jso->_ref_count < UINT32_MAX\0" as *const u8 as *const libc::c_char,
            b"/home/enumclass/Documents/C2RustTranslation/bkp/json-c/json_object.c\0"
                as *const u8 as *const libc::c_char,
...
pub unsafe extern "C" fn json_object_put(mut jso: *mut json_object) -> libc::c_int {
    ...
    if (*jso)._ref_count > 0 as libc::c_int as uint32_t {} else {
        __assert_fail(
    ...
    if (*jso)._ref_count > 0 as libc::c_int as uint32_t {
        return 0 as libc::c_int;
    }
...
unsafe extern "C" fn json_object_generic_delete(mut jso: *mut json_object) {
    crate::src::printbuf::printbuf_free((*jso)._pb);
...
unsafe extern "C" fn json_object_new(
    ...
    (*jso)._pb = 0 as *mut crate::src::apps::json_parse::printbuf;
    (*jso)._user_delete = None;
    (*jso)._userdata = 0 as *mut libc::c_void;
    return jso;
}
#[no_mangle]
...
pub unsafe extern "C" fn json_object_get_userdata(
    ...
    return if !jso.is_null() { (*jso)._userdata } else {std::intrinsics::assume((jso).addr() == 0); 0 as *mut libc::c_void };
}
#[no_mangle]
pub unsafe extern "C" fn json_object_set_userdata(
    ...
    if !jso.is_null() {} else {std::intrinsics::assume((jso).addr() == 0);
        __assert_fail(
...
pub unsafe extern "C" fn json_object_to_json_string_length(
    ...
    if jso.is_null() {std::intrinsics::assume((jso).addr() == 0);
        ...
        || {
            (*jso)._pb = crate::src::printbuf::printbuf_new();
            !((*jso)._pb).is_null()
        }
    {
        crate::src::printbuf::printbuf_reset((*jso)._pb);
    ...
    if !length.is_null() {
        *length = s;
    }else { std::intrinsics::assume((length).addr() == 0); }
    return r;
}
#[no_mangle]
...
unsafe extern "C" fn indent(
    ...
    if flags & (1 as libc::c_int) << 1 as libc::c_int != 0 {
        if flags & (1 as libc::c_int) << 3 as libc::c_int != 0 {
            crate::src::printbuf::printbuf_memset(pb, -(1 as libc::c_int), '\t' as i32, level);
        } else {
            crate::src::printbuf::printbuf_memset(
                pb,
                -(1 as libc::c_int),
                ' ' as i32,
...
unsafe extern "C" fn json_object_object_to_json_string(
        ...
        .is_null()
    {
        ...
        if (iter.val).is_null() {std::intrinsics::assume((iter.val).addr() == 0);
            if flags & (1 as libc::c_int) << 5 as libc::c_int != 0 {
                crate::src::printbuf::printbuf_memappend(
                    pb,
    ...
    }std::intrinsics::assume((if !iter.entry.is_null()
        {
                iter.key = lh_entry_k(iter.entry) as *mut libc::c_char;
                iter.val = lh_entry_v(iter.entry) as *mut json_object;
                iter.entry
            } else { 0 as *mut lh_entry }).addr() == 0);
    ...
    if flags & (1 as libc::c_int) << 0 as libc::c_int != 0
        && flags & (1 as libc::c_int) << 1 as libc::c_int == 0
    {
        return crate::src::printbuf::printbuf_memappend(
            pb,
            b" }\0" as *const u8 as *const libc::c_char,
            (::core::mem::size_of::<[libc::c_char; 3]>() as libc::c_ulong)
                .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
...
unsafe extern "C" fn json_object_object_delete(mut jso_base: *mut json_object) {
    crate::src::linkhash::lh_table_free((*JC_OBJECT(jso_base)).c_object);
...
pub unsafe extern "C" fn json_object_new_object() -> *mut json_object {
    let mut jso: *mut json_object_object = json_object_new(
        json_type_object,
        ::core::mem::size_of::<json_object_object>() as libc::c_ulong,
    ...
    (*jso)
        .c_object = crate::src::linkhash::lh_kchar_table_new(
        16 as libc::c_int,
        Some(json_object_lh_entry_free as unsafe extern "C" fn(*mut lh_entry) -> ()),
    );
    if ((*jso).c_object).is_null() {std::intrinsics::assume(((*jso).c_object).addr() == 0);
...
pub unsafe extern "C" fn json_object_object_add_ex(
        ...
        != 0
    {
        ...
        crate::src::linkhash::lh_table_lookup_entry_w_hash(
    ...
    if existing_entry.is_null() {std::intrinsics::assume((existing_entry).addr() == 0);
        ...
        if k.is_null() {std::intrinsics::assume((k).addr() == 0);
            return -(1 as libc::c_int);
        }
        return crate::src::linkhash::lh_table_insert_w_hash(
            (*JC_OBJECT(jso)).c_object,
            k,
    ...
    }else { std::intrinsics::assume((existing_value).addr() == 0); }
...
pub unsafe extern "C" fn json_object_object_length(
    ...
    return crate::src::linkhash::lh_table_length((*JC_OBJECT_C(jso)).c_object);
}
#[no_mangle]
pub unsafe extern "C" fn json_c_object_sizeof() -> size_t {
    return ::core::mem::size_of::<json_object>() as libc::c_ulong;
}
#[no_mangle]
...
pub unsafe extern "C" fn json_object_object_get_ex(
    ...
    match (*jso).o_type as libc::c_uint {
        4 => {
            return crate::src::linkhash::lh_table_lookup_ex(
...
pub unsafe extern "C" fn json_object_object_del(
    ...
    crate::src::linkhash::lh_table_delete((*JC_OBJECT(jso)).c_object, key as *const libc::c_void);
}
unsafe extern "C" fn json_object_boolean_to_json_string(
    ...
    if (*JC_BOOL(jso)).c_boolean != 0 {
        ret = crate::src::printbuf::printbuf_memappend(
            pb,
    ...
    if ret > -(1 as libc::c_int) && flags & (1 as libc::c_int) << 5 as libc::c_int != 0 {
        return crate::src::printbuf::printbuf_memappend(
            pb,
            b"\x1B[0m\0" as *const u8 as *const libc::c_char,
            (::core::mem::size_of::<[libc::c_char; 5]>() as libc::c_ulong)
...
pub unsafe extern "C" fn json_object_new_boolean(mut b: json_bool) -> *mut json_object {
    let mut jso: *mut json_object_boolean = json_object_new(
        json_type_boolean,
        ::core::mem::size_of::<json_object_boolean>() as libc::c_ulong,
    ...
    match (*jso).o_type as libc::c_uint {
        ...
        3 => {
            match (*JC_INT_C(jso)).cint_type as libc::c_uint {
                0 => {
                    return ((*JC_INT_C(jso)).cint.c_int64 != 0 as libc::c_int as int64_t)
                        as libc::c_int;
                }
                1 => {
                    return ((*JC_INT_C(jso)).cint.c_uint64
                        != 0 as libc::c_int as uint64_t) as libc::c_int;
                }
                _ => {
                    json_abort(
        ...
        6 => {
            return ((*JC_STRING_C(jso)).len != 0 as libc::c_int as ssize_t)
                as libc::c_int;
        }
...
pub unsafe extern "C" fn json_object_get_int(mut jso: *const json_object) -> int32_t {
    ...
    *__errno_location() = 0 as libc::c_int;
    ...
    if o_type as libc::c_uint == json_type_int as libc::c_int as libc::c_uint {
        ...
        if crate::src::json_util::json_parse_int64(get_string_component(jso), &raw mut cint64) != 0 as libc::c_int {
            return 0 as libc::c_int;
        }
    ...
    match o_type as libc::c_uint {
        3 => {
            if cint64 < (-(2147483647 as libc::c_int) - 1 as libc::c_int) as int64_t {
                *__errno_location() = 34 as libc::c_int;
                return -(2147483647 as libc::c_int) - 1 as libc::c_int;
            }
            if cint64 > 2147483647 as libc::c_int as int64_t {
                *__errno_location() = 34 as libc::c_int;
...
pub unsafe extern "C" fn json_object_new_int64(mut i: int64_t) -> *mut json_object {
    let mut jso: *mut json_object_int = json_object_new(
        json_type_int,
        ::core::mem::size_of::<json_object_int>() as libc::c_ulong,
    ...
    *__errno_location() = 0 as libc::c_int;
    ...
    match (*jso).o_type as libc::c_uint {
        ...
        2 => {
            ...
            if ((*JC_DOUBLE_C(jso)).c_double).is_nan() as i32 != 0 {
                *__errno_location() = 22 as libc::c_int;
                return -(9223372036854775807 as libc::c_long)
                    - 1 as libc::c_int as libc::c_long;
            }
        ...
        6 => {
            if crate::src::json_util::json_parse_int64(get_string_component(jso), &raw mut cint) == 0 as libc::c_int
            {
                return cint;
            }
        }
    ...
    *__errno_location() = 0 as libc::c_int;
    ...
    match (*jso).o_type as libc::c_uint {
        3 => {
            ...
            match (*jsoint).cint_type as libc::c_uint {
                0 => {
                    if (*jsoint).cint.c_int64 < 0 as libc::c_int as int64_t {
                        *__errno_location() = 34 as libc::c_int;
                        return 0 as libc::c_int as uint64_t;
                    }
        ...
        6 => {
            if crate::src::json_util::json_parse_uint64(get_string_component(jso), &raw mut cuint)
                == 0 as libc::c_int
            {
                return cuint;
            }
...
pub unsafe extern "C" fn json_object_int_inc(
    ...
    match (*jsoint).cint_type as libc::c_uint {
        0 => {
            if val > 0 as libc::c_int as int64_t
            ...
            } else if val < 0 as libc::c_int as int64_t
                && (*jsoint).cint.c_int64
                    < -(9223372036854775807 as libc::c_long)
        ...
        1 => {
                ...
                && (*jsoint).cint.c_uint64 >= -val as uint64_t
            {
                (*jsoint)
                    .cint
                    .c_uint64 = ((*jsoint).cint.c_uint64).wrapping_sub(-val as uint64_t);
            } else {
                (*jsoint)
                    .cint
                    .c_uint64 = ((*jsoint).cint.c_uint64).wrapping_add(val as uint64_t);
            }
            return 1 as libc::c_int;
        }
        _ => {
...
pub unsafe extern "C" fn json_c_set_serialization_double_format(
    ...
    if global_or_thread == 0 as libc::c_int {
        ...
        } else {std::intrinsics::assume((double_format).addr() == 0);
        ...
        if !double_format.is_null() {
            ...
            if p_0.is_null() {std::intrinsics::assume((p_0).addr() == 0);
                crate::src::json_util::_json_c_set_last_err(
                    b"json_c_set_serialization_double_format: out of memory\n\0"
                        as *const u8 as *const libc::c_char,
                );
...
unsafe extern "C" fn json_object_double_to_json_string_format(
    ...
    } != 0
    {
        ...
        if format.is_null() {std::intrinsics::assume((format).addr() == 0);
            if !tls_serialization_float_format.is_null() {
    ...
    {
        size = (::core::mem::size_of::<[libc::c_char; 128]>() as libc::c_ulong)
            .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int;
    }
    crate::src::printbuf::printbuf_memappend(pb, buf.as_mut_ptr(), size);
    return size;
}
...
pub unsafe extern "C" fn json_object_new_double(
    ...
    let mut jso: *mut json_object_double = json_object_new(
        json_type_double,
        ::core::mem::size_of::<json_object_double>() as libc::c_ulong,
        Some(
...
pub unsafe extern "C" fn json_object_new_double_s(
    ...
    new_ds = strdup(ds);
    if new_ds.is_null() {std::intrinsics::assume((new_ds).addr() == 0);
        json_object_generic_delete(jso);
        *__errno_location() = 12 as libc::c_int;
        return 0 as *mut json_object;
    }
...
pub unsafe extern "C" fn json_object_userdata_to_json_string(
    ...
    let mut userdata_len: libc::c_int = strlen((*jso)._userdata as *const libc::c_char)
        as libc::c_int;
    crate::src::printbuf::printbuf_memappend(pb, (*jso)._userdata as *const libc::c_char, userdata_len);
    return userdata_len;
}
#[no_mangle]
    ...
    match (*jso).o_type as libc::c_uint {
        ...
        6 => {
            *__errno_location() = 0 as libc::c_int;
            ...
            if *errPtr as libc::c_int != '\0' as i32 {
                *__errno_location() = 22 as libc::c_int;
                return 0.0f64;
            }
...
unsafe extern "C" fn json_object_string_to_json_string(
    ...
    if flags & (1 as libc::c_int) << 5 as libc::c_int != 0 {
        crate::src::printbuf::printbuf_memappend(
            pb,
            b"\x1B[0;32m\0" as *const u8 as *const libc::c_char,
            (::core::mem::size_of::<[libc::c_char; 8]>() as libc::c_ulong)
                .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
        );
    }
    ...
    json_escape_str(
        ...
        (if len < 0 as libc::c_int as ssize_t { -len } else { len }) as size_t,
        flags,
    );
    crate::src::printbuf::printbuf_memappend(
        pb,
...
unsafe extern "C" fn json_object_string_delete(mut jso: *mut json_object) {
    if (*JC_STRING(jso)).len < 0 as libc::c_int as ssize_t {
...
unsafe extern "C" fn _json_object_new_string(
    ...
    if len
        > (9223372036854775807 as libc::c_long as libc::c_ulong)
            .wrapping_sub(
                (::core::mem::size_of::<json_object_string>() as libc::c_ulong)
                    .wrapping_sub(
    ...
    objsize = (::core::mem::size_of::<json_object_string>() as libc::c_ulong)
        .wrapping_sub(::core::mem::size_of::<C2RustUnnamed>() as libc::c_ulong)
        .wrapping_add(len)
        .wrapping_add(1 as libc::c_int as libc::c_ulong);
    if len < ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong {
...
pub unsafe extern "C" fn json_object_new_string(
    ...
    return {let crown_promoted_local_0 = strlen(s);_json_object_new_string(s, crown_promoted_local_0)};
}
#[no_mangle]
...
unsafe extern "C" fn _json_object_get_string_len(
    ...
    len = (*jso).len;
    return if len < 0 as libc::c_int as ssize_t { -len } else { len };
}
#[no_mangle]
...
unsafe extern "C" fn _json_object_set_string_len(
    ...
    if len >= (2147483647 as libc::c_int - 1 as libc::c_int) as size_t {
        return 0 as libc::c_int;
    }
    curlen = (*JC_STRING(jso)).len;
    if curlen < 0 as libc::c_int as ssize_t {
    ...
    if len as ssize_t > curlen {
        dstbuf = malloc(len.wrapping_add(1 as libc::c_int as size_t))
            as *mut libc::c_char;
        if dstbuf.is_null() {std::intrinsics::assume((dstbuf).addr() == 0);
            return 0 as libc::c_int;
        }
        if (*JC_STRING(jso)).len < 0 as libc::c_int as ssize_t {
            free((*JC_STRING(jso)).c_string.pdata as *mut libc::c_void);
        ...
        newlen = -(len as ssize_t);
    } else if (*JC_STRING(jso)).len < 0 as libc::c_int as ssize_t {
        newlen = -(len as ssize_t);
    }
    memcpy(dstbuf as *mut libc::c_void, s as *const libc::c_void, len);
    *dstbuf.offset(len as isize) = '\0' as i32 as libc::c_char;
...
pub unsafe extern "C" fn json_object_set_string(
    ...
    return {let crown_promoted_local_0 = strlen(s);_json_object_set_string_len(jso, s, crown_promoted_local_0)};
}
#[no_mangle]
...
unsafe extern "C" fn json_object_array_delete(mut jso: *mut json_object) {
    crate::src::arraylist::array_list_free((*JC_ARRAY(jso)).c_array);
    json_object_generic_delete(jso);
}
#[no_mangle]
...
pub unsafe extern "C" fn json_object_new_array_ext(
    ...
    let mut jso: *mut json_object_array = json_object_new(
        json_type_array,
        ::core::mem::size_of::<json_object_array>() as libc::c_ulong,
    ...
    (*jso)
        .c_array = crate::src::arraylist::array_list_new2(
        Some(
            json_object_array_entry_free as unsafe extern "C" fn(*mut libc::c_void) -> (),
        ),
        initial_size,
    );
    if ((*jso).c_array).is_null() {std::intrinsics::assume(((*jso).c_array).addr() == 0);
        free(jso as *mut libc::c_void);
        return 0 as *mut json_object;
    }
    return &raw mut (*jso).base;
...
pub unsafe extern "C" fn json_object_get_array(
    ...
    if jso.is_null() {std::intrinsics::assume((jso).addr() == 0);
        return 0 as *mut crate::src::arraylist::array_list;
    }
    match (*jso).o_type as libc::c_uint {
        5 => return (*JC_ARRAY_C(jso)).c_array,
        _ => return 0 as *mut crate::src::arraylist::array_list,
    };
}
#[no_mangle]
pub unsafe extern "C" fn json_object_array_sort(
    ...
    crate::src::arraylist::array_list_sort((*JC_ARRAY(jso)).c_array, sort_fn);
}
#[no_mangle]
pub unsafe extern "C" fn json_object_array_bsearch(
    ...
    result = crate::src::arraylist::array_list_bsearch(
        &raw mut key as *mut *const json_object as *mut libc::c_void
            as *mut *const libc::c_void,
        (*JC_ARRAY_C(jso)).c_array,
        sort_fn,
    ) as *mut *mut json_object;
    if result.is_null() {std::intrinsics::assume((result).addr() == 0);
        return 0 as *mut json_object;
    }
    return *result;
}
...
pub unsafe extern "C" fn json_object_array_length(
    ...
    return crate::src::arraylist::array_list_length((*JC_ARRAY_C(jso)).c_array);
}
#[no_mangle]
pub unsafe extern "C" fn json_object_array_add(
    ...
    return crate::src::arraylist::array_list_add((*JC_ARRAY(jso)).c_array, val as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn json_object_array_insert_idx(
    ...
    {} else {
        __assert_fail(
            ...
            (*::core::mem::transmute::<
                ...
                &[libc::c_char; 85],
            >(
                b"int json_object_array_insert_idx(struct json_object *, size_t, struct json_object *)\0",
            ))
                .as_ptr(),
        );
    }
    ...
    return crate::src::arraylist::array_list_insert_idx(
...
pub unsafe extern "C" fn json_object_array_put_idx(
    ...
    return crate::src::arraylist::array_list_put_idx((*JC_ARRAY(jso)).c_array, idx, val as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn json_object_array_del_idx(
    ...
    return crate::src::arraylist::array_list_del_idx((*JC_ARRAY(jso)).c_array, idx, count);
}
#[no_mangle]
pub unsafe extern "C" fn json_object_array_get_idx(
    ...
    return crate::src::arraylist::array_list_get_idx((*JC_ARRAY_C(jso)).c_array, idx) as *mut json_object;
}
...
pub unsafe extern "C" fn json_object_array_shrink(
    ...
    return crate::src::arraylist::array_list_shrink((*JC_ARRAY(jso)).c_array, empty_slots as size_t);
}
#[no_mangle]
...
unsafe extern "C" fn json_object_all_values_equal(
    ...
    while !if !(iter.entry).is_null() {
        ...
        .is_null()
    {
        if crate::src::linkhash::lh_table_lookup_ex(
            (*JC_OBJECT(jso2)).c_object,
            iter.key as *mut libc::c_void,
            &raw mut sub as *mut *mut json_object as *mut libc::c_void
    ...
    match (*jso1).o_type as libc::c_uint {
        ...
        3 => {
                ...
                == json_object_int_type_int64 as libc::c_int as libc::c_uint
            {
                ...
                if (*int1).cint.c_int64 < 0 as libc::c_int as int64_t {
                    return 0 as libc::c_int;
                }
            ...
            if (*int2).cint.c_int64 < 0 as libc::c_int as int64_t {
                return 0 as libc::c_int;
            }
...
unsafe extern "C" fn json_object_copy_serializer_data(
    ...
    {
        let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
        if !((*src)._userdata).is_null() {} else {std::intrinsics::assume(((*src)._userdata).addr() == 0);
            __assert_fail(
        ...
        (*dst)._userdata = p as *mut libc::c_void;
    } else {
        crate::src::json_util::_json_c_set_last_err(
...
pub unsafe extern "C" fn json_c_shallow_copy_default(
    ...
    if (*dst).is_null() {std::intrinsics::assume((*dst).addr() == 0);
        *__errno_location() = 12 as libc::c_int;
        return -(1 as libc::c_int);
    }
...
unsafe extern "C" fn json_object_deep_copy_recursive(
    ...
    if !(*dst).is_null() {} else {std::intrinsics::assume((*dst).addr() == 0);
        __assert_fail(
...
unsafe extern "C" fn json_abort(mut message: *const libc::c_char) -> ! {
    ...
    }else { std::intrinsics::assume((message).addr() == 0); }
    abort();
}
