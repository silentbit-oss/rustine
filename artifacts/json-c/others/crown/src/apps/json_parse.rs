...
pub struct _IO_FILE {
    ...
    pub _markers: *mut crate::src::tests::test4::_IO_marker,
    ...
    pub _codecvt: *mut crate::src::tests::test_util_file::_IO_codecvt,
...
static mut formatted_output: libc::c_int = (1 as libc::c_int) << 0 as libc::c_int;
...
unsafe extern "C" fn showmem() {
    ...
    memset(
        &raw mut rusage as *mut rusage as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<rusage>() as libc::c_ulong,
    );
...
unsafe extern "C" fn parseit(
    mut fd: libc::c_int,
    mut callback: Option::<unsafe extern "C" fn(*mut crate::src::json_object::json_object) -> libc::c_int>,
) -> libc::c_int {
    ...
    tok = crate::src::json_tokener::json_tokener_new_ex(depth);
    ...
    if strict_mode != 0 {
        crate::src::json_tokener::json_tokener_set_flags(tok, 0x1 as libc::c_int | 0x2 as libc::c_int);
    }
    ...
    loop {
        ...
        total_read = total_read.wrapping_add(retu);
        let mut start_pos: size_t = 0 as libc::c_int as size_t;
        while start_pos != retu {
            obj = crate::src::json_tokener::json_tokener_parse_ex(
                tok,
                &raw mut *buf.as_mut_ptr().offset(start_pos as isize),
                retu.wrapping_sub(start_pos) as libc::c_int,
            );
            let mut jerr: json_tokener_error = crate::src::json_tokener::json_tokener_get_error(tok);
            ...
            start_pos = start_pos.wrapping_add((*tok).char_offset as size_t);
            if start_pos <= retu {} else {
                __assert_fail(
                    b"start_pos <= retu\0" as *const u8 as *const libc::c_char,
                    b"/home/enumclass/Documents/C2RustTranslation/bkp/json-c/apps/json_parse.c\0"
...
unsafe extern "C" fn showobj(mut new_obj: *mut crate::src::json_object::json_object) -> libc::c_int {
    ...
    if show_output != 0 {
        ...
        output = crate::src::json_object::json_object_to_json_string_ext(new_obj, formatted_output | color);
...
unsafe extern "C" fn usage(
    ...
    }else { std::intrinsics::assume((errmsg).addr() == 0); }
    fprintf(
        fp,
...
unsafe fn main_0(
    ...
    loop {
        opt = getopt(argc, argv, b"fF:hnsc\0" as *const u8 as *const libc::c_char);
        if !(opt != -(1 as libc::c_int)) {
            break;
        }
        match opt {
            102 => {
                formatted_output = (1 as libc::c_int) << 1 as libc::c_int;
            }
            70 => {
            ...
            99 => {
                color = (1 as libc::c_int) << 5 as libc::c_int;
            }
            104 => {
                usage(
    ...
    if parseit(
        fd,
        Some(showobj as unsafe extern "C" fn(*mut crate::src::json_object::json_object) -> libc::c_int),
    ) != 0 as libc::c_int
    {
