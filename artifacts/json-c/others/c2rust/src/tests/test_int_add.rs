...
unsafe fn main_0(
    ...
    if json_object_get_int64(tmp) == 200 as libc::c_int as int64_t {} else {
        __assert_fail(
    ...
    if json_object_get_uint64(tmp) == 200 as libc::c_int as uint64_t {} else {
        __assert_fail(
    ...
    json_object_int_inc(tmp, 200 as libc::c_int as int64_t);
    if json_object_get_int64(tmp) == 400 as libc::c_int as int64_t {} else {
        __assert_fail(
    ...
    if json_object_get_uint64(tmp) == 400 as libc::c_int as uint64_t {} else {
        __assert_fail(
    ...
    json_object_int_inc(tmp, -(200 as libc::c_int) as int64_t);
    if json_object_get_int64(tmp) == -(100 as libc::c_int) as int64_t {} else {
        __assert_fail(
    ...
    if json_object_get_uint64(tmp) == 0 as libc::c_int as uint64_t {} else {
        __assert_fail(
