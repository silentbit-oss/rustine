...
unsafe fn main_0(
    ...
    if json_object_get_int64(tmp) == 321321321 as libc::c_int as int64_t {} else {
        __assert_fail(
    ...
    if json_object_get_int64(tmp) == 123 as libc::c_int as int64_t {} else {
        __assert_fail(
    ...
    if json_object_get_uint64(tmp) == 123 as libc::c_int as uint64_t {} else {
        __assert_fail(
    ...
    if json_object_get_uint64(tmp) == 321321321 as libc::c_int as uint64_t {} else {
        __assert_fail(
