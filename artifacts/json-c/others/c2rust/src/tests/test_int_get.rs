...
unsafe fn main_0(
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int64(jtmp_0) == 5 as libc::c_int as int64_t {} else {
        __assert_fail(
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_uint64(jtmp_1) == 5 as libc::c_int as uint64_t {} else {
        __assert_fail(
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int64(jtmp_3) == 0 as libc::c_int as int64_t {} else {
        __assert_fail(
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_uint64(jtmp_4) == 0 as libc::c_int as uint64_t {} else {
        __assert_fail(
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int64(jtmp_6) == 0 as libc::c_int as int64_t {} else {
        __assert_fail(
            b"json_object_get_int64(jtmp) == 0\0" as *const u8 as *const libc::c_char,
            b"/home/enumclass/Documents/C2RustTranslation/bkp/json-c/tests/test_int_get.c\0"
                as *const u8 as *const libc::c_char,
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_uint64(jtmp_7) == 0 as libc::c_int as uint64_t {} else {
        __assert_fail(
            b"json_object_get_uint64(jtmp) == 0\0" as *const u8 as *const libc::c_char,
            b"/home/enumclass/Documents/C2RustTranslation/bkp/json-c/tests/test_int_get.c\0"
                as *const u8 as *const libc::c_char,
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int64(jtmp_9) == 0 as libc::c_int as int64_t {} else {
        __assert_fail(
            b"json_object_get_int64(jtmp) == 0\0" as *const u8 as *const libc::c_char,
            b"/home/enumclass/Documents/C2RustTranslation/bkp/json-c/tests/test_int_get.c\0"
                as *const u8 as *const libc::c_char,
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_uint64(jtmp_10) == 0 as libc::c_int as uint64_t {} else {
        __assert_fail(
            b"json_object_get_uint64(jtmp) == 0\0" as *const u8 as *const libc::c_char,
            b"/home/enumclass/Documents/C2RustTranslation/bkp/json-c/tests/test_int_get.c\0"
                as *const u8 as *const libc::c_char,
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int64(jtmp_12) == 4568789 as libc::c_int as int64_t {} else {
        __assert_fail(
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_uint64(jtmp_13) == 4568789 as libc::c_int as uint64_t {} else {
        __assert_fail(
    ...
    'c_10050: {
        if json_object_get_uint64(jtmp_13) == 4568789 as libc::c_int as uint64_t
        {} else {
            __assert_fail(
                b"json_object_get_uint64(jtmp) == 4568789\0" as *const u8
                    as *const libc::c_char,
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int64(jtmp_15) == 0 as libc::c_int as int64_t
        && *__errno_location() == 0 as libc::c_int
    {} else {
        __assert_fail(
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_uint64(jtmp_16) == 0 as libc::c_int as uint64_t
        && *__errno_location() == 0 as libc::c_int
    {} else {
        __assert_fail(
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int64(jtmp_18) == 333 as libc::c_int as int64_t {} else {
        __assert_fail(
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_uint64(jtmp_19) == 333 as libc::c_int as uint64_t {} else {
        __assert_fail(
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int64(jtmp_21) == 0 as libc::c_int as int64_t
        && *__errno_location() == 22 as libc::c_int
    {} else {
        __assert_fail(
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_uint64(jtmp_22) == 0 as libc::c_int as uint64_t
        && *__errno_location() == 22 as libc::c_int
    {} else {
        __assert_fail(
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int64(jtmp_24) == 0 as libc::c_int as int64_t
        && *__errno_location() == 22 as libc::c_int
    {} else {
        __assert_fail(
            b"json_object_get_int64(jtmp) == 0 && (*__errno_location ()) == 22\0"
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_uint64(jtmp_25) == 0 as libc::c_int as uint64_t
        && *__errno_location() == 22 as libc::c_int
    {} else {
        __assert_fail(
            b"json_object_get_uint64(jtmp) == 0 && (*__errno_location ()) == 22\0"
    ...
    *__errno_location() = 0 as libc::c_int;
    ...
    'c_8885: {
        if json_object_get_int(jtmp_27)
    ...
    *__errno_location() = 0 as libc::c_int;
    ...
    'c_8703: {
        if json_object_get_int(jtmp_29)
            == -(2147483647 as libc::c_int) - 1 as libc::c_int
            && *__errno_location() == 34 as libc::c_int
        {} else {
            __assert_fail(
    ...
    *__errno_location() = 0 as libc::c_int;
    ...
    'c_8519: {
        if json_object_get_int(jtmp_31)
            == -(2147483647 as libc::c_int) - 1 as libc::c_int
            && *__errno_location() == 0 as libc::c_int
        {} else {
            __assert_fail(
    ...
    let mut jtmp_32: *mut json_object = json_object_new_string(
        b"9223372036854775807\0" as *const u8 as *const libc::c_char,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int(jtmp_32) == 2147483647 as libc::c_int
        && *__errno_location() == 34 as libc::c_int
    {} else {
        __assert_fail(
            b"json_object_get_int(jtmp) == (2147483647) && (*__errno_location ()) == 34\0"
    ...
    let mut jtmp_33: *mut json_object = json_object_new_string(
        b"-9223372036854775808\0" as *const u8 as *const libc::c_char,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int(jtmp_33) == -(2147483647 as libc::c_int) - 1 as libc::c_int
        && *__errno_location() == 34 as libc::c_int
    {} else {
        __assert_fail(
            b"json_object_get_int(jtmp) == (-2147483647-1) && (*__errno_location ()) == 34\0"
    ...
    'c_8340: {
        if json_object_get_int(jtmp_33)
            == -(2147483647 as libc::c_int) - 1 as libc::c_int
            && *__errno_location() == 34 as libc::c_int
        {} else {
            __assert_fail(
    ...
    let mut jtmp_34: *mut json_object = json_object_new_double(
        ::core::f32::INFINITY as libc::c_double,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int(jtmp_34) == 2147483647 as libc::c_int
        && *__errno_location() == 34 as libc::c_int
    {} else {
        __assert_fail(
            b"json_object_get_int(jtmp) == (2147483647) && (*__errno_location ()) == 34\0"
    ...
    let mut jtmp_35: *mut json_object = json_object_new_double(
        -::core::f32::INFINITY as libc::c_double,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int(jtmp_35) == -(2147483647 as libc::c_int) - 1 as libc::c_int
        && *__errno_location() == 34 as libc::c_int
    {} else {
        __assert_fail(
            b"json_object_get_int(jtmp) == (-2147483647-1) && (*__errno_location ()) == 34\0"
    ...
    'c_8158: {
        if json_object_get_int(jtmp_35)
            == -(2147483647 as libc::c_int) - 1 as libc::c_int
            && *__errno_location() == 34 as libc::c_int
        {} else {
            __assert_fail(
    ...
    let mut jtmp_36: *mut json_object = json_object_new_double(
        ::core::f32::NAN as libc::c_double,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int(jtmp_36) == -(2147483647 as libc::c_int) - 1 as libc::c_int
        && *__errno_location() == 22 as libc::c_int
    {} else {
        __assert_fail(
    ...
    'c_8060: {
        if json_object_get_int(jtmp_36)
            == -(2147483647 as libc::c_int) - 1 as libc::c_int
            && *__errno_location() == 22 as libc::c_int
        {} else {
            __assert_fail(
    ...
    let mut jtmp_37: *mut json_object = json_object_new_int64(
        9223372036854775807 as libc::c_long,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int64(jtmp_37) == 9223372036854775807 as libc::c_long
        && *__errno_location() == 0 as libc::c_int
    {} else {
        __assert_fail(
    ...
    let mut jtmp_38: *mut json_object = json_object_new_int64(
        -(9223372036854775807 as libc::c_long) - 1 as libc::c_int as libc::c_long,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int64(jtmp_38)
        == -(9223372036854775807 as libc::c_long) - 1 as libc::c_int as libc::c_long
        && *__errno_location() == 0 as libc::c_int
    {} else {
        __assert_fail(
    ...
    let mut jtmp_39: *mut json_object = json_object_new_string(
        b"9223372036854775807\0" as *const u8 as *const libc::c_char,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int64(jtmp_39) == 9223372036854775807 as libc::c_long
        && *__errno_location() == 0 as libc::c_int
    {} else {
        __assert_fail(
            b"json_object_get_int64(jtmp) == (9223372036854775807L) && (*__errno_location ()) == 0\0"
    ...
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int64(jtmp_40)
        == -(9223372036854775807 as libc::c_long) - 1 as libc::c_int as libc::c_long
        && *__errno_location() == 0 as libc::c_int
    {} else {
        __assert_fail(
    ...
    let mut jtmp_41: *mut json_object = json_object_new_string(
        b"9223372036854775808\0" as *const u8 as *const libc::c_char,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int64(jtmp_41) == 9223372036854775807 as libc::c_long
        && *__errno_location() == 34 as libc::c_int
    {} else {
        __assert_fail(
    ...
    json_object_put(jtmp_41);
    let mut jtmp_42: *mut json_object = json_object_new_string(
        b"-9223372036854775809\0" as *const u8 as *const libc::c_char,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int64(jtmp_42)
        == -(9223372036854775807 as libc::c_long) - 1 as libc::c_int as libc::c_long
        && *__errno_location() == 34 as libc::c_int
    {} else {
        __assert_fail(
    ...
    json_object_put(jtmp_42);
    let mut jtmp_43: *mut json_object = json_object_new_double(
        ::core::f32::INFINITY as libc::c_double,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int64(jtmp_43) == 9223372036854775807 as libc::c_long
        && *__errno_location() == 34 as libc::c_int
    {} else {
        __assert_fail(
            b"json_object_get_int64(jtmp) == (9223372036854775807L) && (*__errno_location ()) == 34\0"
    ...
    json_object_put(jtmp_43);
    let mut jtmp_44: *mut json_object = json_object_new_double(
        -::core::f32::INFINITY as libc::c_double,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int64(jtmp_44)
        == -(9223372036854775807 as libc::c_long) - 1 as libc::c_int as libc::c_long
        && *__errno_location() == 34 as libc::c_int
    {} else {
        __assert_fail(
    ...
    json_object_put(jtmp_44);
    let mut jtmp_45: *mut json_object = json_object_new_double(
        ::core::f32::NAN as libc::c_double,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_int64(jtmp_45)
        == -(9223372036854775807 as libc::c_long) - 1 as libc::c_int as libc::c_long
        && *__errno_location() == 22 as libc::c_int
    {} else {
        __assert_fail(
    ...
    json_object_put(jtmp_45);
    printf(b"INT64 GET PASSED\n\0" as *const u8 as *const libc::c_char);
    let mut jtmp_46: *mut json_object = json_object_new_uint64(
        18446744073709551615 as libc::c_ulong,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_uint64(jtmp_46) == 18446744073709551615 as libc::c_ulong
        && *__errno_location() == 0 as libc::c_int
    {} else {
        __assert_fail(
    ...
    json_object_put(jtmp_46);
    let mut jtmp_47: *mut json_object = json_object_new_uint64(
        -(1 as libc::c_int) as uint64_t,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_uint64(jtmp_47) == 18446744073709551615 as libc::c_ulong
        && *__errno_location() == 0 as libc::c_int
    {} else {
        __assert_fail(
            b"json_object_get_uint64(jtmp) == (18446744073709551615UL) && (*__errno_location ()) == 0\0"
    ...
    json_object_put(jtmp_47);
    let mut jtmp_48: *mut json_object = json_object_new_string(
        b"18446744073709551616\0" as *const u8 as *const libc::c_char,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_uint64(jtmp_48) == 18446744073709551615 as libc::c_ulong
        && *__errno_location() == 34 as libc::c_int
    {} else {
        __assert_fail(
    ...
    json_object_put(jtmp_48);
    let mut jtmp_49: *mut json_object = json_object_new_double(
        ::core::f32::INFINITY as libc::c_double,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_uint64(jtmp_49) == 18446744073709551615 as libc::c_ulong
        && *__errno_location() == 34 as libc::c_int
    {} else {
        __assert_fail(
            b"json_object_get_uint64(jtmp) == (18446744073709551615UL) && (*__errno_location ()) == 34\0"
    ...
    json_object_put(jtmp_49);
    let mut jtmp_50: *mut json_object = json_object_new_double(
        -::core::f32::INFINITY as libc::c_double,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_uint64(jtmp_50) == 0 as libc::c_int as uint64_t
        && *__errno_location() == 34 as libc::c_int
    {} else {
        __assert_fail(
    ...
    json_object_put(jtmp_50);
    let mut jtmp_51: *mut json_object = json_object_new_double(
        ::core::f32::NAN as libc::c_double,
    );
    *__errno_location() = 0 as libc::c_int;
    if json_object_get_uint64(jtmp_51) == 0 as libc::c_int as uint64_t
        && *__errno_location() == 22 as libc::c_int
    {} else {
        __assert_fail(
            b"json_object_get_uint64(jtmp) == 0 && (*__errno_location ()) == 22\0"
