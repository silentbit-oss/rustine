...
pub unsafe extern "C" fn test_array_insert_idx() {
    ...
    json_object_array_add(my_array, json_object_new_int(1 as libc::c_int));
    json_object_array_add(my_array, json_object_new_int(2 as libc::c_int));
    json_object_array_add(my_array, json_object_new_int(5 as libc::c_int));
    json_object_array_insert_idx(
        my_array,
        2 as libc::c_int as size_t,
        json_object_new_int(4 as libc::c_int),
    );
    jo1 = json_tokener_parse(b"[1, 2, 4, 5]\0" as *const u8 as *const libc::c_char);
    if 1 as libc::c_int == json_object_equal(my_array, jo1) {} else {
        __assert_fail(
    ...
    json_object_array_insert_idx(
        my_array,
        2 as libc::c_int as size_t,
        json_object_new_int(3 as libc::c_int),
    );
    jo1 = json_tokener_parse(b"[1, 2, 3, 4, 5]\0" as *const u8 as *const libc::c_char);
    if 1 as libc::c_int == json_object_equal(my_array, jo1) {} else {
        __assert_fail(
            b"1 == json_object_equal(my_array, jo1)\0" as *const u8
                as *const libc::c_char,
    ...
    json_object_array_insert_idx(
        ...
        json_object_new_int(8 as libc::c_int),
    );
    jo1 = json_tokener_parse(
...
unsafe fn main_0(
    ...
    while i < json_object_array_length(my_array) {
        ...
        printf(
            b"\t[%d]=%s\n\0" as *const u8 as *const libc::c_char,
            i as libc::c_int,
            json_object_to_json_string(obj_0),
        );
        i = i.wrapping_add(1);
        i;
    }
    ...
    while i < json_object_array_length(my_array) {
        ...
        printf(
            b"\t[%d]=%s\n\0" as *const u8 as *const libc::c_char,
            i as libc::c_int,
            json_object_to_json_string(obj_1),
        );
        i = i.wrapping_add(1);
        i;
    }
