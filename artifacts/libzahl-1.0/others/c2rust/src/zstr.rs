...
pub unsafe extern "C" fn zstr(
    ...
    if b.is_null() {
        b = malloc(n.wrapping_add(1 as libc::c_int as size_t)) as *mut libc::c_char;
        if b.is_null() {
            libzahl_error = *__errno_location();
            longjmp(libzahl_jmp_buf.as_mut_ptr(), 1 as libc::c_int);
        }
    ...
    *b.offset(0 as libc::c_int as isize) = '-' as i32 as libc::c_char;
    ...
    n = n.wrapping_sub(neg as size_t);
    n = if n > 9 as libc::c_int as size_t {
        n.wrapping_sub(9 as libc::c_int as size_t)
    } else {
    ...
    loop {
        ...
        if zzero(libzahl_tmp_str_num.as_mut_ptr()) == 0 {
            ...
            *b.offset(n.wrapping_add(9 as libc::c_int as size_t) as isize) = overridden;
