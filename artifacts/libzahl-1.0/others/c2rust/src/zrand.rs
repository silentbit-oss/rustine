...
unsafe extern "C" fn zrand_get_random_bits(
    ...
    let mut chars: size_t = bits
        .wrapping_add((32 as libc::c_int - 1 as libc::c_int) as size_t)
        >> 5 as libc::c_int;
    ...
    n = chars.wrapping_mul(::core::mem::size_of::<zahl_char_t>() as libc::c_ulong);
    while n != 0 {
        read_just = read(fd, buf.offset(read_total as isize) as *mut libc::c_void, n);
        if read_just < 0 as libc::c_int as ssize_t {
