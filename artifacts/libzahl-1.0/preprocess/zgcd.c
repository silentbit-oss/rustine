# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zgcd.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zgcd.c"
...
# 3 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zgcd.c" 2
...
zgcd(z_t a, z_t b, z_t c)
{
 ...
 for (; i < libzahl_tmp_gcd_u->used; i++)
  for (bit = 1; bit; bit <<= 1, shifts++)
   if (libzahl_tmp_gcd_u->chars[i] & bit)
    goto loop_done;
 for (; i < libzahl_tmp_gcd_v->used; i++)
  for (bit = 1; bit; bit <<= 1, shifts++)
