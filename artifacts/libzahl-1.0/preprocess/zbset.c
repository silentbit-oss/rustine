# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zbset.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zbset.c"
...
# 3 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zbset.c" 2
...
zbset(z_t a, z_t b, size_t bit, int action)
{
 ...
 if (action) {
  ...
  if (a->used <= chars) {
   do { if ((a)->alloced < (chars + 1)) libzahl_realloc(a, (chars + 1)); } while (0);
