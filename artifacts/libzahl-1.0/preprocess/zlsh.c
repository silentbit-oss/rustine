# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zlsh.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zlsh.c"
...
# 3 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zlsh.c" 2
...
zlsh(z_t a, z_t b, size_t bits)
{
 ...
 do { if ((a)->alloced < (b->used + chars)) libzahl_realloc(a, (b->used + chars)); } while (0);
 if (a == b)
 ...
 if (bits) {
  ...
  if (carry[i & 1]) {
   do { if ((a)->alloced < (a->used + 1)) libzahl_realloc(a, (a->used + 1)); } while (0);
   a->chars[i] = carry[i & 1];
   a->used++;
  }
 }
