# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zsetup.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zsetup.c"
...
# 3 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zsetup.c" 2


z_t libzahl_tmp_cmp; z_t libzahl_tmp_str_num; z_t libzahl_tmp_str_mag; z_t libzahl_tmp_str_div; z_t libzahl_tmp_str_rem; z_t libzahl_tmp_gcd_u; z_t libzahl_tmp_gcd_v; z_t libzahl_tmp_sub; z_t libzahl_tmp_modmul; z_t libzahl_tmp_div; z_t libzahl_tmp_mod; z_t libzahl_tmp_pow_b; z_t libzahl_tmp_pow_c; z_t libzahl_tmp_pow_d; z_t libzahl_tmp_modsqr; z_t libzahl_tmp_divmod_a; z_t libzahl_tmp_divmod_b; z_t libzahl_tmp_divmod_d; z_t libzahl_tmp_ptest_x; z_t libzahl_tmp_ptest_a; z_t libzahl_tmp_ptest_d; z_t libzahl_tmp_ptest_n1; z_t libzahl_tmp_ptest_n4;


z_t libzahl_const_1e19; z_t libzahl_const_1e9; z_t libzahl_const_1; z_t libzahl_const_2; z_t libzahl_const_4;
 ...
 *libzahl_jmp_buf = *env;
 ...
 if (!libzahl_set_up) {
  ...
  zinit(libzahl_tmp_cmp); zinit(libzahl_tmp_str_num); zinit(libzahl_tmp_str_mag); zinit(libzahl_tmp_str_div); zinit(libzahl_tmp_str_rem); zinit(libzahl_tmp_gcd_u); zinit(libzahl_tmp_gcd_v); zinit(libzahl_tmp_sub); zinit(libzahl_tmp_modmul); zinit(libzahl_tmp_div); zinit(libzahl_tmp_mod); zinit(libzahl_tmp_pow_b); zinit(libzahl_tmp_pow_c); zinit(libzahl_tmp_pow_d); zinit(libzahl_tmp_modsqr); zinit(libzahl_tmp_divmod_a); zinit(libzahl_tmp_divmod_b); zinit(libzahl_tmp_divmod_d); zinit(libzahl_tmp_ptest_x); zinit(libzahl_tmp_ptest_a); zinit(libzahl_tmp_ptest_d); zinit(libzahl_tmp_ptest_n1); zinit(libzahl_tmp_ptest_n4);;



  zinit(libzahl_const_1e19), zsetu(libzahl_const_1e19, 10000000000000000000ULL); zinit(libzahl_const_1e9), zsetu(libzahl_const_1e9, 1000000000ULL); zinit(libzahl_const_1), zsetu(libzahl_const_1, 1); zinit(libzahl_const_2), zsetu(libzahl_const_2, 2); zinit(libzahl_const_4), zsetu(libzahl_const_4, 4);;
