# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zunsetup.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zunsetup.c"
...
# 3 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zunsetup.c" 2
...
zunsetup(void)
{
 ...
 if (libzahl_set_up) {
  ...
  free(libzahl_tmp_cmp->chars); free(libzahl_tmp_str_num->chars); free(libzahl_tmp_str_mag->chars); free(libzahl_tmp_str_div->chars); free(libzahl_tmp_str_rem->chars); free(libzahl_tmp_gcd_u->chars); free(libzahl_tmp_gcd_v->chars); free(libzahl_tmp_sub->chars); free(libzahl_tmp_modmul->chars); free(libzahl_tmp_div->chars); free(libzahl_tmp_mod->chars); free(libzahl_tmp_pow_b->chars); free(libzahl_tmp_pow_c->chars); free(libzahl_tmp_pow_d->chars); free(libzahl_tmp_modsqr->chars); free(libzahl_tmp_divmod_a->chars); free(libzahl_tmp_divmod_b->chars); free(libzahl_tmp_divmod_d->chars); free(libzahl_tmp_ptest_x->chars); free(libzahl_tmp_ptest_a->chars); free(libzahl_tmp_ptest_d->chars); free(libzahl_tmp_ptest_n1->chars); free(libzahl_tmp_ptest_n4->chars);;



  free(libzahl_const_1e19->chars); free(libzahl_const_1e9->chars); free(libzahl_const_1->chars); free(libzahl_const_2->chars); free(libzahl_const_4->chars);;
