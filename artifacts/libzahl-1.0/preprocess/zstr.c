# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zstr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zstr.c"
...
# 3 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zstr.c" 2

# 1 "/home/enumclass/Documents/C2RustTranslation/pipeline/preprocess/fake_libc_include/stdio.h" 1
# 5 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zstr.c" 2
# 15 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zstr.c"
char *
zstr(z_t a, char *b)
{
 char buf[9 + 1];
 ...
 for (;;) {
  ...
  if (!zzero(libzahl_tmp_str_num)) {
   sprintf(b + n, "%09lu", zzero(libzahl_tmp_str_rem) ? 0UL : (unsigned long)(libzahl_tmp_str_rem->chars[0]));
   b[n + 9] = overridden;
   overridden = b[n];
   n = n > 9 ? (n - 9) : 0;
  } else {
