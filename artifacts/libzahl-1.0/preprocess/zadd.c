# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zadd.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zadd.c"
...
# 3 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zadd.c" 2
...
zadd_unsigned(z_t a, z_t b, z_t c)
{
 ...
 for (i = 0; i < n; i++) {
  if (carry[i & 1])
   carry[~i & 1] = (UINT32_MAX - a->chars[i] <= addend[i]);
  else
   carry[~i & 1] = (UINT32_MAX - a->chars[i] < addend[i]);
