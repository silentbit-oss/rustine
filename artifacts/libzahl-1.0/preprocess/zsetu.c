# 0 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zsetu.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zsetu.c"
...
# 3 "/home/enumclass/Documents/C2RustTranslation/bkp/libzahl-1.0/src/zsetu.c" 2
...
zsetu(z_t a, unsigned long long int b)
{
 ...
 do { if ((a)->alloced < (((sizeof(b) + sizeof(*(a->chars)) - 1) / sizeof(*(a->chars))))) libzahl_realloc(a, (((sizeof(b) + sizeof(*(a->chars)) - 1) / sizeof(*(a->chars))))); } while (0);
 ((a)->sign = (1));
 a->used = 0;
 while (b) {
