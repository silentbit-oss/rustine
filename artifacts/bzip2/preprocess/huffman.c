# 0 "/app/subjects/bzip2/huffman.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/app/subjects/bzip2/huffman.c"
# 22 "/app/subjects/bzip2/huffman.c"
...
BZ2_hbCreateDecodeTables ( Int32*, Int32*, Int32*, UChar*,
                           Int32, Int32, Int32 );
# 23 "/app/subjects/bzip2/huffman.c" 2
# 63 "/app/subjects/bzip2/huffman.c"
                             ...
                             Int32 maxLen )
{
   ...
   while (((Bool)1)) {
      ...
      if (! tooLong) break;
# 142 "/app/subjects/bzip2/huffman.c"
      for (i = 1; i <= alphaSize; i++) {
         j = weight[i] >> 8;
         j = 1 + (j / 2);
         weight[i] = j << 8;
