...
// hint:  ['inStr_idx_ref is a mutable refrence to unsigned int', 'outStr_idx_ref is a mutable refrence to unsigned int']
...
void helper_helper_helper_main_3_1_1(Cell * const aa, Int32 j)
{
  switch (aa->name[j])
  {
    case 'c':
...
// hint:  ['j_ref is a mutable refrence to Int32']
void helper_helper_main_3_1(Int32 * const j_ref, Cell * const aa)
{
  Int32 j = *j_ref;
  for (j = 1; aa->name[j] != '\0'; j += 1)
  {
    helper_helper_helper_main_3_1_1(aa, j);
  }
...
// hint:  ['j_ref is a mutable refrence to Int32']
void helper_main_3(Int32 * const j_ref, Cell * const aa)
{
  Int32 j = *j_ref;
  if (strcmp(aa->name, "--") == 0)
  {
...
// hint:  ['bzf_idx_ref is a mutable refrence to unsigned int', 'streamNo_ref is a mutable refrence to Int32', 'i_ref is a mutable refrence to Int32', 'unusedTmp_idx_ref is a mutable refrence to unsigned int']
...
// hint:  ['aa_idx_ref is a mutable refrence to unsigned int', 'decode_ref is a mutable refrence to Bool']
...
// hint:  ['bzf_idx_ref is a mutable refrence to unsigned int', 'nread_ref is a mutable refrence to Int32', 'streamNo_ref is a mutable refrence to Int32', 'i_ref is a mutable refrence to Int32', 'unusedTmp_idx_ref is a mutable refrence to unsigned int']
void helper_uncompressStream_1(unsigned int * const bzf_idx_ref, Int32 * const nread_ref, Int32 * const streamNo_ref, Int32 * const i_ref, unsigned int * const unusedTmp_idx_ref, FILE * const zStream, FILE * const stream, BZFILE * const bzf, Int32 bzerr, UChar obuf[5000], UChar unused[5000], Int32 nUnused, void * const unusedTmpV, UChar * const unusedTmp)
{
  unsigned int bzf_idx = *bzf_idx_ref;
...
void helper_main_2(Cell * const aa)
{
  if (strcmp(aa->name, "--") == 0)
  {
    break;
...
static Bool uncompressStream(FILE *zStream, FILE *stream)
{
  ...
  while ((Bool) 1)
  {
    helper_uncompressStream_1(&bzf_idx, &nread, &streamNo, &i, &unusedTmp_idx, zStream, stream, bzf, bzerr, obuf, unused, nUnused, unusedTmpV, unusedTmp);
  }
