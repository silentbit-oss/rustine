...
pub struct EState {
    ...
    pub arr1: Option<Vec<UInt32>>,
    pub arr2: Option<Vec<UInt32>>,
    pub ftab: Option<Vec<UInt32>>,
    pub origPtr: Int32,
    pub ptr: Option<Vec<UInt32>>,
    pub block: Option<Vec<UChar>>,
    pub mtfv: Option<Vec<UInt16>>,
    pub zbits: Option<Vec<UChar>>,
