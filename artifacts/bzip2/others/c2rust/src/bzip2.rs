...
unsafe extern "C" fn uInt64_from_UInt32s(
    ...
    (*n)
        .b[7 as libc::c_int
        as usize] = (hi32 >> 24 as libc::c_int & 0xff as libc::c_int as UInt32) as UChar;
    (*n)
        .b[6 as libc::c_int
        as usize] = (hi32 >> 16 as libc::c_int & 0xff as libc::c_int as UInt32) as UChar;
    (*n)
        .b[5 as libc::c_int
        as usize] = (hi32 >> 8 as libc::c_int & 0xff as libc::c_int as UInt32) as UChar;
    (*n).b[4 as libc::c_int as usize] = (hi32 & 0xff as libc::c_int as UInt32) as UChar;
    (*n)
        .b[3 as libc::c_int
        as usize] = (lo32 >> 24 as libc::c_int & 0xff as libc::c_int as UInt32) as UChar;
    (*n)
        .b[2 as libc::c_int
        as usize] = (lo32 >> 16 as libc::c_int & 0xff as libc::c_int as UInt32) as UChar;
    (*n)
        .b[1 as libc::c_int
        as usize] = (lo32 >> 8 as libc::c_int & 0xff as libc::c_int as UInt32) as UChar;
    (*n).b[0 as libc::c_int as usize] = (lo32 & 0xff as libc::c_int as UInt32) as UChar;
}
...
unsafe extern "C" fn uInt64_qrm10(mut n: *mut UInt64) -> Int32 {
    ...
    while i >= 0 as libc::c_int {
        tmp = (rem * 256 as libc::c_int as UInt32)
            .wrapping_add((*n).b[i as usize] as UInt32);
        (*n).b[i as usize] = (tmp / 10 as libc::c_int as UInt32) as UChar;
        rem = tmp % 10 as libc::c_int as UInt32;
        i -= 1;
        i;
    }
    return rem as Int32;
    ...
    if !(ferror(stream) != 0) {
        if !(ferror(zStream) != 0) {
            ...
            if bzerr != 0 as libc::c_int {
                current_block = 16490405360745617483;
            } else {
                ...
                loop {
                    ...
                    if ferror(stream) != 0 {
                        current_block = 10558691296855271122;
                        break;
                    }
                ...
                match current_block {
                    10558691296855271122 => {}
                    16490405360745617483 => {}
                    _ => {
                        BZ2_bzWriteClose64(
                            &mut bzerr,
                            bzf,
                                        ...
                                        if ferror(stream) != 0 {
                                            ...
                                            if ret == -(1 as libc::c_int) {
                                                ...
                                                if verbosity >= 1 as libc::c_int {
                                                    if nbytes_in_lo32 == 0 as libc::c_int as UInt32
                                                        && nbytes_in_hi32 == 0 as libc::c_int as UInt32
                                                    {
                                                        fprintf(
                                                            stderr,
            ...
            match current_block {
                ...
                _ => {
                    ...
                    match bzerr {
                        -9 => {
                            current_block = 18219932089923136765;
                            match current_block {
                                2318216883367804037 => {
                                    panic(
                        ...
                        -3 => {
                            current_block = 6801053210060364487;
                            match current_block {
                                2318216883367804037 => {
                                    panic(
                                        b"compress:unexpected error\0" as *const u8
                        ...
                        -6 => {}
                        _ => {
                            current_block = 2318216883367804037;
                            match current_block {
                                2318216883367804037 => {
                                    panic(
                                        b"compress:unexpected error\0" as *const u8
...
unsafe extern "C" fn uncompressStream(
    ...
    if !(ferror(stream) != 0) {
        if !(ferror(zStream) != 0) {
            's_37: loop {
                if !(1 as libc::c_int as Bool != 0) {
                    current_block = 14115668573823922359;
                    break;
                }
                bzf = BZ2_bzReadOpen(
                    &mut bzerr,
                ...
                if bzf.is_null() || bzerr != 0 as libc::c_int {
                    current_block = 1985472625393355384;
                    break;
                }
                streamNo += 1;
                streamNo;
                while bzerr == 0 as libc::c_int {
                    ...
                    if bzerr == -(5 as libc::c_int) {
                        current_block = 12433200056772737070;
                        break 's_37;
                    }
                    ...
                    if ferror(stream) != 0 {
                        current_block = 7288401511169961011;
                        break 's_37;
                    }
                }
                        ...
                        _ => {
                            match current_block {
                                1985472625393355384 => {
                                    ...
                                    match bzerr {
                                        -9 => {
                                            current_block = 1453219861829019671;
                                            match current_block {
                                                915434609822124871 => {
                                                    panic(
                                                ...
                                                18008106894064943527 => {
                                                    outOfMemory();
                                                }
                                                15186586185000703871 => {
                                                    compressedStreamEOF();
                                                }
                                                _ => {
                                                    if zStream != stdin {
                                        ...
                                        -3 => {
                                            current_block = 18008106894064943527;
                                            match current_block {
                                                915434609822124871 => {
                                                    panic(
                                                        b"decompress:unexpected error\0" as *const u8
                                        ...
                                        -7 => {
                                            current_block = 15186586185000703871;
                                            match current_block {
                                                915434609822124871 => {
                                                    panic(
                                                        b"decompress:unexpected error\0" as *const u8
                                        ...
                                        -5 => {
                                            current_block = 14089104929489300582;
                                            match current_block {
                                                915434609822124871 => {
                                                    panic(
                                                        b"decompress:unexpected error\0" as *const u8
                                        ...
                                        _ => {
                                            current_block = 915434609822124871;
                                            match current_block {
                                                915434609822124871 => {
                                                    panic(
                                                        b"decompress:unexpected error\0" as *const u8
...
unsafe extern "C" fn testStream(mut zStream: *mut FILE) -> Bool {
    ...
    if !(ferror(zStream) != 0) {
        's_29: loop {
            ...
            if bzf.is_null() || bzerr != 0 as libc::c_int {
                current_block = 13228589757831376859;
                break;
            }
            streamNo += 1;
            streamNo;
        ...
        match current_block {
            ...
            _ => {
                ...
                match bzerr {
                    -9 => {
                        current_block = 769859103124116079;
                        match current_block {
                            3916557021881384030 => {
                                panic(
                    ...
                    -6 => {}
                    -4 => {
                        current_block = 8338506562088262322;
                        match current_block {
                            3916557021881384030 => {
                                panic(
                                    b"test:unexpected error\0" as *const u8
                    ...
                    -3 => {
                        current_block = 18060889758800202101;
                        match current_block {
                            3916557021881384030 => {
                                panic(
                                    b"test:unexpected error\0" as *const u8
                    ...
                    -7 => {
                        current_block = 10850727971728771180;
                        match current_block {
                            3916557021881384030 => {
                                panic(
                                    b"test:unexpected error\0" as *const u8
                    ...
                    -5 => {
                        current_block = 2579311170923300325;
                        match current_block {
                            3916557021881384030 => {
                                panic(
                                    b"test:unexpected error\0" as *const u8
                    ...
                    _ => {
                        current_block = 3916557021881384030;
                        match current_block {
                            3916557021881384030 => {
                                panic(
                                    b"test:unexpected error\0" as *const u8
...
unsafe extern "C" fn countHardLinks(mut name: *mut Char) -> Int32 {
    ...
    return (statBuf.st_nlink).wrapping_sub(1 as libc::c_int as __nlink_t) as Int32;
}
    ...
    match srcMode {
        ...
        3 => {
            ...
            loop {
                ...
                {
                    current_block = 12393643333012952785;
                    break;
                }
                i += 1;
                i;
