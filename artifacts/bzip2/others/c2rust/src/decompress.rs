...
pub unsafe extern "C" fn BZ2_decompress(mut s: *mut DState) -> Int32 {
    ...
    match (*s).state {
        10 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as libc::c_int {
                    ...
                    retVal = 0 as libc::c_int;
                    current_block = 11717304878927251570;
                    break;
                } else {
                    (*s)
        ...
        12 => {
            current_block = 2123892893423497184;
        }
        13 => {
            current_block = 6647354717146955692;
        }
        14 => {
            current_block = 5923971150664689143;
        }
        15 => {
            current_block = 16895173841726248354;
        }
        16 => {
            current_block = 3428975173716614779;
        }
        17 => {
            current_block = 4092966239614665407;
        }
        18 => {
            current_block = 2980450203074785926;
        }
        19 => {
            current_block = 7027936441946786238;
        }
        20 => {
            current_block = 3316212072554826766;
        }
        21 => {
            current_block = 17788683342750976530;
        }
        22 => {
            current_block = 16763327625679766743;
        }
        23 => {
            current_block = 2753221582732090144;
        }
        24 => {
            current_block = 7028299883459863757;
        }
        25 => {
            current_block = 10558128394541571005;
        }
        26 => {
            current_block = 3090459483003093378;
        }
        27 => {
            current_block = 12357810967434783910;
        }
        28 => {
            current_block = 1014735324179809244;
        }
        29 => {
            current_block = 5068356807518902766;
        }
        30 => {
            current_block = 352174004638099311;
        }
        31 => {
            current_block = 17710424497559986530;
        }
        32 => {
            current_block = 11769676105048145885;
        }
        33 => {
            current_block = 16287285214608083696;
        }
        34 => {
            current_block = 10164249394345525866;
        }
        35 => {
            current_block = 7927055803486018239;
        }
        36 => {
            current_block = 16749256938512238719;
        }
        37 => {
            current_block = 14866680452771743319;
        }
        38 => {
            current_block = 1160918837943143059;
        }
        39 => {
            current_block = 7428115157062513781;
        }
        40 => {
            current_block = 17897994839440848612;
        }
        41 => {
            current_block = 12844153872181735999;
        }
        42 => {
            current_block = 7420332858505820598;
        }
        43 => {
            current_block = 15618895202585715075;
        }
        44 => {
            current_block = 16256435526883039473;
        }
        45 => {
            current_block = 13166756517552135310;
        }
        46 => {
            current_block = 16089598228750784139;
        }
        47 => {
            current_block = 17269611726026144225;
        }
        48 => {
            current_block = 14713248164547525923;
        }
        49 => {
            current_block = 14825232298057625833;
        }
        50 => {
            current_block = 14137955793484410301;
        }
        _ => {
